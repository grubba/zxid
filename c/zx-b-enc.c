/* c/zx-b-enc.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
int zx_LEN_SO_b_ApplicationEPR(struct zx_ctx* c, struct zx_b_ApplicationEPR_s* x )
{
  ...
  if (1)
    len += zx_len_xmlns_if_not_seen(c, zx_ns_tab+(zx_b_NS >> ZX_TOK_NS_SHIFT), &pop_seen);
...
char* zx_ENC_SO_b_ApplicationEPR(struct zx_ctx* c, struct zx_b_ApplicationEPR_s* x, char* p )
{
  ...
  if (1)
    zx_add_xmlns_if_not_seen(c, zx_ns_tab+(zx_b_NS >> ZX_TOK_NS_SHIFT), &pop_seen);
  if (x->actor || x->mustUnderstand)
...
int zx_LEN_SO_b_CredentialsContext(struct zx_ctx* c, struct zx_b_CredentialsContext_s* x )
{
  ...
  for (se = x->SecurityMechID;
    se && se->g.tok == zx_b_SecurityMechID_ELEM;
    se = (struct zx_elem_s*)se->g.n)
    len += zx_LEN_SO_simple_elem(c,se, sizeof("b:SecurityMechID")-1, zx_ns_tab+(zx_b_NS >> ZX_TOK_NS_SHIFT));
...
char* zx_ENC_SO_b_CredentialsContext(struct zx_ctx* c, struct zx_b_CredentialsContext_s* x, char* p )
{
  ...
  for (se = x->SecurityMechID;
       se && se->g.tok == zx_b_SecurityMechID_ELEM;
       se = (struct zx_elem_s*)se->g.n)
    p = zx_ENC_SO_simple_elem(c, se, p, "b:SecurityMechID", sizeof("b:SecurityMechID")-1, zx_ns_tab+(zx_b_NS >> ZX_TOK_NS_SHIFT));
...
int zx_LEN_SO_b_UsageDirective(struct zx_ctx* c, struct zx_b_UsageDirective_s* x )
{
  ...
  for (se = &x->Dict->gg;
       ...
       se = (struct zx_elem_s*)se->g.n)
    len += zx_LEN_SO_tas3sol_Dict(c, (struct zx_tas3sol_Dict_s*)se);
...
char* zx_ENC_SO_b_UsageDirective(struct zx_ctx* c, struct zx_b_UsageDirective_s* x, char* p )
{
  ...
  for (se = &x->Dict->gg;
       se && se->g.tok == zx_tas3sol_Dict_ELEM;
       se = (struct zx_elem_s*)se->g.n)
    p = zx_ENC_SO_tas3sol_Dict(c, (struct zx_tas3sol_Dict_s*)se, p);
...
int zx_LEN_SO_b_UserInteraction(struct zx_ctx* c, struct zx_b_UserInteraction_s* x )
{
  ...
  for (se = &x->InteractionService->gg;
       ...
       se = (struct zx_elem_s*)se->g.n)
    len += zx_LEN_SO_b_InteractionService(c, (struct zx_b_InteractionService_s*)se);
...
char* zx_ENC_SO_b_UserInteraction(struct zx_ctx* c, struct zx_b_UserInteraction_s* x, char* p )
{
  ...
  for (se = &x->InteractionService->gg;
       se && se->g.tok == zx_b_InteractionService_ELEM;
       se = (struct zx_elem_s*)se->g.n)
    p = zx_ENC_SO_b_InteractionService(c, (struct zx_b_InteractionService_s*)se, p);
