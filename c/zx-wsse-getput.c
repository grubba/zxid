...
int zx_wsse_Security_NUM_BinarySecurityToken(struct zx_wsse_Security_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->BinarySecurityToken; y && y->gg.g.tok == zx_wsse_BinarySecurityToken_ELEM; ++n, y = (struct zx_wsse_BinarySecurityToken_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wsse_BinarySecurityToken_s* zx_wsse_Security_GET_BinarySecurityToken(struct zx_wsse_Security_s* x, int n)
{
  struct zx_wsse_BinarySecurityToken_s* y;
  if (!x) return 0;
  for (y = x->BinarySecurityToken; n>=0 && y && y->gg.g.tok == zx_wsse_BinarySecurityToken_ELEM; --n, y = (struct zx_wsse_BinarySecurityToken_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wsse_Security_PUT_BinarySecurityToken(struct zx_wsse_Security_s* x, int n, struct zx_wsse_BinarySecurityToken_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wsse_BinarySecurityToken_ELEM; --n, y = (struct zx_wsse_BinarySecurityToken_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wsse_Security_ADD_BinarySecurityToken(struct zx_wsse_Security_s* x, int n, struct zx_wsse_BinarySecurityToken_s* z)
{
  ...
  case -1:
    y = x->BinarySecurityToken;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wsse_BinarySecurityToken_ELEM; y = (struct zx_wsse_BinarySecurityToken_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->BinarySecurityToken; n > 1 && y && y->gg.g.tok == zx_wsse_BinarySecurityToken_ELEM; --n, y = (struct zx_wsse_BinarySecurityToken_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wsse_Security_DEL_BinarySecurityToken(struct zx_wsse_Security_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->BinarySecurityToken; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wsse_BinarySecurityToken_ELEM; --n, y = (struct zx_wsse_BinarySecurityToken_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wsse_Security_NUM_Timestamp(struct zx_wsse_Security_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Timestamp; y && y->gg.g.tok == zx_wsu_Timestamp_ELEM; ++n, y = (struct zx_wsu_Timestamp_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wsu_Timestamp_s* zx_wsse_Security_GET_Timestamp(struct zx_wsse_Security_s* x, int n)
{
  struct zx_wsu_Timestamp_s* y;
  if (!x) return 0;
  for (y = x->Timestamp; n>=0 && y && y->gg.g.tok == zx_wsu_Timestamp_ELEM; --n, y = (struct zx_wsu_Timestamp_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wsse_Security_PUT_Timestamp(struct zx_wsse_Security_s* x, int n, struct zx_wsu_Timestamp_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wsu_Timestamp_ELEM; --n, y = (struct zx_wsu_Timestamp_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wsse_Security_ADD_Timestamp(struct zx_wsse_Security_s* x, int n, struct zx_wsu_Timestamp_s* z)
{
  ...
  case -1:
    y = x->Timestamp;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wsu_Timestamp_ELEM; y = (struct zx_wsu_Timestamp_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Timestamp; n > 1 && y && y->gg.g.tok == zx_wsu_Timestamp_ELEM; --n, y = (struct zx_wsu_Timestamp_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wsse_Security_DEL_Timestamp(struct zx_wsse_Security_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Timestamp; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wsu_Timestamp_ELEM; --n, y = (struct zx_wsu_Timestamp_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wsse_SecurityTokenReference_NUM_KeyIdentifier(struct zx_wsse_SecurityTokenReference_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->KeyIdentifier; y && y->gg.g.tok == zx_wsse_KeyIdentifier_ELEM; ++n, y = (struct zx_wsse_KeyIdentifier_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wsse_KeyIdentifier_s* zx_wsse_SecurityTokenReference_GET_KeyIdentifier(struct zx_wsse_SecurityTokenReference_s* x, int n)
{
  struct zx_wsse_KeyIdentifier_s* y;
  if (!x) return 0;
  for (y = x->KeyIdentifier; n>=0 && y && y->gg.g.tok == zx_wsse_KeyIdentifier_ELEM; --n, y = (struct zx_wsse_KeyIdentifier_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wsse_SecurityTokenReference_PUT_KeyIdentifier(struct zx_wsse_SecurityTokenReference_s* x, int n, struct zx_wsse_KeyIdentifier_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wsse_KeyIdentifier_ELEM; --n, y = (struct zx_wsse_KeyIdentifier_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wsse_SecurityTokenReference_ADD_KeyIdentifier(struct zx_wsse_SecurityTokenReference_s* x, int n, struct zx_wsse_KeyIdentifier_s* z)
{
  ...
  case -1:
    y = x->KeyIdentifier;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wsse_KeyIdentifier_ELEM; y = (struct zx_wsse_KeyIdentifier_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->KeyIdentifier; n > 1 && y && y->gg.g.tok == zx_wsse_KeyIdentifier_ELEM; --n, y = (struct zx_wsse_KeyIdentifier_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wsse_SecurityTokenReference_DEL_KeyIdentifier(struct zx_wsse_SecurityTokenReference_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->KeyIdentifier; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wsse_KeyIdentifier_ELEM; --n, y = (struct zx_wsse_KeyIdentifier_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wsse_UsernameToken_NUM_Username(struct zx_wsse_UsernameToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Username; y && y->gg.g.tok == zx_wsse_Username_ELEM; ++n, y = (struct zx_wsse_Username_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wsse_Username_s* zx_wsse_UsernameToken_GET_Username(struct zx_wsse_UsernameToken_s* x, int n)
{
  struct zx_wsse_Username_s* y;
  if (!x) return 0;
  for (y = x->Username; n>=0 && y && y->gg.g.tok == zx_wsse_Username_ELEM; --n, y = (struct zx_wsse_Username_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wsse_UsernameToken_PUT_Username(struct zx_wsse_UsernameToken_s* x, int n, struct zx_wsse_Username_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wsse_Username_ELEM; --n, y = (struct zx_wsse_Username_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wsse_UsernameToken_ADD_Username(struct zx_wsse_UsernameToken_s* x, int n, struct zx_wsse_Username_s* z)
{
  ...
  case -1:
    y = x->Username;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wsse_Username_ELEM; y = (struct zx_wsse_Username_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Username; n > 1 && y && y->gg.g.tok == zx_wsse_Username_ELEM; --n, y = (struct zx_wsse_Username_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wsse_UsernameToken_DEL_Username(struct zx_wsse_UsernameToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Username; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wsse_Username_ELEM; --n, y = (struct zx_wsse_Username_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
