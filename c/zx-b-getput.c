/* c/zx-b-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
struct zx_attr_s* zx_b_ApplicationEPR_GET_ID(struct zx_b_ApplicationEPR_s* x) { return x->ID; }
/* FUNC(zx_b_ApplicationEPR_PUT_ID) */
void zx_b_ApplicationEPR_PUT_ID(struct zx_b_ApplicationEPR_s* x, struct zx_attr_s* y) { x->ID = y; }
/* FUNC(zx_b_ApplicationEPR_GET_id) */
struct zx_attr_s* zx_b_ApplicationEPR_GET_id(struct zx_b_ApplicationEPR_s* x) { return x->id; }
/* FUNC(zx_b_ApplicationEPR_PUT_id) */
void zx_b_ApplicationEPR_PUT_id(struct zx_b_ApplicationEPR_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_b_ApplicationEPR_GET_notOnOrAfter) */
struct zx_attr_s* zx_b_ApplicationEPR_GET_notOnOrAfter(struct zx_b_ApplicationEPR_s* x) { return x->notOnOrAfter; }
/* FUNC(zx_b_ApplicationEPR_PUT_notOnOrAfter) */
void zx_b_ApplicationEPR_PUT_notOnOrAfter(struct zx_b_ApplicationEPR_s* x, struct zx_attr_s* y) { x->notOnOrAfter = y; }
/* FUNC(zx_b_ApplicationEPR_GET_Id) */
struct zx_attr_s* zx_b_ApplicationEPR_GET_Id(struct zx_b_ApplicationEPR_s* x) { return x->Id; }
/* FUNC(zx_b_ApplicationEPR_PUT_Id) */
void zx_b_ApplicationEPR_PUT_Id(struct zx_b_ApplicationEPR_s* x, struct zx_attr_s* y) { x->Id = y; }
/* FUNC(zx_b_ApplicationEPR_GET_actor) */
struct zx_attr_s* zx_b_ApplicationEPR_GET_actor(struct zx_b_ApplicationEPR_s* x) { return x->actor; }
/* FUNC(zx_b_ApplicationEPR_PUT_actor) */
void zx_b_ApplicationEPR_PUT_actor(struct zx_b_ApplicationEPR_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_b_ApplicationEPR_GET_mustUnderstand) */
struct zx_attr_s* zx_b_ApplicationEPR_GET_mustUnderstand(struct zx_b_ApplicationEPR_s* x) { return x->mustUnderstand; }
/* FUNC(zx_b_ApplicationEPR_PUT_mustUnderstand) */
void zx_b_ApplicationEPR_PUT_mustUnderstand(struct zx_b_ApplicationEPR_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
...
struct zx_attr_s* zx_b_Consent_GET_id(struct zx_b_Consent_s* x) { return x->id; }
/* FUNC(zx_b_Consent_PUT_id) */
void zx_b_Consent_PUT_id(struct zx_b_Consent_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_b_Consent_GET_timestamp) */
struct zx_attr_s* zx_b_Consent_GET_timestamp(struct zx_b_Consent_s* x) { return x->timestamp; }
/* FUNC(zx_b_Consent_PUT_timestamp) */
void zx_b_Consent_PUT_timestamp(struct zx_b_Consent_s* x, struct zx_attr_s* y) { x->timestamp = y; }
/* FUNC(zx_b_Consent_GET_uri) */
struct zx_attr_s* zx_b_Consent_GET_uri(struct zx_b_Consent_s* x) { return x->uri; }
/* FUNC(zx_b_Consent_PUT_uri) */
void zx_b_Consent_PUT_uri(struct zx_b_Consent_s* x, struct zx_attr_s* y) { x->uri = y; }
/* FUNC(zx_b_Consent_GET_Id) */
struct zx_attr_s* zx_b_Consent_GET_Id(struct zx_b_Consent_s* x) { return x->Id; }
/* FUNC(zx_b_Consent_PUT_Id) */
void zx_b_Consent_PUT_Id(struct zx_b_Consent_s* x, struct zx_attr_s* y) { x->Id = y; }
/* FUNC(zx_b_Consent_GET_actor) */
struct zx_attr_s* zx_b_Consent_GET_actor(struct zx_b_Consent_s* x) { return x->actor; }
/* FUNC(zx_b_Consent_PUT_actor) */
void zx_b_Consent_PUT_actor(struct zx_b_Consent_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_b_Consent_GET_mustUnderstand) */
struct zx_attr_s* zx_b_Consent_GET_mustUnderstand(struct zx_b_Consent_s* x) { return x->mustUnderstand; }
/* FUNC(zx_b_Consent_PUT_mustUnderstand) */
void zx_b_Consent_PUT_mustUnderstand(struct zx_b_Consent_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
...
struct zx_attr_s* zx_b_CredentialsContext_GET_id(struct zx_b_CredentialsContext_s* x) { return x->id; }
/* FUNC(zx_b_CredentialsContext_PUT_id) */
void zx_b_CredentialsContext_PUT_id(struct zx_b_CredentialsContext_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_b_CredentialsContext_GET_Id) */
struct zx_attr_s* zx_b_CredentialsContext_GET_Id(struct zx_b_CredentialsContext_s* x) { return x->Id; }
/* FUNC(zx_b_CredentialsContext_PUT_Id) */
void zx_b_CredentialsContext_PUT_Id(struct zx_b_CredentialsContext_s* x, struct zx_attr_s* y) { x->Id = y; }
/* FUNC(zx_b_CredentialsContext_GET_actor) */
struct zx_attr_s* zx_b_CredentialsContext_GET_actor(struct zx_b_CredentialsContext_s* x) { return x->actor; }
/* FUNC(zx_b_CredentialsContext_PUT_actor) */
void zx_b_CredentialsContext_PUT_actor(struct zx_b_CredentialsContext_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_b_CredentialsContext_GET_mustUnderstand) */
struct zx_attr_s* zx_b_CredentialsContext_GET_mustUnderstand(struct zx_b_CredentialsContext_s* x) { return x->mustUnderstand; }
/* FUNC(zx_b_CredentialsContext_PUT_mustUnderstand) */
void zx_b_CredentialsContext_PUT_mustUnderstand(struct zx_b_CredentialsContext_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
...
struct zx_attr_s* zx_b_EndpointUpdate_GET_ID(struct zx_b_EndpointUpdate_s* x) { return x->ID; }
/* FUNC(zx_b_EndpointUpdate_PUT_ID) */
void zx_b_EndpointUpdate_PUT_ID(struct zx_b_EndpointUpdate_s* x, struct zx_attr_s* y) { x->ID = y; }
/* FUNC(zx_b_EndpointUpdate_GET_id) */
struct zx_attr_s* zx_b_EndpointUpdate_GET_id(struct zx_b_EndpointUpdate_s* x) { return x->id; }
/* FUNC(zx_b_EndpointUpdate_PUT_id) */
void zx_b_EndpointUpdate_PUT_id(struct zx_b_EndpointUpdate_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_b_EndpointUpdate_GET_notOnOrAfter) */
struct zx_attr_s* zx_b_EndpointUpdate_GET_notOnOrAfter(struct zx_b_EndpointUpdate_s* x) { return x->notOnOrAfter; }
/* FUNC(zx_b_EndpointUpdate_PUT_notOnOrAfter) */
void zx_b_EndpointUpdate_PUT_notOnOrAfter(struct zx_b_EndpointUpdate_s* x, struct zx_attr_s* y) { x->notOnOrAfter = y; }
/* FUNC(zx_b_EndpointUpdate_GET_updateType) */
struct zx_attr_s* zx_b_EndpointUpdate_GET_updateType(struct zx_b_EndpointUpdate_s* x) { return x->updateType; }
/* FUNC(zx_b_EndpointUpdate_PUT_updateType) */
void zx_b_EndpointUpdate_PUT_updateType(struct zx_b_EndpointUpdate_s* x, struct zx_attr_s* y) { x->updateType = y; }
/* FUNC(zx_b_EndpointUpdate_GET_Id) */
struct zx_attr_s* zx_b_EndpointUpdate_GET_Id(struct zx_b_EndpointUpdate_s* x) { return x->Id; }
/* FUNC(zx_b_EndpointUpdate_PUT_Id) */
void zx_b_EndpointUpdate_PUT_Id(struct zx_b_EndpointUpdate_s* x, struct zx_attr_s* y) { x->Id = y; }
/* FUNC(zx_b_EndpointUpdate_GET_actor) */
struct zx_attr_s* zx_b_EndpointUpdate_GET_actor(struct zx_b_EndpointUpdate_s* x) { return x->actor; }
/* FUNC(zx_b_EndpointUpdate_PUT_actor) */
void zx_b_EndpointUpdate_PUT_actor(struct zx_b_EndpointUpdate_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_b_EndpointUpdate_GET_mustUnderstand) */
struct zx_attr_s* zx_b_EndpointUpdate_GET_mustUnderstand(struct zx_b_EndpointUpdate_s* x) { return x->mustUnderstand; }
/* FUNC(zx_b_EndpointUpdate_PUT_mustUnderstand) */
void zx_b_EndpointUpdate_PUT_mustUnderstand(struct zx_b_EndpointUpdate_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
...
struct zx_attr_s* zx_b_Framework_GET_id(struct zx_b_Framework_s* x) { return x->id; }
/* FUNC(zx_b_Framework_PUT_id) */
void zx_b_Framework_PUT_id(struct zx_b_Framework_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_b_Framework_GET_version) */
struct zx_attr_s* zx_b_Framework_GET_version(struct zx_b_Framework_s* x) { return x->version; }
/* FUNC(zx_b_Framework_PUT_version) */
void zx_b_Framework_PUT_version(struct zx_b_Framework_s* x, struct zx_attr_s* y) { x->version = y; }
/* FUNC(zx_b_Framework_GET_Id) */
struct zx_attr_s* zx_b_Framework_GET_Id(struct zx_b_Framework_s* x) { return x->Id; }
/* FUNC(zx_b_Framework_PUT_Id) */
void zx_b_Framework_PUT_Id(struct zx_b_Framework_s* x, struct zx_attr_s* y) { x->Id = y; }
/* FUNC(zx_b_Framework_GET_actor) */
struct zx_attr_s* zx_b_Framework_GET_actor(struct zx_b_Framework_s* x) { return x->actor; }
/* FUNC(zx_b_Framework_PUT_actor) */
void zx_b_Framework_PUT_actor(struct zx_b_Framework_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_b_Framework_GET_mustUnderstand) */
struct zx_attr_s* zx_b_Framework_GET_mustUnderstand(struct zx_b_Framework_s* x) { return x->mustUnderstand; }
/* FUNC(zx_b_Framework_PUT_mustUnderstand) */
void zx_b_Framework_PUT_mustUnderstand(struct zx_b_Framework_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
...
struct zx_attr_s* zx_b_InteractionService_GET_ID(struct zx_b_InteractionService_s* x) { return x->ID; }
/* FUNC(zx_b_InteractionService_PUT_ID) */
void zx_b_InteractionService_PUT_ID(struct zx_b_InteractionService_s* x, struct zx_attr_s* y) { x->ID = y; }
/* FUNC(zx_b_InteractionService_GET_id) */
struct zx_attr_s* zx_b_InteractionService_GET_id(struct zx_b_InteractionService_s* x) { return x->id; }
/* FUNC(zx_b_InteractionService_PUT_id) */
void zx_b_InteractionService_PUT_id(struct zx_b_InteractionService_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_b_InteractionService_GET_notOnOrAfter) */
struct zx_attr_s* zx_b_InteractionService_GET_notOnOrAfter(struct zx_b_InteractionService_s* x) { return x->notOnOrAfter; }
/* FUNC(zx_b_InteractionService_PUT_notOnOrAfter) */
void zx_b_InteractionService_PUT_notOnOrAfter(struct zx_b_InteractionService_s* x, struct zx_attr_s* y) { x->notOnOrAfter = y; }
/* FUNC(zx_b_InteractionService_GET_Id) */
struct zx_attr_s* zx_b_InteractionService_GET_Id(struct zx_b_InteractionService_s* x) { return x->Id; }
/* FUNC(zx_b_InteractionService_PUT_Id) */
void zx_b_InteractionService_PUT_Id(struct zx_b_InteractionService_s* x, struct zx_attr_s* y) { x->Id = y; }
/* FUNC(zx_b_InteractionService_GET_actor) */
struct zx_attr_s* zx_b_InteractionService_GET_actor(struct zx_b_InteractionService_s* x) { return x->actor; }
/* FUNC(zx_b_InteractionService_PUT_actor) */
void zx_b_InteractionService_PUT_actor(struct zx_b_InteractionService_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_b_InteractionService_GET_mustUnderstand) */
struct zx_attr_s* zx_b_InteractionService_GET_mustUnderstand(struct zx_b_InteractionService_s* x) { return x->mustUnderstand; }
/* FUNC(zx_b_InteractionService_PUT_mustUnderstand) */
void zx_b_InteractionService_PUT_mustUnderstand(struct zx_b_InteractionService_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
...
struct zx_attr_s* zx_b_ProcessingContext_GET_id(struct zx_b_ProcessingContext_s* x) { return x->id; }
/* FUNC(zx_b_ProcessingContext_PUT_id) */
void zx_b_ProcessingContext_PUT_id(struct zx_b_ProcessingContext_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_b_ProcessingContext_GET_Id) */
struct zx_attr_s* zx_b_ProcessingContext_GET_Id(struct zx_b_ProcessingContext_s* x) { return x->Id; }
/* FUNC(zx_b_ProcessingContext_PUT_Id) */
void zx_b_ProcessingContext_PUT_Id(struct zx_b_ProcessingContext_s* x, struct zx_attr_s* y) { x->Id = y; }
/* FUNC(zx_b_ProcessingContext_GET_actor) */
struct zx_attr_s* zx_b_ProcessingContext_GET_actor(struct zx_b_ProcessingContext_s* x) { return x->actor; }
/* FUNC(zx_b_ProcessingContext_PUT_actor) */
void zx_b_ProcessingContext_PUT_actor(struct zx_b_ProcessingContext_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_b_ProcessingContext_GET_mustUnderstand) */
struct zx_attr_s* zx_b_ProcessingContext_GET_mustUnderstand(struct zx_b_ProcessingContext_s* x) { return x->mustUnderstand; }
/* FUNC(zx_b_ProcessingContext_PUT_mustUnderstand) */
void zx_b_ProcessingContext_PUT_mustUnderstand(struct zx_b_ProcessingContext_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
...
struct zx_attr_s* zx_b_RedirectRequest_GET_id(struct zx_b_RedirectRequest_s* x) { return x->id; }
/* FUNC(zx_b_RedirectRequest_PUT_id) */
void zx_b_RedirectRequest_PUT_id(struct zx_b_RedirectRequest_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_b_RedirectRequest_GET_redirectURL) */
struct zx_attr_s* zx_b_RedirectRequest_GET_redirectURL(struct zx_b_RedirectRequest_s* x) { return x->redirectURL; }
/* FUNC(zx_b_RedirectRequest_PUT_redirectURL) */
void zx_b_RedirectRequest_PUT_redirectURL(struct zx_b_RedirectRequest_s* x, struct zx_attr_s* y) { x->redirectURL = y; }
/* FUNC(zx_b_RedirectRequest_GET_Id) */
struct zx_attr_s* zx_b_RedirectRequest_GET_Id(struct zx_b_RedirectRequest_s* x) { return x->Id; }
/* FUNC(zx_b_RedirectRequest_PUT_Id) */
void zx_b_RedirectRequest_PUT_Id(struct zx_b_RedirectRequest_s* x, struct zx_attr_s* y) { x->Id = y; }
/* FUNC(zx_b_RedirectRequest_GET_actor) */
struct zx_attr_s* zx_b_RedirectRequest_GET_actor(struct zx_b_RedirectRequest_s* x) { return x->actor; }
/* FUNC(zx_b_RedirectRequest_PUT_actor) */
void zx_b_RedirectRequest_PUT_actor(struct zx_b_RedirectRequest_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_b_RedirectRequest_GET_mustUnderstand) */
struct zx_attr_s* zx_b_RedirectRequest_GET_mustUnderstand(struct zx_b_RedirectRequest_s* x) { return x->mustUnderstand; }
/* FUNC(zx_b_RedirectRequest_PUT_mustUnderstand) */
void zx_b_RedirectRequest_PUT_mustUnderstand(struct zx_b_RedirectRequest_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
...
struct zx_attr_s* zx_b_Sender_GET_affiliationID(struct zx_b_Sender_s* x) { return x->affiliationID; }
/* FUNC(zx_b_Sender_PUT_affiliationID) */
void zx_b_Sender_PUT_affiliationID(struct zx_b_Sender_s* x, struct zx_attr_s* y) { x->affiliationID = y; }
/* FUNC(zx_b_Sender_GET_id) */
struct zx_attr_s* zx_b_Sender_GET_id(struct zx_b_Sender_s* x) { return x->id; }
/* FUNC(zx_b_Sender_PUT_id) */
void zx_b_Sender_PUT_id(struct zx_b_Sender_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_b_Sender_GET_providerID) */
struct zx_attr_s* zx_b_Sender_GET_providerID(struct zx_b_Sender_s* x) { return x->providerID; }
/* FUNC(zx_b_Sender_PUT_providerID) */
void zx_b_Sender_PUT_providerID(struct zx_b_Sender_s* x, struct zx_attr_s* y) { x->providerID = y; }
/* FUNC(zx_b_Sender_GET_Id) */
struct zx_attr_s* zx_b_Sender_GET_Id(struct zx_b_Sender_s* x) { return x->Id; }
/* FUNC(zx_b_Sender_PUT_Id) */
void zx_b_Sender_PUT_Id(struct zx_b_Sender_s* x, struct zx_attr_s* y) { x->Id = y; }
/* FUNC(zx_b_Sender_GET_actor) */
struct zx_attr_s* zx_b_Sender_GET_actor(struct zx_b_Sender_s* x) { return x->actor; }
/* FUNC(zx_b_Sender_PUT_actor) */
void zx_b_Sender_PUT_actor(struct zx_b_Sender_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_b_Sender_GET_mustUnderstand) */
struct zx_attr_s* zx_b_Sender_GET_mustUnderstand(struct zx_b_Sender_s* x) { return x->mustUnderstand; }
/* FUNC(zx_b_Sender_PUT_mustUnderstand) */
void zx_b_Sender_PUT_mustUnderstand(struct zx_b_Sender_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
...
struct zx_attr_s* zx_b_TargetIdentity_GET_id(struct zx_b_TargetIdentity_s* x) { return x->id; }
/* FUNC(zx_b_TargetIdentity_PUT_id) */
void zx_b_TargetIdentity_PUT_id(struct zx_b_TargetIdentity_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_b_TargetIdentity_GET_Id) */
struct zx_attr_s* zx_b_TargetIdentity_GET_Id(struct zx_b_TargetIdentity_s* x) { return x->Id; }
/* FUNC(zx_b_TargetIdentity_PUT_Id) */
void zx_b_TargetIdentity_PUT_Id(struct zx_b_TargetIdentity_s* x, struct zx_attr_s* y) { x->Id = y; }
/* FUNC(zx_b_TargetIdentity_GET_actor) */
struct zx_attr_s* zx_b_TargetIdentity_GET_actor(struct zx_b_TargetIdentity_s* x) { return x->actor; }
/* FUNC(zx_b_TargetIdentity_PUT_actor) */
void zx_b_TargetIdentity_PUT_actor(struct zx_b_TargetIdentity_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_b_TargetIdentity_GET_mustUnderstand) */
struct zx_attr_s* zx_b_TargetIdentity_GET_mustUnderstand(struct zx_b_TargetIdentity_s* x) { return x->mustUnderstand; }
/* FUNC(zx_b_TargetIdentity_PUT_mustUnderstand) */
void zx_b_TargetIdentity_PUT_mustUnderstand(struct zx_b_TargetIdentity_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
...
struct zx_attr_s* zx_b_Timeout_GET_id(struct zx_b_Timeout_s* x) { return x->id; }
/* FUNC(zx_b_Timeout_PUT_id) */
void zx_b_Timeout_PUT_id(struct zx_b_Timeout_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_b_Timeout_GET_maxProcessingTime) */
struct zx_attr_s* zx_b_Timeout_GET_maxProcessingTime(struct zx_b_Timeout_s* x) { return x->maxProcessingTime; }
/* FUNC(zx_b_Timeout_PUT_maxProcessingTime) */
void zx_b_Timeout_PUT_maxProcessingTime(struct zx_b_Timeout_s* x, struct zx_attr_s* y) { x->maxProcessingTime = y; }
/* FUNC(zx_b_Timeout_GET_Id) */
struct zx_attr_s* zx_b_Timeout_GET_Id(struct zx_b_Timeout_s* x) { return x->Id; }
/* FUNC(zx_b_Timeout_PUT_Id) */
void zx_b_Timeout_PUT_Id(struct zx_b_Timeout_s* x, struct zx_attr_s* y) { x->Id = y; }
/* FUNC(zx_b_Timeout_GET_actor) */
struct zx_attr_s* zx_b_Timeout_GET_actor(struct zx_b_Timeout_s* x) { return x->actor; }
/* FUNC(zx_b_Timeout_PUT_actor) */
void zx_b_Timeout_PUT_actor(struct zx_b_Timeout_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_b_Timeout_GET_mustUnderstand) */
struct zx_attr_s* zx_b_Timeout_GET_mustUnderstand(struct zx_b_Timeout_s* x) { return x->mustUnderstand; }
/* FUNC(zx_b_Timeout_PUT_mustUnderstand) */
void zx_b_Timeout_PUT_mustUnderstand(struct zx_b_Timeout_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
...
int zx_b_UsageDirective_NUM_Dict(struct zx_b_UsageDirective_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Dict; y && y->gg.g.tok == zx_tas3sol_Dict_ELEM; ++n, y = (struct zx_tas3sol_Dict_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_tas3sol_Dict_s* zx_b_UsageDirective_GET_Dict(struct zx_b_UsageDirective_s* x, int n)
{
  struct zx_tas3sol_Dict_s* y;
  if (!x) return 0;
  for (y = x->Dict; n>=0 && y && y->gg.g.tok == zx_tas3sol_Dict_ELEM; --n, y = (struct zx_tas3sol_Dict_s*)y->gg.g.n) ;
  return y;
}
...
void zx_b_UsageDirective_PUT_Dict(struct zx_b_UsageDirective_s* x, int n, struct zx_tas3sol_Dict_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_tas3sol_Dict_ELEM; --n, y = (struct zx_tas3sol_Dict_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_b_UsageDirective_ADD_Dict(struct zx_b_UsageDirective_s* x, int n, struct zx_tas3sol_Dict_s* z)
{
  ...
  case -1:
    y = x->Dict;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_tas3sol_Dict_ELEM; y = (struct zx_tas3sol_Dict_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Dict; n > 1 && y && y->gg.g.tok == zx_tas3sol_Dict_ELEM; --n, y = (struct zx_tas3sol_Dict_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_b_UsageDirective_DEL_Dict(struct zx_b_UsageDirective_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Dict; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_tas3sol_Dict_ELEM; --n, y = (struct zx_tas3sol_Dict_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_b_UsageDirective_GET_id(struct zx_b_UsageDirective_s* x) { return x->id; }
/* FUNC(zx_b_UsageDirective_PUT_id) */
void zx_b_UsageDirective_PUT_id(struct zx_b_UsageDirective_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_b_UsageDirective_GET_ref) */
struct zx_attr_s* zx_b_UsageDirective_GET_ref(struct zx_b_UsageDirective_s* x) { return x->ref; }
/* FUNC(zx_b_UsageDirective_PUT_ref) */
void zx_b_UsageDirective_PUT_ref(struct zx_b_UsageDirective_s* x, struct zx_attr_s* y) { x->ref = y; }
/* FUNC(zx_b_UsageDirective_GET_Id) */
struct zx_attr_s* zx_b_UsageDirective_GET_Id(struct zx_b_UsageDirective_s* x) { return x->Id; }
/* FUNC(zx_b_UsageDirective_PUT_Id) */
void zx_b_UsageDirective_PUT_Id(struct zx_b_UsageDirective_s* x, struct zx_attr_s* y) { x->Id = y; }
/* FUNC(zx_b_UsageDirective_GET_actor) */
struct zx_attr_s* zx_b_UsageDirective_GET_actor(struct zx_b_UsageDirective_s* x) { return x->actor; }
/* FUNC(zx_b_UsageDirective_PUT_actor) */
void zx_b_UsageDirective_PUT_actor(struct zx_b_UsageDirective_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_b_UsageDirective_GET_mustUnderstand) */
struct zx_attr_s* zx_b_UsageDirective_GET_mustUnderstand(struct zx_b_UsageDirective_s* x) { return x->mustUnderstand; }
/* FUNC(zx_b_UsageDirective_PUT_mustUnderstand) */
void zx_b_UsageDirective_PUT_mustUnderstand(struct zx_b_UsageDirective_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
...
int zx_b_UserInteraction_NUM_InteractionService(struct zx_b_UserInteraction_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->InteractionService; y && y->gg.g.tok == zx_b_InteractionService_ELEM; ++n, y = (struct zx_b_InteractionService_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_b_InteractionService_s* zx_b_UserInteraction_GET_InteractionService(struct zx_b_UserInteraction_s* x, int n)
{
  struct zx_b_InteractionService_s* y;
  if (!x) return 0;
  for (y = x->InteractionService; n>=0 && y && y->gg.g.tok == zx_b_InteractionService_ELEM; --n, y = (struct zx_b_InteractionService_s*)y->gg.g.n) ;
  return y;
}
...
void zx_b_UserInteraction_PUT_InteractionService(struct zx_b_UserInteraction_s* x, int n, struct zx_b_InteractionService_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_b_InteractionService_ELEM; --n, y = (struct zx_b_InteractionService_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_b_UserInteraction_ADD_InteractionService(struct zx_b_UserInteraction_s* x, int n, struct zx_b_InteractionService_s* z)
{
  ...
  case -1:
    y = x->InteractionService;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_b_InteractionService_ELEM; y = (struct zx_b_InteractionService_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->InteractionService; n > 1 && y && y->gg.g.tok == zx_b_InteractionService_ELEM; --n, y = (struct zx_b_InteractionService_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_b_UserInteraction_DEL_InteractionService(struct zx_b_UserInteraction_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->InteractionService; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_b_InteractionService_ELEM; --n, y = (struct zx_b_InteractionService_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_b_UserInteraction_GET_id(struct zx_b_UserInteraction_s* x) { return x->id; }
/* FUNC(zx_b_UserInteraction_PUT_id) */
void zx_b_UserInteraction_PUT_id(struct zx_b_UserInteraction_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_b_UserInteraction_GET_interact) */
struct zx_attr_s* zx_b_UserInteraction_GET_interact(struct zx_b_UserInteraction_s* x) { return x->interact; }
/* FUNC(zx_b_UserInteraction_PUT_interact) */
void zx_b_UserInteraction_PUT_interact(struct zx_b_UserInteraction_s* x, struct zx_attr_s* y) { x->interact = y; }
/* FUNC(zx_b_UserInteraction_GET_language) */
struct zx_attr_s* zx_b_UserInteraction_GET_language(struct zx_b_UserInteraction_s* x) { return x->language; }
/* FUNC(zx_b_UserInteraction_PUT_language) */
void zx_b_UserInteraction_PUT_language(struct zx_b_UserInteraction_s* x, struct zx_attr_s* y) { x->language = y; }
/* FUNC(zx_b_UserInteraction_GET_maxInteractTime) */
struct zx_attr_s* zx_b_UserInteraction_GET_maxInteractTime(struct zx_b_UserInteraction_s* x) { return x->maxInteractTime; }
/* FUNC(zx_b_UserInteraction_PUT_maxInteractTime) */
void zx_b_UserInteraction_PUT_maxInteractTime(struct zx_b_UserInteraction_s* x, struct zx_attr_s* y) { x->maxInteractTime = y; }
/* FUNC(zx_b_UserInteraction_GET_redirect) */
struct zx_attr_s* zx_b_UserInteraction_GET_redirect(struct zx_b_UserInteraction_s* x) { return x->redirect; }
/* FUNC(zx_b_UserInteraction_PUT_redirect) */
void zx_b_UserInteraction_PUT_redirect(struct zx_b_UserInteraction_s* x, struct zx_attr_s* y) { x->redirect = y; }
/* FUNC(zx_b_UserInteraction_GET_Id) */
struct zx_attr_s* zx_b_UserInteraction_GET_Id(struct zx_b_UserInteraction_s* x) { return x->Id; }
/* FUNC(zx_b_UserInteraction_PUT_Id) */
void zx_b_UserInteraction_PUT_Id(struct zx_b_UserInteraction_s* x, struct zx_attr_s* y) { x->Id = y; }
/* FUNC(zx_b_UserInteraction_GET_actor) */
struct zx_attr_s* zx_b_UserInteraction_GET_actor(struct zx_b_UserInteraction_s* x) { return x->actor; }
/* FUNC(zx_b_UserInteraction_PUT_actor) */
void zx_b_UserInteraction_PUT_actor(struct zx_b_UserInteraction_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_b_UserInteraction_GET_mustUnderstand) */
struct zx_attr_s* zx_b_UserInteraction_GET_mustUnderstand(struct zx_b_UserInteraction_s* x) { return x->mustUnderstand; }
/* FUNC(zx_b_UserInteraction_PUT_mustUnderstand) */
void zx_b_UserInteraction_PUT_mustUnderstand(struct zx_b_UserInteraction_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
