/* c/zx-sa11-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
struct zx_attr_s* zx_sa11_Action_GET_Namespace(struct zx_sa11_Action_s* x) { return x->Namespace; }
/* FUNC(zx_sa11_Action_PUT_Namespace) */
void zx_sa11_Action_PUT_Namespace(struct zx_sa11_Action_s* x, struct zx_attr_s* y) { x->Namespace = y; }
...
int zx_sa11_Advice_NUM_sa_Assertion(struct zx_sa11_Advice_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->sa_Assertion; y && y->gg.g.tok == zx_sa_Assertion_ELEM; ++n, y = (struct zx_sa_Assertion_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa_Assertion_s* zx_sa11_Advice_GET_sa_Assertion(struct zx_sa11_Advice_s* x, int n)
{
  struct zx_sa_Assertion_s* y;
  if (!x) return 0;
  for (y = x->sa_Assertion; n>=0 && y && y->gg.g.tok == zx_sa_Assertion_ELEM; --n, y = (struct zx_sa_Assertion_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa11_Advice_ADD_sa_Assertion(struct zx_sa11_Advice_s* x, int n, struct zx_sa_Assertion_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->sa_Assertion; n > 1 && y && y->gg.g.tok == zx_sa_Assertion_ELEM; --n, y = (struct zx_sa_Assertion_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa11_Advice_DEL_sa_Assertion(struct zx_sa11_Advice_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->sa_Assertion; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_Assertion_ELEM; --n, y = (struct zx_sa_Assertion_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_sa11_Assertion_GET_AssertionID(struct zx_sa11_Assertion_s* x) { return x->AssertionID; }
/* FUNC(zx_sa11_Assertion_PUT_AssertionID) */
void zx_sa11_Assertion_PUT_AssertionID(struct zx_sa11_Assertion_s* x, struct zx_attr_s* y) { x->AssertionID = y; }
/* FUNC(zx_sa11_Assertion_GET_IssueInstant) */
struct zx_attr_s* zx_sa11_Assertion_GET_IssueInstant(struct zx_sa11_Assertion_s* x) { return x->IssueInstant; }
/* FUNC(zx_sa11_Assertion_PUT_IssueInstant) */
void zx_sa11_Assertion_PUT_IssueInstant(struct zx_sa11_Assertion_s* x, struct zx_attr_s* y) { x->IssueInstant = y; }
/* FUNC(zx_sa11_Assertion_GET_Issuer) */
struct zx_attr_s* zx_sa11_Assertion_GET_Issuer(struct zx_sa11_Assertion_s* x) { return x->Issuer; }
/* FUNC(zx_sa11_Assertion_PUT_Issuer) */
void zx_sa11_Assertion_PUT_Issuer(struct zx_sa11_Assertion_s* x, struct zx_attr_s* y) { x->Issuer = y; }
/* FUNC(zx_sa11_Assertion_GET_MajorVersion) */
struct zx_attr_s* zx_sa11_Assertion_GET_MajorVersion(struct zx_sa11_Assertion_s* x) { return x->MajorVersion; }
/* FUNC(zx_sa11_Assertion_PUT_MajorVersion) */
void zx_sa11_Assertion_PUT_MajorVersion(struct zx_sa11_Assertion_s* x, struct zx_attr_s* y) { x->MajorVersion = y; }
/* FUNC(zx_sa11_Assertion_GET_MinorVersion) */
struct zx_attr_s* zx_sa11_Assertion_GET_MinorVersion(struct zx_sa11_Assertion_s* x) { return x->MinorVersion; }
/* FUNC(zx_sa11_Assertion_PUT_MinorVersion) */
void zx_sa11_Assertion_PUT_MinorVersion(struct zx_sa11_Assertion_s* x, struct zx_attr_s* y) { x->MinorVersion = y; }
...
int zx_sa11_Attribute_NUM_AttributeValue(struct zx_sa11_Attribute_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AttributeValue; y && y->gg.g.tok == zx_sa11_AttributeValue_ELEM; ++n, y = (struct zx_sa11_AttributeValue_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa11_AttributeValue_s* zx_sa11_Attribute_GET_AttributeValue(struct zx_sa11_Attribute_s* x, int n)
{
  struct zx_sa11_AttributeValue_s* y;
  if (!x) return 0;
  for (y = x->AttributeValue; n>=0 && y && y->gg.g.tok == zx_sa11_AttributeValue_ELEM; --n, y = (struct zx_sa11_AttributeValue_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa11_Attribute_PUT_AttributeValue(struct zx_sa11_Attribute_s* x, int n, struct zx_sa11_AttributeValue_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_AttributeValue_ELEM; --n, y = (struct zx_sa11_AttributeValue_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa11_Attribute_ADD_AttributeValue(struct zx_sa11_Attribute_s* x, int n, struct zx_sa11_AttributeValue_s* z)
{
  ...
  case -1:
    y = x->AttributeValue;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_AttributeValue_ELEM; y = (struct zx_sa11_AttributeValue_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->AttributeValue; n > 1 && y && y->gg.g.tok == zx_sa11_AttributeValue_ELEM; --n, y = (struct zx_sa11_AttributeValue_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa11_Attribute_DEL_AttributeValue(struct zx_sa11_Attribute_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AttributeValue; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_AttributeValue_ELEM; --n, y = (struct zx_sa11_AttributeValue_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_sa11_Attribute_GET_AttributeName(struct zx_sa11_Attribute_s* x) { return x->AttributeName; }
/* FUNC(zx_sa11_Attribute_PUT_AttributeName) */
void zx_sa11_Attribute_PUT_AttributeName(struct zx_sa11_Attribute_s* x, struct zx_attr_s* y) { x->AttributeName = y; }
/* FUNC(zx_sa11_Attribute_GET_AttributeNamespace) */
struct zx_attr_s* zx_sa11_Attribute_GET_AttributeNamespace(struct zx_sa11_Attribute_s* x) { return x->AttributeNamespace; }
/* FUNC(zx_sa11_Attribute_PUT_AttributeNamespace) */
void zx_sa11_Attribute_PUT_AttributeNamespace(struct zx_sa11_Attribute_s* x, struct zx_attr_s* y) { x->AttributeNamespace = y; }
...
struct zx_attr_s* zx_sa11_AttributeDesignator_GET_AttributeName(struct zx_sa11_AttributeDesignator_s* x) { return x->AttributeName; }
/* FUNC(zx_sa11_AttributeDesignator_PUT_AttributeName) */
void zx_sa11_AttributeDesignator_PUT_AttributeName(struct zx_sa11_AttributeDesignator_s* x, struct zx_attr_s* y) { x->AttributeName = y; }
/* FUNC(zx_sa11_AttributeDesignator_GET_AttributeNamespace) */
struct zx_attr_s* zx_sa11_AttributeDesignator_GET_AttributeNamespace(struct zx_sa11_AttributeDesignator_s* x) { return x->AttributeNamespace; }
/* FUNC(zx_sa11_AttributeDesignator_PUT_AttributeNamespace) */
void zx_sa11_AttributeDesignator_PUT_AttributeNamespace(struct zx_sa11_AttributeDesignator_s* x, struct zx_attr_s* y) { x->AttributeNamespace = y; }
...
int zx_sa11_AttributeStatement_NUM_Attribute(struct zx_sa11_AttributeStatement_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Attribute; y && y->gg.g.tok == zx_sa11_Attribute_ELEM; ++n, y = (struct zx_sa11_Attribute_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa11_Attribute_s* zx_sa11_AttributeStatement_GET_Attribute(struct zx_sa11_AttributeStatement_s* x, int n)
{
  struct zx_sa11_Attribute_s* y;
  if (!x) return 0;
  for (y = x->Attribute; n>=0 && y && y->gg.g.tok == zx_sa11_Attribute_ELEM; --n, y = (struct zx_sa11_Attribute_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa11_AttributeStatement_PUT_Attribute(struct zx_sa11_AttributeStatement_s* x, int n, struct zx_sa11_Attribute_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_Attribute_ELEM; --n, y = (struct zx_sa11_Attribute_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa11_AttributeStatement_ADD_Attribute(struct zx_sa11_AttributeStatement_s* x, int n, struct zx_sa11_Attribute_s* z)
{
  ...
  case -1:
    y = x->Attribute;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_Attribute_ELEM; y = (struct zx_sa11_Attribute_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Attribute; n > 1 && y && y->gg.g.tok == zx_sa11_Attribute_ELEM; --n, y = (struct zx_sa11_Attribute_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa11_AttributeStatement_DEL_Attribute(struct zx_sa11_AttributeStatement_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Attribute; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_Attribute_ELEM; --n, y = (struct zx_sa11_Attribute_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_sa11_AuthenticationStatement_GET_AuthenticationInstant(struct zx_sa11_AuthenticationStatement_s* x) { return x->AuthenticationInstant; }
/* FUNC(zx_sa11_AuthenticationStatement_PUT_AuthenticationInstant) */
void zx_sa11_AuthenticationStatement_PUT_AuthenticationInstant(struct zx_sa11_AuthenticationStatement_s* x, struct zx_attr_s* y) { x->AuthenticationInstant = y; }
/* FUNC(zx_sa11_AuthenticationStatement_GET_AuthenticationMethod) */
struct zx_attr_s* zx_sa11_AuthenticationStatement_GET_AuthenticationMethod(struct zx_sa11_AuthenticationStatement_s* x) { return x->AuthenticationMethod; }
/* FUNC(zx_sa11_AuthenticationStatement_PUT_AuthenticationMethod) */
void zx_sa11_AuthenticationStatement_PUT_AuthenticationMethod(struct zx_sa11_AuthenticationStatement_s* x, struct zx_attr_s* y) { x->AuthenticationMethod = y; }
...
struct zx_attr_s* zx_sa11_AuthorityBinding_GET_AuthorityKind(struct zx_sa11_AuthorityBinding_s* x) { return x->AuthorityKind; }
/* FUNC(zx_sa11_AuthorityBinding_PUT_AuthorityKind) */
void zx_sa11_AuthorityBinding_PUT_AuthorityKind(struct zx_sa11_AuthorityBinding_s* x, struct zx_attr_s* y) { x->AuthorityKind = y; }
/* FUNC(zx_sa11_AuthorityBinding_GET_Binding) */
struct zx_attr_s* zx_sa11_AuthorityBinding_GET_Binding(struct zx_sa11_AuthorityBinding_s* x) { return x->Binding; }
/* FUNC(zx_sa11_AuthorityBinding_PUT_Binding) */
void zx_sa11_AuthorityBinding_PUT_Binding(struct zx_sa11_AuthorityBinding_s* x, struct zx_attr_s* y) { x->Binding = y; }
/* FUNC(zx_sa11_AuthorityBinding_GET_Location) */
struct zx_attr_s* zx_sa11_AuthorityBinding_GET_Location(struct zx_sa11_AuthorityBinding_s* x) { return x->Location; }
/* FUNC(zx_sa11_AuthorityBinding_PUT_Location) */
void zx_sa11_AuthorityBinding_PUT_Location(struct zx_sa11_AuthorityBinding_s* x, struct zx_attr_s* y) { x->Location = y; }
...
int zx_sa11_AuthorizationDecisionStatement_NUM_Action(struct zx_sa11_AuthorizationDecisionStatement_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Action; y && y->gg.g.tok == zx_sa11_Action_ELEM; ++n, y = (struct zx_sa11_Action_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa11_Action_s* zx_sa11_AuthorizationDecisionStatement_GET_Action(struct zx_sa11_AuthorizationDecisionStatement_s* x, int n)
{
  struct zx_sa11_Action_s* y;
  if (!x) return 0;
  for (y = x->Action; n>=0 && y && y->gg.g.tok == zx_sa11_Action_ELEM; --n, y = (struct zx_sa11_Action_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa11_AuthorizationDecisionStatement_PUT_Action(struct zx_sa11_AuthorizationDecisionStatement_s* x, int n, struct zx_sa11_Action_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_Action_ELEM; --n, y = (struct zx_sa11_Action_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa11_AuthorizationDecisionStatement_ADD_Action(struct zx_sa11_AuthorizationDecisionStatement_s* x, int n, struct zx_sa11_Action_s* z)
{
  ...
  case -1:
    y = x->Action;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_Action_ELEM; y = (struct zx_sa11_Action_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Action; n > 1 && y && y->gg.g.tok == zx_sa11_Action_ELEM; --n, y = (struct zx_sa11_Action_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa11_AuthorizationDecisionStatement_DEL_Action(struct zx_sa11_AuthorizationDecisionStatement_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Action; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_Action_ELEM; --n, y = (struct zx_sa11_Action_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sa11_AuthorizationDecisionStatement_NUM_Evidence(struct zx_sa11_AuthorizationDecisionStatement_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Evidence; y && y->gg.g.tok == zx_sa11_Evidence_ELEM; ++n, y = (struct zx_sa11_Evidence_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa11_Evidence_s* zx_sa11_AuthorizationDecisionStatement_GET_Evidence(struct zx_sa11_AuthorizationDecisionStatement_s* x, int n)
{
  struct zx_sa11_Evidence_s* y;
  if (!x) return 0;
  for (y = x->Evidence; n>=0 && y && y->gg.g.tok == zx_sa11_Evidence_ELEM; --n, y = (struct zx_sa11_Evidence_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa11_AuthorizationDecisionStatement_PUT_Evidence(struct zx_sa11_AuthorizationDecisionStatement_s* x, int n, struct zx_sa11_Evidence_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_Evidence_ELEM; --n, y = (struct zx_sa11_Evidence_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa11_AuthorizationDecisionStatement_ADD_Evidence(struct zx_sa11_AuthorizationDecisionStatement_s* x, int n, struct zx_sa11_Evidence_s* z)
{
  ...
  case -1:
    y = x->Evidence;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_Evidence_ELEM; y = (struct zx_sa11_Evidence_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Evidence; n > 1 && y && y->gg.g.tok == zx_sa11_Evidence_ELEM; --n, y = (struct zx_sa11_Evidence_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa11_AuthorizationDecisionStatement_DEL_Evidence(struct zx_sa11_AuthorizationDecisionStatement_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Evidence; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_Evidence_ELEM; --n, y = (struct zx_sa11_Evidence_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_sa11_AuthorizationDecisionStatement_GET_Decision(struct zx_sa11_AuthorizationDecisionStatement_s* x) { return x->Decision; }
/* FUNC(zx_sa11_AuthorizationDecisionStatement_PUT_Decision) */
void zx_sa11_AuthorizationDecisionStatement_PUT_Decision(struct zx_sa11_AuthorizationDecisionStatement_s* x, struct zx_attr_s* y) { x->Decision = y; }
/* FUNC(zx_sa11_AuthorizationDecisionStatement_GET_Resource) */
struct zx_attr_s* zx_sa11_AuthorizationDecisionStatement_GET_Resource(struct zx_sa11_AuthorizationDecisionStatement_s* x) { return x->Resource; }
/* FUNC(zx_sa11_AuthorizationDecisionStatement_PUT_Resource) */
void zx_sa11_AuthorizationDecisionStatement_PUT_Resource(struct zx_sa11_AuthorizationDecisionStatement_s* x, struct zx_attr_s* y) { x->Resource = y; }
...
int zx_sa11_Conditions_NUM_AudienceRestrictionCondition(struct zx_sa11_Conditions_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AudienceRestrictionCondition; y && y->gg.g.tok == zx_sa11_AudienceRestrictionCondition_ELEM; ++n, y = (struct zx_sa11_AudienceRestrictionCondition_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa11_AudienceRestrictionCondition_s* zx_sa11_Conditions_GET_AudienceRestrictionCondition(struct zx_sa11_Conditions_s* x, int n)
{
  struct zx_sa11_AudienceRestrictionCondition_s* y;
  if (!x) return 0;
  for (y = x->AudienceRestrictionCondition; n>=0 && y && y->gg.g.tok == zx_sa11_AudienceRestrictionCondition_ELEM; --n, y = (struct zx_sa11_AudienceRestrictionCondition_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa11_Conditions_PUT_AudienceRestrictionCondition(struct zx_sa11_Conditions_s* x, int n, struct zx_sa11_AudienceRestrictionCondition_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_AudienceRestrictionCondition_ELEM; --n, y = (struct zx_sa11_AudienceRestrictionCondition_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa11_Conditions_ADD_AudienceRestrictionCondition(struct zx_sa11_Conditions_s* x, int n, struct zx_sa11_AudienceRestrictionCondition_s* z)
{
  ...
  case -1:
    y = x->AudienceRestrictionCondition;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_AudienceRestrictionCondition_ELEM; y = (struct zx_sa11_AudienceRestrictionCondition_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->AudienceRestrictionCondition; n > 1 && y && y->gg.g.tok == zx_sa11_AudienceRestrictionCondition_ELEM; --n, y = (struct zx_sa11_AudienceRestrictionCondition_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa11_Conditions_DEL_AudienceRestrictionCondition(struct zx_sa11_Conditions_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AudienceRestrictionCondition; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_AudienceRestrictionCondition_ELEM; --n, y = (struct zx_sa11_AudienceRestrictionCondition_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sa11_Conditions_NUM_DoNotCacheCondition(struct zx_sa11_Conditions_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->DoNotCacheCondition; y && y->gg.g.tok == zx_sa11_DoNotCacheCondition_ELEM; ++n, y = (struct zx_sa11_DoNotCacheCondition_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa11_DoNotCacheCondition_s* zx_sa11_Conditions_GET_DoNotCacheCondition(struct zx_sa11_Conditions_s* x, int n)
{
  struct zx_sa11_DoNotCacheCondition_s* y;
  if (!x) return 0;
  for (y = x->DoNotCacheCondition; n>=0 && y && y->gg.g.tok == zx_sa11_DoNotCacheCondition_ELEM; --n, y = (struct zx_sa11_DoNotCacheCondition_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa11_Conditions_PUT_DoNotCacheCondition(struct zx_sa11_Conditions_s* x, int n, struct zx_sa11_DoNotCacheCondition_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_DoNotCacheCondition_ELEM; --n, y = (struct zx_sa11_DoNotCacheCondition_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa11_Conditions_ADD_DoNotCacheCondition(struct zx_sa11_Conditions_s* x, int n, struct zx_sa11_DoNotCacheCondition_s* z)
{
  ...
  case -1:
    y = x->DoNotCacheCondition;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_DoNotCacheCondition_ELEM; y = (struct zx_sa11_DoNotCacheCondition_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->DoNotCacheCondition; n > 1 && y && y->gg.g.tok == zx_sa11_DoNotCacheCondition_ELEM; --n, y = (struct zx_sa11_DoNotCacheCondition_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa11_Conditions_DEL_DoNotCacheCondition(struct zx_sa11_Conditions_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->DoNotCacheCondition; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_DoNotCacheCondition_ELEM; --n, y = (struct zx_sa11_DoNotCacheCondition_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_sa11_Conditions_GET_NotBefore(struct zx_sa11_Conditions_s* x) { return x->NotBefore; }
/* FUNC(zx_sa11_Conditions_PUT_NotBefore) */
void zx_sa11_Conditions_PUT_NotBefore(struct zx_sa11_Conditions_s* x, struct zx_attr_s* y) { x->NotBefore = y; }
/* FUNC(zx_sa11_Conditions_GET_NotOnOrAfter) */
struct zx_attr_s* zx_sa11_Conditions_GET_NotOnOrAfter(struct zx_sa11_Conditions_s* x) { return x->NotOnOrAfter; }
/* FUNC(zx_sa11_Conditions_PUT_NotOnOrAfter) */
void zx_sa11_Conditions_PUT_NotOnOrAfter(struct zx_sa11_Conditions_s* x, struct zx_attr_s* y) { x->NotOnOrAfter = y; }
...
struct zx_attr_s* zx_sa11_NameIdentifier_GET_Format(struct zx_sa11_NameIdentifier_s* x) { return x->Format; }
/* FUNC(zx_sa11_NameIdentifier_PUT_Format) */
void zx_sa11_NameIdentifier_PUT_Format(struct zx_sa11_NameIdentifier_s* x, struct zx_attr_s* y) { x->Format = y; }
/* FUNC(zx_sa11_NameIdentifier_GET_NameQualifier) */
struct zx_attr_s* zx_sa11_NameIdentifier_GET_NameQualifier(struct zx_sa11_NameIdentifier_s* x) { return x->NameQualifier; }
/* FUNC(zx_sa11_NameIdentifier_PUT_NameQualifier) */
void zx_sa11_NameIdentifier_PUT_NameQualifier(struct zx_sa11_NameIdentifier_s* x, struct zx_attr_s* y) { x->NameQualifier = y; }
...
int zx_sa11_SubjectConfirmation_NUM_ConfirmationMethod(struct zx_sa11_SubjectConfirmation_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ConfirmationMethod; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_sa11_SubjectConfirmation_GET_ConfirmationMethod(struct zx_sa11_SubjectConfirmation_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->ConfirmationMethod; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_sa11_SubjectConfirmation_ADD_ConfirmationMethod(struct zx_sa11_SubjectConfirmation_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ConfirmationMethod; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_sa11_SubjectConfirmation_DEL_ConfirmationMethod(struct zx_sa11_SubjectConfirmation_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ConfirmationMethod; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_sa11_SubjectConfirmation_NUM_SubjectConfirmationData(struct zx_sa11_SubjectConfirmation_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->SubjectConfirmationData; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_sa11_SubjectConfirmation_GET_SubjectConfirmationData(struct zx_sa11_SubjectConfirmation_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->SubjectConfirmationData; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_sa11_SubjectConfirmation_ADD_SubjectConfirmationData(struct zx_sa11_SubjectConfirmation_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SubjectConfirmationData; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_sa11_SubjectConfirmation_DEL_SubjectConfirmationData(struct zx_sa11_SubjectConfirmation_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SubjectConfirmationData; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
struct zx_attr_s* zx_sa11_SubjectLocality_GET_DNSAddress(struct zx_sa11_SubjectLocality_s* x) { return x->DNSAddress; }
/* FUNC(zx_sa11_SubjectLocality_PUT_DNSAddress) */
void zx_sa11_SubjectLocality_PUT_DNSAddress(struct zx_sa11_SubjectLocality_s* x, struct zx_attr_s* y) { x->DNSAddress = y; }
/* FUNC(zx_sa11_SubjectLocality_GET_IPAddress) */
struct zx_attr_s* zx_sa11_SubjectLocality_GET_IPAddress(struct zx_sa11_SubjectLocality_s* x) { return x->IPAddress; }
/* FUNC(zx_sa11_SubjectLocality_PUT_IPAddress) */
void zx_sa11_SubjectLocality_PUT_IPAddress(struct zx_sa11_SubjectLocality_s* x, struct zx_attr_s* y) { x->IPAddress = y; }
