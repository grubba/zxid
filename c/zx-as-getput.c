/* c/zx-as-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
struct zx_attr_s* zx_as_Parameter_GET_name(struct zx_as_Parameter_s* x) { return x->name; }
/* FUNC(zx_as_Parameter_PUT_name) */
void zx_as_Parameter_PUT_name(struct zx_as_Parameter_s* x, struct zx_attr_s* y) { x->name = y; }
...
int zx_as_PasswordTransforms_NUM_Transform(struct zx_as_PasswordTransforms_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Transform; y && y->gg.g.tok == zx_as_Transform_ELEM; ++n, y = (struct zx_as_Transform_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_as_Transform_s* zx_as_PasswordTransforms_GET_Transform(struct zx_as_PasswordTransforms_s* x, int n)
{
  struct zx_as_Transform_s* y;
  if (!x) return 0;
  for (y = x->Transform; n>=0 && y && y->gg.g.tok == zx_as_Transform_ELEM; --n, y = (struct zx_as_Transform_s*)y->gg.g.n) ;
  return y;
}
...
void zx_as_PasswordTransforms_PUT_Transform(struct zx_as_PasswordTransforms_s* x, int n, struct zx_as_Transform_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_as_Transform_ELEM; --n, y = (struct zx_as_Transform_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_as_PasswordTransforms_ADD_Transform(struct zx_as_PasswordTransforms_s* x, int n, struct zx_as_Transform_s* z)
{
  ...
  case -1:
    ...
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_as_Transform_ELEM; y = (struct zx_as_Transform_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Transform; n > 1 && y && y->gg.g.tok == zx_as_Transform_ELEM; --n, y = (struct zx_as_Transform_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_as_PasswordTransforms_DEL_Transform(struct zx_as_PasswordTransforms_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Transform; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_as_Transform_ELEM; --n, y = (struct zx_as_Transform_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_as_SASLRequest_NUM_Data(struct zx_as_SASLRequest_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Data; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_as_SASLRequest_GET_Data(struct zx_as_SASLRequest_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->Data; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_as_SASLRequest_ADD_Data(struct zx_as_SASLRequest_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Data; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_as_SASLRequest_DEL_Data(struct zx_as_SASLRequest_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Data; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_as_SASLRequest_NUM_Extensions(struct zx_as_SASLRequest_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Extensions; y && y->gg.g.tok == zx_as_Extensions_ELEM; ++n, y = (struct zx_as_Extensions_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_as_Extensions_s* zx_as_SASLRequest_GET_Extensions(struct zx_as_SASLRequest_s* x, int n)
{
  struct zx_as_Extensions_s* y;
  if (!x) return 0;
  for (y = x->Extensions; n>=0 && y && y->gg.g.tok == zx_as_Extensions_ELEM; --n, y = (struct zx_as_Extensions_s*)y->gg.g.n) ;
  return y;
}
...
void zx_as_SASLRequest_PUT_Extensions(struct zx_as_SASLRequest_s* x, int n, struct zx_as_Extensions_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_as_Extensions_ELEM; --n, y = (struct zx_as_Extensions_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_as_SASLRequest_ADD_Extensions(struct zx_as_SASLRequest_s* x, int n, struct zx_as_Extensions_s* z)
{
  ...
  case -1:
    y = x->Extensions;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_as_Extensions_ELEM; y = (struct zx_as_Extensions_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Extensions; n > 1 && y && y->gg.g.tok == zx_as_Extensions_ELEM; --n, y = (struct zx_as_Extensions_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_as_SASLRequest_DEL_Extensions(struct zx_as_SASLRequest_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Extensions; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_as_Extensions_ELEM; --n, y = (struct zx_as_Extensions_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_as_SASLRequest_GET_advisoryAuthnID(struct zx_as_SASLRequest_s* x) { return x->advisoryAuthnID; }
/* FUNC(zx_as_SASLRequest_PUT_advisoryAuthnID) */
void zx_as_SASLRequest_PUT_advisoryAuthnID(struct zx_as_SASLRequest_s* x, struct zx_attr_s* y) { x->advisoryAuthnID = y; }
/* FUNC(zx_as_SASLRequest_GET_authzID) */
struct zx_attr_s* zx_as_SASLRequest_GET_authzID(struct zx_as_SASLRequest_s* x) { return x->authzID; }
/* FUNC(zx_as_SASLRequest_PUT_authzID) */
void zx_as_SASLRequest_PUT_authzID(struct zx_as_SASLRequest_s* x, struct zx_attr_s* y) { x->authzID = y; }
/* FUNC(zx_as_SASLRequest_GET_mechanism) */
struct zx_attr_s* zx_as_SASLRequest_GET_mechanism(struct zx_as_SASLRequest_s* x) { return x->mechanism; }
/* FUNC(zx_as_SASLRequest_PUT_mechanism) */
void zx_as_SASLRequest_PUT_mechanism(struct zx_as_SASLRequest_s* x, struct zx_attr_s* y) { x->mechanism = y; }
...
int zx_as_SASLResponse_NUM_PasswordTransforms(struct zx_as_SASLResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PasswordTransforms; y && y->gg.g.tok == zx_as_PasswordTransforms_ELEM; ++n, y = (struct zx_as_PasswordTransforms_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_as_PasswordTransforms_s* zx_as_SASLResponse_GET_PasswordTransforms(struct zx_as_SASLResponse_s* x, int n)
{
  struct zx_as_PasswordTransforms_s* y;
  if (!x) return 0;
  for (y = x->PasswordTransforms; n>=0 && y && y->gg.g.tok == zx_as_PasswordTransforms_ELEM; --n, y = (struct zx_as_PasswordTransforms_s*)y->gg.g.n) ;
  return y;
}
...
void zx_as_SASLResponse_PUT_PasswordTransforms(struct zx_as_SASLResponse_s* x, int n, struct zx_as_PasswordTransforms_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_as_PasswordTransforms_ELEM; --n, y = (struct zx_as_PasswordTransforms_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_as_SASLResponse_ADD_PasswordTransforms(struct zx_as_SASLResponse_s* x, int n, struct zx_as_PasswordTransforms_s* z)
{
  ...
  case -1:
    y = x->PasswordTransforms;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_as_PasswordTransforms_ELEM; y = (struct zx_as_PasswordTransforms_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->PasswordTransforms; n > 1 && y && y->gg.g.tok == zx_as_PasswordTransforms_ELEM; --n, y = (struct zx_as_PasswordTransforms_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_as_SASLResponse_DEL_PasswordTransforms(struct zx_as_SASLResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PasswordTransforms; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_as_PasswordTransforms_ELEM; --n, y = (struct zx_as_PasswordTransforms_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_as_SASLResponse_GET_serverMechanism(struct zx_as_SASLResponse_s* x) { return x->serverMechanism; }
/* FUNC(zx_as_SASLResponse_PUT_serverMechanism) */
void zx_as_SASLResponse_PUT_serverMechanism(struct zx_as_SASLResponse_s* x, struct zx_attr_s* y) { x->serverMechanism = y; }
...
int zx_as_Transform_NUM_Parameter(struct zx_as_Transform_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Parameter; y && y->gg.g.tok == zx_as_Parameter_ELEM; ++n, y = (struct zx_as_Parameter_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_as_Parameter_s* zx_as_Transform_GET_Parameter(struct zx_as_Transform_s* x, int n)
{
  struct zx_as_Parameter_s* y;
  if (!x) return 0;
  for (y = x->Parameter; n>=0 && y && y->gg.g.tok == zx_as_Parameter_ELEM; --n, y = (struct zx_as_Parameter_s*)y->gg.g.n) ;
  return y;
}
...
void zx_as_Transform_PUT_Parameter(struct zx_as_Transform_s* x, int n, struct zx_as_Parameter_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_as_Parameter_ELEM; --n, y = (struct zx_as_Parameter_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_as_Transform_ADD_Parameter(struct zx_as_Transform_s* x, int n, struct zx_as_Parameter_s* z)
{
  ...
  case -1:
    y = x->Parameter;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_as_Parameter_ELEM; y = (struct zx_as_Parameter_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Parameter; n > 1 && y && y->gg.g.tok == zx_as_Parameter_ELEM; --n, y = (struct zx_as_Parameter_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_as_Transform_DEL_Parameter(struct zx_as_Transform_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Parameter; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_as_Parameter_ELEM; --n, y = (struct zx_as_Parameter_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_as_Transform_GET_name(struct zx_as_Transform_s* x) { return x->name; }
/* FUNC(zx_as_Transform_PUT_name) */
void zx_as_Transform_PUT_name(struct zx_as_Transform_s* x, struct zx_attr_s* y) { x->name = y; }
