/* c/zx-ac-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
struct zx_attr_s* zx_ac_ActivationLimitDuration_GET_duration(struct zx_ac_ActivationLimitDuration_s* x) { return x->duration; }
/* FUNC(zx_ac_ActivationLimitDuration_PUT_duration) */
void zx_ac_ActivationLimitDuration_PUT_duration(struct zx_ac_ActivationLimitDuration_s* x, struct zx_attr_s* y) { x->duration = y; }
...
struct zx_attr_s* zx_ac_ActivationLimitUsages_GET_number(struct zx_ac_ActivationLimitUsages_s* x) { return x->number; }
/* FUNC(zx_ac_ActivationLimitUsages_PUT_number) */
void zx_ac_ActivationLimitUsages_PUT_number(struct zx_ac_ActivationLimitUsages_s* x, struct zx_attr_s* y) { x->number = y; }
...
struct zx_attr_s* zx_ac_Alphabet_GET_case_is_c_keyword(struct zx_ac_Alphabet_s* x) { return x->case_is_c_keyword; }
/* FUNC(zx_ac_Alphabet_PUT_case_is_c_keyword) */
void zx_ac_Alphabet_PUT_case_is_c_keyword(struct zx_ac_Alphabet_s* x, struct zx_attr_s* y) { x->case_is_c_keyword = y; }
/* FUNC(zx_ac_Alphabet_GET_excludedChars) */
struct zx_attr_s* zx_ac_Alphabet_GET_excludedChars(struct zx_ac_Alphabet_s* x) { return x->excludedChars; }
/* FUNC(zx_ac_Alphabet_PUT_excludedChars) */
void zx_ac_Alphabet_PUT_excludedChars(struct zx_ac_Alphabet_s* x, struct zx_attr_s* y) { x->excludedChars = y; }
/* FUNC(zx_ac_Alphabet_GET_requiredChars) */
struct zx_attr_s* zx_ac_Alphabet_GET_requiredChars(struct zx_ac_Alphabet_s* x) { return x->requiredChars; }
/* FUNC(zx_ac_Alphabet_PUT_requiredChars) */
void zx_ac_Alphabet_PUT_requiredChars(struct zx_ac_Alphabet_s* x, struct zx_attr_s* y) { x->requiredChars = y; }
...
struct zx_attr_s* zx_ac_AuthenticatingAuthority_GET_ID(struct zx_ac_AuthenticatingAuthority_s* x) { return x->ID; }
/* FUNC(zx_ac_AuthenticatingAuthority_PUT_ID) */
void zx_ac_AuthenticatingAuthority_PUT_ID(struct zx_ac_AuthenticatingAuthority_s* x, struct zx_attr_s* y) { x->ID = y; }
...
struct zx_attr_s* zx_ac_AuthenticationContextStatement_GET_ID(struct zx_ac_AuthenticationContextStatement_s* x) { return x->ID; }
/* FUNC(zx_ac_AuthenticationContextStatement_PUT_ID) */
void zx_ac_AuthenticationContextStatement_PUT_ID(struct zx_ac_AuthenticationContextStatement_s* x, struct zx_attr_s* y) { x->ID = y; }
...
struct zx_attr_s* zx_ac_Generation_GET_mechanism(struct zx_ac_Generation_s* x) { return x->mechanism; }
/* FUNC(zx_ac_Generation_PUT_mechanism) */
void zx_ac_Generation_PUT_mechanism(struct zx_ac_Generation_s* x, struct zx_attr_s* y) { x->mechanism = y; }
...
struct zx_attr_s* zx_ac_GoverningAgreementRef_GET_governingAgreementRef(struct zx_ac_GoverningAgreementRef_s* x) { return x->governingAgreementRef; }
/* FUNC(zx_ac_GoverningAgreementRef_PUT_governingAgreementRef) */
void zx_ac_GoverningAgreementRef_PUT_governingAgreementRef(struct zx_ac_GoverningAgreementRef_s* x, struct zx_attr_s* y) { x->governingAgreementRef = y; }
...
struct zx_attr_s* zx_ac_Identification_GET_nym(struct zx_ac_Identification_s* x) { return x->nym; }
/* FUNC(zx_ac_Identification_PUT_nym) */
void zx_ac_Identification_PUT_nym(struct zx_ac_Identification_s* x, struct zx_attr_s* y) { x->nym = y; }
...
struct zx_attr_s* zx_ac_KeySharing_GET_sharing(struct zx_ac_KeySharing_s* x) { return x->sharing; }
/* FUNC(zx_ac_KeySharing_PUT_sharing) */
void zx_ac_KeySharing_PUT_sharing(struct zx_ac_KeySharing_s* x, struct zx_attr_s* y) { x->sharing = y; }
...
struct zx_attr_s* zx_ac_KeyStorage_GET_medium(struct zx_ac_KeyStorage_s* x) { return x->medium; }
/* FUNC(zx_ac_KeyStorage_PUT_medium) */
void zx_ac_KeyStorage_PUT_medium(struct zx_ac_KeyStorage_s* x, struct zx_attr_s* y) { x->medium = y; }
...
struct zx_attr_s* zx_ac_Length_GET_max(struct zx_ac_Length_s* x) { return x->max; }
/* FUNC(zx_ac_Length_PUT_max) */
void zx_ac_Length_PUT_max(struct zx_ac_Length_s* x, struct zx_attr_s* y) { x->max = y; }
/* FUNC(zx_ac_Length_GET_min) */
struct zx_attr_s* zx_ac_Length_GET_min(struct zx_ac_Length_s* x) { return x->min; }
/* FUNC(zx_ac_Length_PUT_min) */
void zx_ac_Length_PUT_min(struct zx_ac_Length_s* x, struct zx_attr_s* y) { x->min = y; }
...
struct zx_attr_s* zx_ac_PhysicalVerification_GET_credentialLevel(struct zx_ac_PhysicalVerification_s* x) { return x->credentialLevel; }
/* FUNC(zx_ac_PhysicalVerification_PUT_credentialLevel) */
void zx_ac_PhysicalVerification_PUT_credentialLevel(struct zx_ac_PhysicalVerification_s* x, struct zx_attr_s* y) { x->credentialLevel = y; }
...
struct zx_attr_s* zx_ac_TimeSyncToken_GET_DeviceInHand(struct zx_ac_TimeSyncToken_s* x) { return x->DeviceInHand; }
/* FUNC(zx_ac_TimeSyncToken_PUT_DeviceInHand) */
void zx_ac_TimeSyncToken_PUT_DeviceInHand(struct zx_ac_TimeSyncToken_s* x, struct zx_attr_s* y) { x->DeviceInHand = y; }
/* FUNC(zx_ac_TimeSyncToken_GET_DeviceType) */
struct zx_attr_s* zx_ac_TimeSyncToken_GET_DeviceType(struct zx_ac_TimeSyncToken_s* x) { return x->DeviceType; }
/* FUNC(zx_ac_TimeSyncToken_PUT_DeviceType) */
void zx_ac_TimeSyncToken_PUT_DeviceType(struct zx_ac_TimeSyncToken_s* x, struct zx_attr_s* y) { x->DeviceType = y; }
/* FUNC(zx_ac_TimeSyncToken_GET_SeedLength) */
struct zx_attr_s* zx_ac_TimeSyncToken_GET_SeedLength(struct zx_ac_TimeSyncToken_s* x) { return x->SeedLength; }
/* FUNC(zx_ac_TimeSyncToken_PUT_SeedLength) */
void zx_ac_TimeSyncToken_PUT_SeedLength(struct zx_ac_TimeSyncToken_s* x, struct zx_attr_s* y) { x->SeedLength = y; }
