/* c/zx-sa-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
struct zx_attr_s* zx_sa_Action_GET_Namespace(struct zx_sa_Action_s* x) { return x->Namespace; }
/* FUNC(zx_sa_Action_PUT_Namespace) */
void zx_sa_Action_PUT_Namespace(struct zx_sa_Action_s* x, struct zx_attr_s* y) { x->Namespace = y; }
...
int zx_sa_Advice_NUM_AssertionURIRef(struct zx_sa_Advice_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AssertionURIRef; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_sa_Advice_GET_AssertionURIRef(struct zx_sa_Advice_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->AssertionURIRef; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_sa_Advice_ADD_AssertionURIRef(struct zx_sa_Advice_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AssertionURIRef; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_sa_Advice_DEL_AssertionURIRef(struct zx_sa_Advice_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AssertionURIRef; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_sa_Assertion_NUM_Advice(struct zx_sa_Assertion_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Advice; y && y->gg.g.tok == zx_sa_Advice_ELEM; ++n, y = (struct zx_sa_Advice_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa_Advice_s* zx_sa_Assertion_GET_Advice(struct zx_sa_Assertion_s* x, int n)
{
  struct zx_sa_Advice_s* y;
  if (!x) return 0;
  for (y = x->Advice; n>=0 && y && y->gg.g.tok == zx_sa_Advice_ELEM; --n, y = (struct zx_sa_Advice_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_Assertion_PUT_Advice(struct zx_sa_Assertion_s* x, int n, struct zx_sa_Advice_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_Advice_ELEM; --n, y = (struct zx_sa_Advice_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa_Assertion_ADD_Advice(struct zx_sa_Assertion_s* x, int n, struct zx_sa_Advice_s* z)
{
  ...
  case -1:
    y = x->Advice;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_Advice_ELEM; y = (struct zx_sa_Advice_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Advice; n > 1 && y && y->gg.g.tok == zx_sa_Advice_ELEM; --n, y = (struct zx_sa_Advice_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_Assertion_DEL_Advice(struct zx_sa_Assertion_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Advice; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_Advice_ELEM; --n, y = (struct zx_sa_Advice_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sa_Assertion_NUM_Statement(struct zx_sa_Assertion_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Statement; y && y->gg.g.tok == zx_sa_Statement_ELEM; ++n, y = (struct zx_sa_Statement_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa_Statement_s* zx_sa_Assertion_GET_Statement(struct zx_sa_Assertion_s* x, int n)
{
  struct zx_sa_Statement_s* y;
  if (!x) return 0;
  for (y = x->Statement; n>=0 && y && y->gg.g.tok == zx_sa_Statement_ELEM; --n, y = (struct zx_sa_Statement_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_Assertion_PUT_Statement(struct zx_sa_Assertion_s* x, int n, struct zx_sa_Statement_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_Statement_ELEM; --n, y = (struct zx_sa_Statement_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa_Assertion_ADD_Statement(struct zx_sa_Assertion_s* x, int n, struct zx_sa_Statement_s* z)
{
  ...
  case -1:
    y = x->Statement;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_Statement_ELEM; y = (struct zx_sa_Statement_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Statement; n > 1 && y && y->gg.g.tok == zx_sa_Statement_ELEM; --n, y = (struct zx_sa_Statement_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_Assertion_DEL_Statement(struct zx_sa_Assertion_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Statement; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_Statement_ELEM; --n, y = (struct zx_sa_Statement_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sa_Assertion_NUM_AuthnStatement(struct zx_sa_Assertion_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AuthnStatement; y && y->gg.g.tok == zx_sa_AuthnStatement_ELEM; ++n, y = (struct zx_sa_AuthnStatement_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa_AuthnStatement_s* zx_sa_Assertion_GET_AuthnStatement(struct zx_sa_Assertion_s* x, int n)
{
  struct zx_sa_AuthnStatement_s* y;
  if (!x) return 0;
  for (y = x->AuthnStatement; n>=0 && y && y->gg.g.tok == zx_sa_AuthnStatement_ELEM; --n, y = (struct zx_sa_AuthnStatement_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_Assertion_PUT_AuthnStatement(struct zx_sa_Assertion_s* x, int n, struct zx_sa_AuthnStatement_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_AuthnStatement_ELEM; --n, y = (struct zx_sa_AuthnStatement_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa_Assertion_ADD_AuthnStatement(struct zx_sa_Assertion_s* x, int n, struct zx_sa_AuthnStatement_s* z)
{
  ...
  case -1:
    y = x->AuthnStatement;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_AuthnStatement_ELEM; y = (struct zx_sa_AuthnStatement_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->AuthnStatement; n > 1 && y && y->gg.g.tok == zx_sa_AuthnStatement_ELEM; --n, y = (struct zx_sa_AuthnStatement_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_Assertion_DEL_AuthnStatement(struct zx_sa_Assertion_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AuthnStatement; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_AuthnStatement_ELEM; --n, y = (struct zx_sa_AuthnStatement_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sa_Assertion_NUM_AuthzDecisionStatement(struct zx_sa_Assertion_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AuthzDecisionStatement; y && y->gg.g.tok == zx_sa_AuthzDecisionStatement_ELEM; ++n, y = (struct zx_sa_AuthzDecisionStatement_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa_AuthzDecisionStatement_s* zx_sa_Assertion_GET_AuthzDecisionStatement(struct zx_sa_Assertion_s* x, int n)
{
  struct zx_sa_AuthzDecisionStatement_s* y;
  if (!x) return 0;
  for (y = x->AuthzDecisionStatement; n>=0 && y && y->gg.g.tok == zx_sa_AuthzDecisionStatement_ELEM; --n, y = (struct zx_sa_AuthzDecisionStatement_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_Assertion_PUT_AuthzDecisionStatement(struct zx_sa_Assertion_s* x, int n, struct zx_sa_AuthzDecisionStatement_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_AuthzDecisionStatement_ELEM; --n, y = (struct zx_sa_AuthzDecisionStatement_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa_Assertion_ADD_AuthzDecisionStatement(struct zx_sa_Assertion_s* x, int n, struct zx_sa_AuthzDecisionStatement_s* z)
{
  ...
  case -1:
    y = x->AuthzDecisionStatement;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_AuthzDecisionStatement_ELEM; y = (struct zx_sa_AuthzDecisionStatement_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->AuthzDecisionStatement; n > 1 && y && y->gg.g.tok == zx_sa_AuthzDecisionStatement_ELEM; --n, y = (struct zx_sa_AuthzDecisionStatement_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_Assertion_DEL_AuthzDecisionStatement(struct zx_sa_Assertion_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AuthzDecisionStatement; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_AuthzDecisionStatement_ELEM; --n, y = (struct zx_sa_AuthzDecisionStatement_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sa_Assertion_NUM_AttributeStatement(struct zx_sa_Assertion_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AttributeStatement; y && y->gg.g.tok == zx_sa_AttributeStatement_ELEM; ++n, y = (struct zx_sa_AttributeStatement_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa_AttributeStatement_s* zx_sa_Assertion_GET_AttributeStatement(struct zx_sa_Assertion_s* x, int n)
{
  struct zx_sa_AttributeStatement_s* y;
  if (!x) return 0;
  for (y = x->AttributeStatement; n>=0 && y && y->gg.g.tok == zx_sa_AttributeStatement_ELEM; --n, y = (struct zx_sa_AttributeStatement_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_Assertion_PUT_AttributeStatement(struct zx_sa_Assertion_s* x, int n, struct zx_sa_AttributeStatement_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_AttributeStatement_ELEM; --n, y = (struct zx_sa_AttributeStatement_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa_Assertion_ADD_AttributeStatement(struct zx_sa_Assertion_s* x, int n, struct zx_sa_AttributeStatement_s* z)
{
  ...
  case -1:
    y = x->AttributeStatement;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_AttributeStatement_ELEM; y = (struct zx_sa_AttributeStatement_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->AttributeStatement; n > 1 && y && y->gg.g.tok == zx_sa_AttributeStatement_ELEM; --n, y = (struct zx_sa_AttributeStatement_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_Assertion_DEL_AttributeStatement(struct zx_sa_Assertion_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AttributeStatement; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_AttributeStatement_ELEM; --n, y = (struct zx_sa_AttributeStatement_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_sa_Assertion_GET_ID(struct zx_sa_Assertion_s* x) { return x->ID; }
/* FUNC(zx_sa_Assertion_PUT_ID) */
void zx_sa_Assertion_PUT_ID(struct zx_sa_Assertion_s* x, struct zx_attr_s* y) { x->ID = y; }
/* FUNC(zx_sa_Assertion_GET_IssueInstant) */
struct zx_attr_s* zx_sa_Assertion_GET_IssueInstant(struct zx_sa_Assertion_s* x) { return x->IssueInstant; }
/* FUNC(zx_sa_Assertion_PUT_IssueInstant) */
void zx_sa_Assertion_PUT_IssueInstant(struct zx_sa_Assertion_s* x, struct zx_attr_s* y) { x->IssueInstant = y; }
/* FUNC(zx_sa_Assertion_GET_Version) */
struct zx_attr_s* zx_sa_Assertion_GET_Version(struct zx_sa_Assertion_s* x) { return x->Version; }
/* FUNC(zx_sa_Assertion_PUT_Version) */
void zx_sa_Assertion_PUT_Version(struct zx_sa_Assertion_s* x, struct zx_attr_s* y) { x->Version = y; }
...
struct zx_attr_s* zx_sa_Attribute_GET_FriendlyName(struct zx_sa_Attribute_s* x) { return x->FriendlyName; }
/* FUNC(zx_sa_Attribute_PUT_FriendlyName) */
void zx_sa_Attribute_PUT_FriendlyName(struct zx_sa_Attribute_s* x, struct zx_attr_s* y) { x->FriendlyName = y; }
/* FUNC(zx_sa_Attribute_GET_Name) */
struct zx_attr_s* zx_sa_Attribute_GET_Name(struct zx_sa_Attribute_s* x) { return x->Name; }
/* FUNC(zx_sa_Attribute_PUT_Name) */
void zx_sa_Attribute_PUT_Name(struct zx_sa_Attribute_s* x, struct zx_attr_s* y) { x->Name = y; }
/* FUNC(zx_sa_Attribute_GET_NameFormat) */
struct zx_attr_s* zx_sa_Attribute_GET_NameFormat(struct zx_sa_Attribute_s* x) { return x->NameFormat; }
/* FUNC(zx_sa_Attribute_PUT_NameFormat) */
void zx_sa_Attribute_PUT_NameFormat(struct zx_sa_Attribute_s* x, struct zx_attr_s* y) { x->NameFormat = y; }
...
int zx_sa_AttributeValue_NUM_EndpointReference(struct zx_sa_AttributeValue_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->EndpointReference; y && y->gg.g.tok == zx_a_EndpointReference_ELEM; ++n, y = (struct zx_a_EndpointReference_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_a_EndpointReference_s* zx_sa_AttributeValue_GET_EndpointReference(struct zx_sa_AttributeValue_s* x, int n)
{
  struct zx_a_EndpointReference_s* y;
  if (!x) return 0;
  for (y = x->EndpointReference; n>=0 && y && y->gg.g.tok == zx_a_EndpointReference_ELEM; --n, y = (struct zx_a_EndpointReference_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_AttributeValue_PUT_EndpointReference(struct zx_sa_AttributeValue_s* x, int n, struct zx_a_EndpointReference_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_a_EndpointReference_ELEM; --n, y = (struct zx_a_EndpointReference_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa_AttributeValue_ADD_EndpointReference(struct zx_sa_AttributeValue_s* x, int n, struct zx_a_EndpointReference_s* z)
{
  ...
  case -1:
    y = x->EndpointReference;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_a_EndpointReference_ELEM; y = (struct zx_a_EndpointReference_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->EndpointReference; n > 1 && y && y->gg.g.tok == zx_a_EndpointReference_ELEM; --n, y = (struct zx_a_EndpointReference_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_AttributeValue_DEL_EndpointReference(struct zx_sa_AttributeValue_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->EndpointReference; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_a_EndpointReference_ELEM; --n, y = (struct zx_a_EndpointReference_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
void zx_sa_AttributeValue_PUT_type(struct zx_sa_AttributeValue_s* x, struct zx_attr_s* y) { x->type = y; }
...
int zx_sa_AudienceRestriction_NUM_Audience(struct zx_sa_AudienceRestriction_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Audience; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_sa_AudienceRestriction_GET_Audience(struct zx_sa_AudienceRestriction_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->Audience; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_sa_AudienceRestriction_ADD_Audience(struct zx_sa_AudienceRestriction_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Audience; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_sa_AudienceRestriction_DEL_Audience(struct zx_sa_AudienceRestriction_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Audience; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_sa_AuthnContext_NUM_AuthnContextDecl(struct zx_sa_AuthnContext_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AuthnContextDecl; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_sa_AuthnContext_GET_AuthnContextDecl(struct zx_sa_AuthnContext_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->AuthnContextDecl; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_sa_AuthnContext_ADD_AuthnContextDecl(struct zx_sa_AuthnContext_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AuthnContextDecl; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_sa_AuthnContext_DEL_AuthnContextDecl(struct zx_sa_AuthnContext_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AuthnContextDecl; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_sa_AuthnContext_NUM_AuthenticatingAuthority(struct zx_sa_AuthnContext_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AuthenticatingAuthority; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_sa_AuthnContext_GET_AuthenticatingAuthority(struct zx_sa_AuthnContext_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->AuthenticatingAuthority; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_sa_AuthnContext_ADD_AuthenticatingAuthority(struct zx_sa_AuthnContext_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AuthenticatingAuthority; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_sa_AuthnContext_DEL_AuthenticatingAuthority(struct zx_sa_AuthnContext_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AuthenticatingAuthority; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_sa_AuthnStatement_NUM_SubjectLocality(struct zx_sa_AuthnStatement_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->SubjectLocality; y && y->gg.g.tok == zx_sa_SubjectLocality_ELEM; ++n, y = (struct zx_sa_SubjectLocality_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa_SubjectLocality_s* zx_sa_AuthnStatement_GET_SubjectLocality(struct zx_sa_AuthnStatement_s* x, int n)
{
  struct zx_sa_SubjectLocality_s* y;
  if (!x) return 0;
  for (y = x->SubjectLocality; n>=0 && y && y->gg.g.tok == zx_sa_SubjectLocality_ELEM; --n, y = (struct zx_sa_SubjectLocality_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_AuthnStatement_PUT_SubjectLocality(struct zx_sa_AuthnStatement_s* x, int n, struct zx_sa_SubjectLocality_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_SubjectLocality_ELEM; --n, y = (struct zx_sa_SubjectLocality_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa_AuthnStatement_ADD_SubjectLocality(struct zx_sa_AuthnStatement_s* x, int n, struct zx_sa_SubjectLocality_s* z)
{
  ...
  case -1:
    y = x->SubjectLocality;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_SubjectLocality_ELEM; y = (struct zx_sa_SubjectLocality_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->SubjectLocality; n > 1 && y && y->gg.g.tok == zx_sa_SubjectLocality_ELEM; --n, y = (struct zx_sa_SubjectLocality_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_AuthnStatement_DEL_SubjectLocality(struct zx_sa_AuthnStatement_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SubjectLocality; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_SubjectLocality_ELEM; --n, y = (struct zx_sa_SubjectLocality_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sa_AuthnStatement_NUM_AuthnContext(struct zx_sa_AuthnStatement_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AuthnContext; y && y->gg.g.tok == zx_sa_AuthnContext_ELEM; ++n, y = (struct zx_sa_AuthnContext_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa_AuthnContext_s* zx_sa_AuthnStatement_GET_AuthnContext(struct zx_sa_AuthnStatement_s* x, int n)
{
  struct zx_sa_AuthnContext_s* y;
  if (!x) return 0;
  for (y = x->AuthnContext; n>=0 && y && y->gg.g.tok == zx_sa_AuthnContext_ELEM; --n, y = (struct zx_sa_AuthnContext_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_AuthnStatement_PUT_AuthnContext(struct zx_sa_AuthnStatement_s* x, int n, struct zx_sa_AuthnContext_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_AuthnContext_ELEM; --n, y = (struct zx_sa_AuthnContext_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa_AuthnStatement_ADD_AuthnContext(struct zx_sa_AuthnStatement_s* x, int n, struct zx_sa_AuthnContext_s* z)
{
  ...
  case -1:
    y = x->AuthnContext;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_AuthnContext_ELEM; y = (struct zx_sa_AuthnContext_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->AuthnContext; n > 1 && y && y->gg.g.tok == zx_sa_AuthnContext_ELEM; --n, y = (struct zx_sa_AuthnContext_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_AuthnStatement_DEL_AuthnContext(struct zx_sa_AuthnStatement_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AuthnContext; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_AuthnContext_ELEM; --n, y = (struct zx_sa_AuthnContext_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_sa_AuthnStatement_GET_AuthnInstant(struct zx_sa_AuthnStatement_s* x) { return x->AuthnInstant; }
/* FUNC(zx_sa_AuthnStatement_PUT_AuthnInstant) */
void zx_sa_AuthnStatement_PUT_AuthnInstant(struct zx_sa_AuthnStatement_s* x, struct zx_attr_s* y) { x->AuthnInstant = y; }
/* FUNC(zx_sa_AuthnStatement_GET_SessionIndex) */
struct zx_attr_s* zx_sa_AuthnStatement_GET_SessionIndex(struct zx_sa_AuthnStatement_s* x) { return x->SessionIndex; }
/* FUNC(zx_sa_AuthnStatement_PUT_SessionIndex) */
void zx_sa_AuthnStatement_PUT_SessionIndex(struct zx_sa_AuthnStatement_s* x, struct zx_attr_s* y) { x->SessionIndex = y; }
/* FUNC(zx_sa_AuthnStatement_GET_SessionNotOnOrAfter) */
struct zx_attr_s* zx_sa_AuthnStatement_GET_SessionNotOnOrAfter(struct zx_sa_AuthnStatement_s* x) { return x->SessionNotOnOrAfter; }
/* FUNC(zx_sa_AuthnStatement_PUT_SessionNotOnOrAfter) */
void zx_sa_AuthnStatement_PUT_SessionNotOnOrAfter(struct zx_sa_AuthnStatement_s* x, struct zx_attr_s* y) { x->SessionNotOnOrAfter = y; }
...
struct zx_attr_s* zx_sa_AuthzDecisionStatement_GET_Decision(struct zx_sa_AuthzDecisionStatement_s* x) { return x->Decision; }
/* FUNC(zx_sa_AuthzDecisionStatement_PUT_Decision) */
void zx_sa_AuthzDecisionStatement_PUT_Decision(struct zx_sa_AuthzDecisionStatement_s* x, struct zx_attr_s* y) { x->Decision = y; }
/* FUNC(zx_sa_AuthzDecisionStatement_GET_Resource) */
struct zx_attr_s* zx_sa_AuthzDecisionStatement_GET_Resource(struct zx_sa_AuthzDecisionStatement_s* x) { return x->Resource; }
/* FUNC(zx_sa_AuthzDecisionStatement_PUT_Resource) */
void zx_sa_AuthzDecisionStatement_PUT_Resource(struct zx_sa_AuthzDecisionStatement_s* x, struct zx_attr_s* y) { x->Resource = y; }
...
struct zx_attr_s* zx_sa_BaseID_GET_NameQualifier(struct zx_sa_BaseID_s* x) { return x->NameQualifier; }
/* FUNC(zx_sa_BaseID_PUT_NameQualifier) */
void zx_sa_BaseID_PUT_NameQualifier(struct zx_sa_BaseID_s* x, struct zx_attr_s* y) { x->NameQualifier = y; }
/* FUNC(zx_sa_BaseID_GET_SPNameQualifier) */
struct zx_attr_s* zx_sa_BaseID_GET_SPNameQualifier(struct zx_sa_BaseID_s* x) { return x->SPNameQualifier; }
/* FUNC(zx_sa_BaseID_PUT_SPNameQualifier) */
void zx_sa_BaseID_PUT_SPNameQualifier(struct zx_sa_BaseID_s* x, struct zx_attr_s* y) { x->SPNameQualifier = y; }
...
int zx_sa_Conditions_NUM_Condition(struct zx_sa_Conditions_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Condition; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_sa_Conditions_GET_Condition(struct zx_sa_Conditions_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->Condition; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_sa_Conditions_ADD_Condition(struct zx_sa_Conditions_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Condition; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_sa_Conditions_DEL_Condition(struct zx_sa_Conditions_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Condition; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_sa_Conditions_NUM_AudienceRestriction(struct zx_sa_Conditions_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AudienceRestriction; y && y->gg.g.tok == zx_sa_AudienceRestriction_ELEM; ++n, y = (struct zx_sa_AudienceRestriction_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa_AudienceRestriction_s* zx_sa_Conditions_GET_AudienceRestriction(struct zx_sa_Conditions_s* x, int n)
{
  struct zx_sa_AudienceRestriction_s* y;
  if (!x) return 0;
  for (y = x->AudienceRestriction; n>=0 && y && y->gg.g.tok == zx_sa_AudienceRestriction_ELEM; --n, y = (struct zx_sa_AudienceRestriction_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_Conditions_PUT_AudienceRestriction(struct zx_sa_Conditions_s* x, int n, struct zx_sa_AudienceRestriction_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_AudienceRestriction_ELEM; --n, y = (struct zx_sa_AudienceRestriction_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa_Conditions_ADD_AudienceRestriction(struct zx_sa_Conditions_s* x, int n, struct zx_sa_AudienceRestriction_s* z)
{
  ...
  case -1:
    y = x->AudienceRestriction;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_AudienceRestriction_ELEM; y = (struct zx_sa_AudienceRestriction_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->AudienceRestriction; n > 1 && y && y->gg.g.tok == zx_sa_AudienceRestriction_ELEM; --n, y = (struct zx_sa_AudienceRestriction_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_Conditions_DEL_AudienceRestriction(struct zx_sa_Conditions_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AudienceRestriction; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_AudienceRestriction_ELEM; --n, y = (struct zx_sa_AudienceRestriction_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sa_Conditions_NUM_OneTimeUse(struct zx_sa_Conditions_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->OneTimeUse; y && y->gg.g.tok == zx_sa_OneTimeUse_ELEM; ++n, y = (struct zx_sa_OneTimeUse_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa_OneTimeUse_s* zx_sa_Conditions_GET_OneTimeUse(struct zx_sa_Conditions_s* x, int n)
{
  struct zx_sa_OneTimeUse_s* y;
  if (!x) return 0;
  for (y = x->OneTimeUse; n>=0 && y && y->gg.g.tok == zx_sa_OneTimeUse_ELEM; --n, y = (struct zx_sa_OneTimeUse_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_Conditions_PUT_OneTimeUse(struct zx_sa_Conditions_s* x, int n, struct zx_sa_OneTimeUse_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_OneTimeUse_ELEM; --n, y = (struct zx_sa_OneTimeUse_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa_Conditions_ADD_OneTimeUse(struct zx_sa_Conditions_s* x, int n, struct zx_sa_OneTimeUse_s* z)
{
  ...
  case -1:
    y = x->OneTimeUse;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_OneTimeUse_ELEM; y = (struct zx_sa_OneTimeUse_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->OneTimeUse; n > 1 && y && y->gg.g.tok == zx_sa_OneTimeUse_ELEM; --n, y = (struct zx_sa_OneTimeUse_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_Conditions_DEL_OneTimeUse(struct zx_sa_Conditions_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->OneTimeUse; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_OneTimeUse_ELEM; --n, y = (struct zx_sa_OneTimeUse_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sa_Conditions_NUM_ProxyRestriction(struct zx_sa_Conditions_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ProxyRestriction; y && y->gg.g.tok == zx_sa_ProxyRestriction_ELEM; ++n, y = (struct zx_sa_ProxyRestriction_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa_ProxyRestriction_s* zx_sa_Conditions_GET_ProxyRestriction(struct zx_sa_Conditions_s* x, int n)
{
  struct zx_sa_ProxyRestriction_s* y;
  if (!x) return 0;
  for (y = x->ProxyRestriction; n>=0 && y && y->gg.g.tok == zx_sa_ProxyRestriction_ELEM; --n, y = (struct zx_sa_ProxyRestriction_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_Conditions_PUT_ProxyRestriction(struct zx_sa_Conditions_s* x, int n, struct zx_sa_ProxyRestriction_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_ProxyRestriction_ELEM; --n, y = (struct zx_sa_ProxyRestriction_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa_Conditions_ADD_ProxyRestriction(struct zx_sa_Conditions_s* x, int n, struct zx_sa_ProxyRestriction_s* z)
{
  ...
  case -1:
    y = x->ProxyRestriction;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_ProxyRestriction_ELEM; y = (struct zx_sa_ProxyRestriction_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->ProxyRestriction; n > 1 && y && y->gg.g.tok == zx_sa_ProxyRestriction_ELEM; --n, y = (struct zx_sa_ProxyRestriction_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_Conditions_DEL_ProxyRestriction(struct zx_sa_Conditions_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ProxyRestriction; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_ProxyRestriction_ELEM; --n, y = (struct zx_sa_ProxyRestriction_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sa_Conditions_NUM_SubjectRestriction(struct zx_sa_Conditions_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->SubjectRestriction; y && y->gg.g.tok == zx_idp_SubjectRestriction_ELEM; ++n, y = (struct zx_idp_SubjectRestriction_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idp_SubjectRestriction_s* zx_sa_Conditions_GET_SubjectRestriction(struct zx_sa_Conditions_s* x, int n)
{
  struct zx_idp_SubjectRestriction_s* y;
  if (!x) return 0;
  for (y = x->SubjectRestriction; n>=0 && y && y->gg.g.tok == zx_idp_SubjectRestriction_ELEM; --n, y = (struct zx_idp_SubjectRestriction_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_Conditions_PUT_SubjectRestriction(struct zx_sa_Conditions_s* x, int n, struct zx_idp_SubjectRestriction_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_SubjectRestriction_ELEM; --n, y = (struct zx_idp_SubjectRestriction_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa_Conditions_ADD_SubjectRestriction(struct zx_sa_Conditions_s* x, int n, struct zx_idp_SubjectRestriction_s* z)
{
  ...
  case -1:
    y = x->SubjectRestriction;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_SubjectRestriction_ELEM; y = (struct zx_idp_SubjectRestriction_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->SubjectRestriction; n > 1 && y && y->gg.g.tok == zx_idp_SubjectRestriction_ELEM; --n, y = (struct zx_idp_SubjectRestriction_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_Conditions_DEL_SubjectRestriction(struct zx_sa_Conditions_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SubjectRestriction; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_SubjectRestriction_ELEM; --n, y = (struct zx_idp_SubjectRestriction_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_sa_Conditions_GET_NotBefore(struct zx_sa_Conditions_s* x) { return x->NotBefore; }
/* FUNC(zx_sa_Conditions_PUT_NotBefore) */
void zx_sa_Conditions_PUT_NotBefore(struct zx_sa_Conditions_s* x, struct zx_attr_s* y) { x->NotBefore = y; }
/* FUNC(zx_sa_Conditions_GET_NotOnOrAfter) */
struct zx_attr_s* zx_sa_Conditions_GET_NotOnOrAfter(struct zx_sa_Conditions_s* x) { return x->NotOnOrAfter; }
/* FUNC(zx_sa_Conditions_PUT_NotOnOrAfter) */
void zx_sa_Conditions_PUT_NotOnOrAfter(struct zx_sa_Conditions_s* x, struct zx_attr_s* y) { x->NotOnOrAfter = y; }
...
struct zx_attr_s* zx_sa_Issuer_GET_Format(struct zx_sa_Issuer_s* x) { return x->Format; }
/* FUNC(zx_sa_Issuer_PUT_Format) */
void zx_sa_Issuer_PUT_Format(struct zx_sa_Issuer_s* x, struct zx_attr_s* y) { x->Format = y; }
/* FUNC(zx_sa_Issuer_GET_NameQualifier) */
struct zx_attr_s* zx_sa_Issuer_GET_NameQualifier(struct zx_sa_Issuer_s* x) { return x->NameQualifier; }
/* FUNC(zx_sa_Issuer_PUT_NameQualifier) */
void zx_sa_Issuer_PUT_NameQualifier(struct zx_sa_Issuer_s* x, struct zx_attr_s* y) { x->NameQualifier = y; }
/* FUNC(zx_sa_Issuer_GET_SPNameQualifier) */
struct zx_attr_s* zx_sa_Issuer_GET_SPNameQualifier(struct zx_sa_Issuer_s* x) { return x->SPNameQualifier; }
/* FUNC(zx_sa_Issuer_PUT_SPNameQualifier) */
void zx_sa_Issuer_PUT_SPNameQualifier(struct zx_sa_Issuer_s* x, struct zx_attr_s* y) { x->SPNameQualifier = y; }
/* FUNC(zx_sa_Issuer_GET_SPProvidedID) */
struct zx_attr_s* zx_sa_Issuer_GET_SPProvidedID(struct zx_sa_Issuer_s* x) { return x->SPProvidedID; }
/* FUNC(zx_sa_Issuer_PUT_SPProvidedID) */
void zx_sa_Issuer_PUT_SPProvidedID(struct zx_sa_Issuer_s* x, struct zx_attr_s* y) { x->SPProvidedID = y; }
...
struct zx_attr_s* zx_sa_NameID_GET_Format(struct zx_sa_NameID_s* x) { return x->Format; }
/* FUNC(zx_sa_NameID_PUT_Format) */
void zx_sa_NameID_PUT_Format(struct zx_sa_NameID_s* x, struct zx_attr_s* y) { x->Format = y; }
/* FUNC(zx_sa_NameID_GET_NameQualifier) */
struct zx_attr_s* zx_sa_NameID_GET_NameQualifier(struct zx_sa_NameID_s* x) { return x->NameQualifier; }
/* FUNC(zx_sa_NameID_PUT_NameQualifier) */
void zx_sa_NameID_PUT_NameQualifier(struct zx_sa_NameID_s* x, struct zx_attr_s* y) { x->NameQualifier = y; }
/* FUNC(zx_sa_NameID_GET_SPNameQualifier) */
struct zx_attr_s* zx_sa_NameID_GET_SPNameQualifier(struct zx_sa_NameID_s* x) { return x->SPNameQualifier; }
/* FUNC(zx_sa_NameID_PUT_SPNameQualifier) */
void zx_sa_NameID_PUT_SPNameQualifier(struct zx_sa_NameID_s* x, struct zx_attr_s* y) { x->SPNameQualifier = y; }
/* FUNC(zx_sa_NameID_GET_SPProvidedID) */
struct zx_attr_s* zx_sa_NameID_GET_SPProvidedID(struct zx_sa_NameID_s* x) { return x->SPProvidedID; }
/* FUNC(zx_sa_NameID_PUT_SPProvidedID) */
void zx_sa_NameID_PUT_SPProvidedID(struct zx_sa_NameID_s* x, struct zx_attr_s* y) { x->SPProvidedID = y; }
...
struct zx_attr_s* zx_sa_ProxyRestriction_GET_Count(struct zx_sa_ProxyRestriction_s* x) { return x->Count; }
/* FUNC(zx_sa_ProxyRestriction_PUT_Count) */
void zx_sa_ProxyRestriction_PUT_Count(struct zx_sa_ProxyRestriction_s* x, struct zx_attr_s* y) { x->Count = y; }
...
int zx_sa_Statement_NUM_Response(struct zx_sa_Statement_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Response; y && y->gg.g.tok == zx_xac_Response_ELEM; ++n, y = (struct zx_xac_Response_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_xac_Response_s* zx_sa_Statement_GET_Response(struct zx_sa_Statement_s* x, int n)
{
  struct zx_xac_Response_s* y;
  if (!x) return 0;
  for (y = x->Response; n>=0 && y && y->gg.g.tok == zx_xac_Response_ELEM; --n, y = (struct zx_xac_Response_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_Statement_ADD_Response(struct zx_sa_Statement_s* x, int n, struct zx_xac_Response_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Response; n > 1 && y && y->gg.g.tok == zx_xac_Response_ELEM; --n, y = (struct zx_xac_Response_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_Statement_DEL_Response(struct zx_sa_Statement_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Response; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_xac_Response_ELEM; --n, y = (struct zx_xac_Response_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sa_Statement_NUM_Request(struct zx_sa_Statement_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Request; y && y->gg.g.tok == zx_xac_Request_ELEM; ++n, y = (struct zx_xac_Request_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_xac_Request_s* zx_sa_Statement_GET_Request(struct zx_sa_Statement_s* x, int n)
{
  struct zx_xac_Request_s* y;
  if (!x) return 0;
  for (y = x->Request; n>=0 && y && y->gg.g.tok == zx_xac_Request_ELEM; --n, y = (struct zx_xac_Request_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_Statement_ADD_Request(struct zx_sa_Statement_s* x, int n, struct zx_xac_Request_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Request; n > 1 && y && y->gg.g.tok == zx_xac_Request_ELEM; --n, y = (struct zx_xac_Request_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_Statement_DEL_Request(struct zx_sa_Statement_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Request; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_xac_Request_ELEM; --n, y = (struct zx_xac_Request_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_sa_Statement_GET_type(struct zx_sa_Statement_s* x) { return x->type; }
/* FUNC(zx_sa_Statement_PUT_type) */
void zx_sa_Statement_PUT_type(struct zx_sa_Statement_s* x, struct zx_attr_s* y) { x->type = y; }
...
int zx_sa_Subject_NUM_SubjectConfirmation(struct zx_sa_Subject_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->SubjectConfirmation; y && y->gg.g.tok == zx_sa_SubjectConfirmation_ELEM; ++n, y = (struct zx_sa_SubjectConfirmation_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa_SubjectConfirmation_s* zx_sa_Subject_GET_SubjectConfirmation(struct zx_sa_Subject_s* x, int n)
{
  struct zx_sa_SubjectConfirmation_s* y;
  if (!x) return 0;
  for (y = x->SubjectConfirmation; n>=0 && y && y->gg.g.tok == zx_sa_SubjectConfirmation_ELEM; --n, y = (struct zx_sa_SubjectConfirmation_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_Subject_PUT_SubjectConfirmation(struct zx_sa_Subject_s* x, int n, struct zx_sa_SubjectConfirmation_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_SubjectConfirmation_ELEM; --n, y = (struct zx_sa_SubjectConfirmation_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa_Subject_ADD_SubjectConfirmation(struct zx_sa_Subject_s* x, int n, struct zx_sa_SubjectConfirmation_s* z)
{
  ...
  case -1:
    y = x->SubjectConfirmation;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_SubjectConfirmation_ELEM; y = (struct zx_sa_SubjectConfirmation_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->SubjectConfirmation; n > 1 && y && y->gg.g.tok == zx_sa_SubjectConfirmation_ELEM; --n, y = (struct zx_sa_SubjectConfirmation_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_Subject_DEL_SubjectConfirmation(struct zx_sa_Subject_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SubjectConfirmation; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_SubjectConfirmation_ELEM; --n, y = (struct zx_sa_SubjectConfirmation_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sa_SubjectConfirmation_NUM_SubjectConfirmationData(struct zx_sa_SubjectConfirmation_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->SubjectConfirmationData; y && y->gg.g.tok == zx_sa_SubjectConfirmationData_ELEM; ++n, y = (struct zx_sa_SubjectConfirmationData_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa_SubjectConfirmationData_s* zx_sa_SubjectConfirmation_GET_SubjectConfirmationData(struct zx_sa_SubjectConfirmation_s* x, int n)
{
  struct zx_sa_SubjectConfirmationData_s* y;
  if (!x) return 0;
  for (y = x->SubjectConfirmationData; n>=0 && y && y->gg.g.tok == zx_sa_SubjectConfirmationData_ELEM; --n, y = (struct zx_sa_SubjectConfirmationData_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sa_SubjectConfirmation_PUT_SubjectConfirmationData(struct zx_sa_SubjectConfirmation_s* x, int n, struct zx_sa_SubjectConfirmationData_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_SubjectConfirmationData_ELEM; --n, y = (struct zx_sa_SubjectConfirmationData_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sa_SubjectConfirmation_ADD_SubjectConfirmationData(struct zx_sa_SubjectConfirmation_s* x, int n, struct zx_sa_SubjectConfirmationData_s* z)
{
  ...
  case -1:
    y = x->SubjectConfirmationData;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_SubjectConfirmationData_ELEM; y = (struct zx_sa_SubjectConfirmationData_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->SubjectConfirmationData; n > 1 && y && y->gg.g.tok == zx_sa_SubjectConfirmationData_ELEM; --n, y = (struct zx_sa_SubjectConfirmationData_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sa_SubjectConfirmation_DEL_SubjectConfirmationData(struct zx_sa_SubjectConfirmation_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SubjectConfirmationData; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa_SubjectConfirmationData_ELEM; --n, y = (struct zx_sa_SubjectConfirmationData_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_sa_SubjectConfirmation_GET_Method(struct zx_sa_SubjectConfirmation_s* x) { return x->Method; }
/* FUNC(zx_sa_SubjectConfirmation_PUT_Method) */
void zx_sa_SubjectConfirmation_PUT_Method(struct zx_sa_SubjectConfirmation_s* x, struct zx_attr_s* y) { x->Method = y; }
...
struct zx_attr_s* zx_sa_SubjectConfirmationData_GET_Address(struct zx_sa_SubjectConfirmationData_s* x) { return x->Address; }
/* FUNC(zx_sa_SubjectConfirmationData_PUT_Address) */
void zx_sa_SubjectConfirmationData_PUT_Address(struct zx_sa_SubjectConfirmationData_s* x, struct zx_attr_s* y) { x->Address = y; }
/* FUNC(zx_sa_SubjectConfirmationData_GET_InResponseTo) */
struct zx_attr_s* zx_sa_SubjectConfirmationData_GET_InResponseTo(struct zx_sa_SubjectConfirmationData_s* x) { return x->InResponseTo; }
/* FUNC(zx_sa_SubjectConfirmationData_PUT_InResponseTo) */
void zx_sa_SubjectConfirmationData_PUT_InResponseTo(struct zx_sa_SubjectConfirmationData_s* x, struct zx_attr_s* y) { x->InResponseTo = y; }
/* FUNC(zx_sa_SubjectConfirmationData_GET_NotBefore) */
struct zx_attr_s* zx_sa_SubjectConfirmationData_GET_NotBefore(struct zx_sa_SubjectConfirmationData_s* x) { return x->NotBefore; }
/* FUNC(zx_sa_SubjectConfirmationData_PUT_NotBefore) */
void zx_sa_SubjectConfirmationData_PUT_NotBefore(struct zx_sa_SubjectConfirmationData_s* x, struct zx_attr_s* y) { x->NotBefore = y; }
/* FUNC(zx_sa_SubjectConfirmationData_GET_NotOnOrAfter) */
struct zx_attr_s* zx_sa_SubjectConfirmationData_GET_NotOnOrAfter(struct zx_sa_SubjectConfirmationData_s* x) { return x->NotOnOrAfter; }
/* FUNC(zx_sa_SubjectConfirmationData_PUT_NotOnOrAfter) */
void zx_sa_SubjectConfirmationData_PUT_NotOnOrAfter(struct zx_sa_SubjectConfirmationData_s* x, struct zx_attr_s* y) { x->NotOnOrAfter = y; }
/* FUNC(zx_sa_SubjectConfirmationData_GET_Recipient) */
struct zx_attr_s* zx_sa_SubjectConfirmationData_GET_Recipient(struct zx_sa_SubjectConfirmationData_s* x) { return x->Recipient; }
/* FUNC(zx_sa_SubjectConfirmationData_PUT_Recipient) */
void zx_sa_SubjectConfirmationData_PUT_Recipient(struct zx_sa_SubjectConfirmationData_s* x, struct zx_attr_s* y) { x->Recipient = y; }
/* FUNC(zx_sa_SubjectConfirmationData_GET_type) */
struct zx_attr_s* zx_sa_SubjectConfirmationData_GET_type(struct zx_sa_SubjectConfirmationData_s* x) { return x->type; }
/* FUNC(zx_sa_SubjectConfirmationData_PUT_type) */
void zx_sa_SubjectConfirmationData_PUT_type(struct zx_sa_SubjectConfirmationData_s* x, struct zx_attr_s* y) { x->type = y; }
...
struct zx_attr_s* zx_sa_SubjectLocality_GET_Address(struct zx_sa_SubjectLocality_s* x) { return x->Address; }
/* FUNC(zx_sa_SubjectLocality_PUT_Address) */
void zx_sa_SubjectLocality_PUT_Address(struct zx_sa_SubjectLocality_s* x, struct zx_attr_s* y) { x->Address = y; }
/* FUNC(zx_sa_SubjectLocality_GET_DNSName) */
struct zx_attr_s* zx_sa_SubjectLocality_GET_DNSName(struct zx_sa_SubjectLocality_s* x) { return x->DNSName; }
/* FUNC(zx_sa_SubjectLocality_PUT_DNSName) */
void zx_sa_SubjectLocality_PUT_DNSName(struct zx_sa_SubjectLocality_s* x, struct zx_attr_s* y) { x->DNSName = y; }
