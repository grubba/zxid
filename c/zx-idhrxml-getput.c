/* c/zx-idhrxml-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
int zx_idhrxml_Create_NUM_Subscription(struct zx_idhrxml_Create_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Subscription; y && y->gg.g.tok == zx_idhrxml_Subscription_ELEM; ++n, y = (struct zx_idhrxml_Subscription_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idhrxml_Subscription_s* zx_idhrxml_Create_GET_Subscription(struct zx_idhrxml_Create_s* x, int n)
{
  struct zx_idhrxml_Subscription_s* y;
  if (!x) return 0;
  for (y = x->Subscription; n>=0 && y && y->gg.g.tok == zx_idhrxml_Subscription_ELEM; --n, y = (struct zx_idhrxml_Subscription_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idhrxml_Create_PUT_Subscription(struct zx_idhrxml_Create_s* x, int n, struct zx_idhrxml_Subscription_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_Subscription_ELEM; --n, y = (struct zx_idhrxml_Subscription_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idhrxml_Create_ADD_Subscription(struct zx_idhrxml_Create_s* x, int n, struct zx_idhrxml_Subscription_s* z)
{
  ...
  case -1:
    y = x->Subscription;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_Subscription_ELEM; y = (struct zx_idhrxml_Subscription_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Subscription; n > 1 && y && y->gg.g.tok == zx_idhrxml_Subscription_ELEM; --n, y = (struct zx_idhrxml_Subscription_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idhrxml_Create_DEL_Subscription(struct zx_idhrxml_Create_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Subscription; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_Subscription_ELEM; --n, y = (struct zx_idhrxml_Subscription_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_idhrxml_Create_NUM_CreateItem(struct zx_idhrxml_Create_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->CreateItem; y && y->gg.g.tok == zx_idhrxml_CreateItem_ELEM; ++n, y = (struct zx_idhrxml_CreateItem_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idhrxml_CreateItem_s* zx_idhrxml_Create_GET_CreateItem(struct zx_idhrxml_Create_s* x, int n)
{
  struct zx_idhrxml_CreateItem_s* y;
  if (!x) return 0;
  for (y = x->CreateItem; n>=0 && y && y->gg.g.tok == zx_idhrxml_CreateItem_ELEM; --n, y = (struct zx_idhrxml_CreateItem_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idhrxml_Create_PUT_CreateItem(struct zx_idhrxml_Create_s* x, int n, struct zx_idhrxml_CreateItem_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_CreateItem_ELEM; --n, y = (struct zx_idhrxml_CreateItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idhrxml_Create_ADD_CreateItem(struct zx_idhrxml_Create_s* x, int n, struct zx_idhrxml_CreateItem_s* z)
{
  ...
  case -1:
    y = x->CreateItem;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_CreateItem_ELEM; y = (struct zx_idhrxml_CreateItem_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->CreateItem; n > 1 && y && y->gg.g.tok == zx_idhrxml_CreateItem_ELEM; --n, y = (struct zx_idhrxml_CreateItem_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idhrxml_Create_DEL_CreateItem(struct zx_idhrxml_Create_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CreateItem; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_CreateItem_ELEM; --n, y = (struct zx_idhrxml_CreateItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_idhrxml_Create_NUM_ResultQuery(struct zx_idhrxml_Create_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ResultQuery; y && y->gg.g.tok == zx_idhrxml_ResultQuery_ELEM; ++n, y = (struct zx_idhrxml_ResultQuery_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idhrxml_ResultQuery_s* zx_idhrxml_Create_GET_ResultQuery(struct zx_idhrxml_Create_s* x, int n)
{
  struct zx_idhrxml_ResultQuery_s* y;
  if (!x) return 0;
  for (y = x->ResultQuery; n>=0 && y && y->gg.g.tok == zx_idhrxml_ResultQuery_ELEM; --n, y = (struct zx_idhrxml_ResultQuery_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idhrxml_Create_PUT_ResultQuery(struct zx_idhrxml_Create_s* x, int n, struct zx_idhrxml_ResultQuery_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_ResultQuery_ELEM; --n, y = (struct zx_idhrxml_ResultQuery_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idhrxml_Create_ADD_ResultQuery(struct zx_idhrxml_Create_s* x, int n, struct zx_idhrxml_ResultQuery_s* z)
{
  ...
  case -1:
    y = x->ResultQuery;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_ResultQuery_ELEM; y = (struct zx_idhrxml_ResultQuery_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->ResultQuery; n > 1 && y && y->gg.g.tok == zx_idhrxml_ResultQuery_ELEM; --n, y = (struct zx_idhrxml_ResultQuery_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idhrxml_Create_DEL_ResultQuery(struct zx_idhrxml_Create_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ResultQuery; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_ResultQuery_ELEM; --n, y = (struct zx_idhrxml_ResultQuery_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_idhrxml_Create_GET_itemID(struct zx_idhrxml_Create_s* x) { return x->itemID; }
/* FUNC(zx_idhrxml_Create_PUT_itemID) */
void zx_idhrxml_Create_PUT_itemID(struct zx_idhrxml_Create_s* x, struct zx_attr_s* y) { x->itemID = y; }
...
int zx_idhrxml_CreateItem_NUM_NewData(struct zx_idhrxml_CreateItem_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->NewData; y && y->gg.g.tok == zx_idhrxml_NewData_ELEM; ++n, y = (struct zx_idhrxml_NewData_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idhrxml_NewData_s* zx_idhrxml_CreateItem_GET_NewData(struct zx_idhrxml_CreateItem_s* x, int n)
{
  struct zx_idhrxml_NewData_s* y;
  if (!x) return 0;
  for (y = x->NewData; n>=0 && y && y->gg.g.tok == zx_idhrxml_NewData_ELEM; --n, y = (struct zx_idhrxml_NewData_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idhrxml_CreateItem_PUT_NewData(struct zx_idhrxml_CreateItem_s* x, int n, struct zx_idhrxml_NewData_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_NewData_ELEM; --n, y = (struct zx_idhrxml_NewData_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idhrxml_CreateItem_ADD_NewData(struct zx_idhrxml_CreateItem_s* x, int n, struct zx_idhrxml_NewData_s* z)
{
  ...
  case -1:
    y = x->NewData;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_NewData_ELEM; y = (struct zx_idhrxml_NewData_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->NewData; n > 1 && y && y->gg.g.tok == zx_idhrxml_NewData_ELEM; --n, y = (struct zx_idhrxml_NewData_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idhrxml_CreateItem_DEL_NewData(struct zx_idhrxml_CreateItem_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->NewData; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_NewData_ELEM; --n, y = (struct zx_idhrxml_NewData_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_idhrxml_CreateItem_GET_id(struct zx_idhrxml_CreateItem_s* x) { return x->id; }
/* FUNC(zx_idhrxml_CreateItem_PUT_id) */
void zx_idhrxml_CreateItem_PUT_id(struct zx_idhrxml_CreateItem_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_idhrxml_CreateItem_GET_itemID) */
struct zx_attr_s* zx_idhrxml_CreateItem_GET_itemID(struct zx_idhrxml_CreateItem_s* x) { return x->itemID; }
/* FUNC(zx_idhrxml_CreateItem_PUT_itemID) */
void zx_idhrxml_CreateItem_PUT_itemID(struct zx_idhrxml_CreateItem_s* x, struct zx_attr_s* y) { x->itemID = y; }
/* FUNC(zx_idhrxml_CreateItem_GET_objectType) */
struct zx_attr_s* zx_idhrxml_CreateItem_GET_objectType(struct zx_idhrxml_CreateItem_s* x) { return x->objectType; }
/* FUNC(zx_idhrxml_CreateItem_PUT_objectType) */
void zx_idhrxml_CreateItem_PUT_objectType(struct zx_idhrxml_CreateItem_s* x, struct zx_attr_s* y) { x->objectType = y; }
...
int zx_idhrxml_CreateResponse_NUM_ItemData(struct zx_idhrxml_CreateResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ItemData; y && y->gg.g.tok == zx_idhrxml_ItemData_ELEM; ++n, y = (struct zx_idhrxml_ItemData_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idhrxml_ItemData_s* zx_idhrxml_CreateResponse_GET_ItemData(struct zx_idhrxml_CreateResponse_s* x, int n)
{
  struct zx_idhrxml_ItemData_s* y;
  if (!x) return 0;
  for (y = x->ItemData; n>=0 && y && y->gg.g.tok == zx_idhrxml_ItemData_ELEM; --n, y = (struct zx_idhrxml_ItemData_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idhrxml_CreateResponse_PUT_ItemData(struct zx_idhrxml_CreateResponse_s* x, int n, struct zx_idhrxml_ItemData_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_ItemData_ELEM; --n, y = (struct zx_idhrxml_ItemData_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idhrxml_CreateResponse_ADD_ItemData(struct zx_idhrxml_CreateResponse_s* x, int n, struct zx_idhrxml_ItemData_s* z)
{
  ...
  case -1:
    y = x->ItemData;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_ItemData_ELEM; y = (struct zx_idhrxml_ItemData_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->ItemData; n > 1 && y && y->gg.g.tok == zx_idhrxml_ItemData_ELEM; --n, y = (struct zx_idhrxml_ItemData_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idhrxml_CreateResponse_DEL_ItemData(struct zx_idhrxml_CreateResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ItemData; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_ItemData_ELEM; --n, y = (struct zx_idhrxml_ItemData_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_idhrxml_CreateResponse_GET_timeStamp(struct zx_idhrxml_CreateResponse_s* x) { return x->timeStamp; }
/* FUNC(zx_idhrxml_CreateResponse_PUT_timeStamp) */
void zx_idhrxml_CreateResponse_PUT_timeStamp(struct zx_idhrxml_CreateResponse_s* x, struct zx_attr_s* y) { x->timeStamp = y; }
/* FUNC(zx_idhrxml_CreateResponse_GET_itemIDRef) */
struct zx_attr_s* zx_idhrxml_CreateResponse_GET_itemIDRef(struct zx_idhrxml_CreateResponse_s* x) { return x->itemIDRef; }
/* FUNC(zx_idhrxml_CreateResponse_PUT_itemIDRef) */
void zx_idhrxml_CreateResponse_PUT_itemIDRef(struct zx_idhrxml_CreateResponse_s* x, struct zx_attr_s* y) { x->itemIDRef = y; }
...
int zx_idhrxml_Data_NUM_Candidate(struct zx_idhrxml_Data_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Candidate; y && y->gg.g.tok == zx_hrxml_Candidate_ELEM; ++n, y = (struct zx_hrxml_Candidate_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_hrxml_Candidate_s* zx_idhrxml_Data_GET_Candidate(struct zx_idhrxml_Data_s* x, int n)
{
  struct zx_hrxml_Candidate_s* y;
  if (!x) return 0;
  for (y = x->Candidate; n>=0 && y && y->gg.g.tok == zx_hrxml_Candidate_ELEM; --n, y = (struct zx_hrxml_Candidate_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idhrxml_Data_PUT_Candidate(struct zx_idhrxml_Data_s* x, int n, struct zx_hrxml_Candidate_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_hrxml_Candidate_ELEM; --n, y = (struct zx_hrxml_Candidate_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idhrxml_Data_ADD_Candidate(struct zx_idhrxml_Data_s* x, int n, struct zx_hrxml_Candidate_s* z)
{
  ...
  case -1:
    y = x->Candidate;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_hrxml_Candidate_ELEM; y = (struct zx_hrxml_Candidate_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Candidate; n > 1 && y && y->gg.g.tok == zx_hrxml_Candidate_ELEM; --n, y = (struct zx_hrxml_Candidate_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idhrxml_Data_DEL_Candidate(struct zx_idhrxml_Data_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Candidate; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_hrxml_Candidate_ELEM; --n, y = (struct zx_hrxml_Candidate_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_idhrxml_Data_GET_nextOffset(struct zx_idhrxml_Data_s* x) { return x->nextOffset; }
/* FUNC(zx_idhrxml_Data_PUT_nextOffset) */
void zx_idhrxml_Data_PUT_nextOffset(struct zx_idhrxml_Data_s* x, struct zx_attr_s* y) { x->nextOffset = y; }
/* FUNC(zx_idhrxml_Data_GET_notSorted) */
struct zx_attr_s* zx_idhrxml_Data_GET_notSorted(struct zx_idhrxml_Data_s* x) { return x->notSorted; }
/* FUNC(zx_idhrxml_Data_PUT_notSorted) */
void zx_idhrxml_Data_PUT_notSorted(struct zx_idhrxml_Data_s* x, struct zx_attr_s* y) { x->notSorted = y; }
/* FUNC(zx_idhrxml_Data_GET_remaining) */
struct zx_attr_s* zx_idhrxml_Data_GET_remaining(struct zx_idhrxml_Data_s* x) { return x->remaining; }
/* FUNC(zx_idhrxml_Data_PUT_remaining) */
void zx_idhrxml_Data_PUT_remaining(struct zx_idhrxml_Data_s* x, struct zx_attr_s* y) { x->remaining = y; }
/* FUNC(zx_idhrxml_Data_GET_setID) */
struct zx_attr_s* zx_idhrxml_Data_GET_setID(struct zx_idhrxml_Data_s* x) { return x->setID; }
/* FUNC(zx_idhrxml_Data_PUT_setID) */
void zx_idhrxml_Data_PUT_setID(struct zx_idhrxml_Data_s* x, struct zx_attr_s* y) { x->setID = y; }
/* FUNC(zx_idhrxml_Data_GET_changeFormat) */
struct zx_attr_s* zx_idhrxml_Data_GET_changeFormat(struct zx_idhrxml_Data_s* x) { return x->changeFormat; }
/* FUNC(zx_idhrxml_Data_PUT_changeFormat) */
void zx_idhrxml_Data_PUT_changeFormat(struct zx_idhrxml_Data_s* x, struct zx_attr_s* y) { x->changeFormat = y; }
/* FUNC(zx_idhrxml_Data_GET_itemIDRef) */
struct zx_attr_s* zx_idhrxml_Data_GET_itemIDRef(struct zx_idhrxml_Data_s* x) { return x->itemIDRef; }
/* FUNC(zx_idhrxml_Data_PUT_itemIDRef) */
void zx_idhrxml_Data_PUT_itemIDRef(struct zx_idhrxml_Data_s* x, struct zx_attr_s* y) { x->itemIDRef = y; }
...
int zx_idhrxml_Delete_NUM_DeleteItem(struct zx_idhrxml_Delete_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->DeleteItem; y && y->gg.g.tok == zx_idhrxml_DeleteItem_ELEM; ++n, y = (struct zx_idhrxml_DeleteItem_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idhrxml_DeleteItem_s* zx_idhrxml_Delete_GET_DeleteItem(struct zx_idhrxml_Delete_s* x, int n)
{
  struct zx_idhrxml_DeleteItem_s* y;
  if (!x) return 0;
  for (y = x->DeleteItem; n>=0 && y && y->gg.g.tok == zx_idhrxml_DeleteItem_ELEM; --n, y = (struct zx_idhrxml_DeleteItem_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idhrxml_Delete_PUT_DeleteItem(struct zx_idhrxml_Delete_s* x, int n, struct zx_idhrxml_DeleteItem_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_DeleteItem_ELEM; --n, y = (struct zx_idhrxml_DeleteItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idhrxml_Delete_ADD_DeleteItem(struct zx_idhrxml_Delete_s* x, int n, struct zx_idhrxml_DeleteItem_s* z)
{
  ...
  case -1:
    y = x->DeleteItem;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_DeleteItem_ELEM; y = (struct zx_idhrxml_DeleteItem_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->DeleteItem; n > 1 && y && y->gg.g.tok == zx_idhrxml_DeleteItem_ELEM; --n, y = (struct zx_idhrxml_DeleteItem_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idhrxml_Delete_DEL_DeleteItem(struct zx_idhrxml_Delete_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->DeleteItem; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_DeleteItem_ELEM; --n, y = (struct zx_idhrxml_DeleteItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_idhrxml_Delete_GET_itemID(struct zx_idhrxml_Delete_s* x) { return x->itemID; }
/* FUNC(zx_idhrxml_Delete_PUT_itemID) */
void zx_idhrxml_Delete_PUT_itemID(struct zx_idhrxml_Delete_s* x, struct zx_attr_s* y) { x->itemID = y; }
...
struct zx_attr_s* zx_idhrxml_DeleteItem_GET_id(struct zx_idhrxml_DeleteItem_s* x) { return x->id; }
/* FUNC(zx_idhrxml_DeleteItem_PUT_id) */
void zx_idhrxml_DeleteItem_PUT_id(struct zx_idhrxml_DeleteItem_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_idhrxml_DeleteItem_GET_notChangedSince) */
struct zx_attr_s* zx_idhrxml_DeleteItem_GET_notChangedSince(struct zx_idhrxml_DeleteItem_s* x) { return x->notChangedSince; }
/* FUNC(zx_idhrxml_DeleteItem_PUT_notChangedSince) */
void zx_idhrxml_DeleteItem_PUT_notChangedSince(struct zx_idhrxml_DeleteItem_s* x, struct zx_attr_s* y) { x->notChangedSince = y; }
/* FUNC(zx_idhrxml_DeleteItem_GET_itemID) */
struct zx_attr_s* zx_idhrxml_DeleteItem_GET_itemID(struct zx_idhrxml_DeleteItem_s* x) { return x->itemID; }
/* FUNC(zx_idhrxml_DeleteItem_PUT_itemID) */
void zx_idhrxml_DeleteItem_PUT_itemID(struct zx_idhrxml_DeleteItem_s* x, struct zx_attr_s* y) { x->itemID = y; }
/* FUNC(zx_idhrxml_DeleteItem_GET_objectType) */
struct zx_attr_s* zx_idhrxml_DeleteItem_GET_objectType(struct zx_idhrxml_DeleteItem_s* x) { return x->objectType; }
/* FUNC(zx_idhrxml_DeleteItem_PUT_objectType) */
void zx_idhrxml_DeleteItem_PUT_objectType(struct zx_idhrxml_DeleteItem_s* x, struct zx_attr_s* y) { x->objectType = y; }
/* FUNC(zx_idhrxml_DeleteItem_GET_predefined) */
struct zx_attr_s* zx_idhrxml_DeleteItem_GET_predefined(struct zx_idhrxml_DeleteItem_s* x) { return x->predefined; }
/* FUNC(zx_idhrxml_DeleteItem_PUT_predefined) */
void zx_idhrxml_DeleteItem_PUT_predefined(struct zx_idhrxml_DeleteItem_s* x, struct zx_attr_s* y) { x->predefined = y; }
...
struct zx_attr_s* zx_idhrxml_DeleteResponse_GET_itemIDRef(struct zx_idhrxml_DeleteResponse_s* x) { return x->itemIDRef; }
/* FUNC(zx_idhrxml_DeleteResponse_PUT_itemIDRef) */
void zx_idhrxml_DeleteResponse_PUT_itemIDRef(struct zx_idhrxml_DeleteResponse_s* x, struct zx_attr_s* y) { x->itemIDRef = y; }
...
struct zx_attr_s* zx_idhrxml_ItemData_GET_notSorted(struct zx_idhrxml_ItemData_s* x) { return x->notSorted; }
/* FUNC(zx_idhrxml_ItemData_PUT_notSorted) */
void zx_idhrxml_ItemData_PUT_notSorted(struct zx_idhrxml_ItemData_s* x, struct zx_attr_s* y) { x->notSorted = y; }
/* FUNC(zx_idhrxml_ItemData_GET_changeFormat) */
struct zx_attr_s* zx_idhrxml_ItemData_GET_changeFormat(struct zx_idhrxml_ItemData_s* x) { return x->changeFormat; }
/* FUNC(zx_idhrxml_ItemData_PUT_changeFormat) */
void zx_idhrxml_ItemData_PUT_changeFormat(struct zx_idhrxml_ItemData_s* x, struct zx_attr_s* y) { x->changeFormat = y; }
/* FUNC(zx_idhrxml_ItemData_GET_itemIDRef) */
struct zx_attr_s* zx_idhrxml_ItemData_GET_itemIDRef(struct zx_idhrxml_ItemData_s* x) { return x->itemIDRef; }
/* FUNC(zx_idhrxml_ItemData_PUT_itemIDRef) */
void zx_idhrxml_ItemData_PUT_itemIDRef(struct zx_idhrxml_ItemData_s* x, struct zx_attr_s* y) { x->itemIDRef = y; }
...
int zx_idhrxml_Modify_NUM_ModifyItem(struct zx_idhrxml_Modify_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ModifyItem; y && y->gg.g.tok == zx_idhrxml_ModifyItem_ELEM; ++n, y = (struct zx_idhrxml_ModifyItem_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idhrxml_ModifyItem_s* zx_idhrxml_Modify_GET_ModifyItem(struct zx_idhrxml_Modify_s* x, int n)
{
  struct zx_idhrxml_ModifyItem_s* y;
  if (!x) return 0;
  for (y = x->ModifyItem; n>=0 && y && y->gg.g.tok == zx_idhrxml_ModifyItem_ELEM; --n, y = (struct zx_idhrxml_ModifyItem_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idhrxml_Modify_PUT_ModifyItem(struct zx_idhrxml_Modify_s* x, int n, struct zx_idhrxml_ModifyItem_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_ModifyItem_ELEM; --n, y = (struct zx_idhrxml_ModifyItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idhrxml_Modify_ADD_ModifyItem(struct zx_idhrxml_Modify_s* x, int n, struct zx_idhrxml_ModifyItem_s* z)
{
  ...
  case -1:
    y = x->ModifyItem;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_ModifyItem_ELEM; y = (struct zx_idhrxml_ModifyItem_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->ModifyItem; n > 1 && y && y->gg.g.tok == zx_idhrxml_ModifyItem_ELEM; --n, y = (struct zx_idhrxml_ModifyItem_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idhrxml_Modify_DEL_ModifyItem(struct zx_idhrxml_Modify_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ModifyItem; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_ModifyItem_ELEM; --n, y = (struct zx_idhrxml_ModifyItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_idhrxml_Modify_GET_itemID(struct zx_idhrxml_Modify_s* x) { return x->itemID; }
/* FUNC(zx_idhrxml_Modify_PUT_itemID) */
void zx_idhrxml_Modify_PUT_itemID(struct zx_idhrxml_Modify_s* x, struct zx_attr_s* y) { x->itemID = y; }
...
struct zx_attr_s* zx_idhrxml_ModifyItem_GET_id(struct zx_idhrxml_ModifyItem_s* x) { return x->id; }
/* FUNC(zx_idhrxml_ModifyItem_PUT_id) */
void zx_idhrxml_ModifyItem_PUT_id(struct zx_idhrxml_ModifyItem_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_idhrxml_ModifyItem_GET_notChangedSince) */
struct zx_attr_s* zx_idhrxml_ModifyItem_GET_notChangedSince(struct zx_idhrxml_ModifyItem_s* x) { return x->notChangedSince; }
/* FUNC(zx_idhrxml_ModifyItem_PUT_notChangedSince) */
void zx_idhrxml_ModifyItem_PUT_notChangedSince(struct zx_idhrxml_ModifyItem_s* x, struct zx_attr_s* y) { x->notChangedSince = y; }
/* FUNC(zx_idhrxml_ModifyItem_GET_overrideAllowed) */
struct zx_attr_s* zx_idhrxml_ModifyItem_GET_overrideAllowed(struct zx_idhrxml_ModifyItem_s* x) { return x->overrideAllowed; }
/* FUNC(zx_idhrxml_ModifyItem_PUT_overrideAllowed) */
void zx_idhrxml_ModifyItem_PUT_overrideAllowed(struct zx_idhrxml_ModifyItem_s* x, struct zx_attr_s* y) { x->overrideAllowed = y; }
/* FUNC(zx_idhrxml_ModifyItem_GET_itemID) */
struct zx_attr_s* zx_idhrxml_ModifyItem_GET_itemID(struct zx_idhrxml_ModifyItem_s* x) { return x->itemID; }
/* FUNC(zx_idhrxml_ModifyItem_PUT_itemID) */
void zx_idhrxml_ModifyItem_PUT_itemID(struct zx_idhrxml_ModifyItem_s* x, struct zx_attr_s* y) { x->itemID = y; }
/* FUNC(zx_idhrxml_ModifyItem_GET_objectType) */
struct zx_attr_s* zx_idhrxml_ModifyItem_GET_objectType(struct zx_idhrxml_ModifyItem_s* x) { return x->objectType; }
/* FUNC(zx_idhrxml_ModifyItem_PUT_objectType) */
void zx_idhrxml_ModifyItem_PUT_objectType(struct zx_idhrxml_ModifyItem_s* x, struct zx_attr_s* y) { x->objectType = y; }
/* FUNC(zx_idhrxml_ModifyItem_GET_predefined) */
struct zx_attr_s* zx_idhrxml_ModifyItem_GET_predefined(struct zx_idhrxml_ModifyItem_s* x) { return x->predefined; }
/* FUNC(zx_idhrxml_ModifyItem_PUT_predefined) */
void zx_idhrxml_ModifyItem_PUT_predefined(struct zx_idhrxml_ModifyItem_s* x, struct zx_attr_s* y) { x->predefined = y; }
...
struct zx_attr_s* zx_idhrxml_ModifyResponse_GET_timeStamp(struct zx_idhrxml_ModifyResponse_s* x) { return x->timeStamp; }
/* FUNC(zx_idhrxml_ModifyResponse_PUT_timeStamp) */
void zx_idhrxml_ModifyResponse_PUT_timeStamp(struct zx_idhrxml_ModifyResponse_s* x, struct zx_attr_s* y) { x->timeStamp = y; }
/* FUNC(zx_idhrxml_ModifyResponse_GET_itemIDRef) */
struct zx_attr_s* zx_idhrxml_ModifyResponse_GET_itemIDRef(struct zx_idhrxml_ModifyResponse_s* x) { return x->itemIDRef; }
/* FUNC(zx_idhrxml_ModifyResponse_PUT_itemIDRef) */
void zx_idhrxml_ModifyResponse_PUT_itemIDRef(struct zx_idhrxml_ModifyResponse_s* x, struct zx_attr_s* y) { x->itemIDRef = y; }
...
struct zx_attr_s* zx_idhrxml_Notification_GET_endReason(struct zx_idhrxml_Notification_s* x) { return x->endReason; }
/* FUNC(zx_idhrxml_Notification_PUT_endReason) */
void zx_idhrxml_Notification_PUT_endReason(struct zx_idhrxml_Notification_s* x, struct zx_attr_s* y) { x->endReason = y; }
/* FUNC(zx_idhrxml_Notification_GET_expires) */
struct zx_attr_s* zx_idhrxml_Notification_GET_expires(struct zx_idhrxml_Notification_s* x) { return x->expires; }
/* FUNC(zx_idhrxml_Notification_PUT_expires) */
void zx_idhrxml_Notification_PUT_expires(struct zx_idhrxml_Notification_s* x, struct zx_attr_s* y) { x->expires = y; }
/* FUNC(zx_idhrxml_Notification_GET_id) */
struct zx_attr_s* zx_idhrxml_Notification_GET_id(struct zx_idhrxml_Notification_s* x) { return x->id; }
/* FUNC(zx_idhrxml_Notification_PUT_id) */
void zx_idhrxml_Notification_PUT_id(struct zx_idhrxml_Notification_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_idhrxml_Notification_GET_subscriptionID) */
struct zx_attr_s* zx_idhrxml_Notification_GET_subscriptionID(struct zx_idhrxml_Notification_s* x) { return x->subscriptionID; }
/* FUNC(zx_idhrxml_Notification_PUT_subscriptionID) */
void zx_idhrxml_Notification_PUT_subscriptionID(struct zx_idhrxml_Notification_s* x, struct zx_attr_s* y) { x->subscriptionID = y; }
...
int zx_idhrxml_Notify_NUM_Notification(struct zx_idhrxml_Notify_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Notification; y && y->gg.g.tok == zx_idhrxml_Notification_ELEM; ++n, y = (struct zx_idhrxml_Notification_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idhrxml_Notification_s* zx_idhrxml_Notify_GET_Notification(struct zx_idhrxml_Notify_s* x, int n)
{
  struct zx_idhrxml_Notification_s* y;
  if (!x) return 0;
  for (y = x->Notification; n>=0 && y && y->gg.g.tok == zx_idhrxml_Notification_ELEM; --n, y = (struct zx_idhrxml_Notification_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idhrxml_Notify_PUT_Notification(struct zx_idhrxml_Notify_s* x, int n, struct zx_idhrxml_Notification_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_Notification_ELEM; --n, y = (struct zx_idhrxml_Notification_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idhrxml_Notify_ADD_Notification(struct zx_idhrxml_Notify_s* x, int n, struct zx_idhrxml_Notification_s* z)
{
  ...
  case -1:
    y = x->Notification;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_Notification_ELEM; y = (struct zx_idhrxml_Notification_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Notification; n > 1 && y && y->gg.g.tok == zx_idhrxml_Notification_ELEM; --n, y = (struct zx_idhrxml_Notification_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idhrxml_Notify_DEL_Notification(struct zx_idhrxml_Notify_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Notification; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_Notification_ELEM; --n, y = (struct zx_idhrxml_Notification_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_idhrxml_Notify_GET_timeStamp(struct zx_idhrxml_Notify_s* x) { return x->timeStamp; }
/* FUNC(zx_idhrxml_Notify_PUT_timeStamp) */
void zx_idhrxml_Notify_PUT_timeStamp(struct zx_idhrxml_Notify_s* x, struct zx_attr_s* y) { x->timeStamp = y; }
/* FUNC(zx_idhrxml_Notify_GET_itemID) */
struct zx_attr_s* zx_idhrxml_Notify_GET_itemID(struct zx_idhrxml_Notify_s* x) { return x->itemID; }
/* FUNC(zx_idhrxml_Notify_PUT_itemID) */
void zx_idhrxml_Notify_PUT_itemID(struct zx_idhrxml_Notify_s* x, struct zx_attr_s* y) { x->itemID = y; }
...
struct zx_attr_s* zx_idhrxml_NotifyResponse_GET_itemIDRef(struct zx_idhrxml_NotifyResponse_s* x) { return x->itemIDRef; }
/* FUNC(zx_idhrxml_NotifyResponse_PUT_itemIDRef) */
void zx_idhrxml_NotifyResponse_PUT_itemIDRef(struct zx_idhrxml_NotifyResponse_s* x, struct zx_attr_s* y) { x->itemIDRef = y; }
...
int zx_idhrxml_Query_NUM_TestItem(struct zx_idhrxml_Query_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->TestItem; y && y->gg.g.tok == zx_idhrxml_TestItem_ELEM; ++n, y = (struct zx_idhrxml_TestItem_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idhrxml_TestItem_s* zx_idhrxml_Query_GET_TestItem(struct zx_idhrxml_Query_s* x, int n)
{
  struct zx_idhrxml_TestItem_s* y;
  if (!x) return 0;
  for (y = x->TestItem; n>=0 && y && y->gg.g.tok == zx_idhrxml_TestItem_ELEM; --n, y = (struct zx_idhrxml_TestItem_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idhrxml_Query_PUT_TestItem(struct zx_idhrxml_Query_s* x, int n, struct zx_idhrxml_TestItem_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_TestItem_ELEM; --n, y = (struct zx_idhrxml_TestItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idhrxml_Query_ADD_TestItem(struct zx_idhrxml_Query_s* x, int n, struct zx_idhrxml_TestItem_s* z)
{
  ...
  case -1:
    y = x->TestItem;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_TestItem_ELEM; y = (struct zx_idhrxml_TestItem_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->TestItem; n > 1 && y && y->gg.g.tok == zx_idhrxml_TestItem_ELEM; --n, y = (struct zx_idhrxml_TestItem_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idhrxml_Query_DEL_TestItem(struct zx_idhrxml_Query_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->TestItem; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_TestItem_ELEM; --n, y = (struct zx_idhrxml_TestItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_idhrxml_Query_NUM_QueryItem(struct zx_idhrxml_Query_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->QueryItem; y && y->gg.g.tok == zx_idhrxml_QueryItem_ELEM; ++n, y = (struct zx_idhrxml_QueryItem_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idhrxml_QueryItem_s* zx_idhrxml_Query_GET_QueryItem(struct zx_idhrxml_Query_s* x, int n)
{
  struct zx_idhrxml_QueryItem_s* y;
  if (!x) return 0;
  for (y = x->QueryItem; n>=0 && y && y->gg.g.tok == zx_idhrxml_QueryItem_ELEM; --n, y = (struct zx_idhrxml_QueryItem_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idhrxml_Query_PUT_QueryItem(struct zx_idhrxml_Query_s* x, int n, struct zx_idhrxml_QueryItem_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_QueryItem_ELEM; --n, y = (struct zx_idhrxml_QueryItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idhrxml_Query_ADD_QueryItem(struct zx_idhrxml_Query_s* x, int n, struct zx_idhrxml_QueryItem_s* z)
{
  ...
  case -1:
    y = x->QueryItem;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_QueryItem_ELEM; y = (struct zx_idhrxml_QueryItem_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->QueryItem; n > 1 && y && y->gg.g.tok == zx_idhrxml_QueryItem_ELEM; --n, y = (struct zx_idhrxml_QueryItem_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idhrxml_Query_DEL_QueryItem(struct zx_idhrxml_Query_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->QueryItem; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_QueryItem_ELEM; --n, y = (struct zx_idhrxml_QueryItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_idhrxml_Query_GET_itemID(struct zx_idhrxml_Query_s* x) { return x->itemID; }
/* FUNC(zx_idhrxml_Query_PUT_itemID) */
void zx_idhrxml_Query_PUT_itemID(struct zx_idhrxml_Query_s* x, struct zx_attr_s* y) { x->itemID = y; }
...
struct zx_attr_s* zx_idhrxml_QueryItem_GET_changedSince(struct zx_idhrxml_QueryItem_s* x) { return x->changedSince; }
/* FUNC(zx_idhrxml_QueryItem_PUT_changedSince) */
void zx_idhrxml_QueryItem_PUT_changedSince(struct zx_idhrxml_QueryItem_s* x, struct zx_attr_s* y) { x->changedSince = y; }
/* FUNC(zx_idhrxml_QueryItem_GET_contingency) */
struct zx_attr_s* zx_idhrxml_QueryItem_GET_contingency(struct zx_idhrxml_QueryItem_s* x) { return x->contingency; }
/* FUNC(zx_idhrxml_QueryItem_PUT_contingency) */
void zx_idhrxml_QueryItem_PUT_contingency(struct zx_idhrxml_QueryItem_s* x, struct zx_attr_s* y) { x->contingency = y; }
/* FUNC(zx_idhrxml_QueryItem_GET_count) */
struct zx_attr_s* zx_idhrxml_QueryItem_GET_count(struct zx_idhrxml_QueryItem_s* x) { return x->count; }
/* FUNC(zx_idhrxml_QueryItem_PUT_count) */
void zx_idhrxml_QueryItem_PUT_count(struct zx_idhrxml_QueryItem_s* x, struct zx_attr_s* y) { x->count = y; }
/* FUNC(zx_idhrxml_QueryItem_GET_includeCommonAttributes) */
struct zx_attr_s* zx_idhrxml_QueryItem_GET_includeCommonAttributes(struct zx_idhrxml_QueryItem_s* x) { return x->includeCommonAttributes; }
/* FUNC(zx_idhrxml_QueryItem_PUT_includeCommonAttributes) */
void zx_idhrxml_QueryItem_PUT_includeCommonAttributes(struct zx_idhrxml_QueryItem_s* x, struct zx_attr_s* y) { x->includeCommonAttributes = y; }
/* FUNC(zx_idhrxml_QueryItem_GET_offset) */
struct zx_attr_s* zx_idhrxml_QueryItem_GET_offset(struct zx_idhrxml_QueryItem_s* x) { return x->offset; }
/* FUNC(zx_idhrxml_QueryItem_PUT_offset) */
void zx_idhrxml_QueryItem_PUT_offset(struct zx_idhrxml_QueryItem_s* x, struct zx_attr_s* y) { x->offset = y; }
/* FUNC(zx_idhrxml_QueryItem_GET_setID) */
struct zx_attr_s* zx_idhrxml_QueryItem_GET_setID(struct zx_idhrxml_QueryItem_s* x) { return x->setID; }
/* FUNC(zx_idhrxml_QueryItem_PUT_setID) */
void zx_idhrxml_QueryItem_PUT_setID(struct zx_idhrxml_QueryItem_s* x, struct zx_attr_s* y) { x->setID = y; }
/* FUNC(zx_idhrxml_QueryItem_GET_setReq) */
struct zx_attr_s* zx_idhrxml_QueryItem_GET_setReq(struct zx_idhrxml_QueryItem_s* x) { return x->setReq; }
/* FUNC(zx_idhrxml_QueryItem_PUT_setReq) */
void zx_idhrxml_QueryItem_PUT_setReq(struct zx_idhrxml_QueryItem_s* x, struct zx_attr_s* y) { x->setReq = y; }
/* FUNC(zx_idhrxml_QueryItem_GET_itemID) */
struct zx_attr_s* zx_idhrxml_QueryItem_GET_itemID(struct zx_idhrxml_QueryItem_s* x) { return x->itemID; }
/* FUNC(zx_idhrxml_QueryItem_PUT_itemID) */
void zx_idhrxml_QueryItem_PUT_itemID(struct zx_idhrxml_QueryItem_s* x, struct zx_attr_s* y) { x->itemID = y; }
/* FUNC(zx_idhrxml_QueryItem_GET_itemIDRef) */
struct zx_attr_s* zx_idhrxml_QueryItem_GET_itemIDRef(struct zx_idhrxml_QueryItem_s* x) { return x->itemIDRef; }
/* FUNC(zx_idhrxml_QueryItem_PUT_itemIDRef) */
void zx_idhrxml_QueryItem_PUT_itemIDRef(struct zx_idhrxml_QueryItem_s* x, struct zx_attr_s* y) { x->itemIDRef = y; }
/* FUNC(zx_idhrxml_QueryItem_GET_objectType) */
struct zx_attr_s* zx_idhrxml_QueryItem_GET_objectType(struct zx_idhrxml_QueryItem_s* x) { return x->objectType; }
/* FUNC(zx_idhrxml_QueryItem_PUT_objectType) */
void zx_idhrxml_QueryItem_PUT_objectType(struct zx_idhrxml_QueryItem_s* x, struct zx_attr_s* y) { x->objectType = y; }
/* FUNC(zx_idhrxml_QueryItem_GET_predefined) */
struct zx_attr_s* zx_idhrxml_QueryItem_GET_predefined(struct zx_idhrxml_QueryItem_s* x) { return x->predefined; }
/* FUNC(zx_idhrxml_QueryItem_PUT_predefined) */
void zx_idhrxml_QueryItem_PUT_predefined(struct zx_idhrxml_QueryItem_s* x, struct zx_attr_s* y) { x->predefined = y; }
...
int zx_idhrxml_QueryResponse_NUM_Data(struct zx_idhrxml_QueryResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Data; y && y->gg.g.tok == zx_idhrxml_Data_ELEM; ++n, y = (struct zx_idhrxml_Data_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idhrxml_Data_s* zx_idhrxml_QueryResponse_GET_Data(struct zx_idhrxml_QueryResponse_s* x, int n)
{
  struct zx_idhrxml_Data_s* y;
  if (!x) return 0;
  for (y = x->Data; n>=0 && y && y->gg.g.tok == zx_idhrxml_Data_ELEM; --n, y = (struct zx_idhrxml_Data_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idhrxml_QueryResponse_PUT_Data(struct zx_idhrxml_QueryResponse_s* x, int n, struct zx_idhrxml_Data_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_Data_ELEM; --n, y = (struct zx_idhrxml_Data_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idhrxml_QueryResponse_ADD_Data(struct zx_idhrxml_QueryResponse_s* x, int n, struct zx_idhrxml_Data_s* z)
{
  ...
  case -1:
    y = x->Data;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_Data_ELEM; y = (struct zx_idhrxml_Data_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Data; n > 1 && y && y->gg.g.tok == zx_idhrxml_Data_ELEM; --n, y = (struct zx_idhrxml_Data_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idhrxml_QueryResponse_DEL_Data(struct zx_idhrxml_QueryResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Data; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idhrxml_Data_ELEM; --n, y = (struct zx_idhrxml_Data_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_idhrxml_QueryResponse_GET_timeStamp(struct zx_idhrxml_QueryResponse_s* x) { return x->timeStamp; }
/* FUNC(zx_idhrxml_QueryResponse_PUT_timeStamp) */
void zx_idhrxml_QueryResponse_PUT_timeStamp(struct zx_idhrxml_QueryResponse_s* x, struct zx_attr_s* y) { x->timeStamp = y; }
/* FUNC(zx_idhrxml_QueryResponse_GET_itemIDRef) */
struct zx_attr_s* zx_idhrxml_QueryResponse_GET_itemIDRef(struct zx_idhrxml_QueryResponse_s* x) { return x->itemIDRef; }
/* FUNC(zx_idhrxml_QueryResponse_PUT_itemIDRef) */
void zx_idhrxml_QueryResponse_PUT_itemIDRef(struct zx_idhrxml_QueryResponse_s* x, struct zx_attr_s* y) { x->itemIDRef = y; }
...
struct zx_attr_s* zx_idhrxml_ResultQuery_GET_changedSince(struct zx_idhrxml_ResultQuery_s* x) { return x->changedSince; }
/* FUNC(zx_idhrxml_ResultQuery_PUT_changedSince) */
void zx_idhrxml_ResultQuery_PUT_changedSince(struct zx_idhrxml_ResultQuery_s* x, struct zx_attr_s* y) { x->changedSince = y; }
/* FUNC(zx_idhrxml_ResultQuery_GET_contingency) */
struct zx_attr_s* zx_idhrxml_ResultQuery_GET_contingency(struct zx_idhrxml_ResultQuery_s* x) { return x->contingency; }
/* FUNC(zx_idhrxml_ResultQuery_PUT_contingency) */
void zx_idhrxml_ResultQuery_PUT_contingency(struct zx_idhrxml_ResultQuery_s* x, struct zx_attr_s* y) { x->contingency = y; }
/* FUNC(zx_idhrxml_ResultQuery_GET_includeCommonAttributes) */
struct zx_attr_s* zx_idhrxml_ResultQuery_GET_includeCommonAttributes(struct zx_idhrxml_ResultQuery_s* x) { return x->includeCommonAttributes; }
/* FUNC(zx_idhrxml_ResultQuery_PUT_includeCommonAttributes) */
void zx_idhrxml_ResultQuery_PUT_includeCommonAttributes(struct zx_idhrxml_ResultQuery_s* x, struct zx_attr_s* y) { x->includeCommonAttributes = y; }
/* FUNC(zx_idhrxml_ResultQuery_GET_itemID) */
struct zx_attr_s* zx_idhrxml_ResultQuery_GET_itemID(struct zx_idhrxml_ResultQuery_s* x) { return x->itemID; }
/* FUNC(zx_idhrxml_ResultQuery_PUT_itemID) */
void zx_idhrxml_ResultQuery_PUT_itemID(struct zx_idhrxml_ResultQuery_s* x, struct zx_attr_s* y) { x->itemID = y; }
/* FUNC(zx_idhrxml_ResultQuery_GET_itemIDRef) */
struct zx_attr_s* zx_idhrxml_ResultQuery_GET_itemIDRef(struct zx_idhrxml_ResultQuery_s* x) { return x->itemIDRef; }
/* FUNC(zx_idhrxml_ResultQuery_PUT_itemIDRef) */
void zx_idhrxml_ResultQuery_PUT_itemIDRef(struct zx_idhrxml_ResultQuery_s* x, struct zx_attr_s* y) { x->itemIDRef = y; }
/* FUNC(zx_idhrxml_ResultQuery_GET_objectType) */
struct zx_attr_s* zx_idhrxml_ResultQuery_GET_objectType(struct zx_idhrxml_ResultQuery_s* x) { return x->objectType; }
/* FUNC(zx_idhrxml_ResultQuery_PUT_objectType) */
void zx_idhrxml_ResultQuery_PUT_objectType(struct zx_idhrxml_ResultQuery_s* x, struct zx_attr_s* y) { x->objectType = y; }
/* FUNC(zx_idhrxml_ResultQuery_GET_predefined) */
struct zx_attr_s* zx_idhrxml_ResultQuery_GET_predefined(struct zx_idhrxml_ResultQuery_s* x) { return x->predefined; }
/* FUNC(zx_idhrxml_ResultQuery_PUT_predefined) */
void zx_idhrxml_ResultQuery_PUT_predefined(struct zx_idhrxml_ResultQuery_s* x, struct zx_attr_s* y) { x->predefined = y; }
...
struct zx_attr_s* zx_idhrxml_Subscription_GET_adminNotifyToRef(struct zx_idhrxml_Subscription_s* x) { return x->adminNotifyToRef; }
/* FUNC(zx_idhrxml_Subscription_PUT_adminNotifyToRef) */
void zx_idhrxml_Subscription_PUT_adminNotifyToRef(struct zx_idhrxml_Subscription_s* x, struct zx_attr_s* y) { x->adminNotifyToRef = y; }
/* FUNC(zx_idhrxml_Subscription_GET_expires) */
struct zx_attr_s* zx_idhrxml_Subscription_GET_expires(struct zx_idhrxml_Subscription_s* x) { return x->expires; }
/* FUNC(zx_idhrxml_Subscription_PUT_expires) */
void zx_idhrxml_Subscription_PUT_expires(struct zx_idhrxml_Subscription_s* x, struct zx_attr_s* y) { x->expires = y; }
/* FUNC(zx_idhrxml_Subscription_GET_id) */
struct zx_attr_s* zx_idhrxml_Subscription_GET_id(struct zx_idhrxml_Subscription_s* x) { return x->id; }
/* FUNC(zx_idhrxml_Subscription_PUT_id) */
void zx_idhrxml_Subscription_PUT_id(struct zx_idhrxml_Subscription_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_idhrxml_Subscription_GET_includeData) */
struct zx_attr_s* zx_idhrxml_Subscription_GET_includeData(struct zx_idhrxml_Subscription_s* x) { return x->includeData; }
/* FUNC(zx_idhrxml_Subscription_PUT_includeData) */
void zx_idhrxml_Subscription_PUT_includeData(struct zx_idhrxml_Subscription_s* x, struct zx_attr_s* y) { x->includeData = y; }
/* FUNC(zx_idhrxml_Subscription_GET_notifyToRef) */
struct zx_attr_s* zx_idhrxml_Subscription_GET_notifyToRef(struct zx_idhrxml_Subscription_s* x) { return x->notifyToRef; }
/* FUNC(zx_idhrxml_Subscription_PUT_notifyToRef) */
void zx_idhrxml_Subscription_PUT_notifyToRef(struct zx_idhrxml_Subscription_s* x, struct zx_attr_s* y) { x->notifyToRef = y; }
/* FUNC(zx_idhrxml_Subscription_GET_starts) */
struct zx_attr_s* zx_idhrxml_Subscription_GET_starts(struct zx_idhrxml_Subscription_s* x) { return x->starts; }
/* FUNC(zx_idhrxml_Subscription_PUT_starts) */
void zx_idhrxml_Subscription_PUT_starts(struct zx_idhrxml_Subscription_s* x, struct zx_attr_s* y) { x->starts = y; }
/* FUNC(zx_idhrxml_Subscription_GET_subscriptionID) */
struct zx_attr_s* zx_idhrxml_Subscription_GET_subscriptionID(struct zx_idhrxml_Subscription_s* x) { return x->subscriptionID; }
/* FUNC(zx_idhrxml_Subscription_PUT_subscriptionID) */
void zx_idhrxml_Subscription_PUT_subscriptionID(struct zx_idhrxml_Subscription_s* x, struct zx_attr_s* y) { x->subscriptionID = y; }
...
int zx_idhrxml_TestItem_NUM_TestOp(struct zx_idhrxml_TestItem_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->TestOp; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_idhrxml_TestItem_GET_TestOp(struct zx_idhrxml_TestItem_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->TestOp; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_idhrxml_TestItem_ADD_TestOp(struct zx_idhrxml_TestItem_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->TestOp; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_idhrxml_TestItem_DEL_TestOp(struct zx_idhrxml_TestItem_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->TestOp; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
struct zx_attr_s* zx_idhrxml_TestItem_GET_id(struct zx_idhrxml_TestItem_s* x) { return x->id; }
/* FUNC(zx_idhrxml_TestItem_PUT_id) */
void zx_idhrxml_TestItem_PUT_id(struct zx_idhrxml_TestItem_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_idhrxml_TestItem_GET_itemID) */
struct zx_attr_s* zx_idhrxml_TestItem_GET_itemID(struct zx_idhrxml_TestItem_s* x) { return x->itemID; }
/* FUNC(zx_idhrxml_TestItem_PUT_itemID) */
void zx_idhrxml_TestItem_PUT_itemID(struct zx_idhrxml_TestItem_s* x, struct zx_attr_s* y) { x->itemID = y; }
/* FUNC(zx_idhrxml_TestItem_GET_objectType) */
struct zx_attr_s* zx_idhrxml_TestItem_GET_objectType(struct zx_idhrxml_TestItem_s* x) { return x->objectType; }
/* FUNC(zx_idhrxml_TestItem_PUT_objectType) */
void zx_idhrxml_TestItem_PUT_objectType(struct zx_idhrxml_TestItem_s* x, struct zx_attr_s* y) { x->objectType = y; }
/* FUNC(zx_idhrxml_TestItem_GET_predefined) */
struct zx_attr_s* zx_idhrxml_TestItem_GET_predefined(struct zx_idhrxml_TestItem_s* x) { return x->predefined; }
/* FUNC(zx_idhrxml_TestItem_PUT_predefined) */
void zx_idhrxml_TestItem_PUT_predefined(struct zx_idhrxml_TestItem_s* x, struct zx_attr_s* y) { x->predefined = y; }
