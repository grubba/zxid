...
#define zx_ac_N_ELEMS 0
#if !defined(zx_ac__ELEM_MAX) && zx_ac_N_ELEMS == 0
#define zx_ac__ELEM_MAX 0
#endif
extern struct zx_el_tok zx_ac_el_tab[zx_ac__ELEM_MAX];
struct zx_el_tok* zx_ac_elem2tok(const char* name, unsigned int name_len);
