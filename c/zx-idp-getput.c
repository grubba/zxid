...
int zx_idp_AssertionItem_NUM_MEDInfo(struct zx_idp_AssertionItem_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->MEDInfo; y && y->gg.g.tok == zx_idp_MEDInfo_ELEM; ++n, y = (struct zx_idp_MEDInfo_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idp_MEDInfo_s* zx_idp_AssertionItem_GET_MEDInfo(struct zx_idp_AssertionItem_s* x, int n)
{
  struct zx_idp_MEDInfo_s* y;
  if (!x) return 0;
  for (y = x->MEDInfo; n>=0 && y && y->gg.g.tok == zx_idp_MEDInfo_ELEM; --n, y = (struct zx_idp_MEDInfo_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idp_AssertionItem_PUT_MEDInfo(struct zx_idp_AssertionItem_s* x, int n, struct zx_idp_MEDInfo_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_MEDInfo_ELEM; --n, y = (struct zx_idp_MEDInfo_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idp_AssertionItem_ADD_MEDInfo(struct zx_idp_AssertionItem_s* x, int n, struct zx_idp_MEDInfo_s* z)
{
  ...
  case -1:
    ...
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_MEDInfo_ELEM; y = (struct zx_idp_MEDInfo_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->MEDInfo; n > 1 && y && y->gg.g.tok == zx_idp_MEDInfo_ELEM; --n, y = (struct zx_idp_MEDInfo_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idp_AssertionItem_DEL_MEDInfo(struct zx_idp_AssertionItem_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->MEDInfo; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_MEDInfo_ELEM; --n, y = (struct zx_idp_MEDInfo_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_idp_CreatedStatus_NUM_CreatedStatusItem(struct zx_idp_CreatedStatus_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->CreatedStatusItem; y && y->gg.g.tok == zx_idp_CreatedStatusItem_ELEM; ++n, y = (struct zx_idp_CreatedStatusItem_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idp_CreatedStatusItem_s* zx_idp_CreatedStatus_GET_CreatedStatusItem(struct zx_idp_CreatedStatus_s* x, int n)
{
  struct zx_idp_CreatedStatusItem_s* y;
  if (!x) return 0;
  for (y = x->CreatedStatusItem; n>=0 && y && y->gg.g.tok == zx_idp_CreatedStatusItem_ELEM; --n, y = (struct zx_idp_CreatedStatusItem_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idp_CreatedStatus_PUT_CreatedStatusItem(struct zx_idp_CreatedStatus_s* x, int n, struct zx_idp_CreatedStatusItem_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_CreatedStatusItem_ELEM; --n, y = (struct zx_idp_CreatedStatusItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idp_CreatedStatus_ADD_CreatedStatusItem(struct zx_idp_CreatedStatus_s* x, int n, struct zx_idp_CreatedStatusItem_s* z)
{
  ...
  case -1:
    y = x->CreatedStatusItem;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_CreatedStatusItem_ELEM; y = (struct zx_idp_CreatedStatusItem_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->CreatedStatusItem; n > 1 && y && y->gg.g.tok == zx_idp_CreatedStatusItem_ELEM; --n, y = (struct zx_idp_CreatedStatusItem_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idp_CreatedStatus_DEL_CreatedStatusItem(struct zx_idp_CreatedStatus_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CreatedStatusItem; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_CreatedStatusItem_ELEM; --n, y = (struct zx_idp_CreatedStatusItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_idp_GetAssertionResponse_NUM_GetAssertionResponseItem(struct zx_idp_GetAssertionResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->GetAssertionResponseItem; y && y->gg.g.tok == zx_idp_GetAssertionResponseItem_ELEM; ++n, y = (struct zx_idp_GetAssertionResponseItem_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idp_GetAssertionResponseItem_s* zx_idp_GetAssertionResponse_GET_GetAssertionResponseItem(struct zx_idp_GetAssertionResponse_s* x, int n)
{
  struct zx_idp_GetAssertionResponseItem_s* y;
  if (!x) return 0;
  for (y = x->GetAssertionResponseItem; n>=0 && y && y->gg.g.tok == zx_idp_GetAssertionResponseItem_ELEM; --n, y = (struct zx_idp_GetAssertionResponseItem_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idp_GetAssertionResponse_PUT_GetAssertionResponseItem(struct zx_idp_GetAssertionResponse_s* x, int n, struct zx_idp_GetAssertionResponseItem_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_GetAssertionResponseItem_ELEM; --n, y = (struct zx_idp_GetAssertionResponseItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idp_GetAssertionResponse_ADD_GetAssertionResponseItem(struct zx_idp_GetAssertionResponse_s* x, int n, struct zx_idp_GetAssertionResponseItem_s* z)
{
  ...
  case -1:
    y = x->GetAssertionResponseItem;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_GetAssertionResponseItem_ELEM; y = (struct zx_idp_GetAssertionResponseItem_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->GetAssertionResponseItem; n > 1 && y && y->gg.g.tok == zx_idp_GetAssertionResponseItem_ELEM; --n, y = (struct zx_idp_GetAssertionResponseItem_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idp_GetAssertionResponse_DEL_GetAssertionResponseItem(struct zx_idp_GetAssertionResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->GetAssertionResponseItem; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_GetAssertionResponseItem_ELEM; --n, y = (struct zx_idp_GetAssertionResponseItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_idp_GetAssertionResponseItem_NUM_AssertionItem(struct zx_idp_GetAssertionResponseItem_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AssertionItem; y && y->gg.g.tok == zx_idp_AssertionItem_ELEM; ++n, y = (struct zx_idp_AssertionItem_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idp_AssertionItem_s* zx_idp_GetAssertionResponseItem_GET_AssertionItem(struct zx_idp_GetAssertionResponseItem_s* x, int n)
{
  struct zx_idp_AssertionItem_s* y;
  if (!x) return 0;
  for (y = x->AssertionItem; n>=0 && y && y->gg.g.tok == zx_idp_AssertionItem_ELEM; --n, y = (struct zx_idp_AssertionItem_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idp_GetAssertionResponseItem_PUT_AssertionItem(struct zx_idp_GetAssertionResponseItem_s* x, int n, struct zx_idp_AssertionItem_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_AssertionItem_ELEM; --n, y = (struct zx_idp_AssertionItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idp_GetAssertionResponseItem_ADD_AssertionItem(struct zx_idp_GetAssertionResponseItem_s* x, int n, struct zx_idp_AssertionItem_s* z)
{
  ...
  case -1:
    y = x->AssertionItem;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_AssertionItem_ELEM; y = (struct zx_idp_AssertionItem_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->AssertionItem; n > 1 && y && y->gg.g.tok == zx_idp_AssertionItem_ELEM; --n, y = (struct zx_idp_AssertionItem_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idp_GetAssertionResponseItem_DEL_AssertionItem(struct zx_idp_GetAssertionResponseItem_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AssertionItem; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_AssertionItem_ELEM; --n, y = (struct zx_idp_AssertionItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_idp_GetProviderInfoResponse_NUM_ProviderInfo(struct zx_idp_GetProviderInfoResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ProviderInfo; y && y->gg.g.tok == zx_idp_ProviderInfo_ELEM; ++n, y = (struct zx_idp_ProviderInfo_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_idp_ProviderInfo_s* zx_idp_GetProviderInfoResponse_GET_ProviderInfo(struct zx_idp_GetProviderInfoResponse_s* x, int n)
{
  struct zx_idp_ProviderInfo_s* y;
  if (!x) return 0;
  for (y = x->ProviderInfo; n>=0 && y && y->gg.g.tok == zx_idp_ProviderInfo_ELEM; --n, y = (struct zx_idp_ProviderInfo_s*)y->gg.g.n) ;
  return y;
}
...
void zx_idp_GetProviderInfoResponse_PUT_ProviderInfo(struct zx_idp_GetProviderInfoResponse_s* x, int n, struct zx_idp_ProviderInfo_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_ProviderInfo_ELEM; --n, y = (struct zx_idp_ProviderInfo_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_idp_GetProviderInfoResponse_ADD_ProviderInfo(struct zx_idp_GetProviderInfoResponse_s* x, int n, struct zx_idp_ProviderInfo_s* z)
{
  ...
  case -1:
    y = x->ProviderInfo;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_ProviderInfo_ELEM; y = (struct zx_idp_ProviderInfo_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->ProviderInfo; n > 1 && y && y->gg.g.tok == zx_idp_ProviderInfo_ELEM; --n, y = (struct zx_idp_ProviderInfo_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_idp_GetProviderInfoResponse_DEL_ProviderInfo(struct zx_idp_GetProviderInfoResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ProviderInfo; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_idp_ProviderInfo_ELEM; --n, y = (struct zx_idp_ProviderInfo_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
