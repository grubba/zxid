...
#define zx_idhrxml_N_ELEMS 0
#if !defined(zx_idhrxml__ELEM_MAX) && zx_idhrxml_N_ELEMS == 0
#define zx_idhrxml__ELEM_MAX 0
#endif
extern struct zx_el_tok zx_idhrxml_el_tab[zx_idhrxml__ELEM_MAX];
struct zx_el_tok* zx_idhrxml_elem2tok(const char* name, unsigned int name_len);
