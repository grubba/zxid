/* c/zx-tas3sol-enc.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
int zx_LEN_SO_tas3sol_Dict(struct zx_ctx* c, struct zx_tas3sol_Dict_s* x )
{
  ...
  len += zx_len_xmlns_if_not_seen(c, zx_ns_tab+(zx_tas3sol_NS >>  ZX_TOK_NS_SHIFT), &pop_seen);
...
char* zx_ENC_SO_tas3sol_Dict(struct zx_ctx* c, struct zx_tas3sol_Dict_s* x, char* p )
{
  ...
  zx_add_xmlns_if_not_seen(c, zx_ns_tab+(zx_tas3sol_NS >> ZX_TOK_NS_SHIFT), &pop_seen);
