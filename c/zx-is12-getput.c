/* c/zx-is12-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
int zx_is12_Confirm_NUM_Help(struct zx_is12_Confirm_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Help; y && y->gg.g.tok == zx_is12_Help_ELEM; ++n, y = (struct zx_is12_Help_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_is12_Help_s* zx_is12_Confirm_GET_Help(struct zx_is12_Confirm_s* x, int n)
{
  struct zx_is12_Help_s* y;
  if (!x) return 0;
  for (y = x->Help; n>=0 && y && y->gg.g.tok == zx_is12_Help_ELEM; --n, y = (struct zx_is12_Help_s*)y->gg.g.n) ;
  return y;
}
...
void zx_is12_Confirm_PUT_Help(struct zx_is12_Confirm_s* x, int n, struct zx_is12_Help_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Help_ELEM; --n, y = (struct zx_is12_Help_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_is12_Confirm_ADD_Help(struct zx_is12_Confirm_s* x, int n, struct zx_is12_Help_s* z)
{
  ...
  case -1:
    ...
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Help_ELEM; y = (struct zx_is12_Help_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Help; n > 1 && y && y->gg.g.tok == zx_is12_Help_ELEM; --n, y = (struct zx_is12_Help_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_is12_Confirm_DEL_Help(struct zx_is12_Confirm_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Help; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Help_ELEM; --n, y = (struct zx_is12_Help_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_is12_Confirm_GET_name(struct zx_is12_Confirm_s* x) { return x->name; }
/* FUNC(zx_is12_Confirm_PUT_name) */
void zx_is12_Confirm_PUT_name(struct zx_is12_Confirm_s* x, struct zx_attr_s* y) { x->name = y; }
...
struct zx_attr_s* zx_is12_Help_GET_label(struct zx_is12_Help_s* x) { return x->label; }
/* FUNC(zx_is12_Help_PUT_label) */
void zx_is12_Help_PUT_label(struct zx_is12_Help_s* x, struct zx_attr_s* y) { x->label = y; }
/* FUNC(zx_is12_Help_GET_link) */
struct zx_attr_s* zx_is12_Help_GET_link(struct zx_is12_Help_s* x) { return x->link; }
/* FUNC(zx_is12_Help_PUT_link) */
void zx_is12_Help_PUT_link(struct zx_is12_Help_s* x, struct zx_attr_s* y) { x->link = y; }
/* FUNC(zx_is12_Help_GET_moreLink) */
struct zx_attr_s* zx_is12_Help_GET_moreLink(struct zx_is12_Help_s* x) { return x->moreLink; }
/* FUNC(zx_is12_Help_PUT_moreLink) */
void zx_is12_Help_PUT_moreLink(struct zx_is12_Help_s* x, struct zx_attr_s* y) { x->moreLink = y; }
...
int zx_is12_Inquiry_NUM_Select(struct zx_is12_Inquiry_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Select; y && y->gg.g.tok == zx_is12_Select_ELEM; ++n, y = (struct zx_is12_Select_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_is12_Select_s* zx_is12_Inquiry_GET_Select(struct zx_is12_Inquiry_s* x, int n)
{
  struct zx_is12_Select_s* y;
  if (!x) return 0;
  for (y = x->Select; n>=0 && y && y->gg.g.tok == zx_is12_Select_ELEM; --n, y = (struct zx_is12_Select_s*)y->gg.g.n) ;
  return y;
}
...
void zx_is12_Inquiry_PUT_Select(struct zx_is12_Inquiry_s* x, int n, struct zx_is12_Select_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Select_ELEM; --n, y = (struct zx_is12_Select_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_is12_Inquiry_ADD_Select(struct zx_is12_Inquiry_s* x, int n, struct zx_is12_Select_s* z)
{
  ...
  case -1:
    y = x->Select;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Select_ELEM; y = (struct zx_is12_Select_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Select; n > 1 && y && y->gg.g.tok == zx_is12_Select_ELEM; --n, y = (struct zx_is12_Select_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_is12_Inquiry_DEL_Select(struct zx_is12_Inquiry_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Select; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Select_ELEM; --n, y = (struct zx_is12_Select_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_is12_Inquiry_NUM_Confirm(struct zx_is12_Inquiry_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Confirm; y && y->gg.g.tok == zx_is12_Confirm_ELEM; ++n, y = (struct zx_is12_Confirm_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_is12_Confirm_s* zx_is12_Inquiry_GET_Confirm(struct zx_is12_Inquiry_s* x, int n)
{
  struct zx_is12_Confirm_s* y;
  if (!x) return 0;
  for (y = x->Confirm; n>=0 && y && y->gg.g.tok == zx_is12_Confirm_ELEM; --n, y = (struct zx_is12_Confirm_s*)y->gg.g.n) ;
  return y;
}
...
void zx_is12_Inquiry_PUT_Confirm(struct zx_is12_Inquiry_s* x, int n, struct zx_is12_Confirm_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Confirm_ELEM; --n, y = (struct zx_is12_Confirm_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_is12_Inquiry_ADD_Confirm(struct zx_is12_Inquiry_s* x, int n, struct zx_is12_Confirm_s* z)
{
  ...
  case -1:
    y = x->Confirm;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Confirm_ELEM; y = (struct zx_is12_Confirm_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Confirm; n > 1 && y && y->gg.g.tok == zx_is12_Confirm_ELEM; --n, y = (struct zx_is12_Confirm_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_is12_Inquiry_DEL_Confirm(struct zx_is12_Inquiry_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Confirm; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Confirm_ELEM; --n, y = (struct zx_is12_Confirm_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_is12_Inquiry_NUM_Text(struct zx_is12_Inquiry_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Text; y && y->gg.g.tok == zx_is12_Text_ELEM; ++n, y = (struct zx_is12_Text_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_is12_Text_s* zx_is12_Inquiry_GET_Text(struct zx_is12_Inquiry_s* x, int n)
{
  struct zx_is12_Text_s* y;
  if (!x) return 0;
  for (y = x->Text; n>=0 && y && y->gg.g.tok == zx_is12_Text_ELEM; --n, y = (struct zx_is12_Text_s*)y->gg.g.n) ;
  return y;
}
...
void zx_is12_Inquiry_PUT_Text(struct zx_is12_Inquiry_s* x, int n, struct zx_is12_Text_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Text_ELEM; --n, y = (struct zx_is12_Text_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_is12_Inquiry_ADD_Text(struct zx_is12_Inquiry_s* x, int n, struct zx_is12_Text_s* z)
{
  ...
  case -1:
    y = x->Text;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Text_ELEM; y = (struct zx_is12_Text_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Text; n > 1 && y && y->gg.g.tok == zx_is12_Text_ELEM; --n, y = (struct zx_is12_Text_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_is12_Inquiry_DEL_Text(struct zx_is12_Inquiry_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Text; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Text_ELEM; --n, y = (struct zx_is12_Text_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_is12_Inquiry_GET_id(struct zx_is12_Inquiry_s* x) { return x->id; }
/* FUNC(zx_is12_Inquiry_PUT_id) */
void zx_is12_Inquiry_PUT_id(struct zx_is12_Inquiry_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_is12_Inquiry_GET_title) */
struct zx_attr_s* zx_is12_Inquiry_GET_title(struct zx_is12_Inquiry_s* x) { return x->title; }
/* FUNC(zx_is12_Inquiry_PUT_title) */
void zx_is12_Inquiry_PUT_title(struct zx_is12_Inquiry_s* x, struct zx_attr_s* y) { x->title = y; }
...
int zx_is12_InteractionRequest_NUM_Inquiry(struct zx_is12_InteractionRequest_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Inquiry; y && y->gg.g.tok == zx_is12_Inquiry_ELEM; ++n, y = (struct zx_is12_Inquiry_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_is12_Inquiry_s* zx_is12_InteractionRequest_GET_Inquiry(struct zx_is12_InteractionRequest_s* x, int n)
{
  struct zx_is12_Inquiry_s* y;
  if (!x) return 0;
  for (y = x->Inquiry; n>=0 && y && y->gg.g.tok == zx_is12_Inquiry_ELEM; --n, y = (struct zx_is12_Inquiry_s*)y->gg.g.n) ;
  return y;
}
...
void zx_is12_InteractionRequest_PUT_Inquiry(struct zx_is12_InteractionRequest_s* x, int n, struct zx_is12_Inquiry_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Inquiry_ELEM; --n, y = (struct zx_is12_Inquiry_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_is12_InteractionRequest_ADD_Inquiry(struct zx_is12_InteractionRequest_s* x, int n, struct zx_is12_Inquiry_s* z)
{
  ...
  case -1:
    y = x->Inquiry;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Inquiry_ELEM; y = (struct zx_is12_Inquiry_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Inquiry; n > 1 && y && y->gg.g.tok == zx_is12_Inquiry_ELEM; --n, y = (struct zx_is12_Inquiry_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_is12_InteractionRequest_DEL_Inquiry(struct zx_is12_InteractionRequest_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Inquiry; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Inquiry_ELEM; --n, y = (struct zx_is12_Inquiry_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_is12_InteractionRequest_GET_id(struct zx_is12_InteractionRequest_s* x) { return x->id; }
/* FUNC(zx_is12_InteractionRequest_PUT_id) */
void zx_is12_InteractionRequest_PUT_id(struct zx_is12_InteractionRequest_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_is12_InteractionRequest_GET_language) */
struct zx_attr_s* zx_is12_InteractionRequest_GET_language(struct zx_is12_InteractionRequest_s* x) { return x->language; }
/* FUNC(zx_is12_InteractionRequest_PUT_language) */
void zx_is12_InteractionRequest_PUT_language(struct zx_is12_InteractionRequest_s* x, struct zx_attr_s* y) { x->language = y; }
/* FUNC(zx_is12_InteractionRequest_GET_maxInteractTime) */
struct zx_attr_s* zx_is12_InteractionRequest_GET_maxInteractTime(struct zx_is12_InteractionRequest_s* x) { return x->maxInteractTime; }
/* FUNC(zx_is12_InteractionRequest_PUT_maxInteractTime) */
void zx_is12_InteractionRequest_PUT_maxInteractTime(struct zx_is12_InteractionRequest_s* x, struct zx_attr_s* y) { x->maxInteractTime = y; }
/* FUNC(zx_is12_InteractionRequest_GET_signed_is_c_keyword) */
struct zx_attr_s* zx_is12_InteractionRequest_GET_signed_is_c_keyword(struct zx_is12_InteractionRequest_s* x) { return x->signed_is_c_keyword; }
/* FUNC(zx_is12_InteractionRequest_PUT_signed_is_c_keyword) */
void zx_is12_InteractionRequest_PUT_signed_is_c_keyword(struct zx_is12_InteractionRequest_s* x, struct zx_attr_s* y) { x->signed_is_c_keyword = y; }
...
int zx_is12_InteractionResponse_NUM_Status(struct zx_is12_InteractionResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Status; y && y->gg.g.tok == zx_is12_Status_ELEM; ++n, y = (struct zx_is12_Status_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_is12_Status_s* zx_is12_InteractionResponse_GET_Status(struct zx_is12_InteractionResponse_s* x, int n)
{
  struct zx_is12_Status_s* y;
  if (!x) return 0;
  for (y = x->Status; n>=0 && y && y->gg.g.tok == zx_is12_Status_ELEM; --n, y = (struct zx_is12_Status_s*)y->gg.g.n) ;
  return y;
}
...
void zx_is12_InteractionResponse_PUT_Status(struct zx_is12_InteractionResponse_s* x, int n, struct zx_is12_Status_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Status_ELEM; --n, y = (struct zx_is12_Status_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_is12_InteractionResponse_ADD_Status(struct zx_is12_InteractionResponse_s* x, int n, struct zx_is12_Status_s* z)
{
  ...
  case -1:
    y = x->Status;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Status_ELEM; y = (struct zx_is12_Status_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Status; n > 1 && y && y->gg.g.tok == zx_is12_Status_ELEM; --n, y = (struct zx_is12_Status_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_is12_InteractionResponse_DEL_Status(struct zx_is12_InteractionResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Status; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Status_ELEM; --n, y = (struct zx_is12_Status_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_is12_InteractionResponse_NUM_InteractionStatement(struct zx_is12_InteractionResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->InteractionStatement; y && y->gg.g.tok == zx_is12_InteractionStatement_ELEM; ++n, y = (struct zx_is12_InteractionStatement_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_is12_InteractionStatement_s* zx_is12_InteractionResponse_GET_InteractionStatement(struct zx_is12_InteractionResponse_s* x, int n)
{
  struct zx_is12_InteractionStatement_s* y;
  if (!x) return 0;
  for (y = x->InteractionStatement; n>=0 && y && y->gg.g.tok == zx_is12_InteractionStatement_ELEM; --n, y = (struct zx_is12_InteractionStatement_s*)y->gg.g.n) ;
  return y;
}
...
void zx_is12_InteractionResponse_PUT_InteractionStatement(struct zx_is12_InteractionResponse_s* x, int n, struct zx_is12_InteractionStatement_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_InteractionStatement_ELEM; --n, y = (struct zx_is12_InteractionStatement_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_is12_InteractionResponse_ADD_InteractionStatement(struct zx_is12_InteractionResponse_s* x, int n, struct zx_is12_InteractionStatement_s* z)
{
  ...
  case -1:
    y = x->InteractionStatement;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_InteractionStatement_ELEM; y = (struct zx_is12_InteractionStatement_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->InteractionStatement; n > 1 && y && y->gg.g.tok == zx_is12_InteractionStatement_ELEM; --n, y = (struct zx_is12_InteractionStatement_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_is12_InteractionResponse_DEL_InteractionStatement(struct zx_is12_InteractionResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->InteractionStatement; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_InteractionStatement_ELEM; --n, y = (struct zx_is12_InteractionStatement_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_is12_InteractionResponse_NUM_Parameter(struct zx_is12_InteractionResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Parameter; y && y->gg.g.tok == zx_is12_Parameter_ELEM; ++n, y = (struct zx_is12_Parameter_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_is12_Parameter_s* zx_is12_InteractionResponse_GET_Parameter(struct zx_is12_InteractionResponse_s* x, int n)
{
  struct zx_is12_Parameter_s* y;
  if (!x) return 0;
  for (y = x->Parameter; n>=0 && y && y->gg.g.tok == zx_is12_Parameter_ELEM; --n, y = (struct zx_is12_Parameter_s*)y->gg.g.n) ;
  return y;
}
...
void zx_is12_InteractionResponse_PUT_Parameter(struct zx_is12_InteractionResponse_s* x, int n, struct zx_is12_Parameter_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Parameter_ELEM; --n, y = (struct zx_is12_Parameter_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_is12_InteractionResponse_ADD_Parameter(struct zx_is12_InteractionResponse_s* x, int n, struct zx_is12_Parameter_s* z)
{
  ...
  case -1:
    y = x->Parameter;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Parameter_ELEM; y = (struct zx_is12_Parameter_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Parameter; n > 1 && y && y->gg.g.tok == zx_is12_Parameter_ELEM; --n, y = (struct zx_is12_Parameter_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_is12_InteractionResponse_DEL_Parameter(struct zx_is12_InteractionResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Parameter; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Parameter_ELEM; --n, y = (struct zx_is12_Parameter_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_is12_InteractionService_GET_entryID(struct zx_is12_InteractionService_s* x) { return x->entryID; }
/* FUNC(zx_is12_InteractionService_PUT_entryID) */
void zx_is12_InteractionService_PUT_entryID(struct zx_is12_InteractionService_s* x, struct zx_attr_s* y) { x->entryID = y; }
...
struct zx_attr_s* zx_is12_Item_GET_label(struct zx_is12_Item_s* x) { return x->label; }
/* FUNC(zx_is12_Item_PUT_label) */
void zx_is12_Item_PUT_label(struct zx_is12_Item_s* x, struct zx_attr_s* y) { x->label = y; }
/* FUNC(zx_is12_Item_GET_value) */
struct zx_attr_s* zx_is12_Item_GET_value(struct zx_is12_Item_s* x) { return x->value; }
/* FUNC(zx_is12_Item_PUT_value) */
void zx_is12_Item_PUT_value(struct zx_is12_Item_s* x, struct zx_attr_s* y) { x->value = y; }
...
struct zx_attr_s* zx_is12_Parameter_GET_name(struct zx_is12_Parameter_s* x) { return x->name; }
/* FUNC(zx_is12_Parameter_PUT_name) */
void zx_is12_Parameter_PUT_name(struct zx_is12_Parameter_s* x, struct zx_attr_s* y) { x->name = y; }
/* FUNC(zx_is12_Parameter_GET_value) */
struct zx_attr_s* zx_is12_Parameter_GET_value(struct zx_is12_Parameter_s* x) { return x->value; }
/* FUNC(zx_is12_Parameter_PUT_value) */
void zx_is12_Parameter_PUT_value(struct zx_is12_Parameter_s* x, struct zx_attr_s* y) { x->value = y; }
...
struct zx_attr_s* zx_is12_RedirectRequest_GET_redirectURL(struct zx_is12_RedirectRequest_s* x) { return x->redirectURL; }
/* FUNC(zx_is12_RedirectRequest_PUT_redirectURL) */
void zx_is12_RedirectRequest_PUT_redirectURL(struct zx_is12_RedirectRequest_s* x, struct zx_attr_s* y) { x->redirectURL = y; }
...
struct zx_attr_s* zx_is12_ResourceID_GET_id(struct zx_is12_ResourceID_s* x) { return x->id; }
/* FUNC(zx_is12_ResourceID_PUT_id) */
void zx_is12_ResourceID_PUT_id(struct zx_is12_ResourceID_s* x, struct zx_attr_s* y) { x->id = y; }
...
int zx_is12_Select_NUM_Item(struct zx_is12_Select_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Item; y && y->gg.g.tok == zx_is12_Item_ELEM; ++n, y = (struct zx_is12_Item_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_is12_Item_s* zx_is12_Select_GET_Item(struct zx_is12_Select_s* x, int n)
{
  struct zx_is12_Item_s* y;
  if (!x) return 0;
  for (y = x->Item; n>=0 && y && y->gg.g.tok == zx_is12_Item_ELEM; --n, y = (struct zx_is12_Item_s*)y->gg.g.n) ;
  return y;
}
...
void zx_is12_Select_PUT_Item(struct zx_is12_Select_s* x, int n, struct zx_is12_Item_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Item_ELEM; --n, y = (struct zx_is12_Item_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_is12_Select_ADD_Item(struct zx_is12_Select_s* x, int n, struct zx_is12_Item_s* z)
{
  ...
  case -1:
    y = x->Item;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Item_ELEM; y = (struct zx_is12_Item_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Item; n > 1 && y && y->gg.g.tok == zx_is12_Item_ELEM; --n, y = (struct zx_is12_Item_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_is12_Select_DEL_Item(struct zx_is12_Select_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Item; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_Item_ELEM; --n, y = (struct zx_is12_Item_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_is12_Select_GET_multiple(struct zx_is12_Select_s* x) { return x->multiple; }
/* FUNC(zx_is12_Select_PUT_multiple) */
void zx_is12_Select_PUT_multiple(struct zx_is12_Select_s* x, struct zx_attr_s* y) { x->multiple = y; }
/* FUNC(zx_is12_Select_GET_name) */
struct zx_attr_s* zx_is12_Select_GET_name(struct zx_is12_Select_s* x) { return x->name; }
/* FUNC(zx_is12_Select_PUT_name) */
void zx_is12_Select_PUT_name(struct zx_is12_Select_s* x, struct zx_attr_s* y) { x->name = y; }
...
struct zx_attr_s* zx_is12_Status_GET_code(struct zx_is12_Status_s* x) { return x->code; }
/* FUNC(zx_is12_Status_PUT_code) */
void zx_is12_Status_PUT_code(struct zx_is12_Status_s* x, struct zx_attr_s* y) { x->code = y; }
/* FUNC(zx_is12_Status_GET_comment) */
struct zx_attr_s* zx_is12_Status_GET_comment(struct zx_is12_Status_s* x) { return x->comment; }
/* FUNC(zx_is12_Status_PUT_comment) */
void zx_is12_Status_PUT_comment(struct zx_is12_Status_s* x, struct zx_attr_s* y) { x->comment = y; }
/* FUNC(zx_is12_Status_GET_ref) */
struct zx_attr_s* zx_is12_Status_GET_ref(struct zx_is12_Status_s* x) { return x->ref; }
/* FUNC(zx_is12_Status_PUT_ref) */
void zx_is12_Status_PUT_ref(struct zx_is12_Status_s* x, struct zx_attr_s* y) { x->ref = y; }
...
struct zx_attr_s* zx_is12_Text_GET_format(struct zx_is12_Text_s* x) { return x->format; }
/* FUNC(zx_is12_Text_PUT_format) */
void zx_is12_Text_PUT_format(struct zx_is12_Text_s* x, struct zx_attr_s* y) { x->format = y; }
/* FUNC(zx_is12_Text_GET_maxChars) */
struct zx_attr_s* zx_is12_Text_GET_maxChars(struct zx_is12_Text_s* x) { return x->maxChars; }
/* FUNC(zx_is12_Text_PUT_maxChars) */
void zx_is12_Text_PUT_maxChars(struct zx_is12_Text_s* x, struct zx_attr_s* y) { x->maxChars = y; }
/* FUNC(zx_is12_Text_GET_minChars) */
struct zx_attr_s* zx_is12_Text_GET_minChars(struct zx_is12_Text_s* x) { return x->minChars; }
/* FUNC(zx_is12_Text_PUT_minChars) */
void zx_is12_Text_PUT_minChars(struct zx_is12_Text_s* x, struct zx_attr_s* y) { x->minChars = y; }
/* FUNC(zx_is12_Text_GET_name) */
struct zx_attr_s* zx_is12_Text_GET_name(struct zx_is12_Text_s* x) { return x->name; }
/* FUNC(zx_is12_Text_PUT_name) */
void zx_is12_Text_PUT_name(struct zx_is12_Text_s* x, struct zx_attr_s* y) { x->name = y; }
...
int zx_is12_UserInteraction_NUM_InteractionService(struct zx_is12_UserInteraction_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->InteractionService; y && y->gg.g.tok == zx_is12_InteractionService_ELEM; ++n, y = (struct zx_is12_InteractionService_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_is12_InteractionService_s* zx_is12_UserInteraction_GET_InteractionService(struct zx_is12_UserInteraction_s* x, int n)
{
  struct zx_is12_InteractionService_s* y;
  if (!x) return 0;
  for (y = x->InteractionService; n>=0 && y && y->gg.g.tok == zx_is12_InteractionService_ELEM; --n, y = (struct zx_is12_InteractionService_s*)y->gg.g.n) ;
  return y;
}
...
void zx_is12_UserInteraction_PUT_InteractionService(struct zx_is12_UserInteraction_s* x, int n, struct zx_is12_InteractionService_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_InteractionService_ELEM; --n, y = (struct zx_is12_InteractionService_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_is12_UserInteraction_ADD_InteractionService(struct zx_is12_UserInteraction_s* x, int n, struct zx_is12_InteractionService_s* z)
{
  ...
  case -1:
    y = x->InteractionService;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_InteractionService_ELEM; y = (struct zx_is12_InteractionService_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->InteractionService; n > 1 && y && y->gg.g.tok == zx_is12_InteractionService_ELEM; --n, y = (struct zx_is12_InteractionService_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_is12_UserInteraction_DEL_InteractionService(struct zx_is12_UserInteraction_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->InteractionService; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_is12_InteractionService_ELEM; --n, y = (struct zx_is12_InteractionService_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_is12_UserInteraction_GET_id(struct zx_is12_UserInteraction_s* x) { return x->id; }
/* FUNC(zx_is12_UserInteraction_PUT_id) */
void zx_is12_UserInteraction_PUT_id(struct zx_is12_UserInteraction_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_is12_UserInteraction_GET_interact) */
struct zx_attr_s* zx_is12_UserInteraction_GET_interact(struct zx_is12_UserInteraction_s* x) { return x->interact; }
/* FUNC(zx_is12_UserInteraction_PUT_interact) */
void zx_is12_UserInteraction_PUT_interact(struct zx_is12_UserInteraction_s* x, struct zx_attr_s* y) { x->interact = y; }
/* FUNC(zx_is12_UserInteraction_GET_language) */
struct zx_attr_s* zx_is12_UserInteraction_GET_language(struct zx_is12_UserInteraction_s* x) { return x->language; }
/* FUNC(zx_is12_UserInteraction_PUT_language) */
void zx_is12_UserInteraction_PUT_language(struct zx_is12_UserInteraction_s* x, struct zx_attr_s* y) { x->language = y; }
/* FUNC(zx_is12_UserInteraction_GET_maxInteractTime) */
struct zx_attr_s* zx_is12_UserInteraction_GET_maxInteractTime(struct zx_is12_UserInteraction_s* x) { return x->maxInteractTime; }
/* FUNC(zx_is12_UserInteraction_PUT_maxInteractTime) */
void zx_is12_UserInteraction_PUT_maxInteractTime(struct zx_is12_UserInteraction_s* x, struct zx_attr_s* y) { x->maxInteractTime = y; }
/* FUNC(zx_is12_UserInteraction_GET_redirect) */
struct zx_attr_s* zx_is12_UserInteraction_GET_redirect(struct zx_is12_UserInteraction_s* x) { return x->redirect; }
/* FUNC(zx_is12_UserInteraction_PUT_redirect) */
void zx_is12_UserInteraction_PUT_redirect(struct zx_is12_UserInteraction_s* x, struct zx_attr_s* y) { x->redirect = y; }
/* FUNC(zx_is12_UserInteraction_GET_actor) */
struct zx_attr_s* zx_is12_UserInteraction_GET_actor(struct zx_is12_UserInteraction_s* x) { return x->actor; }
/* FUNC(zx_is12_UserInteraction_PUT_actor) */
void zx_is12_UserInteraction_PUT_actor(struct zx_is12_UserInteraction_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_is12_UserInteraction_GET_mustUnderstand) */
struct zx_attr_s* zx_is12_UserInteraction_GET_mustUnderstand(struct zx_is12_UserInteraction_s* x) { return x->mustUnderstand; }
/* FUNC(zx_is12_UserInteraction_PUT_mustUnderstand) */
void zx_is12_UserInteraction_PUT_mustUnderstand(struct zx_is12_UserInteraction_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
