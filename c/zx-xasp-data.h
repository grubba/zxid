/* c/zx-xasp-data.h - WARNING: This header was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
#ifdef ZX_ENA_GETPUT
struct zx_attr_s* zx_xasp_XACMLAuthzDecisionQuery_GET_Consent(struct zx_xasp_XACMLAuthzDecisionQuery_s* x);
struct zx_attr_s* zx_xasp_XACMLAuthzDecisionQuery_GET_Destination(struct zx_xasp_XACMLAuthzDecisionQuery_s* x);
struct zx_attr_s* zx_xasp_XACMLAuthzDecisionQuery_GET_ID(struct zx_xasp_XACMLAuthzDecisionQuery_s* x);
struct zx_attr_s* zx_xasp_XACMLAuthzDecisionQuery_GET_InputContextOnly(struct zx_xasp_XACMLAuthzDecisionQuery_s* x);
struct zx_attr_s* zx_xasp_XACMLAuthzDecisionQuery_GET_IssueInstant(struct zx_xasp_XACMLAuthzDecisionQuery_s* x);
struct zx_attr_s* zx_xasp_XACMLAuthzDecisionQuery_GET_ReturnContext(struct zx_xasp_XACMLAuthzDecisionQuery_s* x);
struct zx_attr_s* zx_xasp_XACMLAuthzDecisionQuery_GET_Version(struct zx_xasp_XACMLAuthzDecisionQuery_s* x);
...
void zx_xasp_XACMLAuthzDecisionQuery_PUT_Consent(struct zx_xasp_XACMLAuthzDecisionQuery_s* x, struct zx_attr_s* y);
void zx_xasp_XACMLAuthzDecisionQuery_PUT_Destination(struct zx_xasp_XACMLAuthzDecisionQuery_s* x, struct zx_attr_s* y);
void zx_xasp_XACMLAuthzDecisionQuery_PUT_ID(struct zx_xasp_XACMLAuthzDecisionQuery_s* x, struct zx_attr_s* y);
void zx_xasp_XACMLAuthzDecisionQuery_PUT_InputContextOnly(struct zx_xasp_XACMLAuthzDecisionQuery_s* x, struct zx_attr_s* y);
void zx_xasp_XACMLAuthzDecisionQuery_PUT_IssueInstant(struct zx_xasp_XACMLAuthzDecisionQuery_s* x, struct zx_attr_s* y);
void zx_xasp_XACMLAuthzDecisionQuery_PUT_ReturnContext(struct zx_xasp_XACMLAuthzDecisionQuery_s* x, struct zx_attr_s* y);
void zx_xasp_XACMLAuthzDecisionQuery_PUT_Version(struct zx_xasp_XACMLAuthzDecisionQuery_s* x, struct zx_attr_s* y);
...
#ifdef ZX_ENA_GETPUT
struct zx_attr_s* zx_xasp_XACMLPolicyQuery_GET_Consent(struct zx_xasp_XACMLPolicyQuery_s* x);
struct zx_attr_s* zx_xasp_XACMLPolicyQuery_GET_Destination(struct zx_xasp_XACMLPolicyQuery_s* x);
struct zx_attr_s* zx_xasp_XACMLPolicyQuery_GET_ID(struct zx_xasp_XACMLPolicyQuery_s* x);
struct zx_attr_s* zx_xasp_XACMLPolicyQuery_GET_IssueInstant(struct zx_xasp_XACMLPolicyQuery_s* x);
struct zx_attr_s* zx_xasp_XACMLPolicyQuery_GET_Version(struct zx_xasp_XACMLPolicyQuery_s* x);
...
void zx_xasp_XACMLPolicyQuery_PUT_Consent(struct zx_xasp_XACMLPolicyQuery_s* x, struct zx_attr_s* y);
void zx_xasp_XACMLPolicyQuery_PUT_Destination(struct zx_xasp_XACMLPolicyQuery_s* x, struct zx_attr_s* y);
void zx_xasp_XACMLPolicyQuery_PUT_ID(struct zx_xasp_XACMLPolicyQuery_s* x, struct zx_attr_s* y);
void zx_xasp_XACMLPolicyQuery_PUT_IssueInstant(struct zx_xasp_XACMLPolicyQuery_s* x, struct zx_attr_s* y);
void zx_xasp_XACMLPolicyQuery_PUT_Version(struct zx_xasp_XACMLPolicyQuery_s* x, struct zx_attr_s* y);
