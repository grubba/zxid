/* c/zx-xasp-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
struct zx_attr_s* zx_xasp_XACMLAuthzDecisionQuery_GET_Consent(struct zx_xasp_XACMLAuthzDecisionQuery_s* x) { return x->Consent; }
/* FUNC(zx_xasp_XACMLAuthzDecisionQuery_PUT_Consent) */
void zx_xasp_XACMLAuthzDecisionQuery_PUT_Consent(struct zx_xasp_XACMLAuthzDecisionQuery_s* x, struct zx_attr_s* y) { x->Consent = y; }
/* FUNC(zx_xasp_XACMLAuthzDecisionQuery_GET_Destination) */
struct zx_attr_s* zx_xasp_XACMLAuthzDecisionQuery_GET_Destination(struct zx_xasp_XACMLAuthzDecisionQuery_s* x) { return x->Destination; }
/* FUNC(zx_xasp_XACMLAuthzDecisionQuery_PUT_Destination) */
void zx_xasp_XACMLAuthzDecisionQuery_PUT_Destination(struct zx_xasp_XACMLAuthzDecisionQuery_s* x, struct zx_attr_s* y) { x->Destination = y; }
/* FUNC(zx_xasp_XACMLAuthzDecisionQuery_GET_ID) */
struct zx_attr_s* zx_xasp_XACMLAuthzDecisionQuery_GET_ID(struct zx_xasp_XACMLAuthzDecisionQuery_s* x) { return x->ID; }
/* FUNC(zx_xasp_XACMLAuthzDecisionQuery_PUT_ID) */
void zx_xasp_XACMLAuthzDecisionQuery_PUT_ID(struct zx_xasp_XACMLAuthzDecisionQuery_s* x, struct zx_attr_s* y) { x->ID = y; }
/* FUNC(zx_xasp_XACMLAuthzDecisionQuery_GET_InputContextOnly) */
struct zx_attr_s* zx_xasp_XACMLAuthzDecisionQuery_GET_InputContextOnly(struct zx_xasp_XACMLAuthzDecisionQuery_s* x) { return x->InputContextOnly; }
/* FUNC(zx_xasp_XACMLAuthzDecisionQuery_PUT_InputContextOnly) */
void zx_xasp_XACMLAuthzDecisionQuery_PUT_InputContextOnly(struct zx_xasp_XACMLAuthzDecisionQuery_s* x, struct zx_attr_s* y) { x->InputContextOnly = y; }
/* FUNC(zx_xasp_XACMLAuthzDecisionQuery_GET_IssueInstant) */
struct zx_attr_s* zx_xasp_XACMLAuthzDecisionQuery_GET_IssueInstant(struct zx_xasp_XACMLAuthzDecisionQuery_s* x) { return x->IssueInstant; }
/* FUNC(zx_xasp_XACMLAuthzDecisionQuery_PUT_IssueInstant) */
void zx_xasp_XACMLAuthzDecisionQuery_PUT_IssueInstant(struct zx_xasp_XACMLAuthzDecisionQuery_s* x, struct zx_attr_s* y) { x->IssueInstant = y; }
/* FUNC(zx_xasp_XACMLAuthzDecisionQuery_GET_ReturnContext) */
struct zx_attr_s* zx_xasp_XACMLAuthzDecisionQuery_GET_ReturnContext(struct zx_xasp_XACMLAuthzDecisionQuery_s* x) { return x->ReturnContext; }
/* FUNC(zx_xasp_XACMLAuthzDecisionQuery_PUT_ReturnContext) */
void zx_xasp_XACMLAuthzDecisionQuery_PUT_ReturnContext(struct zx_xasp_XACMLAuthzDecisionQuery_s* x, struct zx_attr_s* y) { x->ReturnContext = y; }
/* FUNC(zx_xasp_XACMLAuthzDecisionQuery_GET_Version) */
struct zx_attr_s* zx_xasp_XACMLAuthzDecisionQuery_GET_Version(struct zx_xasp_XACMLAuthzDecisionQuery_s* x) { return x->Version; }
/* FUNC(zx_xasp_XACMLAuthzDecisionQuery_PUT_Version) */
void zx_xasp_XACMLAuthzDecisionQuery_PUT_Version(struct zx_xasp_XACMLAuthzDecisionQuery_s* x, struct zx_attr_s* y) { x->Version = y; }
...
struct zx_attr_s* zx_xasp_XACMLPolicyQuery_GET_Consent(struct zx_xasp_XACMLPolicyQuery_s* x) { return x->Consent; }
/* FUNC(zx_xasp_XACMLPolicyQuery_PUT_Consent) */
void zx_xasp_XACMLPolicyQuery_PUT_Consent(struct zx_xasp_XACMLPolicyQuery_s* x, struct zx_attr_s* y) { x->Consent = y; }
/* FUNC(zx_xasp_XACMLPolicyQuery_GET_Destination) */
struct zx_attr_s* zx_xasp_XACMLPolicyQuery_GET_Destination(struct zx_xasp_XACMLPolicyQuery_s* x) { return x->Destination; }
/* FUNC(zx_xasp_XACMLPolicyQuery_PUT_Destination) */
void zx_xasp_XACMLPolicyQuery_PUT_Destination(struct zx_xasp_XACMLPolicyQuery_s* x, struct zx_attr_s* y) { x->Destination = y; }
/* FUNC(zx_xasp_XACMLPolicyQuery_GET_ID) */
struct zx_attr_s* zx_xasp_XACMLPolicyQuery_GET_ID(struct zx_xasp_XACMLPolicyQuery_s* x) { return x->ID; }
/* FUNC(zx_xasp_XACMLPolicyQuery_PUT_ID) */
void zx_xasp_XACMLPolicyQuery_PUT_ID(struct zx_xasp_XACMLPolicyQuery_s* x, struct zx_attr_s* y) { x->ID = y; }
/* FUNC(zx_xasp_XACMLPolicyQuery_GET_IssueInstant) */
struct zx_attr_s* zx_xasp_XACMLPolicyQuery_GET_IssueInstant(struct zx_xasp_XACMLPolicyQuery_s* x) { return x->IssueInstant; }
/* FUNC(zx_xasp_XACMLPolicyQuery_PUT_IssueInstant) */
void zx_xasp_XACMLPolicyQuery_PUT_IssueInstant(struct zx_xasp_XACMLPolicyQuery_s* x, struct zx_attr_s* y) { x->IssueInstant = y; }
/* FUNC(zx_xasp_XACMLPolicyQuery_GET_Version) */
struct zx_attr_s* zx_xasp_XACMLPolicyQuery_GET_Version(struct zx_xasp_XACMLPolicyQuery_s* x) { return x->Version; }
/* FUNC(zx_xasp_XACMLPolicyQuery_PUT_Version) */
void zx_xasp_XACMLPolicyQuery_PUT_Version(struct zx_xasp_XACMLPolicyQuery_s* x, struct zx_attr_s* y) { x->Version = y; }
