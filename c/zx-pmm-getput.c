/* c/zx-pmm-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
int zx_pmm_PMActivate_NUM_PMActivateItem(struct zx_pmm_PMActivate_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PMActivateItem; y && y->gg.g.tok == zx_pmm_PMActivateItem_ELEM; ++n, y = (struct zx_pmm_PMActivateItem_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_pmm_PMActivateItem_s* zx_pmm_PMActivate_GET_PMActivateItem(struct zx_pmm_PMActivate_s* x, int n)
{
  struct zx_pmm_PMActivateItem_s* y;
  if (!x) return 0;
  for (y = x->PMActivateItem; n>=0 && y && y->gg.g.tok == zx_pmm_PMActivateItem_ELEM; --n, y = (struct zx_pmm_PMActivateItem_s*)y->gg.g.n) ;
  return y;
}
...
void zx_pmm_PMActivate_PUT_PMActivateItem(struct zx_pmm_PMActivate_s* x, int n, struct zx_pmm_PMActivateItem_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_pmm_PMActivateItem_ELEM; --n, y = (struct zx_pmm_PMActivateItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_pmm_PMActivate_ADD_PMActivateItem(struct zx_pmm_PMActivate_s* x, int n, struct zx_pmm_PMActivateItem_s* z)
{
  ...
  case -1:
    ...
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_pmm_PMActivateItem_ELEM; y = (struct zx_pmm_PMActivateItem_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->PMActivateItem; n > 1 && y && y->gg.g.tok == zx_pmm_PMActivateItem_ELEM; --n, y = (struct zx_pmm_PMActivateItem_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_pmm_PMActivate_DEL_PMActivateItem(struct zx_pmm_PMActivate_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PMActivateItem; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_pmm_PMActivateItem_ELEM; --n, y = (struct zx_pmm_PMActivateItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_pmm_PMActivateItem_GET_at(struct zx_pmm_PMActivateItem_s* x) { return x->at; }
/* FUNC(zx_pmm_PMActivateItem_PUT_at) */
void zx_pmm_PMActivateItem_PUT_at(struct zx_pmm_PMActivateItem_s* x, struct zx_attr_s* y) { x->at = y; }
/* FUNC(zx_pmm_PMActivateItem_GET_itemID) */
struct zx_attr_s* zx_pmm_PMActivateItem_GET_itemID(struct zx_pmm_PMActivateItem_s* x) { return x->itemID; }
/* FUNC(zx_pmm_PMActivateItem_PUT_itemID) */
void zx_pmm_PMActivateItem_PUT_itemID(struct zx_pmm_PMActivateItem_s* x, struct zx_attr_s* y) { x->itemID = y; }
...
int zx_pmm_PMDeactivate_NUM_PMDeactivateItem(struct zx_pmm_PMDeactivate_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PMDeactivateItem; y && y->gg.g.tok == zx_pmm_PMDeactivateItem_ELEM; ++n, y = (struct zx_pmm_PMDeactivateItem_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_pmm_PMDeactivateItem_s* zx_pmm_PMDeactivate_GET_PMDeactivateItem(struct zx_pmm_PMDeactivate_s* x, int n)
{
  struct zx_pmm_PMDeactivateItem_s* y;
  if (!x) return 0;
  for (y = x->PMDeactivateItem; n>=0 && y && y->gg.g.tok == zx_pmm_PMDeactivateItem_ELEM; --n, y = (struct zx_pmm_PMDeactivateItem_s*)y->gg.g.n) ;
  return y;
}
...
void zx_pmm_PMDeactivate_PUT_PMDeactivateItem(struct zx_pmm_PMDeactivate_s* x, int n, struct zx_pmm_PMDeactivateItem_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_pmm_PMDeactivateItem_ELEM; --n, y = (struct zx_pmm_PMDeactivateItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_pmm_PMDeactivate_ADD_PMDeactivateItem(struct zx_pmm_PMDeactivate_s* x, int n, struct zx_pmm_PMDeactivateItem_s* z)
{
  ...
  case -1:
    y = x->PMDeactivateItem;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_pmm_PMDeactivateItem_ELEM; y = (struct zx_pmm_PMDeactivateItem_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->PMDeactivateItem; n > 1 && y && y->gg.g.tok == zx_pmm_PMDeactivateItem_ELEM; --n, y = (struct zx_pmm_PMDeactivateItem_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_pmm_PMDeactivate_DEL_PMDeactivateItem(struct zx_pmm_PMDeactivate_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PMDeactivateItem; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_pmm_PMDeactivateItem_ELEM; --n, y = (struct zx_pmm_PMDeactivateItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_pmm_PMDeactivateItem_GET_at(struct zx_pmm_PMDeactivateItem_s* x) { return x->at; }
/* FUNC(zx_pmm_PMDeactivateItem_PUT_at) */
void zx_pmm_PMDeactivateItem_PUT_at(struct zx_pmm_PMDeactivateItem_s* x, struct zx_attr_s* y) { x->at = y; }
/* FUNC(zx_pmm_PMDeactivateItem_GET_itemID) */
struct zx_attr_s* zx_pmm_PMDeactivateItem_GET_itemID(struct zx_pmm_PMDeactivateItem_s* x) { return x->itemID; }
/* FUNC(zx_pmm_PMDeactivateItem_PUT_itemID) */
void zx_pmm_PMDeactivateItem_PUT_itemID(struct zx_pmm_PMDeactivateItem_s* x, struct zx_attr_s* y) { x->itemID = y; }
...
int zx_pmm_PMDelete_NUM_PMDeleteItem(struct zx_pmm_PMDelete_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PMDeleteItem; y && y->gg.g.tok == zx_pmm_PMDeleteItem_ELEM; ++n, y = (struct zx_pmm_PMDeleteItem_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_pmm_PMDeleteItem_s* zx_pmm_PMDelete_GET_PMDeleteItem(struct zx_pmm_PMDelete_s* x, int n)
{
  struct zx_pmm_PMDeleteItem_s* y;
  if (!x) return 0;
  for (y = x->PMDeleteItem; n>=0 && y && y->gg.g.tok == zx_pmm_PMDeleteItem_ELEM; --n, y = (struct zx_pmm_PMDeleteItem_s*)y->gg.g.n) ;
  return y;
}
...
void zx_pmm_PMDelete_PUT_PMDeleteItem(struct zx_pmm_PMDelete_s* x, int n, struct zx_pmm_PMDeleteItem_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_pmm_PMDeleteItem_ELEM; --n, y = (struct zx_pmm_PMDeleteItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_pmm_PMDelete_ADD_PMDeleteItem(struct zx_pmm_PMDelete_s* x, int n, struct zx_pmm_PMDeleteItem_s* z)
{
  ...
  case -1:
    y = x->PMDeleteItem;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_pmm_PMDeleteItem_ELEM; y = (struct zx_pmm_PMDeleteItem_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->PMDeleteItem; n > 1 && y && y->gg.g.tok == zx_pmm_PMDeleteItem_ELEM; --n, y = (struct zx_pmm_PMDeleteItem_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_pmm_PMDelete_DEL_PMDeleteItem(struct zx_pmm_PMDelete_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PMDeleteItem; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_pmm_PMDeleteItem_ELEM; --n, y = (struct zx_pmm_PMDeleteItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_pmm_PMDeleteItem_GET_itemID(struct zx_pmm_PMDeleteItem_s* x) { return x->itemID; }
/* FUNC(zx_pmm_PMDeleteItem_PUT_itemID) */
void zx_pmm_PMDeleteItem_PUT_itemID(struct zx_pmm_PMDeleteItem_s* x, struct zx_attr_s* y) { x->itemID = y; }
...
int zx_pmm_PMUpdate_NUM_PMUpdateItem(struct zx_pmm_PMUpdate_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PMUpdateItem; y && y->gg.g.tok == zx_pmm_PMUpdateItem_ELEM; ++n, y = (struct zx_pmm_PMUpdateItem_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_pmm_PMUpdateItem_s* zx_pmm_PMUpdate_GET_PMUpdateItem(struct zx_pmm_PMUpdate_s* x, int n)
{
  struct zx_pmm_PMUpdateItem_s* y;
  if (!x) return 0;
  for (y = x->PMUpdateItem; n>=0 && y && y->gg.g.tok == zx_pmm_PMUpdateItem_ELEM; --n, y = (struct zx_pmm_PMUpdateItem_s*)y->gg.g.n) ;
  return y;
}
...
void zx_pmm_PMUpdate_PUT_PMUpdateItem(struct zx_pmm_PMUpdate_s* x, int n, struct zx_pmm_PMUpdateItem_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_pmm_PMUpdateItem_ELEM; --n, y = (struct zx_pmm_PMUpdateItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_pmm_PMUpdate_ADD_PMUpdateItem(struct zx_pmm_PMUpdate_s* x, int n, struct zx_pmm_PMUpdateItem_s* z)
{
  ...
  case -1:
    y = x->PMUpdateItem;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_pmm_PMUpdateItem_ELEM; y = (struct zx_pmm_PMUpdateItem_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->PMUpdateItem; n > 1 && y && y->gg.g.tok == zx_pmm_PMUpdateItem_ELEM; --n, y = (struct zx_pmm_PMUpdateItem_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_pmm_PMUpdate_DEL_PMUpdateItem(struct zx_pmm_PMUpdate_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PMUpdateItem; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_pmm_PMUpdateItem_ELEM; --n, y = (struct zx_pmm_PMUpdateItem_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_pmm_PMUpdateItem_GET_at(struct zx_pmm_PMUpdateItem_s* x) { return x->at; }
/* FUNC(zx_pmm_PMUpdateItem_PUT_at) */
void zx_pmm_PMUpdateItem_PUT_at(struct zx_pmm_PMUpdateItem_s* x, struct zx_attr_s* y) { x->at = y; }
/* FUNC(zx_pmm_PMUpdateItem_GET_itemID) */
struct zx_attr_s* zx_pmm_PMUpdateItem_GET_itemID(struct zx_pmm_PMUpdateItem_s* x) { return x->itemID; }
/* FUNC(zx_pmm_PMUpdateItem_PUT_itemID) */
void zx_pmm_PMUpdateItem_PUT_itemID(struct zx_pmm_PMUpdateItem_s* x, struct zx_attr_s* y) { x->itemID = y; }
/* FUNC(zx_pmm_PMUpdateItem_GET_type) */
struct zx_attr_s* zx_pmm_PMUpdateItem_GET_type(struct zx_pmm_PMUpdateItem_s* x) { return x->type; }
/* FUNC(zx_pmm_PMUpdateItem_PUT_type) */
void zx_pmm_PMUpdateItem_PUT_type(struct zx_pmm_PMUpdateItem_s* x, struct zx_attr_s* y) { x->type = y; }
...
struct zx_attr_s* zx_pmm_Provision_GET_wait(struct zx_pmm_Provision_s* x) { return x->wait; }
/* FUNC(zx_pmm_Provision_PUT_wait) */
void zx_pmm_Provision_PUT_wait(struct zx_pmm_Provision_s* x, struct zx_attr_s* y) { x->wait = y; }
