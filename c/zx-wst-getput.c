...
int zx_wst_Authenticator_NUM_CombinedHash(struct zx_wst_Authenticator_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->CombinedHash; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_wst_Authenticator_GET_CombinedHash(struct zx_wst_Authenticator_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->CombinedHash; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_wst_Authenticator_ADD_CombinedHash(struct zx_wst_Authenticator_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CombinedHash; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_wst_Authenticator_DEL_CombinedHash(struct zx_wst_Authenticator_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CombinedHash; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_wst_IssuedTokens_NUM_RequestSecurityTokenResponse(struct zx_wst_IssuedTokens_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->RequestSecurityTokenResponse; y && y->gg.g.tok == zx_wst_RequestSecurityTokenResponse_ELEM; ++n, y = (struct zx_wst_RequestSecurityTokenResponse_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_RequestSecurityTokenResponse_s* zx_wst_IssuedTokens_GET_RequestSecurityTokenResponse(struct zx_wst_IssuedTokens_s* x, int n)
{
  struct zx_wst_RequestSecurityTokenResponse_s* y;
  if (!x) return 0;
  for (y = x->RequestSecurityTokenResponse; n>=0 && y && y->gg.g.tok == zx_wst_RequestSecurityTokenResponse_ELEM; --n, y = (struct zx_wst_RequestSecurityTokenResponse_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_IssuedTokens_PUT_RequestSecurityTokenResponse(struct zx_wst_IssuedTokens_s* x, int n, struct zx_wst_RequestSecurityTokenResponse_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestSecurityTokenResponse_ELEM; --n, y = (struct zx_wst_RequestSecurityTokenResponse_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_IssuedTokens_ADD_RequestSecurityTokenResponse(struct zx_wst_IssuedTokens_s* x, int n, struct zx_wst_RequestSecurityTokenResponse_s* z)
{
  ...
  case -1:
    y = x->RequestSecurityTokenResponse;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestSecurityTokenResponse_ELEM; y = (struct zx_wst_RequestSecurityTokenResponse_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->RequestSecurityTokenResponse; n > 1 && y && y->gg.g.tok == zx_wst_RequestSecurityTokenResponse_ELEM; --n, y = (struct zx_wst_RequestSecurityTokenResponse_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_IssuedTokens_DEL_RequestSecurityTokenResponse(struct zx_wst_IssuedTokens_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->RequestSecurityTokenResponse; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestSecurityTokenResponse_ELEM; --n, y = (struct zx_wst_RequestSecurityTokenResponse_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_Participants_NUM_Primary(struct zx_wst_Participants_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Primary; y && y->gg.g.tok == zx_wst_Primary_ELEM; ++n, y = (struct zx_wst_Primary_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_Primary_s* zx_wst_Participants_GET_Primary(struct zx_wst_Participants_s* x, int n)
{
  struct zx_wst_Primary_s* y;
  if (!x) return 0;
  for (y = x->Primary; n>=0 && y && y->gg.g.tok == zx_wst_Primary_ELEM; --n, y = (struct zx_wst_Primary_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_Participants_PUT_Primary(struct zx_wst_Participants_s* x, int n, struct zx_wst_Primary_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Primary_ELEM; --n, y = (struct zx_wst_Primary_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_Participants_ADD_Primary(struct zx_wst_Participants_s* x, int n, struct zx_wst_Primary_s* z)
{
  ...
  case -1:
    y = x->Primary;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Primary_ELEM; y = (struct zx_wst_Primary_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Primary; n > 1 && y && y->gg.g.tok == zx_wst_Primary_ELEM; --n, y = (struct zx_wst_Primary_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_Participants_DEL_Primary(struct zx_wst_Participants_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Primary; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Primary_ELEM; --n, y = (struct zx_wst_Primary_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_Participants_NUM_Participant(struct zx_wst_Participants_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Participant; y && y->gg.g.tok == zx_wst_Participant_ELEM; ++n, y = (struct zx_wst_Participant_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_Participant_s* zx_wst_Participants_GET_Participant(struct zx_wst_Participants_s* x, int n)
{
  struct zx_wst_Participant_s* y;
  if (!x) return 0;
  for (y = x->Participant; n>=0 && y && y->gg.g.tok == zx_wst_Participant_ELEM; --n, y = (struct zx_wst_Participant_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_Participants_PUT_Participant(struct zx_wst_Participants_s* x, int n, struct zx_wst_Participant_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Participant_ELEM; --n, y = (struct zx_wst_Participant_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_Participants_ADD_Participant(struct zx_wst_Participants_s* x, int n, struct zx_wst_Participant_s* z)
{
  ...
  case -1:
    y = x->Participant;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Participant_ELEM; y = (struct zx_wst_Participant_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Participant; n > 1 && y && y->gg.g.tok == zx_wst_Participant_ELEM; --n, y = (struct zx_wst_Participant_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_Participants_DEL_Participant(struct zx_wst_Participants_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Participant; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Participant_ELEM; --n, y = (struct zx_wst_Participant_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_TokenType(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->TokenType; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_wst_RequestSecurityToken_GET_TokenType(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->TokenType; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_ADD_TokenType(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->TokenType; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_wst_RequestSecurityToken_DEL_TokenType(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->TokenType; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_RequestType(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->RequestType; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_wst_RequestSecurityToken_GET_RequestType(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->RequestType; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_ADD_RequestType(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->RequestType; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_wst_RequestSecurityToken_DEL_RequestType(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->RequestType; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_Claims(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Claims; y && y->gg.g.tok == zx_wst_Claims_ELEM; ++n, y = (struct zx_wst_Claims_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_Claims_s* zx_wst_RequestSecurityToken_GET_Claims(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_wst_Claims_s* y;
  if (!x) return 0;
  for (y = x->Claims; n>=0 && y && y->gg.g.tok == zx_wst_Claims_ELEM; --n, y = (struct zx_wst_Claims_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_PUT_Claims(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_Claims_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Claims_ELEM; --n, y = (struct zx_wst_Claims_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityToken_ADD_Claims(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_Claims_s* z)
{
  ...
  case -1:
    y = x->Claims;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Claims_ELEM; y = (struct zx_wst_Claims_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Claims; n > 1 && y && y->gg.g.tok == zx_wst_Claims_ELEM; --n, y = (struct zx_wst_Claims_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityToken_DEL_Claims(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Claims; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Claims_ELEM; --n, y = (struct zx_wst_Claims_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_Entropy(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Entropy; y && y->gg.g.tok == zx_wst_Entropy_ELEM; ++n, y = (struct zx_wst_Entropy_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_Entropy_s* zx_wst_RequestSecurityToken_GET_Entropy(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_wst_Entropy_s* y;
  if (!x) return 0;
  for (y = x->Entropy; n>=0 && y && y->gg.g.tok == zx_wst_Entropy_ELEM; --n, y = (struct zx_wst_Entropy_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_PUT_Entropy(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_Entropy_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Entropy_ELEM; --n, y = (struct zx_wst_Entropy_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityToken_ADD_Entropy(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_Entropy_s* z)
{
  ...
  case -1:
    y = x->Entropy;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Entropy_ELEM; y = (struct zx_wst_Entropy_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Entropy; n > 1 && y && y->gg.g.tok == zx_wst_Entropy_ELEM; --n, y = (struct zx_wst_Entropy_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityToken_DEL_Entropy(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Entropy; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Entropy_ELEM; --n, y = (struct zx_wst_Entropy_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_Lifetime(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Lifetime; y && y->gg.g.tok == zx_wst_Lifetime_ELEM; ++n, y = (struct zx_wst_Lifetime_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_Lifetime_s* zx_wst_RequestSecurityToken_GET_Lifetime(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_wst_Lifetime_s* y;
  if (!x) return 0;
  for (y = x->Lifetime; n>=0 && y && y->gg.g.tok == zx_wst_Lifetime_ELEM; --n, y = (struct zx_wst_Lifetime_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_PUT_Lifetime(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_Lifetime_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Lifetime_ELEM; --n, y = (struct zx_wst_Lifetime_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityToken_ADD_Lifetime(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_Lifetime_s* z)
{
  ...
  case -1:
    y = x->Lifetime;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Lifetime_ELEM; y = (struct zx_wst_Lifetime_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Lifetime; n > 1 && y && y->gg.g.tok == zx_wst_Lifetime_ELEM; --n, y = (struct zx_wst_Lifetime_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityToken_DEL_Lifetime(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Lifetime; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Lifetime_ELEM; --n, y = (struct zx_wst_Lifetime_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_AllowPostdating(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AllowPostdating; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_wst_RequestSecurityToken_GET_AllowPostdating(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->AllowPostdating; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_ADD_AllowPostdating(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AllowPostdating; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_wst_RequestSecurityToken_DEL_AllowPostdating(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AllowPostdating; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_Renewing(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Renewing; y && y->gg.g.tok == zx_wst_Renewing_ELEM; ++n, y = (struct zx_wst_Renewing_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_Renewing_s* zx_wst_RequestSecurityToken_GET_Renewing(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_wst_Renewing_s* y;
  if (!x) return 0;
  for (y = x->Renewing; n>=0 && y && y->gg.g.tok == zx_wst_Renewing_ELEM; --n, y = (struct zx_wst_Renewing_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_PUT_Renewing(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_Renewing_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Renewing_ELEM; --n, y = (struct zx_wst_Renewing_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityToken_ADD_Renewing(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_Renewing_s* z)
{
  ...
  case -1:
    y = x->Renewing;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Renewing_ELEM; y = (struct zx_wst_Renewing_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Renewing; n > 1 && y && y->gg.g.tok == zx_wst_Renewing_ELEM; --n, y = (struct zx_wst_Renewing_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityToken_DEL_Renewing(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Renewing; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Renewing_ELEM; --n, y = (struct zx_wst_Renewing_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_OnBehalfOf(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->OnBehalfOf; y && y->gg.g.tok == zx_wst_OnBehalfOf_ELEM; ++n, y = (struct zx_wst_OnBehalfOf_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_OnBehalfOf_s* zx_wst_RequestSecurityToken_GET_OnBehalfOf(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_wst_OnBehalfOf_s* y;
  if (!x) return 0;
  for (y = x->OnBehalfOf; n>=0 && y && y->gg.g.tok == zx_wst_OnBehalfOf_ELEM; --n, y = (struct zx_wst_OnBehalfOf_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_PUT_OnBehalfOf(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_OnBehalfOf_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_OnBehalfOf_ELEM; --n, y = (struct zx_wst_OnBehalfOf_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityToken_ADD_OnBehalfOf(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_OnBehalfOf_s* z)
{
  ...
  case -1:
    y = x->OnBehalfOf;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_OnBehalfOf_ELEM; y = (struct zx_wst_OnBehalfOf_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->OnBehalfOf; n > 1 && y && y->gg.g.tok == zx_wst_OnBehalfOf_ELEM; --n, y = (struct zx_wst_OnBehalfOf_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityToken_DEL_OnBehalfOf(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->OnBehalfOf; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_OnBehalfOf_ELEM; --n, y = (struct zx_wst_OnBehalfOf_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_Issuer(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Issuer; y && y->gg.g.tok == zx_wst_Issuer_ELEM; ++n, y = (struct zx_wst_Issuer_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_Issuer_s* zx_wst_RequestSecurityToken_GET_Issuer(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_wst_Issuer_s* y;
  if (!x) return 0;
  for (y = x->Issuer; n>=0 && y && y->gg.g.tok == zx_wst_Issuer_ELEM; --n, y = (struct zx_wst_Issuer_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_PUT_Issuer(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_Issuer_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Issuer_ELEM; --n, y = (struct zx_wst_Issuer_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityToken_ADD_Issuer(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_Issuer_s* z)
{
  ...
  case -1:
    y = x->Issuer;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Issuer_ELEM; y = (struct zx_wst_Issuer_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Issuer; n > 1 && y && y->gg.g.tok == zx_wst_Issuer_ELEM; --n, y = (struct zx_wst_Issuer_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityToken_DEL_Issuer(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Issuer; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Issuer_ELEM; --n, y = (struct zx_wst_Issuer_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_AuthenticationType(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AuthenticationType; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_wst_RequestSecurityToken_GET_AuthenticationType(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->AuthenticationType; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_ADD_AuthenticationType(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AuthenticationType; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_wst_RequestSecurityToken_DEL_AuthenticationType(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AuthenticationType; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_KeyType(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->KeyType; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_wst_RequestSecurityToken_GET_KeyType(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->KeyType; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_ADD_KeyType(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->KeyType; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_wst_RequestSecurityToken_DEL_KeyType(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->KeyType; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_SignatureAlgorithm(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->SignatureAlgorithm; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_wst_RequestSecurityToken_GET_SignatureAlgorithm(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->SignatureAlgorithm; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_ADD_SignatureAlgorithm(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SignatureAlgorithm; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_wst_RequestSecurityToken_DEL_SignatureAlgorithm(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SignatureAlgorithm; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_Encryption(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Encryption; y && y->gg.g.tok == zx_wst_Encryption_ELEM; ++n, y = (struct zx_wst_Encryption_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_Encryption_s* zx_wst_RequestSecurityToken_GET_Encryption(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_wst_Encryption_s* y;
  if (!x) return 0;
  for (y = x->Encryption; n>=0 && y && y->gg.g.tok == zx_wst_Encryption_ELEM; --n, y = (struct zx_wst_Encryption_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_PUT_Encryption(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_Encryption_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Encryption_ELEM; --n, y = (struct zx_wst_Encryption_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityToken_ADD_Encryption(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_Encryption_s* z)
{
  ...
  case -1:
    y = x->Encryption;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Encryption_ELEM; y = (struct zx_wst_Encryption_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Encryption; n > 1 && y && y->gg.g.tok == zx_wst_Encryption_ELEM; --n, y = (struct zx_wst_Encryption_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityToken_DEL_Encryption(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Encryption; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Encryption_ELEM; --n, y = (struct zx_wst_Encryption_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_EncryptionAlgorithm(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->EncryptionAlgorithm; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_wst_RequestSecurityToken_GET_EncryptionAlgorithm(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->EncryptionAlgorithm; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_ADD_EncryptionAlgorithm(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->EncryptionAlgorithm; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_wst_RequestSecurityToken_DEL_EncryptionAlgorithm(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->EncryptionAlgorithm; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_CanonicalizationAlgorithm(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->CanonicalizationAlgorithm; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_wst_RequestSecurityToken_GET_CanonicalizationAlgorithm(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->CanonicalizationAlgorithm; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_ADD_CanonicalizationAlgorithm(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CanonicalizationAlgorithm; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_wst_RequestSecurityToken_DEL_CanonicalizationAlgorithm(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CanonicalizationAlgorithm; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_ProofEncryption(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ProofEncryption; y && y->gg.g.tok == zx_wst_ProofEncryption_ELEM; ++n, y = (struct zx_wst_ProofEncryption_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_ProofEncryption_s* zx_wst_RequestSecurityToken_GET_ProofEncryption(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_wst_ProofEncryption_s* y;
  if (!x) return 0;
  for (y = x->ProofEncryption; n>=0 && y && y->gg.g.tok == zx_wst_ProofEncryption_ELEM; --n, y = (struct zx_wst_ProofEncryption_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_PUT_ProofEncryption(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_ProofEncryption_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_ProofEncryption_ELEM; --n, y = (struct zx_wst_ProofEncryption_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityToken_ADD_ProofEncryption(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_ProofEncryption_s* z)
{
  ...
  case -1:
    y = x->ProofEncryption;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_ProofEncryption_ELEM; y = (struct zx_wst_ProofEncryption_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->ProofEncryption; n > 1 && y && y->gg.g.tok == zx_wst_ProofEncryption_ELEM; --n, y = (struct zx_wst_ProofEncryption_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityToken_DEL_ProofEncryption(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ProofEncryption; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_ProofEncryption_ELEM; --n, y = (struct zx_wst_ProofEncryption_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_UseKey(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->UseKey; y && y->gg.g.tok == zx_wst_UseKey_ELEM; ++n, y = (struct zx_wst_UseKey_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_UseKey_s* zx_wst_RequestSecurityToken_GET_UseKey(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_wst_UseKey_s* y;
  if (!x) return 0;
  for (y = x->UseKey; n>=0 && y && y->gg.g.tok == zx_wst_UseKey_ELEM; --n, y = (struct zx_wst_UseKey_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_PUT_UseKey(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_UseKey_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_UseKey_ELEM; --n, y = (struct zx_wst_UseKey_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityToken_ADD_UseKey(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_UseKey_s* z)
{
  ...
  case -1:
    y = x->UseKey;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_UseKey_ELEM; y = (struct zx_wst_UseKey_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->UseKey; n > 1 && y && y->gg.g.tok == zx_wst_UseKey_ELEM; --n, y = (struct zx_wst_UseKey_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityToken_DEL_UseKey(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->UseKey; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_UseKey_ELEM; --n, y = (struct zx_wst_UseKey_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_SignWith(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->SignWith; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_wst_RequestSecurityToken_GET_SignWith(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->SignWith; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_ADD_SignWith(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SignWith; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_wst_RequestSecurityToken_DEL_SignWith(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SignWith; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_EncryptWith(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->EncryptWith; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_wst_RequestSecurityToken_GET_EncryptWith(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->EncryptWith; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_ADD_EncryptWith(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->EncryptWith; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_wst_RequestSecurityToken_DEL_EncryptWith(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->EncryptWith; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_DelegateTo(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->DelegateTo; y && y->gg.g.tok == zx_wst_DelegateTo_ELEM; ++n, y = (struct zx_wst_DelegateTo_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_DelegateTo_s* zx_wst_RequestSecurityToken_GET_DelegateTo(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_wst_DelegateTo_s* y;
  if (!x) return 0;
  for (y = x->DelegateTo; n>=0 && y && y->gg.g.tok == zx_wst_DelegateTo_ELEM; --n, y = (struct zx_wst_DelegateTo_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_PUT_DelegateTo(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_DelegateTo_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_DelegateTo_ELEM; --n, y = (struct zx_wst_DelegateTo_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityToken_ADD_DelegateTo(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_wst_DelegateTo_s* z)
{
  ...
  case -1:
    y = x->DelegateTo;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_DelegateTo_ELEM; y = (struct zx_wst_DelegateTo_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->DelegateTo; n > 1 && y && y->gg.g.tok == zx_wst_DelegateTo_ELEM; --n, y = (struct zx_wst_DelegateTo_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityToken_DEL_DelegateTo(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->DelegateTo; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_DelegateTo_ELEM; --n, y = (struct zx_wst_DelegateTo_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_Forwardable(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Forwardable; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_wst_RequestSecurityToken_GET_Forwardable(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->Forwardable; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_ADD_Forwardable(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Forwardable; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_wst_RequestSecurityToken_DEL_Forwardable(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Forwardable; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_wst_RequestSecurityToken_NUM_Delegatable(struct zx_wst_RequestSecurityToken_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Delegatable; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_wst_RequestSecurityToken_GET_Delegatable(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->Delegatable; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityToken_ADD_Delegatable(struct zx_wst_RequestSecurityToken_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Delegatable; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_wst_RequestSecurityToken_DEL_Delegatable(struct zx_wst_RequestSecurityToken_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Delegatable; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_wst_RequestSecurityTokenCollection_NUM_RequestSecurityToken(struct zx_wst_RequestSecurityTokenCollection_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->RequestSecurityToken; y && y->gg.g.tok == zx_wst_RequestSecurityToken_ELEM; ++n, y = (struct zx_wst_RequestSecurityToken_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_RequestSecurityToken_s* zx_wst_RequestSecurityTokenCollection_GET_RequestSecurityToken(struct zx_wst_RequestSecurityTokenCollection_s* x, int n)
{
  struct zx_wst_RequestSecurityToken_s* y;
  if (!x) return 0;
  for (y = x->RequestSecurityToken; n>=0 && y && y->gg.g.tok == zx_wst_RequestSecurityToken_ELEM; --n, y = (struct zx_wst_RequestSecurityToken_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityTokenCollection_PUT_RequestSecurityToken(struct zx_wst_RequestSecurityTokenCollection_s* x, int n, struct zx_wst_RequestSecurityToken_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestSecurityToken_ELEM; --n, y = (struct zx_wst_RequestSecurityToken_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityTokenCollection_ADD_RequestSecurityToken(struct zx_wst_RequestSecurityTokenCollection_s* x, int n, struct zx_wst_RequestSecurityToken_s* z)
{
  ...
  case -1:
    y = x->RequestSecurityToken;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestSecurityToken_ELEM; y = (struct zx_wst_RequestSecurityToken_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->RequestSecurityToken; n > 1 && y && y->gg.g.tok == zx_wst_RequestSecurityToken_ELEM; --n, y = (struct zx_wst_RequestSecurityToken_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityTokenCollection_DEL_RequestSecurityToken(struct zx_wst_RequestSecurityTokenCollection_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->RequestSecurityToken; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestSecurityToken_ELEM; --n, y = (struct zx_wst_RequestSecurityToken_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityTokenResponse_NUM_RequestedSecurityToken(struct zx_wst_RequestSecurityTokenResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->RequestedSecurityToken; y && y->gg.g.tok == zx_wst_RequestedSecurityToken_ELEM; ++n, y = (struct zx_wst_RequestedSecurityToken_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_RequestedSecurityToken_s* zx_wst_RequestSecurityTokenResponse_GET_RequestedSecurityToken(struct zx_wst_RequestSecurityTokenResponse_s* x, int n)
{
  struct zx_wst_RequestedSecurityToken_s* y;
  if (!x) return 0;
  for (y = x->RequestedSecurityToken; n>=0 && y && y->gg.g.tok == zx_wst_RequestedSecurityToken_ELEM; --n, y = (struct zx_wst_RequestedSecurityToken_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityTokenResponse_PUT_RequestedSecurityToken(struct zx_wst_RequestSecurityTokenResponse_s* x, int n, struct zx_wst_RequestedSecurityToken_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestedSecurityToken_ELEM; --n, y = (struct zx_wst_RequestedSecurityToken_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityTokenResponse_ADD_RequestedSecurityToken(struct zx_wst_RequestSecurityTokenResponse_s* x, int n, struct zx_wst_RequestedSecurityToken_s* z)
{
  ...
  case -1:
    y = x->RequestedSecurityToken;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestedSecurityToken_ELEM; y = (struct zx_wst_RequestedSecurityToken_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->RequestedSecurityToken; n > 1 && y && y->gg.g.tok == zx_wst_RequestedSecurityToken_ELEM; --n, y = (struct zx_wst_RequestedSecurityToken_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityTokenResponse_DEL_RequestedSecurityToken(struct zx_wst_RequestSecurityTokenResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->RequestedSecurityToken; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestedSecurityToken_ELEM; --n, y = (struct zx_wst_RequestedSecurityToken_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityTokenResponse_NUM_RequestedAttachedReference(struct zx_wst_RequestSecurityTokenResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->RequestedAttachedReference; y && y->gg.g.tok == zx_wst_RequestedAttachedReference_ELEM; ++n, y = (struct zx_wst_RequestedAttachedReference_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_RequestedAttachedReference_s* zx_wst_RequestSecurityTokenResponse_GET_RequestedAttachedReference(struct zx_wst_RequestSecurityTokenResponse_s* x, int n)
{
  struct zx_wst_RequestedAttachedReference_s* y;
  if (!x) return 0;
  for (y = x->RequestedAttachedReference; n>=0 && y && y->gg.g.tok == zx_wst_RequestedAttachedReference_ELEM; --n, y = (struct zx_wst_RequestedAttachedReference_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityTokenResponse_PUT_RequestedAttachedReference(struct zx_wst_RequestSecurityTokenResponse_s* x, int n, struct zx_wst_RequestedAttachedReference_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestedAttachedReference_ELEM; --n, y = (struct zx_wst_RequestedAttachedReference_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityTokenResponse_ADD_RequestedAttachedReference(struct zx_wst_RequestSecurityTokenResponse_s* x, int n, struct zx_wst_RequestedAttachedReference_s* z)
{
  ...
  case -1:
    y = x->RequestedAttachedReference;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestedAttachedReference_ELEM; y = (struct zx_wst_RequestedAttachedReference_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->RequestedAttachedReference; n > 1 && y && y->gg.g.tok == zx_wst_RequestedAttachedReference_ELEM; --n, y = (struct zx_wst_RequestedAttachedReference_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityTokenResponse_DEL_RequestedAttachedReference(struct zx_wst_RequestSecurityTokenResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->RequestedAttachedReference; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestedAttachedReference_ELEM; --n, y = (struct zx_wst_RequestedAttachedReference_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityTokenResponse_NUM_RequestedUnattachedReference(struct zx_wst_RequestSecurityTokenResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->RequestedUnattachedReference; y && y->gg.g.tok == zx_wst_RequestedUnattachedReference_ELEM; ++n, y = (struct zx_wst_RequestedUnattachedReference_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_RequestedUnattachedReference_s* zx_wst_RequestSecurityTokenResponse_GET_RequestedUnattachedReference(struct zx_wst_RequestSecurityTokenResponse_s* x, int n)
{
  struct zx_wst_RequestedUnattachedReference_s* y;
  if (!x) return 0;
  for (y = x->RequestedUnattachedReference; n>=0 && y && y->gg.g.tok == zx_wst_RequestedUnattachedReference_ELEM; --n, y = (struct zx_wst_RequestedUnattachedReference_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityTokenResponse_PUT_RequestedUnattachedReference(struct zx_wst_RequestSecurityTokenResponse_s* x, int n, struct zx_wst_RequestedUnattachedReference_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestedUnattachedReference_ELEM; --n, y = (struct zx_wst_RequestedUnattachedReference_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityTokenResponse_ADD_RequestedUnattachedReference(struct zx_wst_RequestSecurityTokenResponse_s* x, int n, struct zx_wst_RequestedUnattachedReference_s* z)
{
  ...
  case -1:
    y = x->RequestedUnattachedReference;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestedUnattachedReference_ELEM; y = (struct zx_wst_RequestedUnattachedReference_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->RequestedUnattachedReference; n > 1 && y && y->gg.g.tok == zx_wst_RequestedUnattachedReference_ELEM; --n, y = (struct zx_wst_RequestedUnattachedReference_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityTokenResponse_DEL_RequestedUnattachedReference(struct zx_wst_RequestSecurityTokenResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->RequestedUnattachedReference; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestedUnattachedReference_ELEM; --n, y = (struct zx_wst_RequestedUnattachedReference_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityTokenResponse_NUM_RequestedProofToken(struct zx_wst_RequestSecurityTokenResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->RequestedProofToken; y && y->gg.g.tok == zx_wst_RequestedProofToken_ELEM; ++n, y = (struct zx_wst_RequestedProofToken_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_RequestedProofToken_s* zx_wst_RequestSecurityTokenResponse_GET_RequestedProofToken(struct zx_wst_RequestSecurityTokenResponse_s* x, int n)
{
  struct zx_wst_RequestedProofToken_s* y;
  if (!x) return 0;
  for (y = x->RequestedProofToken; n>=0 && y && y->gg.g.tok == zx_wst_RequestedProofToken_ELEM; --n, y = (struct zx_wst_RequestedProofToken_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityTokenResponse_PUT_RequestedProofToken(struct zx_wst_RequestSecurityTokenResponse_s* x, int n, struct zx_wst_RequestedProofToken_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestedProofToken_ELEM; --n, y = (struct zx_wst_RequestedProofToken_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityTokenResponse_ADD_RequestedProofToken(struct zx_wst_RequestSecurityTokenResponse_s* x, int n, struct zx_wst_RequestedProofToken_s* z)
{
  ...
  case -1:
    y = x->RequestedProofToken;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestedProofToken_ELEM; y = (struct zx_wst_RequestedProofToken_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->RequestedProofToken; n > 1 && y && y->gg.g.tok == zx_wst_RequestedProofToken_ELEM; --n, y = (struct zx_wst_RequestedProofToken_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityTokenResponse_DEL_RequestedProofToken(struct zx_wst_RequestSecurityTokenResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->RequestedProofToken; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_RequestedProofToken_ELEM; --n, y = (struct zx_wst_RequestedProofToken_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityTokenResponse_NUM_Status(struct zx_wst_RequestSecurityTokenResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Status; y && y->gg.g.tok == zx_wst_Status_ELEM; ++n, y = (struct zx_wst_Status_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_Status_s* zx_wst_RequestSecurityTokenResponse_GET_Status(struct zx_wst_RequestSecurityTokenResponse_s* x, int n)
{
  struct zx_wst_Status_s* y;
  if (!x) return 0;
  for (y = x->Status; n>=0 && y && y->gg.g.tok == zx_wst_Status_ELEM; --n, y = (struct zx_wst_Status_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityTokenResponse_PUT_Status(struct zx_wst_RequestSecurityTokenResponse_s* x, int n, struct zx_wst_Status_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Status_ELEM; --n, y = (struct zx_wst_Status_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityTokenResponse_ADD_Status(struct zx_wst_RequestSecurityTokenResponse_s* x, int n, struct zx_wst_Status_s* z)
{
  ...
  case -1:
    y = x->Status;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Status_ELEM; y = (struct zx_wst_Status_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Status; n > 1 && y && y->gg.g.tok == zx_wst_Status_ELEM; --n, y = (struct zx_wst_Status_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityTokenResponse_DEL_Status(struct zx_wst_RequestSecurityTokenResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Status; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Status_ELEM; --n, y = (struct zx_wst_Status_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_RequestSecurityTokenResponse_NUM_Authenticator(struct zx_wst_RequestSecurityTokenResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Authenticator; y && y->gg.g.tok == zx_wst_Authenticator_ELEM; ++n, y = (struct zx_wst_Authenticator_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_wst_Authenticator_s* zx_wst_RequestSecurityTokenResponse_GET_Authenticator(struct zx_wst_RequestSecurityTokenResponse_s* x, int n)
{
  struct zx_wst_Authenticator_s* y;
  if (!x) return 0;
  for (y = x->Authenticator; n>=0 && y && y->gg.g.tok == zx_wst_Authenticator_ELEM; --n, y = (struct zx_wst_Authenticator_s*)y->gg.g.n) ;
  return y;
}
...
void zx_wst_RequestSecurityTokenResponse_PUT_Authenticator(struct zx_wst_RequestSecurityTokenResponse_s* x, int n, struct zx_wst_Authenticator_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Authenticator_ELEM; --n, y = (struct zx_wst_Authenticator_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_wst_RequestSecurityTokenResponse_ADD_Authenticator(struct zx_wst_RequestSecurityTokenResponse_s* x, int n, struct zx_wst_Authenticator_s* z)
{
  ...
  case -1:
    y = x->Authenticator;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Authenticator_ELEM; y = (struct zx_wst_Authenticator_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Authenticator; n > 1 && y && y->gg.g.tok == zx_wst_Authenticator_ELEM; --n, y = (struct zx_wst_Authenticator_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_wst_RequestSecurityTokenResponse_DEL_Authenticator(struct zx_wst_RequestSecurityTokenResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Authenticator; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_wst_Authenticator_ELEM; --n, y = (struct zx_wst_Authenticator_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_wst_SignChallenge_NUM_Challenge(struct zx_wst_SignChallenge_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Challenge; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_wst_SignChallenge_GET_Challenge(struct zx_wst_SignChallenge_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->Challenge; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_wst_SignChallenge_ADD_Challenge(struct zx_wst_SignChallenge_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Challenge; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_wst_SignChallenge_DEL_Challenge(struct zx_wst_SignChallenge_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Challenge; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_wst_Status_NUM_Reason(struct zx_wst_Status_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Reason; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_wst_Status_GET_Reason(struct zx_wst_Status_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->Reason; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_wst_Status_ADD_Reason(struct zx_wst_Status_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Reason; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_wst_Status_DEL_Reason(struct zx_wst_Status_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Reason; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
