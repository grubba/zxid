...
/* Called by: */
struct zx_as_Extensions_s* zx_DEC_as_Extensions(struct zx_ctx* c, struct zx_as_Extensions_s* x )
{
...
/* Called by: */
struct zx_as_Parameter_s* zx_DEC_as_Parameter(struct zx_ctx* c, struct zx_as_Parameter_s* x )
{
  int tok MAYBE_UNUSED;  /* Unused in zx_DEC_root() */
  struct zx_elem_s* el;
  struct zx_ns_s* pop_seen;
...
/* Called by: */
struct zx_as_PasswordTransforms_s* zx_DEC_as_PasswordTransforms(struct zx_ctx* c, struct zx_as_PasswordTransforms_s* x )
{
  int tok MAYBE_UNUSED;  /* Unused in zx_DEC_root() */
  struct zx_elem_s* el;
  struct zx_ns_s* pop_seen;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (el->g.tok) {
          case zx_as_Transform_ELEM:
            zx_DEC_as_Transform(c, (struct zx_as_Transform_s*)el);
            if (!x->Transform)
...
/* Called by: */
struct zx_as_SASLRequest_s* zx_DEC_as_SASLRequest(struct zx_ctx* c, struct zx_as_SASLRequest_s* x )
{
  int tok MAYBE_UNUSED;  /* Unused in zx_DEC_root() */
  struct zx_elem_s* el;
  struct zx_ns_s* pop_seen;
  ...
  for (; c->p; ++c->p) {
    tok = zx_attr_lookup(c, (struct zx_elem_s*)x, (const char*)__FUNCTION__);
    switch (tok) {
    case zx_advisoryAuthnID_ATTR:  x->advisoryAuthnID = x->gg.attr; break;
    case zx_authzID_ATTR:  x->authzID = x->gg.attr; break;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (el->g.tok) {
          ...
          case zx_as_Extensions_ELEM:
            zx_DEC_as_Extensions(c, (struct zx_as_Extensions_s*)el);
            if (!x->Extensions)
...
/* Called by: */
struct zx_as_SASLResponse_s* zx_DEC_as_SASLResponse(struct zx_ctx* c, struct zx_as_SASLResponse_s* x )
{
  int tok MAYBE_UNUSED;  /* Unused in zx_DEC_root() */
  struct zx_elem_s* el;
  struct zx_ns_s* pop_seen;
  ...
  for (; c->p; ++c->p) {
    tok = zx_attr_lookup(c, (struct zx_elem_s*)x, (const char*)__FUNCTION__);
    switch (tok) {
    case zx_serverMechanism_ATTR:  x->serverMechanism = x->gg.attr; break;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (el->g.tok) {
          ...
          case zx_as_PasswordTransforms_ELEM:
            zx_DEC_as_PasswordTransforms(c, (struct zx_as_PasswordTransforms_s*)el);
...
/* Called by: */
struct zx_as_Transform_s* zx_DEC_as_Transform(struct zx_ctx* c, struct zx_as_Transform_s* x )
{
  int tok MAYBE_UNUSED;  /* Unused in zx_DEC_root() */
  struct zx_elem_s* el;
  struct zx_ns_s* pop_seen;
	...
	if (A_Z_a_z_(*c->p)) {
	  ...
	  switch (el->g.tok) {
          case zx_as_Parameter_ELEM:
            zx_DEC_as_Parameter(c, (struct zx_as_Parameter_s*)el);
            if (!x->Parameter)
