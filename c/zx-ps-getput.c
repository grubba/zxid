/* c/zx-ps-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
int zx_ps_AddCollectionRequest_NUM_Object(struct zx_ps_AddCollectionRequest_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Object; y && y->gg.g.tok == zx_ps_Object_ELEM; ++n, y = (struct zx_ps_Object_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_ps_Object_s* zx_ps_AddCollectionRequest_GET_Object(struct zx_ps_AddCollectionRequest_s* x, int n)
{
  struct zx_ps_Object_s* y;
  if (!x) return 0;
  for (y = x->Object; n>=0 && y && y->gg.g.tok == zx_ps_Object_ELEM; --n, y = (struct zx_ps_Object_s*)y->gg.g.n) ;
  return y;
}
...
void zx_ps_AddCollectionRequest_PUT_Object(struct zx_ps_AddCollectionRequest_s* x, int n, struct zx_ps_Object_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_Object_ELEM; --n, y = (struct zx_ps_Object_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_ps_AddCollectionRequest_ADD_Object(struct zx_ps_AddCollectionRequest_s* x, int n, struct zx_ps_Object_s* z)
{
  ...
  case -1:
    ...
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_Object_ELEM; y = (struct zx_ps_Object_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Object; n > 1 && y && y->gg.g.tok == zx_ps_Object_ELEM; --n, y = (struct zx_ps_Object_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_ps_AddCollectionRequest_DEL_Object(struct zx_ps_AddCollectionRequest_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Object; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_Object_ELEM; --n, y = (struct zx_ps_Object_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_ps_AddCollectionRequest_NUM_Subscription(struct zx_ps_AddCollectionRequest_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Subscription; y && y->gg.g.tok == zx_ps_Subscription_ELEM; ++n, y = (struct zx_ps_Subscription_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_ps_Subscription_s* zx_ps_AddCollectionRequest_GET_Subscription(struct zx_ps_AddCollectionRequest_s* x, int n)
{
  struct zx_ps_Subscription_s* y;
  if (!x) return 0;
  for (y = x->Subscription; n>=0 && y && y->gg.g.tok == zx_ps_Subscription_ELEM; --n, y = (struct zx_ps_Subscription_s*)y->gg.g.n) ;
  return y;
}
...
void zx_ps_AddCollectionRequest_PUT_Subscription(struct zx_ps_AddCollectionRequest_s* x, int n, struct zx_ps_Subscription_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_Subscription_ELEM; --n, y = (struct zx_ps_Subscription_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_ps_AddCollectionRequest_ADD_Subscription(struct zx_ps_AddCollectionRequest_s* x, int n, struct zx_ps_Subscription_s* z)
{
  ...
  case -1:
    y = x->Subscription;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_Subscription_ELEM; y = (struct zx_ps_Subscription_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Subscription; n > 1 && y && y->gg.g.tok == zx_ps_Subscription_ELEM; --n, y = (struct zx_ps_Subscription_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_ps_AddCollectionRequest_DEL_Subscription(struct zx_ps_AddCollectionRequest_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Subscription; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_Subscription_ELEM; --n, y = (struct zx_ps_Subscription_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_ps_AddCollectionRequest_GET_id(struct zx_ps_AddCollectionRequest_s* x) { return x->id; }
/* FUNC(zx_ps_AddCollectionRequest_PUT_id) */
void zx_ps_AddCollectionRequest_PUT_id(struct zx_ps_AddCollectionRequest_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_AddCollectionResponse_GET_TimeStamp(struct zx_ps_AddCollectionResponse_s* x) { return x->TimeStamp; }
/* FUNC(zx_ps_AddCollectionResponse_PUT_TimeStamp) */
void zx_ps_AddCollectionResponse_PUT_TimeStamp(struct zx_ps_AddCollectionResponse_s* x, struct zx_attr_s* y) { x->TimeStamp = y; }
/* FUNC(zx_ps_AddCollectionResponse_GET_id) */
struct zx_attr_s* zx_ps_AddCollectionResponse_GET_id(struct zx_ps_AddCollectionResponse_s* x) { return x->id; }
/* FUNC(zx_ps_AddCollectionResponse_PUT_id) */
void zx_ps_AddCollectionResponse_PUT_id(struct zx_ps_AddCollectionResponse_s* x, struct zx_attr_s* y) { x->id = y; }
...
int zx_ps_AddEntityRequest_NUM_PStoSPRedirectURL(struct zx_ps_AddEntityRequest_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PStoSPRedirectURL; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_ps_AddEntityRequest_GET_PStoSPRedirectURL(struct zx_ps_AddEntityRequest_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->PStoSPRedirectURL; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_ps_AddEntityRequest_ADD_PStoSPRedirectURL(struct zx_ps_AddEntityRequest_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PStoSPRedirectURL; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_ps_AddEntityRequest_DEL_PStoSPRedirectURL(struct zx_ps_AddEntityRequest_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PStoSPRedirectURL; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_ps_AddEntityRequest_NUM_CreatePSObject(struct zx_ps_AddEntityRequest_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->CreatePSObject; y && y->gg.g.tok == zx_ps_CreatePSObject_ELEM; ++n, y = (struct zx_ps_CreatePSObject_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_ps_CreatePSObject_s* zx_ps_AddEntityRequest_GET_CreatePSObject(struct zx_ps_AddEntityRequest_s* x, int n)
{
  struct zx_ps_CreatePSObject_s* y;
  if (!x) return 0;
  for (y = x->CreatePSObject; n>=0 && y && y->gg.g.tok == zx_ps_CreatePSObject_ELEM; --n, y = (struct zx_ps_CreatePSObject_s*)y->gg.g.n) ;
  return y;
}
...
void zx_ps_AddEntityRequest_PUT_CreatePSObject(struct zx_ps_AddEntityRequest_s* x, int n, struct zx_ps_CreatePSObject_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_CreatePSObject_ELEM; --n, y = (struct zx_ps_CreatePSObject_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_ps_AddEntityRequest_ADD_CreatePSObject(struct zx_ps_AddEntityRequest_s* x, int n, struct zx_ps_CreatePSObject_s* z)
{
  ...
  case -1:
    y = x->CreatePSObject;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_CreatePSObject_ELEM; y = (struct zx_ps_CreatePSObject_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->CreatePSObject; n > 1 && y && y->gg.g.tok == zx_ps_CreatePSObject_ELEM; --n, y = (struct zx_ps_CreatePSObject_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_ps_AddEntityRequest_DEL_CreatePSObject(struct zx_ps_AddEntityRequest_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CreatePSObject; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_CreatePSObject_ELEM; --n, y = (struct zx_ps_CreatePSObject_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_ps_AddEntityRequest_GET_id(struct zx_ps_AddEntityRequest_s* x) { return x->id; }
/* FUNC(zx_ps_AddEntityRequest_PUT_id) */
void zx_ps_AddEntityRequest_PUT_id(struct zx_ps_AddEntityRequest_s* x, struct zx_attr_s* y) { x->id = y; }
...
int zx_ps_AddEntityResponse_NUM_SPtoPSRedirectURL(struct zx_ps_AddEntityResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->SPtoPSRedirectURL; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_ps_AddEntityResponse_GET_SPtoPSRedirectURL(struct zx_ps_AddEntityResponse_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->SPtoPSRedirectURL; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_ps_AddEntityResponse_ADD_SPtoPSRedirectURL(struct zx_ps_AddEntityResponse_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SPtoPSRedirectURL; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_ps_AddEntityResponse_DEL_SPtoPSRedirectURL(struct zx_ps_AddEntityResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SPtoPSRedirectURL; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_ps_AddEntityResponse_NUM_QueryString(struct zx_ps_AddEntityResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->QueryString; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_ps_AddEntityResponse_GET_QueryString(struct zx_ps_AddEntityResponse_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->QueryString; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_ps_AddEntityResponse_ADD_QueryString(struct zx_ps_AddEntityResponse_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->QueryString; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_ps_AddEntityResponse_DEL_QueryString(struct zx_ps_AddEntityResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->QueryString; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
struct zx_attr_s* zx_ps_AddEntityResponse_GET_TimeStamp(struct zx_ps_AddEntityResponse_s* x) { return x->TimeStamp; }
/* FUNC(zx_ps_AddEntityResponse_PUT_TimeStamp) */
void zx_ps_AddEntityResponse_PUT_TimeStamp(struct zx_ps_AddEntityResponse_s* x, struct zx_attr_s* y) { x->TimeStamp = y; }
/* FUNC(zx_ps_AddEntityResponse_GET_id) */
struct zx_attr_s* zx_ps_AddEntityResponse_GET_id(struct zx_ps_AddEntityResponse_s* x) { return x->id; }
/* FUNC(zx_ps_AddEntityResponse_PUT_id) */
void zx_ps_AddEntityResponse_PUT_id(struct zx_ps_AddEntityResponse_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_AddKnownEntityRequest_GET_id(struct zx_ps_AddKnownEntityRequest_s* x) { return x->id; }
/* FUNC(zx_ps_AddKnownEntityRequest_PUT_id) */
void zx_ps_AddKnownEntityRequest_PUT_id(struct zx_ps_AddKnownEntityRequest_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_AddKnownEntityResponse_GET_TimeStamp(struct zx_ps_AddKnownEntityResponse_s* x) { return x->TimeStamp; }
/* FUNC(zx_ps_AddKnownEntityResponse_PUT_TimeStamp) */
void zx_ps_AddKnownEntityResponse_PUT_TimeStamp(struct zx_ps_AddKnownEntityResponse_s* x, struct zx_attr_s* y) { x->TimeStamp = y; }
/* FUNC(zx_ps_AddKnownEntityResponse_GET_id) */
struct zx_attr_s* zx_ps_AddKnownEntityResponse_GET_id(struct zx_ps_AddKnownEntityResponse_s* x) { return x->id; }
/* FUNC(zx_ps_AddKnownEntityResponse_PUT_id) */
void zx_ps_AddKnownEntityResponse_PUT_id(struct zx_ps_AddKnownEntityResponse_s* x, struct zx_attr_s* y) { x->id = y; }
...
int zx_ps_AddToCollectionRequest_NUM_TargetObjectID(struct zx_ps_AddToCollectionRequest_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->TargetObjectID; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_ps_AddToCollectionRequest_GET_TargetObjectID(struct zx_ps_AddToCollectionRequest_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->TargetObjectID; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_ps_AddToCollectionRequest_ADD_TargetObjectID(struct zx_ps_AddToCollectionRequest_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->TargetObjectID; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_ps_AddToCollectionRequest_DEL_TargetObjectID(struct zx_ps_AddToCollectionRequest_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->TargetObjectID; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
struct zx_attr_s* zx_ps_AddToCollectionRequest_GET_id(struct zx_ps_AddToCollectionRequest_s* x) { return x->id; }
/* FUNC(zx_ps_AddToCollectionRequest_PUT_id) */
void zx_ps_AddToCollectionRequest_PUT_id(struct zx_ps_AddToCollectionRequest_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_AddToCollectionResponse_GET_TimeStamp(struct zx_ps_AddToCollectionResponse_s* x) { return x->TimeStamp; }
/* FUNC(zx_ps_AddToCollectionResponse_PUT_TimeStamp) */
void zx_ps_AddToCollectionResponse_PUT_TimeStamp(struct zx_ps_AddToCollectionResponse_s* x, struct zx_attr_s* y) { x->TimeStamp = y; }
/* FUNC(zx_ps_AddToCollectionResponse_GET_id) */
struct zx_attr_s* zx_ps_AddToCollectionResponse_GET_id(struct zx_ps_AddToCollectionResponse_s* x) { return x->id; }
/* FUNC(zx_ps_AddToCollectionResponse_PUT_id) */
void zx_ps_AddToCollectionResponse_PUT_id(struct zx_ps_AddToCollectionResponse_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_DisplayName_GET_IsDefault(struct zx_ps_DisplayName_s* x) { return x->IsDefault; }
/* FUNC(zx_ps_DisplayName_PUT_IsDefault) */
void zx_ps_DisplayName_PUT_IsDefault(struct zx_ps_DisplayName_s* x, struct zx_attr_s* y) { x->IsDefault = y; }
/* FUNC(zx_ps_DisplayName_GET_Locale) */
struct zx_attr_s* zx_ps_DisplayName_GET_Locale(struct zx_ps_DisplayName_s* x) { return x->Locale; }
/* FUNC(zx_ps_DisplayName_PUT_Locale) */
void zx_ps_DisplayName_PUT_Locale(struct zx_ps_DisplayName_s* x, struct zx_attr_s* y) { x->Locale = y; }
...
struct zx_attr_s* zx_ps_GetObjectInfoRequest_GET_id(struct zx_ps_GetObjectInfoRequest_s* x) { return x->id; }
/* FUNC(zx_ps_GetObjectInfoRequest_PUT_id) */
void zx_ps_GetObjectInfoRequest_PUT_id(struct zx_ps_GetObjectInfoRequest_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_GetObjectInfoResponse_GET_TimeStamp(struct zx_ps_GetObjectInfoResponse_s* x) { return x->TimeStamp; }
/* FUNC(zx_ps_GetObjectInfoResponse_PUT_TimeStamp) */
void zx_ps_GetObjectInfoResponse_PUT_TimeStamp(struct zx_ps_GetObjectInfoResponse_s* x, struct zx_attr_s* y) { x->TimeStamp = y; }
/* FUNC(zx_ps_GetObjectInfoResponse_GET_id) */
struct zx_attr_s* zx_ps_GetObjectInfoResponse_GET_id(struct zx_ps_GetObjectInfoResponse_s* x) { return x->id; }
/* FUNC(zx_ps_GetObjectInfoResponse_PUT_id) */
void zx_ps_GetObjectInfoResponse_PUT_id(struct zx_ps_GetObjectInfoResponse_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_ListMembersRequest_GET_Count(struct zx_ps_ListMembersRequest_s* x) { return x->Count; }
/* FUNC(zx_ps_ListMembersRequest_PUT_Count) */
void zx_ps_ListMembersRequest_PUT_Count(struct zx_ps_ListMembersRequest_s* x, struct zx_attr_s* y) { x->Count = y; }
/* FUNC(zx_ps_ListMembersRequest_GET_Offset) */
struct zx_attr_s* zx_ps_ListMembersRequest_GET_Offset(struct zx_ps_ListMembersRequest_s* x) { return x->Offset; }
/* FUNC(zx_ps_ListMembersRequest_PUT_Offset) */
void zx_ps_ListMembersRequest_PUT_Offset(struct zx_ps_ListMembersRequest_s* x, struct zx_attr_s* y) { x->Offset = y; }
/* FUNC(zx_ps_ListMembersRequest_GET_Structured) */
struct zx_attr_s* zx_ps_ListMembersRequest_GET_Structured(struct zx_ps_ListMembersRequest_s* x) { return x->Structured; }
/* FUNC(zx_ps_ListMembersRequest_PUT_Structured) */
void zx_ps_ListMembersRequest_PUT_Structured(struct zx_ps_ListMembersRequest_s* x, struct zx_attr_s* y) { x->Structured = y; }
/* FUNC(zx_ps_ListMembersRequest_GET_id) */
struct zx_attr_s* zx_ps_ListMembersRequest_GET_id(struct zx_ps_ListMembersRequest_s* x) { return x->id; }
/* FUNC(zx_ps_ListMembersRequest_PUT_id) */
void zx_ps_ListMembersRequest_PUT_id(struct zx_ps_ListMembersRequest_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_ListMembersResponse_GET_TimeStamp(struct zx_ps_ListMembersResponse_s* x) { return x->TimeStamp; }
/* FUNC(zx_ps_ListMembersResponse_PUT_TimeStamp) */
void zx_ps_ListMembersResponse_PUT_TimeStamp(struct zx_ps_ListMembersResponse_s* x, struct zx_attr_s* y) { x->TimeStamp = y; }
/* FUNC(zx_ps_ListMembersResponse_GET_id) */
struct zx_attr_s* zx_ps_ListMembersResponse_GET_id(struct zx_ps_ListMembersResponse_s* x) { return x->id; }
/* FUNC(zx_ps_ListMembersResponse_PUT_id) */
void zx_ps_ListMembersResponse_PUT_id(struct zx_ps_ListMembersResponse_s* x, struct zx_attr_s* y) { x->id = y; }
...
int zx_ps_Notification_NUM_ItemData(struct zx_ps_Notification_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ItemData; y && y->gg.g.tok == zx_ps_ItemData_ELEM; ++n, y = (struct zx_ps_ItemData_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_ps_ItemData_s* zx_ps_Notification_GET_ItemData(struct zx_ps_Notification_s* x, int n)
{
  struct zx_ps_ItemData_s* y;
  if (!x) return 0;
  for (y = x->ItemData; n>=0 && y && y->gg.g.tok == zx_ps_ItemData_ELEM; --n, y = (struct zx_ps_ItemData_s*)y->gg.g.n) ;
  return y;
}
...
void zx_ps_Notification_PUT_ItemData(struct zx_ps_Notification_s* x, int n, struct zx_ps_ItemData_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_ItemData_ELEM; --n, y = (struct zx_ps_ItemData_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_ps_Notification_ADD_ItemData(struct zx_ps_Notification_s* x, int n, struct zx_ps_ItemData_s* z)
{
  ...
  case -1:
    y = x->ItemData;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_ItemData_ELEM; y = (struct zx_ps_ItemData_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->ItemData; n > 1 && y && y->gg.g.tok == zx_ps_ItemData_ELEM; --n, y = (struct zx_ps_ItemData_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_ps_Notification_DEL_ItemData(struct zx_ps_Notification_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ItemData; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_ItemData_ELEM; --n, y = (struct zx_ps_ItemData_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_ps_Notification_GET_endReason(struct zx_ps_Notification_s* x) { return x->endReason; }
/* FUNC(zx_ps_Notification_PUT_endReason) */
void zx_ps_Notification_PUT_endReason(struct zx_ps_Notification_s* x, struct zx_attr_s* y) { x->endReason = y; }
/* FUNC(zx_ps_Notification_GET_expires) */
struct zx_attr_s* zx_ps_Notification_GET_expires(struct zx_ps_Notification_s* x) { return x->expires; }
/* FUNC(zx_ps_Notification_PUT_expires) */
void zx_ps_Notification_PUT_expires(struct zx_ps_Notification_s* x, struct zx_attr_s* y) { x->expires = y; }
/* FUNC(zx_ps_Notification_GET_id) */
struct zx_attr_s* zx_ps_Notification_GET_id(struct zx_ps_Notification_s* x) { return x->id; }
/* FUNC(zx_ps_Notification_PUT_id) */
void zx_ps_Notification_PUT_id(struct zx_ps_Notification_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_ps_Notification_GET_subscriptionID) */
struct zx_attr_s* zx_ps_Notification_GET_subscriptionID(struct zx_ps_Notification_s* x) { return x->subscriptionID; }
/* FUNC(zx_ps_Notification_PUT_subscriptionID) */
void zx_ps_Notification_PUT_subscriptionID(struct zx_ps_Notification_s* x, struct zx_attr_s* y) { x->subscriptionID = y; }
...
int zx_ps_Notify_NUM_Notification(struct zx_ps_Notify_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Notification; y && y->gg.g.tok == zx_ps_Notification_ELEM; ++n, y = (struct zx_ps_Notification_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_ps_Notification_s* zx_ps_Notify_GET_Notification(struct zx_ps_Notify_s* x, int n)
{
  struct zx_ps_Notification_s* y;
  if (!x) return 0;
  for (y = x->Notification; n>=0 && y && y->gg.g.tok == zx_ps_Notification_ELEM; --n, y = (struct zx_ps_Notification_s*)y->gg.g.n) ;
  return y;
}
...
void zx_ps_Notify_PUT_Notification(struct zx_ps_Notify_s* x, int n, struct zx_ps_Notification_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_Notification_ELEM; --n, y = (struct zx_ps_Notification_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_ps_Notify_ADD_Notification(struct zx_ps_Notify_s* x, int n, struct zx_ps_Notification_s* z)
{
  ...
  case -1:
    y = x->Notification;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_Notification_ELEM; y = (struct zx_ps_Notification_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Notification; n > 1 && y && y->gg.g.tok == zx_ps_Notification_ELEM; --n, y = (struct zx_ps_Notification_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_ps_Notify_DEL_Notification(struct zx_ps_Notify_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Notification; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_Notification_ELEM; --n, y = (struct zx_ps_Notification_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_ps_Notify_GET_id(struct zx_ps_Notify_s* x) { return x->id; }
/* FUNC(zx_ps_Notify_PUT_id) */
void zx_ps_Notify_PUT_id(struct zx_ps_Notify_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_ps_Notify_GET_timeStamp) */
struct zx_attr_s* zx_ps_Notify_GET_timeStamp(struct zx_ps_Notify_s* x) { return x->timeStamp; }
/* FUNC(zx_ps_Notify_PUT_timeStamp) */
void zx_ps_Notify_PUT_timeStamp(struct zx_ps_Notify_s* x, struct zx_attr_s* y) { x->timeStamp = y; }
...
struct zx_attr_s* zx_ps_NotifyResponse_GET_itemIDRef(struct zx_ps_NotifyResponse_s* x) { return x->itemIDRef; }
/* FUNC(zx_ps_NotifyResponse_PUT_itemIDRef) */
void zx_ps_NotifyResponse_PUT_itemIDRef(struct zx_ps_NotifyResponse_s* x, struct zx_attr_s* y) { x->itemIDRef = y; }
...
int zx_ps_Object_NUM_DisplayName(struct zx_ps_Object_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->DisplayName; y && y->gg.g.tok == zx_ps_DisplayName_ELEM; ++n, y = (struct zx_ps_DisplayName_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_ps_DisplayName_s* zx_ps_Object_GET_DisplayName(struct zx_ps_Object_s* x, int n)
{
  struct zx_ps_DisplayName_s* y;
  if (!x) return 0;
  for (y = x->DisplayName; n>=0 && y && y->gg.g.tok == zx_ps_DisplayName_ELEM; --n, y = (struct zx_ps_DisplayName_s*)y->gg.g.n) ;
  return y;
}
...
void zx_ps_Object_PUT_DisplayName(struct zx_ps_Object_s* x, int n, struct zx_ps_DisplayName_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_DisplayName_ELEM; --n, y = (struct zx_ps_DisplayName_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_ps_Object_ADD_DisplayName(struct zx_ps_Object_s* x, int n, struct zx_ps_DisplayName_s* z)
{
  ...
  case -1:
    y = x->DisplayName;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_DisplayName_ELEM; y = (struct zx_ps_DisplayName_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->DisplayName; n > 1 && y && y->gg.g.tok == zx_ps_DisplayName_ELEM; --n, y = (struct zx_ps_DisplayName_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_ps_Object_DEL_DisplayName(struct zx_ps_Object_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->DisplayName; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_DisplayName_ELEM; --n, y = (struct zx_ps_DisplayName_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_ps_Object_NUM_Tag(struct zx_ps_Object_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Tag; y && y->gg.g.tok == zx_ps_Tag_ELEM; ++n, y = (struct zx_ps_Tag_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_ps_Tag_s* zx_ps_Object_GET_Tag(struct zx_ps_Object_s* x, int n)
{
  struct zx_ps_Tag_s* y;
  if (!x) return 0;
  for (y = x->Tag; n>=0 && y && y->gg.g.tok == zx_ps_Tag_ELEM; --n, y = (struct zx_ps_Tag_s*)y->gg.g.n) ;
  return y;
}
...
void zx_ps_Object_PUT_Tag(struct zx_ps_Object_s* x, int n, struct zx_ps_Tag_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_Tag_ELEM; --n, y = (struct zx_ps_Tag_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_ps_Object_ADD_Tag(struct zx_ps_Object_s* x, int n, struct zx_ps_Tag_s* z)
{
  ...
  case -1:
    y = x->Tag;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_Tag_ELEM; y = (struct zx_ps_Tag_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Tag; n > 1 && y && y->gg.g.tok == zx_ps_Tag_ELEM; --n, y = (struct zx_ps_Tag_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_ps_Object_DEL_Tag(struct zx_ps_Object_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Tag; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_Tag_ELEM; --n, y = (struct zx_ps_Tag_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_ps_Object_NUM_ObjectRef(struct zx_ps_Object_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ObjectRef; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_ps_Object_GET_ObjectRef(struct zx_ps_Object_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->ObjectRef; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_ps_Object_ADD_ObjectRef(struct zx_ps_Object_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ObjectRef; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_ps_Object_DEL_ObjectRef(struct zx_ps_Object_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ObjectRef; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
struct zx_attr_s* zx_ps_Object_GET_CreatedDateTime(struct zx_ps_Object_s* x) { return x->CreatedDateTime; }
/* FUNC(zx_ps_Object_PUT_CreatedDateTime) */
void zx_ps_Object_PUT_CreatedDateTime(struct zx_ps_Object_s* x, struct zx_attr_s* y) { x->CreatedDateTime = y; }
/* FUNC(zx_ps_Object_GET_ModifiedDateTime) */
struct zx_attr_s* zx_ps_Object_GET_ModifiedDateTime(struct zx_ps_Object_s* x) { return x->ModifiedDateTime; }
/* FUNC(zx_ps_Object_PUT_ModifiedDateTime) */
void zx_ps_Object_PUT_ModifiedDateTime(struct zx_ps_Object_s* x, struct zx_attr_s* y) { x->ModifiedDateTime = y; }
/* FUNC(zx_ps_Object_GET_NodeType) */
struct zx_attr_s* zx_ps_Object_GET_NodeType(struct zx_ps_Object_s* x) { return x->NodeType; }
/* FUNC(zx_ps_Object_PUT_NodeType) */
void zx_ps_Object_PUT_NodeType(struct zx_ps_Object_s* x, struct zx_attr_s* y) { x->NodeType = y; }
...
struct zx_attr_s* zx_ps_QueryObjectsRequest_GET_Count(struct zx_ps_QueryObjectsRequest_s* x) { return x->Count; }
/* FUNC(zx_ps_QueryObjectsRequest_PUT_Count) */
void zx_ps_QueryObjectsRequest_PUT_Count(struct zx_ps_QueryObjectsRequest_s* x, struct zx_attr_s* y) { x->Count = y; }
/* FUNC(zx_ps_QueryObjectsRequest_GET_Offset) */
struct zx_attr_s* zx_ps_QueryObjectsRequest_GET_Offset(struct zx_ps_QueryObjectsRequest_s* x) { return x->Offset; }
/* FUNC(zx_ps_QueryObjectsRequest_PUT_Offset) */
void zx_ps_QueryObjectsRequest_PUT_Offset(struct zx_ps_QueryObjectsRequest_s* x, struct zx_attr_s* y) { x->Offset = y; }
/* FUNC(zx_ps_QueryObjectsRequest_GET_id) */
struct zx_attr_s* zx_ps_QueryObjectsRequest_GET_id(struct zx_ps_QueryObjectsRequest_s* x) { return x->id; }
/* FUNC(zx_ps_QueryObjectsRequest_PUT_id) */
void zx_ps_QueryObjectsRequest_PUT_id(struct zx_ps_QueryObjectsRequest_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_QueryObjectsResponse_GET_TimeStamp(struct zx_ps_QueryObjectsResponse_s* x) { return x->TimeStamp; }
/* FUNC(zx_ps_QueryObjectsResponse_PUT_TimeStamp) */
void zx_ps_QueryObjectsResponse_PUT_TimeStamp(struct zx_ps_QueryObjectsResponse_s* x, struct zx_attr_s* y) { x->TimeStamp = y; }
/* FUNC(zx_ps_QueryObjectsResponse_GET_id) */
struct zx_attr_s* zx_ps_QueryObjectsResponse_GET_id(struct zx_ps_QueryObjectsResponse_s* x) { return x->id; }
/* FUNC(zx_ps_QueryObjectsResponse_PUT_id) */
void zx_ps_QueryObjectsResponse_PUT_id(struct zx_ps_QueryObjectsResponse_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_RemoveCollectionRequest_GET_id(struct zx_ps_RemoveCollectionRequest_s* x) { return x->id; }
/* FUNC(zx_ps_RemoveCollectionRequest_PUT_id) */
void zx_ps_RemoveCollectionRequest_PUT_id(struct zx_ps_RemoveCollectionRequest_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_RemoveCollectionResponse_GET_TimeStamp(struct zx_ps_RemoveCollectionResponse_s* x) { return x->TimeStamp; }
/* FUNC(zx_ps_RemoveCollectionResponse_PUT_TimeStamp) */
void zx_ps_RemoveCollectionResponse_PUT_TimeStamp(struct zx_ps_RemoveCollectionResponse_s* x, struct zx_attr_s* y) { x->TimeStamp = y; }
/* FUNC(zx_ps_RemoveCollectionResponse_GET_id) */
struct zx_attr_s* zx_ps_RemoveCollectionResponse_GET_id(struct zx_ps_RemoveCollectionResponse_s* x) { return x->id; }
/* FUNC(zx_ps_RemoveCollectionResponse_PUT_id) */
void zx_ps_RemoveCollectionResponse_PUT_id(struct zx_ps_RemoveCollectionResponse_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_RemoveEntityRequest_GET_id(struct zx_ps_RemoveEntityRequest_s* x) { return x->id; }
/* FUNC(zx_ps_RemoveEntityRequest_PUT_id) */
void zx_ps_RemoveEntityRequest_PUT_id(struct zx_ps_RemoveEntityRequest_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_RemoveEntityResponse_GET_TimeStamp(struct zx_ps_RemoveEntityResponse_s* x) { return x->TimeStamp; }
/* FUNC(zx_ps_RemoveEntityResponse_PUT_TimeStamp) */
void zx_ps_RemoveEntityResponse_PUT_TimeStamp(struct zx_ps_RemoveEntityResponse_s* x, struct zx_attr_s* y) { x->TimeStamp = y; }
/* FUNC(zx_ps_RemoveEntityResponse_GET_id) */
struct zx_attr_s* zx_ps_RemoveEntityResponse_GET_id(struct zx_ps_RemoveEntityResponse_s* x) { return x->id; }
/* FUNC(zx_ps_RemoveEntityResponse_PUT_id) */
void zx_ps_RemoveEntityResponse_PUT_id(struct zx_ps_RemoveEntityResponse_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_RemoveFromCollectionRequest_GET_id(struct zx_ps_RemoveFromCollectionRequest_s* x) { return x->id; }
/* FUNC(zx_ps_RemoveFromCollectionRequest_PUT_id) */
void zx_ps_RemoveFromCollectionRequest_PUT_id(struct zx_ps_RemoveFromCollectionRequest_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_RemoveFromCollectionResponse_GET_TimeStamp(struct zx_ps_RemoveFromCollectionResponse_s* x) { return x->TimeStamp; }
/* FUNC(zx_ps_RemoveFromCollectionResponse_PUT_TimeStamp) */
void zx_ps_RemoveFromCollectionResponse_PUT_TimeStamp(struct zx_ps_RemoveFromCollectionResponse_s* x, struct zx_attr_s* y) { x->TimeStamp = y; }
/* FUNC(zx_ps_RemoveFromCollectionResponse_GET_id) */
struct zx_attr_s* zx_ps_RemoveFromCollectionResponse_GET_id(struct zx_ps_RemoveFromCollectionResponse_s* x) { return x->id; }
/* FUNC(zx_ps_RemoveFromCollectionResponse_PUT_id) */
void zx_ps_RemoveFromCollectionResponse_PUT_id(struct zx_ps_RemoveFromCollectionResponse_s* x, struct zx_attr_s* y) { x->id = y; }
...
int zx_ps_ResolveIdentifierRequest_NUM_ResolveInput(struct zx_ps_ResolveIdentifierRequest_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ResolveInput; y && y->gg.g.tok == zx_ps_ResolveInput_ELEM; ++n, y = (struct zx_ps_ResolveInput_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_ps_ResolveInput_s* zx_ps_ResolveIdentifierRequest_GET_ResolveInput(struct zx_ps_ResolveIdentifierRequest_s* x, int n)
{
  struct zx_ps_ResolveInput_s* y;
  if (!x) return 0;
  for (y = x->ResolveInput; n>=0 && y && y->gg.g.tok == zx_ps_ResolveInput_ELEM; --n, y = (struct zx_ps_ResolveInput_s*)y->gg.g.n) ;
  return y;
}
...
void zx_ps_ResolveIdentifierRequest_PUT_ResolveInput(struct zx_ps_ResolveIdentifierRequest_s* x, int n, struct zx_ps_ResolveInput_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_ResolveInput_ELEM; --n, y = (struct zx_ps_ResolveInput_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_ps_ResolveIdentifierRequest_ADD_ResolveInput(struct zx_ps_ResolveIdentifierRequest_s* x, int n, struct zx_ps_ResolveInput_s* z)
{
  ...
  case -1:
    y = x->ResolveInput;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_ResolveInput_ELEM; y = (struct zx_ps_ResolveInput_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->ResolveInput; n > 1 && y && y->gg.g.tok == zx_ps_ResolveInput_ELEM; --n, y = (struct zx_ps_ResolveInput_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_ps_ResolveIdentifierRequest_DEL_ResolveInput(struct zx_ps_ResolveIdentifierRequest_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ResolveInput; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_ResolveInput_ELEM; --n, y = (struct zx_ps_ResolveInput_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_ps_ResolveIdentifierRequest_GET_id(struct zx_ps_ResolveIdentifierRequest_s* x) { return x->id; }
/* FUNC(zx_ps_ResolveIdentifierRequest_PUT_id) */
void zx_ps_ResolveIdentifierRequest_PUT_id(struct zx_ps_ResolveIdentifierRequest_s* x, struct zx_attr_s* y) { x->id = y; }
...
int zx_ps_ResolveIdentifierResponse_NUM_ResolveOutput(struct zx_ps_ResolveIdentifierResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ResolveOutput; y && y->gg.g.tok == zx_ps_ResolveOutput_ELEM; ++n, y = (struct zx_ps_ResolveOutput_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_ps_ResolveOutput_s* zx_ps_ResolveIdentifierResponse_GET_ResolveOutput(struct zx_ps_ResolveIdentifierResponse_s* x, int n)
{
  struct zx_ps_ResolveOutput_s* y;
  if (!x) return 0;
  for (y = x->ResolveOutput; n>=0 && y && y->gg.g.tok == zx_ps_ResolveOutput_ELEM; --n, y = (struct zx_ps_ResolveOutput_s*)y->gg.g.n) ;
  return y;
}
...
void zx_ps_ResolveIdentifierResponse_PUT_ResolveOutput(struct zx_ps_ResolveIdentifierResponse_s* x, int n, struct zx_ps_ResolveOutput_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_ResolveOutput_ELEM; --n, y = (struct zx_ps_ResolveOutput_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_ps_ResolveIdentifierResponse_ADD_ResolveOutput(struct zx_ps_ResolveIdentifierResponse_s* x, int n, struct zx_ps_ResolveOutput_s* z)
{
  ...
  case -1:
    y = x->ResolveOutput;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_ResolveOutput_ELEM; y = (struct zx_ps_ResolveOutput_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->ResolveOutput; n > 1 && y && y->gg.g.tok == zx_ps_ResolveOutput_ELEM; --n, y = (struct zx_ps_ResolveOutput_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_ps_ResolveIdentifierResponse_DEL_ResolveOutput(struct zx_ps_ResolveIdentifierResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ResolveOutput; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_ps_ResolveOutput_ELEM; --n, y = (struct zx_ps_ResolveOutput_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
struct zx_attr_s* zx_ps_ResolveIdentifierResponse_GET_TimeStamp(struct zx_ps_ResolveIdentifierResponse_s* x) { return x->TimeStamp; }
/* FUNC(zx_ps_ResolveIdentifierResponse_PUT_TimeStamp) */
void zx_ps_ResolveIdentifierResponse_PUT_TimeStamp(struct zx_ps_ResolveIdentifierResponse_s* x, struct zx_attr_s* y) { x->TimeStamp = y; }
/* FUNC(zx_ps_ResolveIdentifierResponse_GET_id) */
struct zx_attr_s* zx_ps_ResolveIdentifierResponse_GET_id(struct zx_ps_ResolveIdentifierResponse_s* x) { return x->id; }
/* FUNC(zx_ps_ResolveIdentifierResponse_PUT_id) */
void zx_ps_ResolveIdentifierResponse_PUT_id(struct zx_ps_ResolveIdentifierResponse_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_ResolveInput_GET_reqID(struct zx_ps_ResolveInput_s* x) { return x->reqID; }
/* FUNC(zx_ps_ResolveInput_PUT_reqID) */
void zx_ps_ResolveInput_PUT_reqID(struct zx_ps_ResolveInput_s* x, struct zx_attr_s* y) { x->reqID = y; }
...
struct zx_attr_s* zx_ps_ResolveOutput_GET_reqRef(struct zx_ps_ResolveOutput_s* x) { return x->reqRef; }
/* FUNC(zx_ps_ResolveOutput_PUT_reqRef) */
void zx_ps_ResolveOutput_PUT_reqRef(struct zx_ps_ResolveOutput_s* x, struct zx_attr_s* y) { x->reqRef = y; }
...
struct zx_attr_s* zx_ps_SetObjectInfoRequest_GET_id(struct zx_ps_SetObjectInfoRequest_s* x) { return x->id; }
/* FUNC(zx_ps_SetObjectInfoRequest_PUT_id) */
void zx_ps_SetObjectInfoRequest_PUT_id(struct zx_ps_SetObjectInfoRequest_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_SetObjectInfoResponse_GET_TimeStamp(struct zx_ps_SetObjectInfoResponse_s* x) { return x->TimeStamp; }
/* FUNC(zx_ps_SetObjectInfoResponse_PUT_TimeStamp) */
void zx_ps_SetObjectInfoResponse_PUT_TimeStamp(struct zx_ps_SetObjectInfoResponse_s* x, struct zx_attr_s* y) { x->TimeStamp = y; }
/* FUNC(zx_ps_SetObjectInfoResponse_GET_id) */
struct zx_attr_s* zx_ps_SetObjectInfoResponse_GET_id(struct zx_ps_SetObjectInfoResponse_s* x) { return x->id; }
/* FUNC(zx_ps_SetObjectInfoResponse_PUT_id) */
void zx_ps_SetObjectInfoResponse_PUT_id(struct zx_ps_SetObjectInfoResponse_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_ps_Subscription_GET_adminNotifyToRef(struct zx_ps_Subscription_s* x) { return x->adminNotifyToRef; }
/* FUNC(zx_ps_Subscription_PUT_adminNotifyToRef) */
void zx_ps_Subscription_PUT_adminNotifyToRef(struct zx_ps_Subscription_s* x, struct zx_attr_s* y) { x->adminNotifyToRef = y; }
/* FUNC(zx_ps_Subscription_GET_expires) */
struct zx_attr_s* zx_ps_Subscription_GET_expires(struct zx_ps_Subscription_s* x) { return x->expires; }
/* FUNC(zx_ps_Subscription_PUT_expires) */
void zx_ps_Subscription_PUT_expires(struct zx_ps_Subscription_s* x, struct zx_attr_s* y) { x->expires = y; }
/* FUNC(zx_ps_Subscription_GET_id) */
struct zx_attr_s* zx_ps_Subscription_GET_id(struct zx_ps_Subscription_s* x) { return x->id; }
/* FUNC(zx_ps_Subscription_PUT_id) */
void zx_ps_Subscription_PUT_id(struct zx_ps_Subscription_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_ps_Subscription_GET_includeData) */
struct zx_attr_s* zx_ps_Subscription_GET_includeData(struct zx_ps_Subscription_s* x) { return x->includeData; }
/* FUNC(zx_ps_Subscription_PUT_includeData) */
void zx_ps_Subscription_PUT_includeData(struct zx_ps_Subscription_s* x, struct zx_attr_s* y) { x->includeData = y; }
/* FUNC(zx_ps_Subscription_GET_notifyToRef) */
struct zx_attr_s* zx_ps_Subscription_GET_notifyToRef(struct zx_ps_Subscription_s* x) { return x->notifyToRef; }
/* FUNC(zx_ps_Subscription_PUT_notifyToRef) */
void zx_ps_Subscription_PUT_notifyToRef(struct zx_ps_Subscription_s* x, struct zx_attr_s* y) { x->notifyToRef = y; }
/* FUNC(zx_ps_Subscription_GET_starts) */
struct zx_attr_s* zx_ps_Subscription_GET_starts(struct zx_ps_Subscription_s* x) { return x->starts; }
/* FUNC(zx_ps_Subscription_PUT_starts) */
void zx_ps_Subscription_PUT_starts(struct zx_ps_Subscription_s* x, struct zx_attr_s* y) { x->starts = y; }
/* FUNC(zx_ps_Subscription_GET_subscriptionID) */
struct zx_attr_s* zx_ps_Subscription_GET_subscriptionID(struct zx_ps_Subscription_s* x) { return x->subscriptionID; }
/* FUNC(zx_ps_Subscription_PUT_subscriptionID) */
void zx_ps_Subscription_PUT_subscriptionID(struct zx_ps_Subscription_s* x, struct zx_attr_s* y) { x->subscriptionID = y; }
...
struct zx_attr_s* zx_ps_Tag_GET_Ref(struct zx_ps_Tag_s* x) { return x->Ref; }
/* FUNC(zx_ps_Tag_PUT_Ref) */
void zx_ps_Tag_PUT_Ref(struct zx_ps_Tag_s* x, struct zx_attr_s* y) { x->Ref = y; }
...
struct zx_attr_s* zx_ps_TestMembershipRequest_GET_id(struct zx_ps_TestMembershipRequest_s* x) { return x->id; }
/* FUNC(zx_ps_TestMembershipRequest_PUT_id) */
void zx_ps_TestMembershipRequest_PUT_id(struct zx_ps_TestMembershipRequest_s* x, struct zx_attr_s* y) { x->id = y; }
...
int zx_ps_TestMembershipResponse_NUM_Result(struct zx_ps_TestMembershipResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Result; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_ps_TestMembershipResponse_GET_Result(struct zx_ps_TestMembershipResponse_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->Result; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_ps_TestMembershipResponse_ADD_Result(struct zx_ps_TestMembershipResponse_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Result; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_ps_TestMembershipResponse_DEL_Result(struct zx_ps_TestMembershipResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Result; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
struct zx_attr_s* zx_ps_TestMembershipResponse_GET_TimeStamp(struct zx_ps_TestMembershipResponse_s* x) { return x->TimeStamp; }
/* FUNC(zx_ps_TestMembershipResponse_PUT_TimeStamp) */
void zx_ps_TestMembershipResponse_PUT_TimeStamp(struct zx_ps_TestMembershipResponse_s* x, struct zx_attr_s* y) { x->TimeStamp = y; }
/* FUNC(zx_ps_TestMembershipResponse_GET_id) */
struct zx_attr_s* zx_ps_TestMembershipResponse_GET_id(struct zx_ps_TestMembershipResponse_s* x) { return x->id; }
/* FUNC(zx_ps_TestMembershipResponse_PUT_id) */
void zx_ps_TestMembershipResponse_PUT_id(struct zx_ps_TestMembershipResponse_s* x, struct zx_attr_s* y) { x->id = y; }
