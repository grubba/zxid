...
int zx_cdm_ADR_NUM_HOME(struct zx_cdm_ADR_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->HOME; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_ADR_GET_HOME(struct zx_cdm_ADR_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->HOME; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_ADR_ADD_HOME(struct zx_cdm_ADR_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->HOME; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_ADR_DEL_HOME(struct zx_cdm_ADR_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->HOME; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_ADR_NUM_WORK(struct zx_cdm_ADR_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->WORK; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_ADR_GET_WORK(struct zx_cdm_ADR_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->WORK; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_ADR_ADD_WORK(struct zx_cdm_ADR_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->WORK; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_ADR_DEL_WORK(struct zx_cdm_ADR_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->WORK; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_ADR_NUM_POSTAL(struct zx_cdm_ADR_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->POSTAL; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_ADR_GET_POSTAL(struct zx_cdm_ADR_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->POSTAL; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_ADR_ADD_POSTAL(struct zx_cdm_ADR_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->POSTAL; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_ADR_DEL_POSTAL(struct zx_cdm_ADR_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->POSTAL; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_ADR_NUM_PARCEL(struct zx_cdm_ADR_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PARCEL; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_ADR_GET_PARCEL(struct zx_cdm_ADR_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->PARCEL; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_ADR_ADD_PARCEL(struct zx_cdm_ADR_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PARCEL; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_ADR_DEL_PARCEL(struct zx_cdm_ADR_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PARCEL; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_ADR_NUM_DOM(struct zx_cdm_ADR_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->DOM; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_ADR_GET_DOM(struct zx_cdm_ADR_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->DOM; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_ADR_ADD_DOM(struct zx_cdm_ADR_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->DOM; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_ADR_DEL_DOM(struct zx_cdm_ADR_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->DOM; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_ADR_NUM_INTL(struct zx_cdm_ADR_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->INTL; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_ADR_GET_INTL(struct zx_cdm_ADR_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->INTL; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_ADR_ADD_INTL(struct zx_cdm_ADR_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->INTL; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_ADR_DEL_INTL(struct zx_cdm_ADR_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->INTL; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_ADR_NUM_PREF(struct zx_cdm_ADR_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PREF; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_ADR_GET_PREF(struct zx_cdm_ADR_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->PREF; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_ADR_ADD_PREF(struct zx_cdm_ADR_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PREF; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_ADR_DEL_PREF(struct zx_cdm_ADR_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PREF; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_ADR_NUM_POBOX(struct zx_cdm_ADR_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->POBOX; y && y->gg.g.tok == zx_cdm_POBOX_ELEM; ++n, y = (struct zx_cdm_POBOX_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_POBOX_s* zx_cdm_ADR_GET_POBOX(struct zx_cdm_ADR_s* x, int n)
{
  struct zx_cdm_POBOX_s* y;
  if (!x) return 0;
  for (y = x->POBOX; n>=0 && y && y->gg.g.tok == zx_cdm_POBOX_ELEM; --n, y = (struct zx_cdm_POBOX_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_ADR_PUT_POBOX(struct zx_cdm_ADR_s* x, int n, struct zx_cdm_POBOX_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_POBOX_ELEM; --n, y = (struct zx_cdm_POBOX_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_ADR_ADD_POBOX(struct zx_cdm_ADR_s* x, int n, struct zx_cdm_POBOX_s* z)
{
  ...
  case -1:
    y = x->POBOX;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_POBOX_ELEM; y = (struct zx_cdm_POBOX_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->POBOX; n > 1 && y && y->gg.g.tok == zx_cdm_POBOX_ELEM; --n, y = (struct zx_cdm_POBOX_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_ADR_DEL_POBOX(struct zx_cdm_ADR_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->POBOX; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_POBOX_ELEM; --n, y = (struct zx_cdm_POBOX_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_ADR_NUM_EXTADR(struct zx_cdm_ADR_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->EXTADR; y && y->gg.g.tok == zx_cdm_EXTADR_ELEM; ++n, y = (struct zx_cdm_EXTADR_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_EXTADR_s* zx_cdm_ADR_GET_EXTADR(struct zx_cdm_ADR_s* x, int n)
{
  struct zx_cdm_EXTADR_s* y;
  if (!x) return 0;
  for (y = x->EXTADR; n>=0 && y && y->gg.g.tok == zx_cdm_EXTADR_ELEM; --n, y = (struct zx_cdm_EXTADR_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_ADR_PUT_EXTADR(struct zx_cdm_ADR_s* x, int n, struct zx_cdm_EXTADR_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_EXTADR_ELEM; --n, y = (struct zx_cdm_EXTADR_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_ADR_ADD_EXTADR(struct zx_cdm_ADR_s* x, int n, struct zx_cdm_EXTADR_s* z)
{
  ...
  case -1:
    y = x->EXTADR;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_EXTADR_ELEM; y = (struct zx_cdm_EXTADR_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->EXTADR; n > 1 && y && y->gg.g.tok == zx_cdm_EXTADR_ELEM; --n, y = (struct zx_cdm_EXTADR_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_ADR_DEL_EXTADR(struct zx_cdm_ADR_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->EXTADR; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_EXTADR_ELEM; --n, y = (struct zx_cdm_EXTADR_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_ADR_NUM_STREET(struct zx_cdm_ADR_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->STREET; y && y->gg.g.tok == zx_cdm_STREET_ELEM; ++n, y = (struct zx_cdm_STREET_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_STREET_s* zx_cdm_ADR_GET_STREET(struct zx_cdm_ADR_s* x, int n)
{
  struct zx_cdm_STREET_s* y;
  if (!x) return 0;
  for (y = x->STREET; n>=0 && y && y->gg.g.tok == zx_cdm_STREET_ELEM; --n, y = (struct zx_cdm_STREET_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_ADR_PUT_STREET(struct zx_cdm_ADR_s* x, int n, struct zx_cdm_STREET_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_STREET_ELEM; --n, y = (struct zx_cdm_STREET_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_ADR_ADD_STREET(struct zx_cdm_ADR_s* x, int n, struct zx_cdm_STREET_s* z)
{
  ...
  case -1:
    y = x->STREET;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_STREET_ELEM; y = (struct zx_cdm_STREET_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->STREET; n > 1 && y && y->gg.g.tok == zx_cdm_STREET_ELEM; --n, y = (struct zx_cdm_STREET_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_ADR_DEL_STREET(struct zx_cdm_ADR_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->STREET; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_STREET_ELEM; --n, y = (struct zx_cdm_STREET_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_ADR_NUM_LOCALITY(struct zx_cdm_ADR_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->LOCALITY; y && y->gg.g.tok == zx_cdm_LOCALITY_ELEM; ++n, y = (struct zx_cdm_LOCALITY_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_LOCALITY_s* zx_cdm_ADR_GET_LOCALITY(struct zx_cdm_ADR_s* x, int n)
{
  struct zx_cdm_LOCALITY_s* y;
  if (!x) return 0;
  for (y = x->LOCALITY; n>=0 && y && y->gg.g.tok == zx_cdm_LOCALITY_ELEM; --n, y = (struct zx_cdm_LOCALITY_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_ADR_PUT_LOCALITY(struct zx_cdm_ADR_s* x, int n, struct zx_cdm_LOCALITY_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LOCALITY_ELEM; --n, y = (struct zx_cdm_LOCALITY_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_ADR_ADD_LOCALITY(struct zx_cdm_ADR_s* x, int n, struct zx_cdm_LOCALITY_s* z)
{
  ...
  case -1:
    y = x->LOCALITY;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LOCALITY_ELEM; y = (struct zx_cdm_LOCALITY_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->LOCALITY; n > 1 && y && y->gg.g.tok == zx_cdm_LOCALITY_ELEM; --n, y = (struct zx_cdm_LOCALITY_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_ADR_DEL_LOCALITY(struct zx_cdm_ADR_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->LOCALITY; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LOCALITY_ELEM; --n, y = (struct zx_cdm_LOCALITY_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_ADR_NUM_REGION(struct zx_cdm_ADR_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->REGION; y && y->gg.g.tok == zx_cdm_REGION_ELEM; ++n, y = (struct zx_cdm_REGION_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_REGION_s* zx_cdm_ADR_GET_REGION(struct zx_cdm_ADR_s* x, int n)
{
  struct zx_cdm_REGION_s* y;
  if (!x) return 0;
  for (y = x->REGION; n>=0 && y && y->gg.g.tok == zx_cdm_REGION_ELEM; --n, y = (struct zx_cdm_REGION_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_ADR_PUT_REGION(struct zx_cdm_ADR_s* x, int n, struct zx_cdm_REGION_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_REGION_ELEM; --n, y = (struct zx_cdm_REGION_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_ADR_ADD_REGION(struct zx_cdm_ADR_s* x, int n, struct zx_cdm_REGION_s* z)
{
  ...
  case -1:
    y = x->REGION;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_REGION_ELEM; y = (struct zx_cdm_REGION_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->REGION; n > 1 && y && y->gg.g.tok == zx_cdm_REGION_ELEM; --n, y = (struct zx_cdm_REGION_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_ADR_DEL_REGION(struct zx_cdm_ADR_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->REGION; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_REGION_ELEM; --n, y = (struct zx_cdm_REGION_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_ADR_NUM_PCODE(struct zx_cdm_ADR_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PCODE; y && y->gg.g.tok == zx_cdm_PCODE_ELEM; ++n, y = (struct zx_cdm_PCODE_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_PCODE_s* zx_cdm_ADR_GET_PCODE(struct zx_cdm_ADR_s* x, int n)
{
  struct zx_cdm_PCODE_s* y;
  if (!x) return 0;
  for (y = x->PCODE; n>=0 && y && y->gg.g.tok == zx_cdm_PCODE_ELEM; --n, y = (struct zx_cdm_PCODE_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_ADR_PUT_PCODE(struct zx_cdm_ADR_s* x, int n, struct zx_cdm_PCODE_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PCODE_ELEM; --n, y = (struct zx_cdm_PCODE_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_ADR_ADD_PCODE(struct zx_cdm_ADR_s* x, int n, struct zx_cdm_PCODE_s* z)
{
  ...
  case -1:
    y = x->PCODE;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PCODE_ELEM; y = (struct zx_cdm_PCODE_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->PCODE; n > 1 && y && y->gg.g.tok == zx_cdm_PCODE_ELEM; --n, y = (struct zx_cdm_PCODE_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_ADR_DEL_PCODE(struct zx_cdm_ADR_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PCODE; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PCODE_ELEM; --n, y = (struct zx_cdm_PCODE_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_ADR_NUM_CTRY(struct zx_cdm_ADR_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->CTRY; y && y->gg.g.tok == zx_cdm_CTRY_ELEM; ++n, y = (struct zx_cdm_CTRY_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_CTRY_s* zx_cdm_ADR_GET_CTRY(struct zx_cdm_ADR_s* x, int n)
{
  struct zx_cdm_CTRY_s* y;
  if (!x) return 0;
  for (y = x->CTRY; n>=0 && y && y->gg.g.tok == zx_cdm_CTRY_ELEM; --n, y = (struct zx_cdm_CTRY_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_ADR_PUT_CTRY(struct zx_cdm_ADR_s* x, int n, struct zx_cdm_CTRY_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CTRY_ELEM; --n, y = (struct zx_cdm_CTRY_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_ADR_ADD_CTRY(struct zx_cdm_ADR_s* x, int n, struct zx_cdm_CTRY_s* z)
{
  ...
  case -1:
    y = x->CTRY;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CTRY_ELEM; y = (struct zx_cdm_CTRY_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->CTRY; n > 1 && y && y->gg.g.tok == zx_cdm_CTRY_ELEM; --n, y = (struct zx_cdm_CTRY_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_ADR_DEL_CTRY(struct zx_cdm_ADR_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CTRY; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CTRY_ELEM; --n, y = (struct zx_cdm_CTRY_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_AGENT_NUM_vCard(struct zx_cdm_AGENT_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->vCard; y && y->gg.g.tok == zx_cdm_vCard_ELEM; ++n, y = (struct zx_cdm_vCard_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_vCard_s* zx_cdm_AGENT_GET_vCard(struct zx_cdm_AGENT_s* x, int n)
{
  struct zx_cdm_vCard_s* y;
  if (!x) return 0;
  for (y = x->vCard; n>=0 && y && y->gg.g.tok == zx_cdm_vCard_ELEM; --n, y = (struct zx_cdm_vCard_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_AGENT_PUT_vCard(struct zx_cdm_AGENT_s* x, int n, struct zx_cdm_vCard_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_vCard_ELEM; --n, y = (struct zx_cdm_vCard_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_AGENT_ADD_vCard(struct zx_cdm_AGENT_s* x, int n, struct zx_cdm_vCard_s* z)
{
  ...
  case -1:
    y = x->vCard;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_vCard_ELEM; y = (struct zx_cdm_vCard_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->vCard; n > 1 && y && y->gg.g.tok == zx_cdm_vCard_ELEM; --n, y = (struct zx_cdm_vCard_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_AGENT_DEL_vCard(struct zx_cdm_AGENT_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->vCard; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_vCard_ELEM; --n, y = (struct zx_cdm_vCard_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_AGENT_NUM_EXTVAL(struct zx_cdm_AGENT_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->EXTVAL; y && y->gg.g.tok == zx_cdm_EXTVAL_ELEM; ++n, y = (struct zx_cdm_EXTVAL_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_EXTVAL_s* zx_cdm_AGENT_GET_EXTVAL(struct zx_cdm_AGENT_s* x, int n)
{
  struct zx_cdm_EXTVAL_s* y;
  if (!x) return 0;
  for (y = x->EXTVAL; n>=0 && y && y->gg.g.tok == zx_cdm_EXTVAL_ELEM; --n, y = (struct zx_cdm_EXTVAL_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_AGENT_PUT_EXTVAL(struct zx_cdm_AGENT_s* x, int n, struct zx_cdm_EXTVAL_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_EXTVAL_ELEM; --n, y = (struct zx_cdm_EXTVAL_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_AGENT_ADD_EXTVAL(struct zx_cdm_AGENT_s* x, int n, struct zx_cdm_EXTVAL_s* z)
{
  ...
  case -1:
    y = x->EXTVAL;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_EXTVAL_ELEM; y = (struct zx_cdm_EXTVAL_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->EXTVAL; n > 1 && y && y->gg.g.tok == zx_cdm_EXTVAL_ELEM; --n, y = (struct zx_cdm_EXTVAL_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_AGENT_DEL_EXTVAL(struct zx_cdm_AGENT_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->EXTVAL; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_EXTVAL_ELEM; --n, y = (struct zx_cdm_EXTVAL_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_CALADRURI_NUM_URI(struct zx_cdm_CALADRURI_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->URI; y && y->gg.g.tok == zx_cdm_URI_ELEM; ++n, y = (struct zx_cdm_URI_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_URI_s* zx_cdm_CALADRURI_GET_URI(struct zx_cdm_CALADRURI_s* x, int n)
{
  struct zx_cdm_URI_s* y;
  if (!x) return 0;
  for (y = x->URI; n>=0 && y && y->gg.g.tok == zx_cdm_URI_ELEM; --n, y = (struct zx_cdm_URI_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_CALADRURI_PUT_URI(struct zx_cdm_CALADRURI_s* x, int n, struct zx_cdm_URI_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_URI_ELEM; --n, y = (struct zx_cdm_URI_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_CALADRURI_ADD_URI(struct zx_cdm_CALADRURI_s* x, int n, struct zx_cdm_URI_s* z)
{
  ...
  case -1:
    y = x->URI;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_URI_ELEM; y = (struct zx_cdm_URI_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->URI; n > 1 && y && y->gg.g.tok == zx_cdm_URI_ELEM; --n, y = (struct zx_cdm_URI_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_CALADRURI_DEL_URI(struct zx_cdm_CALADRURI_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->URI; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_URI_ELEM; --n, y = (struct zx_cdm_URI_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_CATEGORIES_NUM_KEYWORD(struct zx_cdm_CATEGORIES_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->KEYWORD; y && y->gg.g.tok == zx_cdm_KEYWORD_ELEM; ++n, y = (struct zx_cdm_KEYWORD_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_KEYWORD_s* zx_cdm_CATEGORIES_GET_KEYWORD(struct zx_cdm_CATEGORIES_s* x, int n)
{
  struct zx_cdm_KEYWORD_s* y;
  if (!x) return 0;
  for (y = x->KEYWORD; n>=0 && y && y->gg.g.tok == zx_cdm_KEYWORD_ELEM; --n, y = (struct zx_cdm_KEYWORD_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_CATEGORIES_PUT_KEYWORD(struct zx_cdm_CATEGORIES_s* x, int n, struct zx_cdm_KEYWORD_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_KEYWORD_ELEM; --n, y = (struct zx_cdm_KEYWORD_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_CATEGORIES_ADD_KEYWORD(struct zx_cdm_CATEGORIES_s* x, int n, struct zx_cdm_KEYWORD_s* z)
{
  ...
  case -1:
    y = x->KEYWORD;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_KEYWORD_ELEM; y = (struct zx_cdm_KEYWORD_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->KEYWORD; n > 1 && y && y->gg.g.tok == zx_cdm_KEYWORD_ELEM; --n, y = (struct zx_cdm_KEYWORD_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_CATEGORIES_DEL_KEYWORD(struct zx_cdm_CATEGORIES_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->KEYWORD; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_KEYWORD_ELEM; --n, y = (struct zx_cdm_KEYWORD_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_CLASS_NUM_PUBLIC(struct zx_cdm_CLASS_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PUBLIC; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_CLASS_GET_PUBLIC(struct zx_cdm_CLASS_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->PUBLIC; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_CLASS_ADD_PUBLIC(struct zx_cdm_CLASS_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PUBLIC; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_CLASS_DEL_PUBLIC(struct zx_cdm_CLASS_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PUBLIC; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_CLASS_NUM_PRIVATE(struct zx_cdm_CLASS_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PRIVATE; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_CLASS_GET_PRIVATE(struct zx_cdm_CLASS_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->PRIVATE; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_CLASS_ADD_PRIVATE(struct zx_cdm_CLASS_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PRIVATE; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_CLASS_DEL_PRIVATE(struct zx_cdm_CLASS_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PRIVATE; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_CLASS_NUM_CONFIDENTIAL(struct zx_cdm_CLASS_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->CONFIDENTIAL; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_CLASS_GET_CONFIDENTIAL(struct zx_cdm_CLASS_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->CONFIDENTIAL; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_CLASS_ADD_CONFIDENTIAL(struct zx_cdm_CLASS_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CONFIDENTIAL; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_CLASS_DEL_CONFIDENTIAL(struct zx_cdm_CLASS_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CONFIDENTIAL; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_EMAIL_NUM_INTERNET(struct zx_cdm_EMAIL_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->INTERNET; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_EMAIL_GET_INTERNET(struct zx_cdm_EMAIL_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->INTERNET; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_EMAIL_ADD_INTERNET(struct zx_cdm_EMAIL_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->INTERNET; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_EMAIL_DEL_INTERNET(struct zx_cdm_EMAIL_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->INTERNET; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_EMAIL_NUM_X400(struct zx_cdm_EMAIL_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->X400; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_EMAIL_GET_X400(struct zx_cdm_EMAIL_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->X400; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_EMAIL_ADD_X400(struct zx_cdm_EMAIL_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->X400; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_EMAIL_DEL_X400(struct zx_cdm_EMAIL_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->X400; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_EMAIL_NUM_USERID(struct zx_cdm_EMAIL_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->USERID; y && y->gg.g.tok == zx_cdm_USERID_ELEM; ++n, y = (struct zx_cdm_USERID_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_USERID_s* zx_cdm_EMAIL_GET_USERID(struct zx_cdm_EMAIL_s* x, int n)
{
  struct zx_cdm_USERID_s* y;
  if (!x) return 0;
  for (y = x->USERID; n>=0 && y && y->gg.g.tok == zx_cdm_USERID_ELEM; --n, y = (struct zx_cdm_USERID_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_EMAIL_PUT_USERID(struct zx_cdm_EMAIL_s* x, int n, struct zx_cdm_USERID_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_USERID_ELEM; --n, y = (struct zx_cdm_USERID_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_EMAIL_ADD_USERID(struct zx_cdm_EMAIL_s* x, int n, struct zx_cdm_USERID_s* z)
{
  ...
  case -1:
    y = x->USERID;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_USERID_ELEM; y = (struct zx_cdm_USERID_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->USERID; n > 1 && y && y->gg.g.tok == zx_cdm_USERID_ELEM; --n, y = (struct zx_cdm_USERID_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_EMAIL_DEL_USERID(struct zx_cdm_EMAIL_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->USERID; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_USERID_ELEM; --n, y = (struct zx_cdm_USERID_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_GEO_NUM_LAT(struct zx_cdm_GEO_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->LAT; y && y->gg.g.tok == zx_cdm_LAT_ELEM; ++n, y = (struct zx_cdm_LAT_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_LAT_s* zx_cdm_GEO_GET_LAT(struct zx_cdm_GEO_s* x, int n)
{
  struct zx_cdm_LAT_s* y;
  if (!x) return 0;
  for (y = x->LAT; n>=0 && y && y->gg.g.tok == zx_cdm_LAT_ELEM; --n, y = (struct zx_cdm_LAT_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_GEO_PUT_LAT(struct zx_cdm_GEO_s* x, int n, struct zx_cdm_LAT_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LAT_ELEM; --n, y = (struct zx_cdm_LAT_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_GEO_ADD_LAT(struct zx_cdm_GEO_s* x, int n, struct zx_cdm_LAT_s* z)
{
  ...
  case -1:
    y = x->LAT;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LAT_ELEM; y = (struct zx_cdm_LAT_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->LAT; n > 1 && y && y->gg.g.tok == zx_cdm_LAT_ELEM; --n, y = (struct zx_cdm_LAT_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_GEO_DEL_LAT(struct zx_cdm_GEO_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->LAT; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LAT_ELEM; --n, y = (struct zx_cdm_LAT_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_GEO_NUM_LON(struct zx_cdm_GEO_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->LON; y && y->gg.g.tok == zx_cdm_LON_ELEM; ++n, y = (struct zx_cdm_LON_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_LON_s* zx_cdm_GEO_GET_LON(struct zx_cdm_GEO_s* x, int n)
{
  struct zx_cdm_LON_s* y;
  if (!x) return 0;
  for (y = x->LON; n>=0 && y && y->gg.g.tok == zx_cdm_LON_ELEM; --n, y = (struct zx_cdm_LON_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_GEO_PUT_LON(struct zx_cdm_GEO_s* x, int n, struct zx_cdm_LON_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LON_ELEM; --n, y = (struct zx_cdm_LON_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_GEO_ADD_LON(struct zx_cdm_GEO_s* x, int n, struct zx_cdm_LON_s* z)
{
  ...
  case -1:
    y = x->LON;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LON_ELEM; y = (struct zx_cdm_LON_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->LON; n > 1 && y && y->gg.g.tok == zx_cdm_LON_ELEM; --n, y = (struct zx_cdm_LON_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_GEO_DEL_LON(struct zx_cdm_GEO_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->LON; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LON_ELEM; --n, y = (struct zx_cdm_LON_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_KEY_NUM_TYPE(struct zx_cdm_KEY_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->TYPE; y && y->gg.g.tok == zx_cdm_TYPE_ELEM; ++n, y = (struct zx_cdm_TYPE_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_TYPE_s* zx_cdm_KEY_GET_TYPE(struct zx_cdm_KEY_s* x, int n)
{
  struct zx_cdm_TYPE_s* y;
  if (!x) return 0;
  for (y = x->TYPE; n>=0 && y && y->gg.g.tok == zx_cdm_TYPE_ELEM; --n, y = (struct zx_cdm_TYPE_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_KEY_PUT_TYPE(struct zx_cdm_KEY_s* x, int n, struct zx_cdm_TYPE_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_TYPE_ELEM; --n, y = (struct zx_cdm_TYPE_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_KEY_ADD_TYPE(struct zx_cdm_KEY_s* x, int n, struct zx_cdm_TYPE_s* z)
{
  ...
  case -1:
    y = x->TYPE;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_TYPE_ELEM; y = (struct zx_cdm_TYPE_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->TYPE; n > 1 && y && y->gg.g.tok == zx_cdm_TYPE_ELEM; --n, y = (struct zx_cdm_TYPE_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_KEY_DEL_TYPE(struct zx_cdm_KEY_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->TYPE; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_TYPE_ELEM; --n, y = (struct zx_cdm_TYPE_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_KEY_NUM_CRED(struct zx_cdm_KEY_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->CRED; y && y->gg.g.tok == zx_cdm_CRED_ELEM; ++n, y = (struct zx_cdm_CRED_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_CRED_s* zx_cdm_KEY_GET_CRED(struct zx_cdm_KEY_s* x, int n)
{
  struct zx_cdm_CRED_s* y;
  if (!x) return 0;
  for (y = x->CRED; n>=0 && y && y->gg.g.tok == zx_cdm_CRED_ELEM; --n, y = (struct zx_cdm_CRED_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_KEY_PUT_CRED(struct zx_cdm_KEY_s* x, int n, struct zx_cdm_CRED_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CRED_ELEM; --n, y = (struct zx_cdm_CRED_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_KEY_ADD_CRED(struct zx_cdm_KEY_s* x, int n, struct zx_cdm_CRED_s* z)
{
  ...
  case -1:
    y = x->CRED;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CRED_ELEM; y = (struct zx_cdm_CRED_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->CRED; n > 1 && y && y->gg.g.tok == zx_cdm_CRED_ELEM; --n, y = (struct zx_cdm_CRED_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_KEY_DEL_CRED(struct zx_cdm_KEY_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CRED; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CRED_ELEM; --n, y = (struct zx_cdm_CRED_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_LABEL_NUM_LINE(struct zx_cdm_LABEL_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->LINE; y && y->gg.g.tok == zx_cdm_LINE_ELEM; ++n, y = (struct zx_cdm_LINE_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_LINE_s* zx_cdm_LABEL_GET_LINE(struct zx_cdm_LABEL_s* x, int n)
{
  struct zx_cdm_LINE_s* y;
  if (!x) return 0;
  for (y = x->LINE; n>=0 && y && y->gg.g.tok == zx_cdm_LINE_ELEM; --n, y = (struct zx_cdm_LINE_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_LABEL_PUT_LINE(struct zx_cdm_LABEL_s* x, int n, struct zx_cdm_LINE_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LINE_ELEM; --n, y = (struct zx_cdm_LINE_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_LABEL_ADD_LINE(struct zx_cdm_LABEL_s* x, int n, struct zx_cdm_LINE_s* z)
{
  ...
  case -1:
    y = x->LINE;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LINE_ELEM; y = (struct zx_cdm_LINE_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->LINE; n > 1 && y && y->gg.g.tok == zx_cdm_LINE_ELEM; --n, y = (struct zx_cdm_LINE_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_LABEL_DEL_LINE(struct zx_cdm_LABEL_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->LINE; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LINE_ELEM; --n, y = (struct zx_cdm_LINE_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_LOGO_NUM_BINVAL(struct zx_cdm_LOGO_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->BINVAL; y && y->gg.g.tok == zx_cdm_BINVAL_ELEM; ++n, y = (struct zx_cdm_BINVAL_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_BINVAL_s* zx_cdm_LOGO_GET_BINVAL(struct zx_cdm_LOGO_s* x, int n)
{
  struct zx_cdm_BINVAL_s* y;
  if (!x) return 0;
  for (y = x->BINVAL; n>=0 && y && y->gg.g.tok == zx_cdm_BINVAL_ELEM; --n, y = (struct zx_cdm_BINVAL_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_LOGO_PUT_BINVAL(struct zx_cdm_LOGO_s* x, int n, struct zx_cdm_BINVAL_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_BINVAL_ELEM; --n, y = (struct zx_cdm_BINVAL_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_LOGO_ADD_BINVAL(struct zx_cdm_LOGO_s* x, int n, struct zx_cdm_BINVAL_s* z)
{
  ...
  case -1:
    y = x->BINVAL;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_BINVAL_ELEM; y = (struct zx_cdm_BINVAL_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->BINVAL; n > 1 && y && y->gg.g.tok == zx_cdm_BINVAL_ELEM; --n, y = (struct zx_cdm_BINVAL_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_LOGO_DEL_BINVAL(struct zx_cdm_LOGO_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->BINVAL; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_BINVAL_ELEM; --n, y = (struct zx_cdm_BINVAL_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_N_NUM_FAMILY(struct zx_cdm_N_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->FAMILY; y && y->gg.g.tok == zx_cdm_FAMILY_ELEM; ++n, y = (struct zx_cdm_FAMILY_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_FAMILY_s* zx_cdm_N_GET_FAMILY(struct zx_cdm_N_s* x, int n)
{
  struct zx_cdm_FAMILY_s* y;
  if (!x) return 0;
  for (y = x->FAMILY; n>=0 && y && y->gg.g.tok == zx_cdm_FAMILY_ELEM; --n, y = (struct zx_cdm_FAMILY_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_N_PUT_FAMILY(struct zx_cdm_N_s* x, int n, struct zx_cdm_FAMILY_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_FAMILY_ELEM; --n, y = (struct zx_cdm_FAMILY_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_N_ADD_FAMILY(struct zx_cdm_N_s* x, int n, struct zx_cdm_FAMILY_s* z)
{
  ...
  case -1:
    y = x->FAMILY;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_FAMILY_ELEM; y = (struct zx_cdm_FAMILY_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->FAMILY; n > 1 && y && y->gg.g.tok == zx_cdm_FAMILY_ELEM; --n, y = (struct zx_cdm_FAMILY_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_N_DEL_FAMILY(struct zx_cdm_N_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->FAMILY; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_FAMILY_ELEM; --n, y = (struct zx_cdm_FAMILY_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_N_NUM_GIVEN(struct zx_cdm_N_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->GIVEN; y && y->gg.g.tok == zx_cdm_GIVEN_ELEM; ++n, y = (struct zx_cdm_GIVEN_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_GIVEN_s* zx_cdm_N_GET_GIVEN(struct zx_cdm_N_s* x, int n)
{
  struct zx_cdm_GIVEN_s* y;
  if (!x) return 0;
  for (y = x->GIVEN; n>=0 && y && y->gg.g.tok == zx_cdm_GIVEN_ELEM; --n, y = (struct zx_cdm_GIVEN_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_N_PUT_GIVEN(struct zx_cdm_N_s* x, int n, struct zx_cdm_GIVEN_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_GIVEN_ELEM; --n, y = (struct zx_cdm_GIVEN_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_N_ADD_GIVEN(struct zx_cdm_N_s* x, int n, struct zx_cdm_GIVEN_s* z)
{
  ...
  case -1:
    y = x->GIVEN;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_GIVEN_ELEM; y = (struct zx_cdm_GIVEN_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->GIVEN; n > 1 && y && y->gg.g.tok == zx_cdm_GIVEN_ELEM; --n, y = (struct zx_cdm_GIVEN_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_N_DEL_GIVEN(struct zx_cdm_N_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->GIVEN; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_GIVEN_ELEM; --n, y = (struct zx_cdm_GIVEN_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_N_NUM_MIDDLE(struct zx_cdm_N_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->MIDDLE; y && y->gg.g.tok == zx_cdm_MIDDLE_ELEM; ++n, y = (struct zx_cdm_MIDDLE_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_MIDDLE_s* zx_cdm_N_GET_MIDDLE(struct zx_cdm_N_s* x, int n)
{
  struct zx_cdm_MIDDLE_s* y;
  if (!x) return 0;
  for (y = x->MIDDLE; n>=0 && y && y->gg.g.tok == zx_cdm_MIDDLE_ELEM; --n, y = (struct zx_cdm_MIDDLE_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_N_PUT_MIDDLE(struct zx_cdm_N_s* x, int n, struct zx_cdm_MIDDLE_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_MIDDLE_ELEM; --n, y = (struct zx_cdm_MIDDLE_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_N_ADD_MIDDLE(struct zx_cdm_N_s* x, int n, struct zx_cdm_MIDDLE_s* z)
{
  ...
  case -1:
    y = x->MIDDLE;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_MIDDLE_ELEM; y = (struct zx_cdm_MIDDLE_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->MIDDLE; n > 1 && y && y->gg.g.tok == zx_cdm_MIDDLE_ELEM; --n, y = (struct zx_cdm_MIDDLE_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_N_DEL_MIDDLE(struct zx_cdm_N_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->MIDDLE; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_MIDDLE_ELEM; --n, y = (struct zx_cdm_MIDDLE_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_N_NUM_PREFIX(struct zx_cdm_N_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PREFIX; y && y->gg.g.tok == zx_cdm_PREFIX_ELEM; ++n, y = (struct zx_cdm_PREFIX_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_PREFIX_s* zx_cdm_N_GET_PREFIX(struct zx_cdm_N_s* x, int n)
{
  struct zx_cdm_PREFIX_s* y;
  if (!x) return 0;
  for (y = x->PREFIX; n>=0 && y && y->gg.g.tok == zx_cdm_PREFIX_ELEM; --n, y = (struct zx_cdm_PREFIX_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_N_PUT_PREFIX(struct zx_cdm_N_s* x, int n, struct zx_cdm_PREFIX_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PREFIX_ELEM; --n, y = (struct zx_cdm_PREFIX_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_N_ADD_PREFIX(struct zx_cdm_N_s* x, int n, struct zx_cdm_PREFIX_s* z)
{
  ...
  case -1:
    y = x->PREFIX;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PREFIX_ELEM; y = (struct zx_cdm_PREFIX_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->PREFIX; n > 1 && y && y->gg.g.tok == zx_cdm_PREFIX_ELEM; --n, y = (struct zx_cdm_PREFIX_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_N_DEL_PREFIX(struct zx_cdm_N_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PREFIX; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PREFIX_ELEM; --n, y = (struct zx_cdm_PREFIX_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_N_NUM_SUFFIX(struct zx_cdm_N_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->SUFFIX; y && y->gg.g.tok == zx_cdm_SUFFIX_ELEM; ++n, y = (struct zx_cdm_SUFFIX_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_SUFFIX_s* zx_cdm_N_GET_SUFFIX(struct zx_cdm_N_s* x, int n)
{
  struct zx_cdm_SUFFIX_s* y;
  if (!x) return 0;
  for (y = x->SUFFIX; n>=0 && y && y->gg.g.tok == zx_cdm_SUFFIX_ELEM; --n, y = (struct zx_cdm_SUFFIX_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_N_PUT_SUFFIX(struct zx_cdm_N_s* x, int n, struct zx_cdm_SUFFIX_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_SUFFIX_ELEM; --n, y = (struct zx_cdm_SUFFIX_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_N_ADD_SUFFIX(struct zx_cdm_N_s* x, int n, struct zx_cdm_SUFFIX_s* z)
{
  ...
  case -1:
    y = x->SUFFIX;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_SUFFIX_ELEM; y = (struct zx_cdm_SUFFIX_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->SUFFIX; n > 1 && y && y->gg.g.tok == zx_cdm_SUFFIX_ELEM; --n, y = (struct zx_cdm_SUFFIX_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_N_DEL_SUFFIX(struct zx_cdm_N_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SUFFIX; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_SUFFIX_ELEM; --n, y = (struct zx_cdm_SUFFIX_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_ORG_NUM_ORGNAME(struct zx_cdm_ORG_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ORGNAME; y && y->gg.g.tok == zx_cdm_ORGNAME_ELEM; ++n, y = (struct zx_cdm_ORGNAME_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_ORGNAME_s* zx_cdm_ORG_GET_ORGNAME(struct zx_cdm_ORG_s* x, int n)
{
  struct zx_cdm_ORGNAME_s* y;
  if (!x) return 0;
  for (y = x->ORGNAME; n>=0 && y && y->gg.g.tok == zx_cdm_ORGNAME_ELEM; --n, y = (struct zx_cdm_ORGNAME_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_ORG_PUT_ORGNAME(struct zx_cdm_ORG_s* x, int n, struct zx_cdm_ORGNAME_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_ORGNAME_ELEM; --n, y = (struct zx_cdm_ORGNAME_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_ORG_ADD_ORGNAME(struct zx_cdm_ORG_s* x, int n, struct zx_cdm_ORGNAME_s* z)
{
  ...
  case -1:
    y = x->ORGNAME;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_ORGNAME_ELEM; y = (struct zx_cdm_ORGNAME_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->ORGNAME; n > 1 && y && y->gg.g.tok == zx_cdm_ORGNAME_ELEM; --n, y = (struct zx_cdm_ORGNAME_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_ORG_DEL_ORGNAME(struct zx_cdm_ORG_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ORGNAME; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_ORGNAME_ELEM; --n, y = (struct zx_cdm_ORGNAME_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_ORG_NUM_ORGUNIT(struct zx_cdm_ORG_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ORGUNIT; y && y->gg.g.tok == zx_cdm_ORGUNIT_ELEM; ++n, y = (struct zx_cdm_ORGUNIT_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_ORGUNIT_s* zx_cdm_ORG_GET_ORGUNIT(struct zx_cdm_ORG_s* x, int n)
{
  struct zx_cdm_ORGUNIT_s* y;
  if (!x) return 0;
  for (y = x->ORGUNIT; n>=0 && y && y->gg.g.tok == zx_cdm_ORGUNIT_ELEM; --n, y = (struct zx_cdm_ORGUNIT_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_ORG_PUT_ORGUNIT(struct zx_cdm_ORG_s* x, int n, struct zx_cdm_ORGUNIT_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_ORGUNIT_ELEM; --n, y = (struct zx_cdm_ORGUNIT_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_ORG_ADD_ORGUNIT(struct zx_cdm_ORG_s* x, int n, struct zx_cdm_ORGUNIT_s* z)
{
  ...
  case -1:
    y = x->ORGUNIT;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_ORGUNIT_ELEM; y = (struct zx_cdm_ORGUNIT_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->ORGUNIT; n > 1 && y && y->gg.g.tok == zx_cdm_ORGUNIT_ELEM; --n, y = (struct zx_cdm_ORGUNIT_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_ORG_DEL_ORGUNIT(struct zx_cdm_ORG_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ORGUNIT; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_ORGUNIT_ELEM; --n, y = (struct zx_cdm_ORGUNIT_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_SOUND_NUM_PHONETIC(struct zx_cdm_SOUND_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PHONETIC; y && y->gg.g.tok == zx_cdm_PHONETIC_ELEM; ++n, y = (struct zx_cdm_PHONETIC_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_PHONETIC_s* zx_cdm_SOUND_GET_PHONETIC(struct zx_cdm_SOUND_s* x, int n)
{
  struct zx_cdm_PHONETIC_s* y;
  if (!x) return 0;
  for (y = x->PHONETIC; n>=0 && y && y->gg.g.tok == zx_cdm_PHONETIC_ELEM; --n, y = (struct zx_cdm_PHONETIC_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_SOUND_PUT_PHONETIC(struct zx_cdm_SOUND_s* x, int n, struct zx_cdm_PHONETIC_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PHONETIC_ELEM; --n, y = (struct zx_cdm_PHONETIC_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_SOUND_ADD_PHONETIC(struct zx_cdm_SOUND_s* x, int n, struct zx_cdm_PHONETIC_s* z)
{
  ...
  case -1:
    y = x->PHONETIC;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PHONETIC_ELEM; y = (struct zx_cdm_PHONETIC_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->PHONETIC; n > 1 && y && y->gg.g.tok == zx_cdm_PHONETIC_ELEM; --n, y = (struct zx_cdm_PHONETIC_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_SOUND_DEL_PHONETIC(struct zx_cdm_SOUND_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PHONETIC; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PHONETIC_ELEM; --n, y = (struct zx_cdm_PHONETIC_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_TEL_NUM_VOICE(struct zx_cdm_TEL_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->VOICE; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_TEL_GET_VOICE(struct zx_cdm_TEL_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->VOICE; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_TEL_ADD_VOICE(struct zx_cdm_TEL_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->VOICE; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_TEL_DEL_VOICE(struct zx_cdm_TEL_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->VOICE; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_TEL_NUM_FAX(struct zx_cdm_TEL_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->FAX; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_TEL_GET_FAX(struct zx_cdm_TEL_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->FAX; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_TEL_ADD_FAX(struct zx_cdm_TEL_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->FAX; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_TEL_DEL_FAX(struct zx_cdm_TEL_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->FAX; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_TEL_NUM_PAGER(struct zx_cdm_TEL_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PAGER; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_TEL_GET_PAGER(struct zx_cdm_TEL_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->PAGER; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_TEL_ADD_PAGER(struct zx_cdm_TEL_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PAGER; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_TEL_DEL_PAGER(struct zx_cdm_TEL_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PAGER; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_TEL_NUM_MSG(struct zx_cdm_TEL_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->MSG; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_TEL_GET_MSG(struct zx_cdm_TEL_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->MSG; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_TEL_ADD_MSG(struct zx_cdm_TEL_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->MSG; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_TEL_DEL_MSG(struct zx_cdm_TEL_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->MSG; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_TEL_NUM_CELL(struct zx_cdm_TEL_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->CELL; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_TEL_GET_CELL(struct zx_cdm_TEL_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->CELL; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_TEL_ADD_CELL(struct zx_cdm_TEL_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CELL; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_TEL_DEL_CELL(struct zx_cdm_TEL_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CELL; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_TEL_NUM_VIDEO(struct zx_cdm_TEL_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->VIDEO; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_TEL_GET_VIDEO(struct zx_cdm_TEL_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->VIDEO; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_TEL_ADD_VIDEO(struct zx_cdm_TEL_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->VIDEO; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_TEL_DEL_VIDEO(struct zx_cdm_TEL_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->VIDEO; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_TEL_NUM_BBS(struct zx_cdm_TEL_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->BBS; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_TEL_GET_BBS(struct zx_cdm_TEL_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->BBS; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_TEL_ADD_BBS(struct zx_cdm_TEL_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->BBS; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_TEL_DEL_BBS(struct zx_cdm_TEL_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->BBS; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_TEL_NUM_MODEM(struct zx_cdm_TEL_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->MODEM; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_TEL_GET_MODEM(struct zx_cdm_TEL_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->MODEM; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_TEL_ADD_MODEM(struct zx_cdm_TEL_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->MODEM; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_TEL_DEL_MODEM(struct zx_cdm_TEL_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->MODEM; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_TEL_NUM_ISDN(struct zx_cdm_TEL_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ISDN; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_TEL_GET_ISDN(struct zx_cdm_TEL_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->ISDN; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_TEL_ADD_ISDN(struct zx_cdm_TEL_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ISDN; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_TEL_DEL_ISDN(struct zx_cdm_TEL_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ISDN; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_TEL_NUM_PCS(struct zx_cdm_TEL_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PCS; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_TEL_GET_PCS(struct zx_cdm_TEL_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->PCS; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_TEL_ADD_PCS(struct zx_cdm_TEL_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PCS; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_TEL_DEL_PCS(struct zx_cdm_TEL_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PCS; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_TEL_NUM_NUMBER(struct zx_cdm_TEL_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->NUMBER; y && y->gg.g.tok == zx_cdm_NUMBER_ELEM; ++n, y = (struct zx_cdm_NUMBER_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_NUMBER_s* zx_cdm_TEL_GET_NUMBER(struct zx_cdm_TEL_s* x, int n)
{
  struct zx_cdm_NUMBER_s* y;
  if (!x) return 0;
  for (y = x->NUMBER; n>=0 && y && y->gg.g.tok == zx_cdm_NUMBER_ELEM; --n, y = (struct zx_cdm_NUMBER_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_TEL_PUT_NUMBER(struct zx_cdm_TEL_s* x, int n, struct zx_cdm_NUMBER_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_NUMBER_ELEM; --n, y = (struct zx_cdm_NUMBER_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_TEL_ADD_NUMBER(struct zx_cdm_TEL_s* x, int n, struct zx_cdm_NUMBER_s* z)
{
  ...
  case -1:
    y = x->NUMBER;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_NUMBER_ELEM; y = (struct zx_cdm_NUMBER_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->NUMBER; n > 1 && y && y->gg.g.tok == zx_cdm_NUMBER_ELEM; --n, y = (struct zx_cdm_NUMBER_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_TEL_DEL_NUMBER(struct zx_cdm_TEL_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->NUMBER; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_NUMBER_ELEM; --n, y = (struct zx_cdm_NUMBER_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_VERSION_is_Perl_MakeMaker_gobbled(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->VERSION_is_Perl_MakeMaker_gobbled; y && y->gg.g.tok == zx_cdm_VERSION_ELEM; ++n, y = (struct zx_cdm_VERSION_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_VERSION_s* zx_cdm_vCard_GET_VERSION_is_Perl_MakeMaker_gobbled(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_VERSION_s* y;
  if (!x) return 0;
  for (y = x->VERSION_is_Perl_MakeMaker_gobbled; n>=0 && y && y->gg.g.tok == zx_cdm_VERSION_ELEM; --n, y = (struct zx_cdm_VERSION_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_VERSION_is_Perl_MakeMaker_gobbled(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_VERSION_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_VERSION_ELEM; --n, y = (struct zx_cdm_VERSION_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_VERSION_is_Perl_MakeMaker_gobbled(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_VERSION_s* z)
{
  ...
  case -1:
    y = x->VERSION_is_Perl_MakeMaker_gobbled;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_VERSION_ELEM; y = (struct zx_cdm_VERSION_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->VERSION_is_Perl_MakeMaker_gobbled; n > 1 && y && y->gg.g.tok == zx_cdm_VERSION_ELEM; --n, y = (struct zx_cdm_VERSION_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_VERSION_is_Perl_MakeMaker_gobbled(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->VERSION_is_Perl_MakeMaker_gobbled; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_VERSION_ELEM; --n, y = (struct zx_cdm_VERSION_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_DISTRIBUTIONLIST(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->DISTRIBUTIONLIST; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_vCard_GET_DISTRIBUTIONLIST(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->DISTRIBUTIONLIST; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_vCard_ADD_DISTRIBUTIONLIST(struct zx_cdm_vCard_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->DISTRIBUTIONLIST; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_vCard_DEL_DISTRIBUTIONLIST(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->DISTRIBUTIONLIST; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_vCard_NUM_SELF(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->SELF; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_vCard_GET_SELF(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->SELF; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_vCard_ADD_SELF(struct zx_cdm_vCard_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SELF; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_vCard_DEL_SELF(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SELF; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_vCard_NUM_FAVORITE(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->FAVORITE; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_cdm_vCard_GET_FAVORITE(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->FAVORITE; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_cdm_vCard_ADD_FAVORITE(struct zx_cdm_vCard_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->FAVORITE; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_cdm_vCard_DEL_FAVORITE(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->FAVORITE; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_cdm_vCard_NUM_FN(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->FN; y && y->gg.g.tok == zx_cdm_FN_ELEM; ++n, y = (struct zx_cdm_FN_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_FN_s* zx_cdm_vCard_GET_FN(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_FN_s* y;
  if (!x) return 0;
  for (y = x->FN; n>=0 && y && y->gg.g.tok == zx_cdm_FN_ELEM; --n, y = (struct zx_cdm_FN_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_FN(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_FN_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_FN_ELEM; --n, y = (struct zx_cdm_FN_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_FN(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_FN_s* z)
{
  ...
  case -1:
    y = x->FN;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_FN_ELEM; y = (struct zx_cdm_FN_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->FN; n > 1 && y && y->gg.g.tok == zx_cdm_FN_ELEM; --n, y = (struct zx_cdm_FN_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_FN(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->FN; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_FN_ELEM; --n, y = (struct zx_cdm_FN_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_N(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->N; y && y->gg.g.tok == zx_cdm_N_ELEM; ++n, y = (struct zx_cdm_N_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_N_s* zx_cdm_vCard_GET_N(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_N_s* y;
  if (!x) return 0;
  for (y = x->N; n>=0 && y && y->gg.g.tok == zx_cdm_N_ELEM; --n, y = (struct zx_cdm_N_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_N(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_N_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_N_ELEM; --n, y = (struct zx_cdm_N_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_N(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_N_s* z)
{
  ...
  case -1:
    y = x->N;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_N_ELEM; y = (struct zx_cdm_N_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->N; n > 1 && y && y->gg.g.tok == zx_cdm_N_ELEM; --n, y = (struct zx_cdm_N_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_N(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->N; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_N_ELEM; --n, y = (struct zx_cdm_N_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_LISTMEMBER(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->LISTMEMBER; y && y->gg.g.tok == zx_cdm_LISTMEMBER_ELEM; ++n, y = (struct zx_cdm_LISTMEMBER_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_LISTMEMBER_s* zx_cdm_vCard_GET_LISTMEMBER(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_LISTMEMBER_s* y;
  if (!x) return 0;
  for (y = x->LISTMEMBER; n>=0 && y && y->gg.g.tok == zx_cdm_LISTMEMBER_ELEM; --n, y = (struct zx_cdm_LISTMEMBER_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_LISTMEMBER(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_LISTMEMBER_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LISTMEMBER_ELEM; --n, y = (struct zx_cdm_LISTMEMBER_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_LISTMEMBER(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_LISTMEMBER_s* z)
{
  ...
  case -1:
    y = x->LISTMEMBER;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LISTMEMBER_ELEM; y = (struct zx_cdm_LISTMEMBER_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->LISTMEMBER; n > 1 && y && y->gg.g.tok == zx_cdm_LISTMEMBER_ELEM; --n, y = (struct zx_cdm_LISTMEMBER_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_LISTMEMBER(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->LISTMEMBER; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LISTMEMBER_ELEM; --n, y = (struct zx_cdm_LISTMEMBER_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_NICKNAME(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->NICKNAME; y && y->gg.g.tok == zx_cdm_NICKNAME_ELEM; ++n, y = (struct zx_cdm_NICKNAME_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_NICKNAME_s* zx_cdm_vCard_GET_NICKNAME(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_NICKNAME_s* y;
  if (!x) return 0;
  for (y = x->NICKNAME; n>=0 && y && y->gg.g.tok == zx_cdm_NICKNAME_ELEM; --n, y = (struct zx_cdm_NICKNAME_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_NICKNAME(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_NICKNAME_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_NICKNAME_ELEM; --n, y = (struct zx_cdm_NICKNAME_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_NICKNAME(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_NICKNAME_s* z)
{
  ...
  case -1:
    y = x->NICKNAME;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_NICKNAME_ELEM; y = (struct zx_cdm_NICKNAME_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->NICKNAME; n > 1 && y && y->gg.g.tok == zx_cdm_NICKNAME_ELEM; --n, y = (struct zx_cdm_NICKNAME_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_NICKNAME(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->NICKNAME; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_NICKNAME_ELEM; --n, y = (struct zx_cdm_NICKNAME_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_PHOTO(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PHOTO; y && y->gg.g.tok == zx_cdm_PHOTO_ELEM; ++n, y = (struct zx_cdm_PHOTO_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_PHOTO_s* zx_cdm_vCard_GET_PHOTO(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_PHOTO_s* y;
  if (!x) return 0;
  for (y = x->PHOTO; n>=0 && y && y->gg.g.tok == zx_cdm_PHOTO_ELEM; --n, y = (struct zx_cdm_PHOTO_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_PHOTO(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_PHOTO_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PHOTO_ELEM; --n, y = (struct zx_cdm_PHOTO_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_PHOTO(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_PHOTO_s* z)
{
  ...
  case -1:
    y = x->PHOTO;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PHOTO_ELEM; y = (struct zx_cdm_PHOTO_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->PHOTO; n > 1 && y && y->gg.g.tok == zx_cdm_PHOTO_ELEM; --n, y = (struct zx_cdm_PHOTO_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_PHOTO(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PHOTO; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PHOTO_ELEM; --n, y = (struct zx_cdm_PHOTO_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_BDAY(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->BDAY; y && y->gg.g.tok == zx_cdm_BDAY_ELEM; ++n, y = (struct zx_cdm_BDAY_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_BDAY_s* zx_cdm_vCard_GET_BDAY(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_BDAY_s* y;
  if (!x) return 0;
  for (y = x->BDAY; n>=0 && y && y->gg.g.tok == zx_cdm_BDAY_ELEM; --n, y = (struct zx_cdm_BDAY_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_BDAY(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_BDAY_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_BDAY_ELEM; --n, y = (struct zx_cdm_BDAY_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_BDAY(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_BDAY_s* z)
{
  ...
  case -1:
    y = x->BDAY;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_BDAY_ELEM; y = (struct zx_cdm_BDAY_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->BDAY; n > 1 && y && y->gg.g.tok == zx_cdm_BDAY_ELEM; --n, y = (struct zx_cdm_BDAY_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_BDAY(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->BDAY; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_BDAY_ELEM; --n, y = (struct zx_cdm_BDAY_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_ADR(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ADR; y && y->gg.g.tok == zx_cdm_ADR_ELEM; ++n, y = (struct zx_cdm_ADR_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_ADR_s* zx_cdm_vCard_GET_ADR(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_ADR_s* y;
  if (!x) return 0;
  for (y = x->ADR; n>=0 && y && y->gg.g.tok == zx_cdm_ADR_ELEM; --n, y = (struct zx_cdm_ADR_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_ADR(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_ADR_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_ADR_ELEM; --n, y = (struct zx_cdm_ADR_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_ADR(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_ADR_s* z)
{
  ...
  case -1:
    y = x->ADR;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_ADR_ELEM; y = (struct zx_cdm_ADR_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->ADR; n > 1 && y && y->gg.g.tok == zx_cdm_ADR_ELEM; --n, y = (struct zx_cdm_ADR_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_ADR(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ADR; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_ADR_ELEM; --n, y = (struct zx_cdm_ADR_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_LABEL(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->LABEL; y && y->gg.g.tok == zx_cdm_LABEL_ELEM; ++n, y = (struct zx_cdm_LABEL_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_LABEL_s* zx_cdm_vCard_GET_LABEL(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_LABEL_s* y;
  if (!x) return 0;
  for (y = x->LABEL; n>=0 && y && y->gg.g.tok == zx_cdm_LABEL_ELEM; --n, y = (struct zx_cdm_LABEL_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_LABEL(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_LABEL_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LABEL_ELEM; --n, y = (struct zx_cdm_LABEL_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_LABEL(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_LABEL_s* z)
{
  ...
  case -1:
    y = x->LABEL;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LABEL_ELEM; y = (struct zx_cdm_LABEL_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->LABEL; n > 1 && y && y->gg.g.tok == zx_cdm_LABEL_ELEM; --n, y = (struct zx_cdm_LABEL_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_LABEL(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->LABEL; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LABEL_ELEM; --n, y = (struct zx_cdm_LABEL_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_TEL(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->TEL; y && y->gg.g.tok == zx_cdm_TEL_ELEM; ++n, y = (struct zx_cdm_TEL_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_TEL_s* zx_cdm_vCard_GET_TEL(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_TEL_s* y;
  if (!x) return 0;
  for (y = x->TEL; n>=0 && y && y->gg.g.tok == zx_cdm_TEL_ELEM; --n, y = (struct zx_cdm_TEL_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_TEL(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_TEL_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_TEL_ELEM; --n, y = (struct zx_cdm_TEL_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_TEL(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_TEL_s* z)
{
  ...
  case -1:
    y = x->TEL;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_TEL_ELEM; y = (struct zx_cdm_TEL_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->TEL; n > 1 && y && y->gg.g.tok == zx_cdm_TEL_ELEM; --n, y = (struct zx_cdm_TEL_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_TEL(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->TEL; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_TEL_ELEM; --n, y = (struct zx_cdm_TEL_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_EMAIL(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->EMAIL; y && y->gg.g.tok == zx_cdm_EMAIL_ELEM; ++n, y = (struct zx_cdm_EMAIL_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_EMAIL_s* zx_cdm_vCard_GET_EMAIL(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_EMAIL_s* y;
  if (!x) return 0;
  for (y = x->EMAIL; n>=0 && y && y->gg.g.tok == zx_cdm_EMAIL_ELEM; --n, y = (struct zx_cdm_EMAIL_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_EMAIL(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_EMAIL_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_EMAIL_ELEM; --n, y = (struct zx_cdm_EMAIL_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_EMAIL(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_EMAIL_s* z)
{
  ...
  case -1:
    y = x->EMAIL;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_EMAIL_ELEM; y = (struct zx_cdm_EMAIL_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->EMAIL; n > 1 && y && y->gg.g.tok == zx_cdm_EMAIL_ELEM; --n, y = (struct zx_cdm_EMAIL_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_EMAIL(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->EMAIL; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_EMAIL_ELEM; --n, y = (struct zx_cdm_EMAIL_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_JABBERID(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->JABBERID; y && y->gg.g.tok == zx_cdm_JABBERID_ELEM; ++n, y = (struct zx_cdm_JABBERID_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_JABBERID_s* zx_cdm_vCard_GET_JABBERID(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_JABBERID_s* y;
  if (!x) return 0;
  for (y = x->JABBERID; n>=0 && y && y->gg.g.tok == zx_cdm_JABBERID_ELEM; --n, y = (struct zx_cdm_JABBERID_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_JABBERID(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_JABBERID_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_JABBERID_ELEM; --n, y = (struct zx_cdm_JABBERID_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_JABBERID(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_JABBERID_s* z)
{
  ...
  case -1:
    y = x->JABBERID;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_JABBERID_ELEM; y = (struct zx_cdm_JABBERID_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->JABBERID; n > 1 && y && y->gg.g.tok == zx_cdm_JABBERID_ELEM; --n, y = (struct zx_cdm_JABBERID_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_JABBERID(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->JABBERID; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_JABBERID_ELEM; --n, y = (struct zx_cdm_JABBERID_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_MAILER(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->MAILER; y && y->gg.g.tok == zx_cdm_MAILER_ELEM; ++n, y = (struct zx_cdm_MAILER_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_MAILER_s* zx_cdm_vCard_GET_MAILER(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_MAILER_s* y;
  if (!x) return 0;
  for (y = x->MAILER; n>=0 && y && y->gg.g.tok == zx_cdm_MAILER_ELEM; --n, y = (struct zx_cdm_MAILER_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_MAILER(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_MAILER_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_MAILER_ELEM; --n, y = (struct zx_cdm_MAILER_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_MAILER(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_MAILER_s* z)
{
  ...
  case -1:
    y = x->MAILER;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_MAILER_ELEM; y = (struct zx_cdm_MAILER_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->MAILER; n > 1 && y && y->gg.g.tok == zx_cdm_MAILER_ELEM; --n, y = (struct zx_cdm_MAILER_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_MAILER(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->MAILER; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_MAILER_ELEM; --n, y = (struct zx_cdm_MAILER_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_TZ(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->TZ; y && y->gg.g.tok == zx_cdm_TZ_ELEM; ++n, y = (struct zx_cdm_TZ_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_TZ_s* zx_cdm_vCard_GET_TZ(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_TZ_s* y;
  if (!x) return 0;
  for (y = x->TZ; n>=0 && y && y->gg.g.tok == zx_cdm_TZ_ELEM; --n, y = (struct zx_cdm_TZ_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_TZ(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_TZ_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_TZ_ELEM; --n, y = (struct zx_cdm_TZ_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_TZ(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_TZ_s* z)
{
  ...
  case -1:
    y = x->TZ;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_TZ_ELEM; y = (struct zx_cdm_TZ_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->TZ; n > 1 && y && y->gg.g.tok == zx_cdm_TZ_ELEM; --n, y = (struct zx_cdm_TZ_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_TZ(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->TZ; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_TZ_ELEM; --n, y = (struct zx_cdm_TZ_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_GEO(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->GEO; y && y->gg.g.tok == zx_cdm_GEO_ELEM; ++n, y = (struct zx_cdm_GEO_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_GEO_s* zx_cdm_vCard_GET_GEO(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_GEO_s* y;
  if (!x) return 0;
  for (y = x->GEO; n>=0 && y && y->gg.g.tok == zx_cdm_GEO_ELEM; --n, y = (struct zx_cdm_GEO_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_GEO(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_GEO_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_GEO_ELEM; --n, y = (struct zx_cdm_GEO_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_GEO(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_GEO_s* z)
{
  ...
  case -1:
    y = x->GEO;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_GEO_ELEM; y = (struct zx_cdm_GEO_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->GEO; n > 1 && y && y->gg.g.tok == zx_cdm_GEO_ELEM; --n, y = (struct zx_cdm_GEO_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_GEO(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->GEO; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_GEO_ELEM; --n, y = (struct zx_cdm_GEO_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_TITLE(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->TITLE; y && y->gg.g.tok == zx_cdm_TITLE_ELEM; ++n, y = (struct zx_cdm_TITLE_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_TITLE_s* zx_cdm_vCard_GET_TITLE(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_TITLE_s* y;
  if (!x) return 0;
  for (y = x->TITLE; n>=0 && y && y->gg.g.tok == zx_cdm_TITLE_ELEM; --n, y = (struct zx_cdm_TITLE_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_TITLE(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_TITLE_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_TITLE_ELEM; --n, y = (struct zx_cdm_TITLE_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_TITLE(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_TITLE_s* z)
{
  ...
  case -1:
    y = x->TITLE;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_TITLE_ELEM; y = (struct zx_cdm_TITLE_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->TITLE; n > 1 && y && y->gg.g.tok == zx_cdm_TITLE_ELEM; --n, y = (struct zx_cdm_TITLE_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_TITLE(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->TITLE; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_TITLE_ELEM; --n, y = (struct zx_cdm_TITLE_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_ROLE(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ROLE; y && y->gg.g.tok == zx_cdm_ROLE_ELEM; ++n, y = (struct zx_cdm_ROLE_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_ROLE_s* zx_cdm_vCard_GET_ROLE(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_ROLE_s* y;
  if (!x) return 0;
  for (y = x->ROLE; n>=0 && y && y->gg.g.tok == zx_cdm_ROLE_ELEM; --n, y = (struct zx_cdm_ROLE_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_ROLE(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_ROLE_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_ROLE_ELEM; --n, y = (struct zx_cdm_ROLE_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_ROLE(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_ROLE_s* z)
{
  ...
  case -1:
    y = x->ROLE;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_ROLE_ELEM; y = (struct zx_cdm_ROLE_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->ROLE; n > 1 && y && y->gg.g.tok == zx_cdm_ROLE_ELEM; --n, y = (struct zx_cdm_ROLE_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_ROLE(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ROLE; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_ROLE_ELEM; --n, y = (struct zx_cdm_ROLE_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_LOGO(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->LOGO; y && y->gg.g.tok == zx_cdm_LOGO_ELEM; ++n, y = (struct zx_cdm_LOGO_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_LOGO_s* zx_cdm_vCard_GET_LOGO(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_LOGO_s* y;
  if (!x) return 0;
  for (y = x->LOGO; n>=0 && y && y->gg.g.tok == zx_cdm_LOGO_ELEM; --n, y = (struct zx_cdm_LOGO_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_LOGO(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_LOGO_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LOGO_ELEM; --n, y = (struct zx_cdm_LOGO_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_LOGO(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_LOGO_s* z)
{
  ...
  case -1:
    y = x->LOGO;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LOGO_ELEM; y = (struct zx_cdm_LOGO_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->LOGO; n > 1 && y && y->gg.g.tok == zx_cdm_LOGO_ELEM; --n, y = (struct zx_cdm_LOGO_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_LOGO(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->LOGO; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_LOGO_ELEM; --n, y = (struct zx_cdm_LOGO_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_AGENT(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AGENT; y && y->gg.g.tok == zx_cdm_AGENT_ELEM; ++n, y = (struct zx_cdm_AGENT_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_AGENT_s* zx_cdm_vCard_GET_AGENT(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_AGENT_s* y;
  if (!x) return 0;
  for (y = x->AGENT; n>=0 && y && y->gg.g.tok == zx_cdm_AGENT_ELEM; --n, y = (struct zx_cdm_AGENT_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_AGENT(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_AGENT_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_AGENT_ELEM; --n, y = (struct zx_cdm_AGENT_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_AGENT(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_AGENT_s* z)
{
  ...
  case -1:
    y = x->AGENT;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_AGENT_ELEM; y = (struct zx_cdm_AGENT_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->AGENT; n > 1 && y && y->gg.g.tok == zx_cdm_AGENT_ELEM; --n, y = (struct zx_cdm_AGENT_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_AGENT(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AGENT; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_AGENT_ELEM; --n, y = (struct zx_cdm_AGENT_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_ORG(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ORG; y && y->gg.g.tok == zx_cdm_ORG_ELEM; ++n, y = (struct zx_cdm_ORG_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_ORG_s* zx_cdm_vCard_GET_ORG(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_ORG_s* y;
  if (!x) return 0;
  for (y = x->ORG; n>=0 && y && y->gg.g.tok == zx_cdm_ORG_ELEM; --n, y = (struct zx_cdm_ORG_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_ORG(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_ORG_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_ORG_ELEM; --n, y = (struct zx_cdm_ORG_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_ORG(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_ORG_s* z)
{
  ...
  case -1:
    y = x->ORG;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_ORG_ELEM; y = (struct zx_cdm_ORG_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->ORG; n > 1 && y && y->gg.g.tok == zx_cdm_ORG_ELEM; --n, y = (struct zx_cdm_ORG_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_ORG(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ORG; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_ORG_ELEM; --n, y = (struct zx_cdm_ORG_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_CATEGORIES(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->CATEGORIES; y && y->gg.g.tok == zx_cdm_CATEGORIES_ELEM; ++n, y = (struct zx_cdm_CATEGORIES_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_CATEGORIES_s* zx_cdm_vCard_GET_CATEGORIES(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_CATEGORIES_s* y;
  if (!x) return 0;
  for (y = x->CATEGORIES; n>=0 && y && y->gg.g.tok == zx_cdm_CATEGORIES_ELEM; --n, y = (struct zx_cdm_CATEGORIES_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_CATEGORIES(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_CATEGORIES_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CATEGORIES_ELEM; --n, y = (struct zx_cdm_CATEGORIES_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_CATEGORIES(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_CATEGORIES_s* z)
{
  ...
  case -1:
    y = x->CATEGORIES;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CATEGORIES_ELEM; y = (struct zx_cdm_CATEGORIES_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->CATEGORIES; n > 1 && y && y->gg.g.tok == zx_cdm_CATEGORIES_ELEM; --n, y = (struct zx_cdm_CATEGORIES_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_CATEGORIES(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CATEGORIES; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CATEGORIES_ELEM; --n, y = (struct zx_cdm_CATEGORIES_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_NOTE(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->NOTE; y && y->gg.g.tok == zx_cdm_NOTE_ELEM; ++n, y = (struct zx_cdm_NOTE_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_NOTE_s* zx_cdm_vCard_GET_NOTE(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_NOTE_s* y;
  if (!x) return 0;
  for (y = x->NOTE; n>=0 && y && y->gg.g.tok == zx_cdm_NOTE_ELEM; --n, y = (struct zx_cdm_NOTE_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_NOTE(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_NOTE_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_NOTE_ELEM; --n, y = (struct zx_cdm_NOTE_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_NOTE(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_NOTE_s* z)
{
  ...
  case -1:
    y = x->NOTE;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_NOTE_ELEM; y = (struct zx_cdm_NOTE_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->NOTE; n > 1 && y && y->gg.g.tok == zx_cdm_NOTE_ELEM; --n, y = (struct zx_cdm_NOTE_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_NOTE(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->NOTE; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_NOTE_ELEM; --n, y = (struct zx_cdm_NOTE_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_PRODID(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PRODID; y && y->gg.g.tok == zx_cdm_PRODID_ELEM; ++n, y = (struct zx_cdm_PRODID_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_PRODID_s* zx_cdm_vCard_GET_PRODID(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_PRODID_s* y;
  if (!x) return 0;
  for (y = x->PRODID; n>=0 && y && y->gg.g.tok == zx_cdm_PRODID_ELEM; --n, y = (struct zx_cdm_PRODID_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_PRODID(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_PRODID_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PRODID_ELEM; --n, y = (struct zx_cdm_PRODID_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_PRODID(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_PRODID_s* z)
{
  ...
  case -1:
    y = x->PRODID;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PRODID_ELEM; y = (struct zx_cdm_PRODID_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->PRODID; n > 1 && y && y->gg.g.tok == zx_cdm_PRODID_ELEM; --n, y = (struct zx_cdm_PRODID_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_PRODID(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PRODID; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PRODID_ELEM; --n, y = (struct zx_cdm_PRODID_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_REV(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->REV; y && y->gg.g.tok == zx_cdm_REV_ELEM; ++n, y = (struct zx_cdm_REV_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_REV_s* zx_cdm_vCard_GET_REV(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_REV_s* y;
  if (!x) return 0;
  for (y = x->REV; n>=0 && y && y->gg.g.tok == zx_cdm_REV_ELEM; --n, y = (struct zx_cdm_REV_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_REV(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_REV_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_REV_ELEM; --n, y = (struct zx_cdm_REV_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_REV(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_REV_s* z)
{
  ...
  case -1:
    y = x->REV;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_REV_ELEM; y = (struct zx_cdm_REV_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->REV; n > 1 && y && y->gg.g.tok == zx_cdm_REV_ELEM; --n, y = (struct zx_cdm_REV_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_REV(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->REV; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_REV_ELEM; --n, y = (struct zx_cdm_REV_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_SORT_STRING(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->SORT_STRING; y && y->gg.g.tok == zx_cdm_SORT_STRING_ELEM; ++n, y = (struct zx_cdm_SORT_STRING_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_SORT_STRING_s* zx_cdm_vCard_GET_SORT_STRING(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_SORT_STRING_s* y;
  if (!x) return 0;
  for (y = x->SORT_STRING; n>=0 && y && y->gg.g.tok == zx_cdm_SORT_STRING_ELEM; --n, y = (struct zx_cdm_SORT_STRING_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_SORT_STRING(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_SORT_STRING_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_SORT_STRING_ELEM; --n, y = (struct zx_cdm_SORT_STRING_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_SORT_STRING(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_SORT_STRING_s* z)
{
  ...
  case -1:
    y = x->SORT_STRING;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_SORT_STRING_ELEM; y = (struct zx_cdm_SORT_STRING_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->SORT_STRING; n > 1 && y && y->gg.g.tok == zx_cdm_SORT_STRING_ELEM; --n, y = (struct zx_cdm_SORT_STRING_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_SORT_STRING(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SORT_STRING; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_SORT_STRING_ELEM; --n, y = (struct zx_cdm_SORT_STRING_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_SOUND(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->SOUND; y && y->gg.g.tok == zx_cdm_SOUND_ELEM; ++n, y = (struct zx_cdm_SOUND_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_SOUND_s* zx_cdm_vCard_GET_SOUND(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_SOUND_s* y;
  if (!x) return 0;
  for (y = x->SOUND; n>=0 && y && y->gg.g.tok == zx_cdm_SOUND_ELEM; --n, y = (struct zx_cdm_SOUND_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_SOUND(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_SOUND_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_SOUND_ELEM; --n, y = (struct zx_cdm_SOUND_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_SOUND(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_SOUND_s* z)
{
  ...
  case -1:
    y = x->SOUND;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_SOUND_ELEM; y = (struct zx_cdm_SOUND_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->SOUND; n > 1 && y && y->gg.g.tok == zx_cdm_SOUND_ELEM; --n, y = (struct zx_cdm_SOUND_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_SOUND(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SOUND; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_SOUND_ELEM; --n, y = (struct zx_cdm_SOUND_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_UID(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->UID; y && y->gg.g.tok == zx_cdm_UID_ELEM; ++n, y = (struct zx_cdm_UID_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_UID_s* zx_cdm_vCard_GET_UID(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_UID_s* y;
  if (!x) return 0;
  for (y = x->UID; n>=0 && y && y->gg.g.tok == zx_cdm_UID_ELEM; --n, y = (struct zx_cdm_UID_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_UID(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_UID_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_UID_ELEM; --n, y = (struct zx_cdm_UID_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_UID(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_UID_s* z)
{
  ...
  case -1:
    y = x->UID;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_UID_ELEM; y = (struct zx_cdm_UID_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->UID; n > 1 && y && y->gg.g.tok == zx_cdm_UID_ELEM; --n, y = (struct zx_cdm_UID_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_UID(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->UID; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_UID_ELEM; --n, y = (struct zx_cdm_UID_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_URL(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->URL; y && y->gg.g.tok == zx_cdm_URL_ELEM; ++n, y = (struct zx_cdm_URL_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_URL_s* zx_cdm_vCard_GET_URL(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_URL_s* y;
  if (!x) return 0;
  for (y = x->URL; n>=0 && y && y->gg.g.tok == zx_cdm_URL_ELEM; --n, y = (struct zx_cdm_URL_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_URL(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_URL_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_URL_ELEM; --n, y = (struct zx_cdm_URL_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_URL(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_URL_s* z)
{
  ...
  case -1:
    y = x->URL;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_URL_ELEM; y = (struct zx_cdm_URL_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->URL; n > 1 && y && y->gg.g.tok == zx_cdm_URL_ELEM; --n, y = (struct zx_cdm_URL_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_URL(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->URL; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_URL_ELEM; --n, y = (struct zx_cdm_URL_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_CLASS(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->CLASS; y && y->gg.g.tok == zx_cdm_CLASS_ELEM; ++n, y = (struct zx_cdm_CLASS_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_CLASS_s* zx_cdm_vCard_GET_CLASS(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_CLASS_s* y;
  if (!x) return 0;
  for (y = x->CLASS; n>=0 && y && y->gg.g.tok == zx_cdm_CLASS_ELEM; --n, y = (struct zx_cdm_CLASS_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_CLASS(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_CLASS_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CLASS_ELEM; --n, y = (struct zx_cdm_CLASS_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_CLASS(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_CLASS_s* z)
{
  ...
  case -1:
    y = x->CLASS;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CLASS_ELEM; y = (struct zx_cdm_CLASS_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->CLASS; n > 1 && y && y->gg.g.tok == zx_cdm_CLASS_ELEM; --n, y = (struct zx_cdm_CLASS_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_CLASS(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CLASS; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CLASS_ELEM; --n, y = (struct zx_cdm_CLASS_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_KEY(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->KEY; y && y->gg.g.tok == zx_cdm_KEY_ELEM; ++n, y = (struct zx_cdm_KEY_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_KEY_s* zx_cdm_vCard_GET_KEY(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_KEY_s* y;
  if (!x) return 0;
  for (y = x->KEY; n>=0 && y && y->gg.g.tok == zx_cdm_KEY_ELEM; --n, y = (struct zx_cdm_KEY_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_KEY(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_KEY_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_KEY_ELEM; --n, y = (struct zx_cdm_KEY_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_KEY(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_KEY_s* z)
{
  ...
  case -1:
    y = x->KEY;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_KEY_ELEM; y = (struct zx_cdm_KEY_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->KEY; n > 1 && y && y->gg.g.tok == zx_cdm_KEY_ELEM; --n, y = (struct zx_cdm_KEY_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_KEY(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->KEY; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_KEY_ELEM; --n, y = (struct zx_cdm_KEY_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_DESC(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->DESC; y && y->gg.g.tok == zx_cdm_DESC_ELEM; ++n, y = (struct zx_cdm_DESC_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_DESC_s* zx_cdm_vCard_GET_DESC(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_DESC_s* y;
  if (!x) return 0;
  for (y = x->DESC; n>=0 && y && y->gg.g.tok == zx_cdm_DESC_ELEM; --n, y = (struct zx_cdm_DESC_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_DESC(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_DESC_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_DESC_ELEM; --n, y = (struct zx_cdm_DESC_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_DESC(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_DESC_s* z)
{
  ...
  case -1:
    y = x->DESC;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_DESC_ELEM; y = (struct zx_cdm_DESC_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->DESC; n > 1 && y && y->gg.g.tok == zx_cdm_DESC_ELEM; --n, y = (struct zx_cdm_DESC_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_DESC(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->DESC; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_DESC_ELEM; --n, y = (struct zx_cdm_DESC_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_PHYSICALACCESS(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->PHYSICALACCESS; y && y->gg.g.tok == zx_cdm_PHYSICALACCESS_ELEM; ++n, y = (struct zx_cdm_PHYSICALACCESS_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_PHYSICALACCESS_s* zx_cdm_vCard_GET_PHYSICALACCESS(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_PHYSICALACCESS_s* y;
  if (!x) return 0;
  for (y = x->PHYSICALACCESS; n>=0 && y && y->gg.g.tok == zx_cdm_PHYSICALACCESS_ELEM; --n, y = (struct zx_cdm_PHYSICALACCESS_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_PHYSICALACCESS(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_PHYSICALACCESS_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PHYSICALACCESS_ELEM; --n, y = (struct zx_cdm_PHYSICALACCESS_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_PHYSICALACCESS(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_PHYSICALACCESS_s* z)
{
  ...
  case -1:
    y = x->PHYSICALACCESS;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PHYSICALACCESS_ELEM; y = (struct zx_cdm_PHYSICALACCESS_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->PHYSICALACCESS; n > 1 && y && y->gg.g.tok == zx_cdm_PHYSICALACCESS_ELEM; --n, y = (struct zx_cdm_PHYSICALACCESS_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_PHYSICALACCESS(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->PHYSICALACCESS; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_PHYSICALACCESS_ELEM; --n, y = (struct zx_cdm_PHYSICALACCESS_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_CALURI(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->CALURI; y && y->gg.g.tok == zx_cdm_CALURI_ELEM; ++n, y = (struct zx_cdm_CALURI_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_CALURI_s* zx_cdm_vCard_GET_CALURI(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_CALURI_s* y;
  if (!x) return 0;
  for (y = x->CALURI; n>=0 && y && y->gg.g.tok == zx_cdm_CALURI_ELEM; --n, y = (struct zx_cdm_CALURI_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_CALURI(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_CALURI_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CALURI_ELEM; --n, y = (struct zx_cdm_CALURI_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_CALURI(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_CALURI_s* z)
{
  ...
  case -1:
    y = x->CALURI;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CALURI_ELEM; y = (struct zx_cdm_CALURI_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->CALURI; n > 1 && y && y->gg.g.tok == zx_cdm_CALURI_ELEM; --n, y = (struct zx_cdm_CALURI_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_CALURI(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CALURI; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CALURI_ELEM; --n, y = (struct zx_cdm_CALURI_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_CAPURI(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->CAPURI; y && y->gg.g.tok == zx_cdm_CAPURI_ELEM; ++n, y = (struct zx_cdm_CAPURI_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_CAPURI_s* zx_cdm_vCard_GET_CAPURI(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_CAPURI_s* y;
  if (!x) return 0;
  for (y = x->CAPURI; n>=0 && y && y->gg.g.tok == zx_cdm_CAPURI_ELEM; --n, y = (struct zx_cdm_CAPURI_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_CAPURI(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_CAPURI_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CAPURI_ELEM; --n, y = (struct zx_cdm_CAPURI_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_CAPURI(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_CAPURI_s* z)
{
  ...
  case -1:
    y = x->CAPURI;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CAPURI_ELEM; y = (struct zx_cdm_CAPURI_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->CAPURI; n > 1 && y && y->gg.g.tok == zx_cdm_CAPURI_ELEM; --n, y = (struct zx_cdm_CAPURI_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_CAPURI(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CAPURI; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CAPURI_ELEM; --n, y = (struct zx_cdm_CAPURI_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_CALADRURI(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->CALADRURI; y && y->gg.g.tok == zx_cdm_CALADRURI_ELEM; ++n, y = (struct zx_cdm_CALADRURI_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_CALADRURI_s* zx_cdm_vCard_GET_CALADRURI(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_CALADRURI_s* y;
  if (!x) return 0;
  for (y = x->CALADRURI; n>=0 && y && y->gg.g.tok == zx_cdm_CALADRURI_ELEM; --n, y = (struct zx_cdm_CALADRURI_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_CALADRURI(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_CALADRURI_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CALADRURI_ELEM; --n, y = (struct zx_cdm_CALADRURI_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_CALADRURI(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_CALADRURI_s* z)
{
  ...
  case -1:
    y = x->CALADRURI;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CALADRURI_ELEM; y = (struct zx_cdm_CALADRURI_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->CALADRURI; n > 1 && y && y->gg.g.tok == zx_cdm_CALADRURI_ELEM; --n, y = (struct zx_cdm_CALADRURI_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_CALADRURI(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->CALADRURI; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_CALADRURI_ELEM; --n, y = (struct zx_cdm_CALADRURI_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_cdm_vCard_NUM_FBURL(struct zx_cdm_vCard_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->FBURL; y && y->gg.g.tok == zx_cdm_FBURL_ELEM; ++n, y = (struct zx_cdm_FBURL_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_cdm_FBURL_s* zx_cdm_vCard_GET_FBURL(struct zx_cdm_vCard_s* x, int n)
{
  struct zx_cdm_FBURL_s* y;
  if (!x) return 0;
  for (y = x->FBURL; n>=0 && y && y->gg.g.tok == zx_cdm_FBURL_ELEM; --n, y = (struct zx_cdm_FBURL_s*)y->gg.g.n) ;
  return y;
}
...
void zx_cdm_vCard_PUT_FBURL(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_FBURL_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_FBURL_ELEM; --n, y = (struct zx_cdm_FBURL_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_cdm_vCard_ADD_FBURL(struct zx_cdm_vCard_s* x, int n, struct zx_cdm_FBURL_s* z)
{
  ...
  case -1:
    y = x->FBURL;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_FBURL_ELEM; y = (struct zx_cdm_FBURL_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->FBURL; n > 1 && y && y->gg.g.tok == zx_cdm_FBURL_ELEM; --n, y = (struct zx_cdm_FBURL_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_cdm_vCard_DEL_FBURL(struct zx_cdm_vCard_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->FBURL; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_cdm_FBURL_ELEM; --n, y = (struct zx_cdm_FBURL_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
