/* c/zx-im-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
struct zx_attr_s* zx_im_MappingInput_GET_reqID(struct zx_im_MappingInput_s* x) { return x->reqID; }
/* FUNC(zx_im_MappingInput_PUT_reqID) */
void zx_im_MappingInput_PUT_reqID(struct zx_im_MappingInput_s* x, struct zx_attr_s* y) { x->reqID = y; }
...
struct zx_attr_s* zx_im_MappingOutput_GET_reqRef(struct zx_im_MappingOutput_s* x) { return x->reqRef; }
/* FUNC(zx_im_MappingOutput_PUT_reqRef) */
void zx_im_MappingOutput_PUT_reqRef(struct zx_im_MappingOutput_s* x, struct zx_attr_s* y) { x->reqRef = y; }
