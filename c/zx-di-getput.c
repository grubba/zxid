...
int zx_di_EndpointContext_NUM_Address(struct zx_di_EndpointContext_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Address; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_di_EndpointContext_GET_Address(struct zx_di_EndpointContext_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->Address; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_di_EndpointContext_ADD_Address(struct zx_di_EndpointContext_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Address; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_di_EndpointContext_DEL_Address(struct zx_di_EndpointContext_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Address; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_di_EndpointContext_NUM_Action(struct zx_di_EndpointContext_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Action; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_di_EndpointContext_GET_Action(struct zx_di_EndpointContext_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->Action; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_di_EndpointContext_ADD_Action(struct zx_di_EndpointContext_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Action; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_di_EndpointContext_DEL_Action(struct zx_di_EndpointContext_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Action; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_di_RequestedService_NUM_Options(struct zx_di_RequestedService_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Options; y && y->gg.g.tok == zx_di_Options_ELEM; ++n, y = (struct zx_di_Options_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_di_Options_s* zx_di_RequestedService_GET_Options(struct zx_di_RequestedService_s* x, int n)
{
  struct zx_di_Options_s* y;
  if (!x) return 0;
  for (y = x->Options; n>=0 && y && y->gg.g.tok == zx_di_Options_ELEM; --n, y = (struct zx_di_Options_s*)y->gg.g.n) ;
  return y;
}
...
void zx_di_RequestedService_PUT_Options(struct zx_di_RequestedService_s* x, int n, struct zx_di_Options_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_Options_ELEM; --n, y = (struct zx_di_Options_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_di_RequestedService_ADD_Options(struct zx_di_RequestedService_s* x, int n, struct zx_di_Options_s* z)
{
  ...
  case -1:
    y = x->Options;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_Options_ELEM; y = (struct zx_di_Options_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Options; n > 1 && y && y->gg.g.tok == zx_di_Options_ELEM; --n, y = (struct zx_di_Options_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_di_RequestedService_DEL_Options(struct zx_di_RequestedService_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Options; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_Options_ELEM; --n, y = (struct zx_di_Options_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_di_RequestedService_NUM_Framework(struct zx_di_RequestedService_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Framework; y && y->gg.g.tok == zx_di_Framework_ELEM; ++n, y = (struct zx_di_Framework_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_di_Framework_s* zx_di_RequestedService_GET_Framework(struct zx_di_RequestedService_s* x, int n)
{
  struct zx_di_Framework_s* y;
  if (!x) return 0;
  for (y = x->Framework; n>=0 && y && y->gg.g.tok == zx_di_Framework_ELEM; --n, y = (struct zx_di_Framework_s*)y->gg.g.n) ;
  return y;
}
...
void zx_di_RequestedService_PUT_Framework(struct zx_di_RequestedService_s* x, int n, struct zx_di_Framework_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_Framework_ELEM; --n, y = (struct zx_di_Framework_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_di_RequestedService_ADD_Framework(struct zx_di_RequestedService_s* x, int n, struct zx_di_Framework_s* z)
{
  ...
  case -1:
    y = x->Framework;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_Framework_ELEM; y = (struct zx_di_Framework_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Framework; n > 1 && y && y->gg.g.tok == zx_di_Framework_ELEM; --n, y = (struct zx_di_Framework_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_di_RequestedService_DEL_Framework(struct zx_di_RequestedService_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Framework; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_Framework_ELEM; --n, y = (struct zx_di_Framework_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_di_ServiceContext_NUM_EndpointContext(struct zx_di_ServiceContext_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->EndpointContext; y && y->gg.g.tok == zx_di_EndpointContext_ELEM; ++n, y = (struct zx_di_EndpointContext_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_di_EndpointContext_s* zx_di_ServiceContext_GET_EndpointContext(struct zx_di_ServiceContext_s* x, int n)
{
  struct zx_di_EndpointContext_s* y;
  if (!x) return 0;
  for (y = x->EndpointContext; n>=0 && y && y->gg.g.tok == zx_di_EndpointContext_ELEM; --n, y = (struct zx_di_EndpointContext_s*)y->gg.g.n) ;
  return y;
}
...
void zx_di_ServiceContext_PUT_EndpointContext(struct zx_di_ServiceContext_s* x, int n, struct zx_di_EndpointContext_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_EndpointContext_ELEM; --n, y = (struct zx_di_EndpointContext_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_di_ServiceContext_ADD_EndpointContext(struct zx_di_ServiceContext_s* x, int n, struct zx_di_EndpointContext_s* z)
{
  ...
  case -1:
    y = x->EndpointContext;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_EndpointContext_ELEM; y = (struct zx_di_EndpointContext_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->EndpointContext; n > 1 && y && y->gg.g.tok == zx_di_EndpointContext_ELEM; --n, y = (struct zx_di_EndpointContext_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_di_ServiceContext_DEL_EndpointContext(struct zx_di_ServiceContext_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->EndpointContext; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_EndpointContext_ELEM; --n, y = (struct zx_di_EndpointContext_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_di_SvcMD_NUM_ServiceContext(struct zx_di_SvcMD_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->ServiceContext; y && y->gg.g.tok == zx_di_ServiceContext_ELEM; ++n, y = (struct zx_di_ServiceContext_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_di_ServiceContext_s* zx_di_SvcMD_GET_ServiceContext(struct zx_di_SvcMD_s* x, int n)
{
  struct zx_di_ServiceContext_s* y;
  if (!x) return 0;
  for (y = x->ServiceContext; n>=0 && y && y->gg.g.tok == zx_di_ServiceContext_ELEM; --n, y = (struct zx_di_ServiceContext_s*)y->gg.g.n) ;
  return y;
}
...
void zx_di_SvcMD_PUT_ServiceContext(struct zx_di_SvcMD_s* x, int n, struct zx_di_ServiceContext_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_ServiceContext_ELEM; --n, y = (struct zx_di_ServiceContext_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_di_SvcMD_ADD_ServiceContext(struct zx_di_SvcMD_s* x, int n, struct zx_di_ServiceContext_s* z)
{
  ...
  case -1:
    y = x->ServiceContext;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_ServiceContext_ELEM; y = (struct zx_di_ServiceContext_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->ServiceContext; n > 1 && y && y->gg.g.tok == zx_di_ServiceContext_ELEM; --n, y = (struct zx_di_ServiceContext_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_di_SvcMD_DEL_ServiceContext(struct zx_di_SvcMD_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->ServiceContext; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_ServiceContext_ELEM; --n, y = (struct zx_di_ServiceContext_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_di_SvcMDAssociationAdd_NUM_SvcMDID(struct zx_di_SvcMDAssociationAdd_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->SvcMDID; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_di_SvcMDAssociationAdd_GET_SvcMDID(struct zx_di_SvcMDAssociationAdd_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->SvcMDID; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_di_SvcMDAssociationAdd_ADD_SvcMDID(struct zx_di_SvcMDAssociationAdd_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SvcMDID; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_di_SvcMDAssociationAdd_DEL_SvcMDID(struct zx_di_SvcMDAssociationAdd_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SvcMDID; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_di_SvcMDQueryResponse_NUM_SvcMD(struct zx_di_SvcMDQueryResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->SvcMD; y && y->gg.g.tok == zx_di_SvcMD_ELEM; ++n, y = (struct zx_di_SvcMD_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_di_SvcMD_s* zx_di_SvcMDQueryResponse_GET_SvcMD(struct zx_di_SvcMDQueryResponse_s* x, int n)
{
  struct zx_di_SvcMD_s* y;
  if (!x) return 0;
  for (y = x->SvcMD; n>=0 && y && y->gg.g.tok == zx_di_SvcMD_ELEM; --n, y = (struct zx_di_SvcMD_s*)y->gg.g.n) ;
  return y;
}
...
void zx_di_SvcMDQueryResponse_PUT_SvcMD(struct zx_di_SvcMDQueryResponse_s* x, int n, struct zx_di_SvcMD_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_SvcMD_ELEM; --n, y = (struct zx_di_SvcMD_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_di_SvcMDQueryResponse_ADD_SvcMD(struct zx_di_SvcMDQueryResponse_s* x, int n, struct zx_di_SvcMD_s* z)
{
  ...
  case -1:
    y = x->SvcMD;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_SvcMD_ELEM; y = (struct zx_di_SvcMD_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->SvcMD; n > 1 && y && y->gg.g.tok == zx_di_SvcMD_ELEM; --n, y = (struct zx_di_SvcMD_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_di_SvcMDQueryResponse_DEL_SvcMD(struct zx_di_SvcMDQueryResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SvcMD; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_SvcMD_ELEM; --n, y = (struct zx_di_SvcMD_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_di_SvcMDRegisterResponse_NUM_Keys(struct zx_di_SvcMDRegisterResponse_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Keys; y && y->gg.g.tok == zx_di_Keys_ELEM; ++n, y = (struct zx_di_Keys_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_di_Keys_s* zx_di_SvcMDRegisterResponse_GET_Keys(struct zx_di_SvcMDRegisterResponse_s* x, int n)
{
  struct zx_di_Keys_s* y;
  if (!x) return 0;
  for (y = x->Keys; n>=0 && y && y->gg.g.tok == zx_di_Keys_ELEM; --n, y = (struct zx_di_Keys_s*)y->gg.g.n) ;
  return y;
}
...
void zx_di_SvcMDRegisterResponse_PUT_Keys(struct zx_di_SvcMDRegisterResponse_s* x, int n, struct zx_di_Keys_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_Keys_ELEM; --n, y = (struct zx_di_Keys_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_di_SvcMDRegisterResponse_ADD_Keys(struct zx_di_SvcMDRegisterResponse_s* x, int n, struct zx_di_Keys_s* z)
{
  ...
  case -1:
    y = x->Keys;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_Keys_ELEM; y = (struct zx_di_Keys_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->Keys; n > 1 && y && y->gg.g.tok == zx_di_Keys_ELEM; --n, y = (struct zx_di_Keys_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_di_SvcMDRegisterResponse_DEL_Keys(struct zx_di_SvcMDRegisterResponse_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Keys; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_di_Keys_ELEM; --n, y = (struct zx_di_Keys_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
