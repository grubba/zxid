...
int zx_LEN_SO_sa11_Action(struct zx_ctx* c, struct zx_sa11_Action_s* x )
{
  ...
  len += zx_len_xmlns_if_not_seen(c, zx_ns_tab+zx_sa11_NS, &pop_seen);
...
char* zx_ENC_SO_sa11_Action(struct zx_ctx* c, struct zx_sa11_Action_s* x, char* p )
{
  ...
  zx_add_xmlns_if_not_seen(c, zx_ns_tab+zx_sa11_NS, &pop_seen);
...
int zx_LEN_SO_sa11_Advice(struct zx_ctx* c, struct zx_sa11_Advice_s* x )
{
  ...
  for (se = x->AssertionIDReference; se; se = (struct zx_elem_s*)se->g.n)
    len += zx_LEN_SO_simple_elem(c,se, sizeof("sa11:AssertionIDReference")-1, zx_ns_tab+zx_sa11_NS);
...
char* zx_ENC_SO_sa11_Advice(struct zx_ctx* c, struct zx_sa11_Advice_s* x, char* p )
{
  ...
  for (se = x->AssertionIDReference; se; se = (struct zx_elem_s*)se->g.n)
    p = zx_ENC_SO_simple_elem(c, se, p, "sa11:AssertionIDReference", sizeof("sa11:AssertionIDReference")-1, zx_ns_tab+zx_sa11_NS);
  for (se = &x->Assertion->gg; se; se = (struct zx_elem_s*)se->g.n)
...
int zx_LEN_SO_sa11_AudienceRestrictionCondition(struct zx_ctx* c, struct zx_sa11_AudienceRestrictionCondition_s* x )
{
  ...
  for (se = x->Audience; se; se = (struct zx_elem_s*)se->g.n)
    len += zx_LEN_SO_simple_elem(c,se, sizeof("sa11:Audience")-1, zx_ns_tab+zx_sa11_NS);
...
char* zx_ENC_SO_sa11_AudienceRestrictionCondition(struct zx_ctx* c, struct zx_sa11_AudienceRestrictionCondition_s* x, char* p )
{
  ...
  for (se = x->Audience; se; se = (struct zx_elem_s*)se->g.n)
    p = zx_ENC_SO_simple_elem(c, se, p, "sa11:Audience", sizeof("sa11:Audience")-1, zx_ns_tab+zx_sa11_NS);
...
int zx_LEN_SO_sa11_Conditions(struct zx_ctx* c, struct zx_sa11_Conditions_s* x )
{
  ...
  for (se = x->Condition; se; se = (struct zx_elem_s*)se->g.n)
    len += zx_LEN_SO_simple_elem(c,se, sizeof("sa11:Condition")-1, zx_ns_tab+zx_sa11_NS);
...
char* zx_ENC_SO_sa11_Conditions(struct zx_ctx* c, struct zx_sa11_Conditions_s* x, char* p )
{
  ...
  for (se = x->Condition; se; se = (struct zx_elem_s*)se->g.n)
    p = zx_ENC_SO_simple_elem(c, se, p, "sa11:Condition", sizeof("sa11:Condition")-1, zx_ns_tab+zx_sa11_NS);
...
int zx_LEN_SO_sa11_SubjectConfirmation(struct zx_ctx* c, struct zx_sa11_SubjectConfirmation_s* x )
{
  ...
  for (se = x->ConfirmationMethod; se; se = (struct zx_elem_s*)se->g.n)
    len += zx_LEN_SO_simple_elem(c,se, sizeof("sa11:ConfirmationMethod")-1, zx_ns_tab+zx_sa11_NS);
  for (se = x->SubjectConfirmationData; se; se = (struct zx_elem_s*)se->g.n)
    len += zx_LEN_SO_simple_elem(c,se, sizeof("sa11:SubjectConfirmationData")-1, zx_ns_tab+zx_sa11_NS);
...
char* zx_ENC_SO_sa11_SubjectConfirmation(struct zx_ctx* c, struct zx_sa11_SubjectConfirmation_s* x, char* p )
{
  ...
  for (se = x->ConfirmationMethod; se; se = (struct zx_elem_s*)se->g.n)
    p = zx_ENC_SO_simple_elem(c, se, p, "sa11:ConfirmationMethod", sizeof("sa11:ConfirmationMethod")-1, zx_ns_tab+zx_sa11_NS);
  for (se = x->SubjectConfirmationData; se; se = (struct zx_elem_s*)se->g.n)
    p = zx_ENC_SO_simple_elem(c, se, p, "sa11:SubjectConfirmationData", sizeof("sa11:SubjectConfirmationData")-1, zx_ns_tab+zx_sa11_NS);
  for (se = &x->KeyInfo->gg; se; se = (struct zx_elem_s*)se->g.n)
