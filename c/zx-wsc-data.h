/* c/zx-wsc-data.h - WARNING: This header was automatically generated. DO NOT EDIT!
 * $Id$ */
...
struct zx_wsc_DerivedKeyToken_s {
  ...
  struct zx_str* Algorithm;	/* {0,1} attribute xs:anyURI */
  struct zx_str* Id;	/* {0,1} attribute xs:ID */
};

#ifdef ZX_ENA_GETPUT
struct zx_str* zx_wsc_DerivedKeyToken_GET_Algorithm(struct zx_wsc_DerivedKeyToken_s* x);
struct zx_str* zx_wsc_DerivedKeyToken_GET_Id(struct zx_wsc_DerivedKeyToken_s* x);
...
void zx_wsc_DerivedKeyToken_PUT_Algorithm(struct zx_wsc_DerivedKeyToken_s* x, struct zx_str* y);
void zx_wsc_DerivedKeyToken_PUT_Id(struct zx_wsc_DerivedKeyToken_s* x, struct zx_str* y);
...
#ifdef ZX_ENA_GETPUT
struct zx_str* zx_wsc_SecurityContextToken_GET_Id(struct zx_wsc_SecurityContextToken_s* x);





void zx_wsc_SecurityContextToken_PUT_Id(struct zx_wsc_SecurityContextToken_s* x, struct zx_str* y);
