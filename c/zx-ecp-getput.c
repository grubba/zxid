/* c/zx-ecp-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
struct zx_attr_s* zx_ecp_RelayState_GET_actor(struct zx_ecp_RelayState_s* x) { return x->actor; }
/* FUNC(zx_ecp_RelayState_PUT_actor) */
void zx_ecp_RelayState_PUT_actor(struct zx_ecp_RelayState_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_ecp_RelayState_GET_mustUnderstand) */
struct zx_attr_s* zx_ecp_RelayState_GET_mustUnderstand(struct zx_ecp_RelayState_s* x) { return x->mustUnderstand; }
/* FUNC(zx_ecp_RelayState_PUT_mustUnderstand) */
void zx_ecp_RelayState_PUT_mustUnderstand(struct zx_ecp_RelayState_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
...
struct zx_attr_s* zx_ecp_Request_GET_IsPassive(struct zx_ecp_Request_s* x) { return x->IsPassive; }
/* FUNC(zx_ecp_Request_PUT_IsPassive) */
void zx_ecp_Request_PUT_IsPassive(struct zx_ecp_Request_s* x, struct zx_attr_s* y) { x->IsPassive = y; }
/* FUNC(zx_ecp_Request_GET_ProviderName) */
struct zx_attr_s* zx_ecp_Request_GET_ProviderName(struct zx_ecp_Request_s* x) { return x->ProviderName; }
/* FUNC(zx_ecp_Request_PUT_ProviderName) */
void zx_ecp_Request_PUT_ProviderName(struct zx_ecp_Request_s* x, struct zx_attr_s* y) { x->ProviderName = y; }
/* FUNC(zx_ecp_Request_GET_actor) */
struct zx_attr_s* zx_ecp_Request_GET_actor(struct zx_ecp_Request_s* x) { return x->actor; }
/* FUNC(zx_ecp_Request_PUT_actor) */
void zx_ecp_Request_PUT_actor(struct zx_ecp_Request_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_ecp_Request_GET_mustUnderstand) */
struct zx_attr_s* zx_ecp_Request_GET_mustUnderstand(struct zx_ecp_Request_s* x) { return x->mustUnderstand; }
/* FUNC(zx_ecp_Request_PUT_mustUnderstand) */
void zx_ecp_Request_PUT_mustUnderstand(struct zx_ecp_Request_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
...
struct zx_attr_s* zx_ecp_Response_GET_AssertionConsumerServiceURL(struct zx_ecp_Response_s* x) { return x->AssertionConsumerServiceURL; }
/* FUNC(zx_ecp_Response_PUT_AssertionConsumerServiceURL) */
void zx_ecp_Response_PUT_AssertionConsumerServiceURL(struct zx_ecp_Response_s* x, struct zx_attr_s* y) { x->AssertionConsumerServiceURL = y; }
/* FUNC(zx_ecp_Response_GET_actor) */
struct zx_attr_s* zx_ecp_Response_GET_actor(struct zx_ecp_Response_s* x) { return x->actor; }
/* FUNC(zx_ecp_Response_PUT_actor) */
void zx_ecp_Response_PUT_actor(struct zx_ecp_Response_s* x, struct zx_attr_s* y) { x->actor = y; }
/* FUNC(zx_ecp_Response_GET_mustUnderstand) */
struct zx_attr_s* zx_ecp_Response_GET_mustUnderstand(struct zx_ecp_Response_s* x) { return x->mustUnderstand; }
/* FUNC(zx_ecp_Response_PUT_mustUnderstand) */
void zx_ecp_Response_PUT_mustUnderstand(struct zx_ecp_Response_s* x, struct zx_attr_s* y) { x->mustUnderstand = y; }
