/* c/zx-wsc-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
struct zx_attr_s* zx_wsc_DerivedKeyToken_GET_Algorithm(struct zx_wsc_DerivedKeyToken_s* x) { return x->Algorithm; }
/* FUNC(zx_wsc_DerivedKeyToken_PUT_Algorithm) */
void zx_wsc_DerivedKeyToken_PUT_Algorithm(struct zx_wsc_DerivedKeyToken_s* x, struct zx_attr_s* y) { x->Algorithm = y; }
/* FUNC(zx_wsc_DerivedKeyToken_GET_Id) */
struct zx_attr_s* zx_wsc_DerivedKeyToken_GET_Id(struct zx_wsc_DerivedKeyToken_s* x) { return x->Id; }
/* FUNC(zx_wsc_DerivedKeyToken_PUT_Id) */
void zx_wsc_DerivedKeyToken_PUT_Id(struct zx_wsc_DerivedKeyToken_s* x, struct zx_attr_s* y) { x->Id = y; }
...
struct zx_attr_s* zx_wsc_SecurityContextToken_GET_Id(struct zx_wsc_SecurityContextToken_s* x) { return x->Id; }
/* FUNC(zx_wsc_SecurityContextToken_PUT_Id) */
void zx_wsc_SecurityContextToken_PUT_Id(struct zx_wsc_SecurityContextToken_s* x, struct zx_attr_s* y) { x->Id = y; }
