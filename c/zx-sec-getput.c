/* c/zx-sec-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
struct zx_attr_s* zx_sec_Token_GET_id(struct zx_sec_Token_s* x) { return x->id; }
/* FUNC(zx_sec_Token_PUT_id) */
void zx_sec_Token_PUT_id(struct zx_sec_Token_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_sec_Token_GET_ref) */
struct zx_attr_s* zx_sec_Token_GET_ref(struct zx_sec_Token_s* x) { return x->ref; }
/* FUNC(zx_sec_Token_PUT_ref) */
void zx_sec_Token_PUT_ref(struct zx_sec_Token_s* x, struct zx_attr_s* y) { x->ref = y; }
/* FUNC(zx_sec_Token_GET_usage) */
struct zx_attr_s* zx_sec_Token_GET_usage(struct zx_sec_Token_s* x) { return x->usage; }
/* FUNC(zx_sec_Token_PUT_usage) */
void zx_sec_Token_PUT_usage(struct zx_sec_Token_s* x, struct zx_attr_s* y) { x->usage = y; }
...
struct zx_attr_s* zx_sec_TokenPolicy_GET_issueTo(struct zx_sec_TokenPolicy_s* x) { return x->issueTo; }
/* FUNC(zx_sec_TokenPolicy_PUT_issueTo) */
void zx_sec_TokenPolicy_PUT_issueTo(struct zx_sec_TokenPolicy_s* x, struct zx_attr_s* y) { x->issueTo = y; }
/* FUNC(zx_sec_TokenPolicy_GET_type) */
struct zx_attr_s* zx_sec_TokenPolicy_GET_type(struct zx_sec_TokenPolicy_s* x) { return x->type; }
/* FUNC(zx_sec_TokenPolicy_PUT_type) */
void zx_sec_TokenPolicy_PUT_type(struct zx_sec_TokenPolicy_s* x, struct zx_attr_s* y) { x->type = y; }
/* FUNC(zx_sec_TokenPolicy_GET_validUntil) */
struct zx_attr_s* zx_sec_TokenPolicy_GET_validUntil(struct zx_sec_TokenPolicy_s* x) { return x->validUntil; }
/* FUNC(zx_sec_TokenPolicy_PUT_validUntil) */
void zx_sec_TokenPolicy_PUT_validUntil(struct zx_sec_TokenPolicy_s* x, struct zx_attr_s* y) { x->validUntil = y; }
/* FUNC(zx_sec_TokenPolicy_GET_wantDSEPR) */
struct zx_attr_s* zx_sec_TokenPolicy_GET_wantDSEPR(struct zx_sec_TokenPolicy_s* x) { return x->wantDSEPR; }
/* FUNC(zx_sec_TokenPolicy_PUT_wantDSEPR) */
void zx_sec_TokenPolicy_PUT_wantDSEPR(struct zx_sec_TokenPolicy_s* x, struct zx_attr_s* y) { x->wantDSEPR = y; }
...
struct zx_attr_s* zx_sec_TransitedProvider_GET_confirmationURI(struct zx_sec_TransitedProvider_s* x) { return x->confirmationURI; }
/* FUNC(zx_sec_TransitedProvider_PUT_confirmationURI) */
void zx_sec_TransitedProvider_PUT_confirmationURI(struct zx_sec_TransitedProvider_s* x, struct zx_attr_s* y) { x->confirmationURI = y; }
/* FUNC(zx_sec_TransitedProvider_GET_timeStamp) */
struct zx_attr_s* zx_sec_TransitedProvider_GET_timeStamp(struct zx_sec_TransitedProvider_s* x) { return x->timeStamp; }
/* FUNC(zx_sec_TransitedProvider_PUT_timeStamp) */
void zx_sec_TransitedProvider_PUT_timeStamp(struct zx_sec_TransitedProvider_s* x, struct zx_attr_s* y) { x->timeStamp = y; }
