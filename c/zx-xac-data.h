...
#define zx_xac_N_ELEMS 0
#if !defined(zx_xac__ELEM_MAX) && zx_xac_N_ELEMS == 0
#define zx_xac__ELEM_MAX 0
#endif
extern struct zx_el_tok zx_xac_el_tab[zx_xac__ELEM_MAX];
struct zx_el_tok* zx_xac_elem2tok(const char* name, unsigned int name_len);
