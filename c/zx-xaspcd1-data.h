/* c/zx-xaspcd1-data.h - WARNING: This header was automatically generated. DO NOT EDIT!
 * $Id$ */
...
struct zx_xaspcd1_XACMLAuthzDecisionQuery_s {
  ...
  struct zx_str* CombinePolicies;	/* {0,1} attribute boolean */
...
#ifdef ZX_ENA_GETPUT
struct zx_str* zx_xaspcd1_XACMLAuthzDecisionQuery_GET_CombinePolicies(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x);
struct zx_str* zx_xaspcd1_XACMLAuthzDecisionQuery_GET_Consent(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x);
struct zx_str* zx_xaspcd1_XACMLAuthzDecisionQuery_GET_Destination(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x);
struct zx_str* zx_xaspcd1_XACMLAuthzDecisionQuery_GET_ID(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x);
struct zx_str* zx_xaspcd1_XACMLAuthzDecisionQuery_GET_InputContextOnly(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x);
struct zx_str* zx_xaspcd1_XACMLAuthzDecisionQuery_GET_IssueInstant(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x);
struct zx_str* zx_xaspcd1_XACMLAuthzDecisionQuery_GET_ReturnContext(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x);
struct zx_str* zx_xaspcd1_XACMLAuthzDecisionQuery_GET_Version(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x);
...
void zx_xaspcd1_XACMLAuthzDecisionQuery_PUT_CombinePolicies(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x, struct zx_str* y);
void zx_xaspcd1_XACMLAuthzDecisionQuery_PUT_Consent(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x, struct zx_str* y);
void zx_xaspcd1_XACMLAuthzDecisionQuery_PUT_Destination(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x, struct zx_str* y);
void zx_xaspcd1_XACMLAuthzDecisionQuery_PUT_ID(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x, struct zx_str* y);
void zx_xaspcd1_XACMLAuthzDecisionQuery_PUT_InputContextOnly(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x, struct zx_str* y);
void zx_xaspcd1_XACMLAuthzDecisionQuery_PUT_IssueInstant(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x, struct zx_str* y);
void zx_xaspcd1_XACMLAuthzDecisionQuery_PUT_ReturnContext(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x, struct zx_str* y);
void zx_xaspcd1_XACMLAuthzDecisionQuery_PUT_Version(struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x, struct zx_str* y);
...
#ifdef ZX_ENA_GETPUT
struct zx_str* zx_xaspcd1_XACMLPolicyQuery_GET_Consent(struct zx_xaspcd1_XACMLPolicyQuery_s* x);
struct zx_str* zx_xaspcd1_XACMLPolicyQuery_GET_Destination(struct zx_xaspcd1_XACMLPolicyQuery_s* x);
struct zx_str* zx_xaspcd1_XACMLPolicyQuery_GET_ID(struct zx_xaspcd1_XACMLPolicyQuery_s* x);
struct zx_str* zx_xaspcd1_XACMLPolicyQuery_GET_IssueInstant(struct zx_xaspcd1_XACMLPolicyQuery_s* x);
struct zx_str* zx_xaspcd1_XACMLPolicyQuery_GET_Version(struct zx_xaspcd1_XACMLPolicyQuery_s* x);
...
void zx_xaspcd1_XACMLPolicyQuery_PUT_Consent(struct zx_xaspcd1_XACMLPolicyQuery_s* x, struct zx_str* y);
void zx_xaspcd1_XACMLPolicyQuery_PUT_Destination(struct zx_xaspcd1_XACMLPolicyQuery_s* x, struct zx_str* y);
void zx_xaspcd1_XACMLPolicyQuery_PUT_ID(struct zx_xaspcd1_XACMLPolicyQuery_s* x, struct zx_str* y);
void zx_xaspcd1_XACMLPolicyQuery_PUT_IssueInstant(struct zx_xaspcd1_XACMLPolicyQuery_s* x, struct zx_str* y);
void zx_xaspcd1_XACMLPolicyQuery_PUT_Version(struct zx_xaspcd1_XACMLPolicyQuery_s* x, struct zx_str* y);
