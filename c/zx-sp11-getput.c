...
int zx_sp11_AttributeQuery_NUM_AttributeDesignator(struct zx_sp11_AttributeQuery_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AttributeDesignator; y && y->gg.g.tok == zx_sa11_AttributeDesignator_ELEM; ++n, y = (struct zx_sa11_AttributeDesignator_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sa11_AttributeDesignator_s* zx_sp11_AttributeQuery_GET_AttributeDesignator(struct zx_sp11_AttributeQuery_s* x, int n)
{
  struct zx_sa11_AttributeDesignator_s* y;
  if (!x) return 0;
  for (y = x->AttributeDesignator; n>=0 && y && y->gg.g.tok == zx_sa11_AttributeDesignator_ELEM; --n, y = (struct zx_sa11_AttributeDesignator_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sp11_AttributeQuery_PUT_AttributeDesignator(struct zx_sp11_AttributeQuery_s* x, int n, struct zx_sa11_AttributeDesignator_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_AttributeDesignator_ELEM; --n, y = (struct zx_sa11_AttributeDesignator_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sp11_AttributeQuery_ADD_AttributeDesignator(struct zx_sp11_AttributeQuery_s* x, int n, struct zx_sa11_AttributeDesignator_s* z)
{
  ...
  case -1:
    y = x->AttributeDesignator;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_AttributeDesignator_ELEM; y = (struct zx_sa11_AttributeDesignator_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->AttributeDesignator; n > 1 && y && y->gg.g.tok == zx_sa11_AttributeDesignator_ELEM; --n, y = (struct zx_sa11_AttributeDesignator_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sp11_AttributeQuery_DEL_AttributeDesignator(struct zx_sp11_AttributeQuery_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AttributeDesignator; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sa11_AttributeDesignator_ELEM; --n, y = (struct zx_sa11_AttributeDesignator_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sp11_Request_NUM_Query(struct zx_sp11_Request_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->Query; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_sp11_Request_GET_Query(struct zx_sp11_Request_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->Query; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_sp11_Request_ADD_Query(struct zx_sp11_Request_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Query; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_sp11_Request_DEL_Query(struct zx_sp11_Request_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->Query; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_sp11_Request_NUM_SubjectQuery(struct zx_sp11_Request_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->SubjectQuery; y && y->gg.g.tok == zx_sp11_SubjectQuery_ELEM; ++n, y = (struct zx_sp11_SubjectQuery_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sp11_SubjectQuery_s* zx_sp11_Request_GET_SubjectQuery(struct zx_sp11_Request_s* x, int n)
{
  struct zx_sp11_SubjectQuery_s* y;
  if (!x) return 0;
  for (y = x->SubjectQuery; n>=0 && y && y->gg.g.tok == zx_sp11_SubjectQuery_ELEM; --n, y = (struct zx_sp11_SubjectQuery_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sp11_Request_PUT_SubjectQuery(struct zx_sp11_Request_s* x, int n, struct zx_sp11_SubjectQuery_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_SubjectQuery_ELEM; --n, y = (struct zx_sp11_SubjectQuery_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sp11_Request_ADD_SubjectQuery(struct zx_sp11_Request_s* x, int n, struct zx_sp11_SubjectQuery_s* z)
{
  ...
  case -1:
    y = x->SubjectQuery;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_SubjectQuery_ELEM; y = (struct zx_sp11_SubjectQuery_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->SubjectQuery; n > 1 && y && y->gg.g.tok == zx_sp11_SubjectQuery_ELEM; --n, y = (struct zx_sp11_SubjectQuery_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sp11_Request_DEL_SubjectQuery(struct zx_sp11_Request_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->SubjectQuery; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_SubjectQuery_ELEM; --n, y = (struct zx_sp11_SubjectQuery_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sp11_Request_NUM_AuthenticationQuery(struct zx_sp11_Request_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AuthenticationQuery; y && y->gg.g.tok == zx_sp11_AuthenticationQuery_ELEM; ++n, y = (struct zx_sp11_AuthenticationQuery_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sp11_AuthenticationQuery_s* zx_sp11_Request_GET_AuthenticationQuery(struct zx_sp11_Request_s* x, int n)
{
  struct zx_sp11_AuthenticationQuery_s* y;
  if (!x) return 0;
  for (y = x->AuthenticationQuery; n>=0 && y && y->gg.g.tok == zx_sp11_AuthenticationQuery_ELEM; --n, y = (struct zx_sp11_AuthenticationQuery_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sp11_Request_PUT_AuthenticationQuery(struct zx_sp11_Request_s* x, int n, struct zx_sp11_AuthenticationQuery_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_AuthenticationQuery_ELEM; --n, y = (struct zx_sp11_AuthenticationQuery_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sp11_Request_ADD_AuthenticationQuery(struct zx_sp11_Request_s* x, int n, struct zx_sp11_AuthenticationQuery_s* z)
{
  ...
  case -1:
    y = x->AuthenticationQuery;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_AuthenticationQuery_ELEM; y = (struct zx_sp11_AuthenticationQuery_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->AuthenticationQuery; n > 1 && y && y->gg.g.tok == zx_sp11_AuthenticationQuery_ELEM; --n, y = (struct zx_sp11_AuthenticationQuery_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sp11_Request_DEL_AuthenticationQuery(struct zx_sp11_Request_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AuthenticationQuery; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_AuthenticationQuery_ELEM; --n, y = (struct zx_sp11_AuthenticationQuery_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sp11_Request_NUM_AttributeQuery(struct zx_sp11_Request_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AttributeQuery; y && y->gg.g.tok == zx_sp11_AttributeQuery_ELEM; ++n, y = (struct zx_sp11_AttributeQuery_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sp11_AttributeQuery_s* zx_sp11_Request_GET_AttributeQuery(struct zx_sp11_Request_s* x, int n)
{
  struct zx_sp11_AttributeQuery_s* y;
  if (!x) return 0;
  for (y = x->AttributeQuery; n>=0 && y && y->gg.g.tok == zx_sp11_AttributeQuery_ELEM; --n, y = (struct zx_sp11_AttributeQuery_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sp11_Request_PUT_AttributeQuery(struct zx_sp11_Request_s* x, int n, struct zx_sp11_AttributeQuery_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_AttributeQuery_ELEM; --n, y = (struct zx_sp11_AttributeQuery_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sp11_Request_ADD_AttributeQuery(struct zx_sp11_Request_s* x, int n, struct zx_sp11_AttributeQuery_s* z)
{
  ...
  case -1:
    y = x->AttributeQuery;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_AttributeQuery_ELEM; y = (struct zx_sp11_AttributeQuery_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->AttributeQuery; n > 1 && y && y->gg.g.tok == zx_sp11_AttributeQuery_ELEM; --n, y = (struct zx_sp11_AttributeQuery_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sp11_Request_DEL_AttributeQuery(struct zx_sp11_Request_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AttributeQuery; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_AttributeQuery_ELEM; --n, y = (struct zx_sp11_AttributeQuery_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sp11_Request_NUM_AuthorizationDecisionQuery(struct zx_sp11_Request_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AuthorizationDecisionQuery; y && y->gg.g.tok == zx_sp11_AuthorizationDecisionQuery_ELEM; ++n, y = (struct zx_sp11_AuthorizationDecisionQuery_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sp11_AuthorizationDecisionQuery_s* zx_sp11_Request_GET_AuthorizationDecisionQuery(struct zx_sp11_Request_s* x, int n)
{
  struct zx_sp11_AuthorizationDecisionQuery_s* y;
  if (!x) return 0;
  for (y = x->AuthorizationDecisionQuery; n>=0 && y && y->gg.g.tok == zx_sp11_AuthorizationDecisionQuery_ELEM; --n, y = (struct zx_sp11_AuthorizationDecisionQuery_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sp11_Request_PUT_AuthorizationDecisionQuery(struct zx_sp11_Request_s* x, int n, struct zx_sp11_AuthorizationDecisionQuery_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_AuthorizationDecisionQuery_ELEM; --n, y = (struct zx_sp11_AuthorizationDecisionQuery_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sp11_Request_ADD_AuthorizationDecisionQuery(struct zx_sp11_Request_s* x, int n, struct zx_sp11_AuthorizationDecisionQuery_s* z)
{
  ...
  case -1:
    y = x->AuthorizationDecisionQuery;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_AuthorizationDecisionQuery_ELEM; y = (struct zx_sp11_AuthorizationDecisionQuery_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->AuthorizationDecisionQuery; n > 1 && y && y->gg.g.tok == zx_sp11_AuthorizationDecisionQuery_ELEM; --n, y = (struct zx_sp11_AuthorizationDecisionQuery_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sp11_Request_DEL_AuthorizationDecisionQuery(struct zx_sp11_Request_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AuthorizationDecisionQuery; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_AuthorizationDecisionQuery_ELEM; --n, y = (struct zx_sp11_AuthorizationDecisionQuery_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sp11_Request_NUM_AssertionArtifact(struct zx_sp11_Request_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AssertionArtifact; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}
...
struct zx_elem_s* zx_sp11_Request_GET_AssertionArtifact(struct zx_sp11_Request_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->AssertionArtifact; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}
...
void zx_sp11_Request_ADD_AssertionArtifact(struct zx_sp11_Request_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AssertionArtifact; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
void zx_sp11_Request_DEL_AssertionArtifact(struct zx_sp11_Request_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AssertionArtifact; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
int zx_sp11_Status_NUM_StatusCode(struct zx_sp11_Status_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->StatusCode; y && y->gg.g.tok == zx_sp11_StatusCode_ELEM; ++n, y = (struct zx_sp11_StatusCode_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sp11_StatusCode_s* zx_sp11_Status_GET_StatusCode(struct zx_sp11_Status_s* x, int n)
{
  struct zx_sp11_StatusCode_s* y;
  if (!x) return 0;
  for (y = x->StatusCode; n>=0 && y && y->gg.g.tok == zx_sp11_StatusCode_ELEM; --n, y = (struct zx_sp11_StatusCode_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sp11_Status_PUT_StatusCode(struct zx_sp11_Status_s* x, int n, struct zx_sp11_StatusCode_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_StatusCode_ELEM; --n, y = (struct zx_sp11_StatusCode_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sp11_Status_ADD_StatusCode(struct zx_sp11_Status_s* x, int n, struct zx_sp11_StatusCode_s* z)
{
  ...
  case -1:
    y = x->StatusCode;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_StatusCode_ELEM; y = (struct zx_sp11_StatusCode_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->StatusCode; n > 1 && y && y->gg.g.tok == zx_sp11_StatusCode_ELEM; --n, y = (struct zx_sp11_StatusCode_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sp11_Status_DEL_StatusCode(struct zx_sp11_Status_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->StatusCode; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_StatusCode_ELEM; --n, y = (struct zx_sp11_StatusCode_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
...
int zx_sp11_Status_NUM_StatusDetail(struct zx_sp11_Status_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->StatusDetail; y && y->gg.g.tok == zx_sp11_StatusDetail_ELEM; ++n, y = (struct zx_sp11_StatusDetail_s*)y->gg.g.n) ;
  return n;
}
...
struct zx_sp11_StatusDetail_s* zx_sp11_Status_GET_StatusDetail(struct zx_sp11_Status_s* x, int n)
{
  struct zx_sp11_StatusDetail_s* y;
  if (!x) return 0;
  for (y = x->StatusDetail; n>=0 && y && y->gg.g.tok == zx_sp11_StatusDetail_ELEM; --n, y = (struct zx_sp11_StatusDetail_s*)y->gg.g.n) ;
  return y;
}
...
void zx_sp11_Status_PUT_StatusDetail(struct zx_sp11_Status_s* x, int n, struct zx_sp11_StatusDetail_s* z)
{
  ...
  case 0:
    ...
    return;
  default:
    for (; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_StatusDetail_ELEM; --n, y = (struct zx_sp11_StatusDetail_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
    z->gg.g.n = y->gg.g.n->n;
    y->gg.g.n = &z->gg.g;
  }
...
void zx_sp11_Status_ADD_StatusDetail(struct zx_sp11_Status_s* x, int n, struct zx_sp11_StatusDetail_s* z)
{
  ...
  case -1:
    y = x->StatusDetail;
    if (!y) goto add_to_start;
    for (; y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_StatusDetail_ELEM; y = (struct zx_sp11_StatusDetail_s*)y->gg.g.n) ;
    break;
  default:
    for (y = x->StatusDetail; n > 1 && y && y->gg.g.tok == zx_sp11_StatusDetail_ELEM; --n, y = (struct zx_sp11_StatusDetail_s*)y->gg.g.n) ;
    if (!y) return;
  }
  z->gg.g.n = y->gg.g.n;
  y->gg.g.n = &z->gg.g;
...
void zx_sp11_Status_DEL_StatusDetail(struct zx_sp11_Status_s* x, int n)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->StatusDetail; n > 1 && y->gg.g.n && y->gg.g.n->gg.g.tok == zx_sp11_StatusDetail_ELEM; --n, y = (struct zx_sp11_StatusDetail_s*)y->gg.g.n) ;
    if (!y->gg.g.n) return;
  }
  y->gg.g.n = y->gg.g.n->n;
}
