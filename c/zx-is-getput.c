/* c/zx-is-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
struct zx_attr_s* zx_is_Confirm_GET_name(struct zx_is_Confirm_s* x) { return x->name; }
/* FUNC(zx_is_Confirm_PUT_name) */
void zx_is_Confirm_PUT_name(struct zx_is_Confirm_s* x, struct zx_attr_s* y) { x->name = y; }
...
struct zx_attr_s* zx_is_Help_GET_label(struct zx_is_Help_s* x) { return x->label; }
/* FUNC(zx_is_Help_PUT_label) */
void zx_is_Help_PUT_label(struct zx_is_Help_s* x, struct zx_attr_s* y) { x->label = y; }
/* FUNC(zx_is_Help_GET_link) */
struct zx_attr_s* zx_is_Help_GET_link(struct zx_is_Help_s* x) { return x->link; }
/* FUNC(zx_is_Help_PUT_link) */
void zx_is_Help_PUT_link(struct zx_is_Help_s* x, struct zx_attr_s* y) { x->link = y; }
/* FUNC(zx_is_Help_GET_moreLink) */
struct zx_attr_s* zx_is_Help_GET_moreLink(struct zx_is_Help_s* x) { return x->moreLink; }
/* FUNC(zx_is_Help_PUT_moreLink) */
void zx_is_Help_PUT_moreLink(struct zx_is_Help_s* x, struct zx_attr_s* y) { x->moreLink = y; }
...
struct zx_attr_s* zx_is_Inquiry_GET_id(struct zx_is_Inquiry_s* x) { return x->id; }
/* FUNC(zx_is_Inquiry_PUT_id) */
void zx_is_Inquiry_PUT_id(struct zx_is_Inquiry_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_is_Inquiry_GET_title) */
struct zx_attr_s* zx_is_Inquiry_GET_title(struct zx_is_Inquiry_s* x) { return x->title; }
/* FUNC(zx_is_Inquiry_PUT_title) */
void zx_is_Inquiry_PUT_title(struct zx_is_Inquiry_s* x, struct zx_attr_s* y) { x->title = y; }
...
struct zx_attr_s* zx_is_InteractionRequest_GET_id(struct zx_is_InteractionRequest_s* x) { return x->id; }
/* FUNC(zx_is_InteractionRequest_PUT_id) */
void zx_is_InteractionRequest_PUT_id(struct zx_is_InteractionRequest_s* x, struct zx_attr_s* y) { x->id = y; }
/* FUNC(zx_is_InteractionRequest_GET_language) */
struct zx_attr_s* zx_is_InteractionRequest_GET_language(struct zx_is_InteractionRequest_s* x) { return x->language; }
/* FUNC(zx_is_InteractionRequest_PUT_language) */
void zx_is_InteractionRequest_PUT_language(struct zx_is_InteractionRequest_s* x, struct zx_attr_s* y) { x->language = y; }
/* FUNC(zx_is_InteractionRequest_GET_maxInteractTime) */
struct zx_attr_s* zx_is_InteractionRequest_GET_maxInteractTime(struct zx_is_InteractionRequest_s* x) { return x->maxInteractTime; }
/* FUNC(zx_is_InteractionRequest_PUT_maxInteractTime) */
void zx_is_InteractionRequest_PUT_maxInteractTime(struct zx_is_InteractionRequest_s* x, struct zx_attr_s* y) { x->maxInteractTime = y; }
/* FUNC(zx_is_InteractionRequest_GET_signed_is_c_keyword) */
struct zx_attr_s* zx_is_InteractionRequest_GET_signed_is_c_keyword(struct zx_is_InteractionRequest_s* x) { return x->signed_is_c_keyword; }
/* FUNC(zx_is_InteractionRequest_PUT_signed_is_c_keyword) */
void zx_is_InteractionRequest_PUT_signed_is_c_keyword(struct zx_is_InteractionRequest_s* x, struct zx_attr_s* y) { x->signed_is_c_keyword = y; }
...
struct zx_attr_s* zx_is_Item_GET_label(struct zx_is_Item_s* x) { return x->label; }
/* FUNC(zx_is_Item_PUT_label) */
void zx_is_Item_PUT_label(struct zx_is_Item_s* x, struct zx_attr_s* y) { x->label = y; }
/* FUNC(zx_is_Item_GET_value) */
struct zx_attr_s* zx_is_Item_GET_value(struct zx_is_Item_s* x) { return x->value; }
/* FUNC(zx_is_Item_PUT_value) */
void zx_is_Item_PUT_value(struct zx_is_Item_s* x, struct zx_attr_s* y) { x->value = y; }
...
struct zx_attr_s* zx_is_Parameter_GET_name(struct zx_is_Parameter_s* x) { return x->name; }
/* FUNC(zx_is_Parameter_PUT_name) */
void zx_is_Parameter_PUT_name(struct zx_is_Parameter_s* x, struct zx_attr_s* y) { x->name = y; }
/* FUNC(zx_is_Parameter_GET_value) */
struct zx_attr_s* zx_is_Parameter_GET_value(struct zx_is_Parameter_s* x) { return x->value; }
/* FUNC(zx_is_Parameter_PUT_value) */
void zx_is_Parameter_PUT_value(struct zx_is_Parameter_s* x, struct zx_attr_s* y) { x->value = y; }
...
struct zx_attr_s* zx_is_Select_GET_multiple(struct zx_is_Select_s* x) { return x->multiple; }
/* FUNC(zx_is_Select_PUT_multiple) */
void zx_is_Select_PUT_multiple(struct zx_is_Select_s* x, struct zx_attr_s* y) { x->multiple = y; }
/* FUNC(zx_is_Select_GET_name) */
struct zx_attr_s* zx_is_Select_GET_name(struct zx_is_Select_s* x) { return x->name; }
/* FUNC(zx_is_Select_PUT_name) */
void zx_is_Select_PUT_name(struct zx_is_Select_s* x, struct zx_attr_s* y) { x->name = y; }
...
struct zx_attr_s* zx_is_Text_GET_format(struct zx_is_Text_s* x) { return x->format; }
/* FUNC(zx_is_Text_PUT_format) */
void zx_is_Text_PUT_format(struct zx_is_Text_s* x, struct zx_attr_s* y) { x->format = y; }
/* FUNC(zx_is_Text_GET_maxChars) */
struct zx_attr_s* zx_is_Text_GET_maxChars(struct zx_is_Text_s* x) { return x->maxChars; }
/* FUNC(zx_is_Text_PUT_maxChars) */
void zx_is_Text_PUT_maxChars(struct zx_is_Text_s* x, struct zx_attr_s* y) { x->maxChars = y; }
/* FUNC(zx_is_Text_GET_minChars) */
struct zx_attr_s* zx_is_Text_GET_minChars(struct zx_is_Text_s* x) { return x->minChars; }
/* FUNC(zx_is_Text_PUT_minChars) */
void zx_is_Text_PUT_minChars(struct zx_is_Text_s* x, struct zx_attr_s* y) { x->minChars = y; }
/* FUNC(zx_is_Text_GET_name) */
struct zx_attr_s* zx_is_Text_GET_name(struct zx_is_Text_s* x) { return x->name; }
/* FUNC(zx_is_Text_PUT_name) */
void zx_is_Text_PUT_name(struct zx_is_Text_s* x, struct zx_attr_s* y) { x->name = y; }
