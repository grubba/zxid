/* c/zx-wsu-getput.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
struct zx_attr_s* zx_wsu_Created_GET_ID(struct zx_wsu_Created_s* x) { return x->ID; }
/* FUNC(zx_wsu_Created_PUT_ID) */
void zx_wsu_Created_PUT_ID(struct zx_wsu_Created_s* x, struct zx_attr_s* y) { x->ID = y; }
/* FUNC(zx_wsu_Created_GET_id) */
struct zx_attr_s* zx_wsu_Created_GET_id(struct zx_wsu_Created_s* x) { return x->id; }
/* FUNC(zx_wsu_Created_PUT_id) */
void zx_wsu_Created_PUT_id(struct zx_wsu_Created_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_wsu_Expires_GET_ID(struct zx_wsu_Expires_s* x) { return x->ID; }
/* FUNC(zx_wsu_Expires_PUT_ID) */
void zx_wsu_Expires_PUT_ID(struct zx_wsu_Expires_s* x, struct zx_attr_s* y) { x->ID = y; }
/* FUNC(zx_wsu_Expires_GET_id) */
struct zx_attr_s* zx_wsu_Expires_GET_id(struct zx_wsu_Expires_s* x) { return x->id; }
/* FUNC(zx_wsu_Expires_PUT_id) */
void zx_wsu_Expires_PUT_id(struct zx_wsu_Expires_s* x, struct zx_attr_s* y) { x->id = y; }
...
struct zx_attr_s* zx_wsu_Timestamp_GET_ID(struct zx_wsu_Timestamp_s* x) { return x->ID; }
/* FUNC(zx_wsu_Timestamp_PUT_ID) */
void zx_wsu_Timestamp_PUT_ID(struct zx_wsu_Timestamp_s* x, struct zx_attr_s* y) { x->ID = y; }
/* FUNC(zx_wsu_Timestamp_GET_id) */
struct zx_attr_s* zx_wsu_Timestamp_GET_id(struct zx_wsu_Timestamp_s* x) { return x->id; }
/* FUNC(zx_wsu_Timestamp_PUT_id) */
void zx_wsu_Timestamp_PUT_id(struct zx_wsu_Timestamp_s* x, struct zx_attr_s* y) { x->id = y; }
