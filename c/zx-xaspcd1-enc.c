/* c/zx-xaspcd1-enc.c - WARNING: This file was auto generated by xsd2sg.pl. DO NOT EDIT!
 * $Id$ */
...
int zx_LEN_SO_xaspcd1_XACMLAuthzDecisionQuery(struct zx_ctx* c, struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x )
{
  ...
  if (1)
    len += zx_len_xmlns_if_not_seen(c, zx_ns_tab+(zx_xaspcd1_NS >> ZX_TOK_NS_SHIFT), &pop_seen);
...
char* zx_ENC_SO_xaspcd1_XACMLAuthzDecisionQuery(struct zx_ctx* c, struct zx_xaspcd1_XACMLAuthzDecisionQuery_s* x, char* p )
{
  ...
  if (1)
    zx_add_xmlns_if_not_seen(c, zx_ns_tab+(zx_xaspcd1_NS >> ZX_TOK_NS_SHIFT), &pop_seen);
