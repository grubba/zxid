...
#$path = '/var/zxid/idp';
$path = '/home/sampo/zxid/postoffice/conf/idp';

$bot = <<HTML;
<div class=zxbot>
<a class=zx href="/index.html">Top</a>
...
if ($cgi{'op'} eq 'md') {
    syswrite STDOUT, "Content-Type: text/html\r\n\r\n".<<HTML;
<title>Synergetics End2End Trust IdP CoT Mgr: MD Reg</title>
<link type="text/css" rel=stylesheet href="e2eta.css">
<h1 class=zxtop>Synergetics End2End Trust IdP Circle of Trust Manager</h1>
<img align=right src="synergetics_logo.png">

<h3>Service Provider Metadata Registration</h3>
<br clear=right>

<form method=post xaction="cot.x">
...
if ($cgi{'op'} eq 'viewcot') {
    ...
    syswrite STDOUT, "Content-Type: text/html\r\n\r\n".<<HTML;
<title>Synergetics End2End Trust IdP CoT Mgr: SP List</title>
<link type="text/css" rel=stylesheet href="e2eta.css">
<h1 class=zxtop>Synergetics End2End Trust IdP Circle of Trust Manager</h1>
<img align=right src="synergetics_logo.png">
$cgi{'msg'}
...
if ($cgi{'op'} eq 'direg') {
    syswrite STDOUT, "Content-Type: text/html\r\n\r\n".<<HTML;
<title>Synergetics End2End Trust IdP CoT Mgr: DI Reg</title>
<link type="text/css" rel=stylesheet href="e2eta.css">
<h1 class=zxtop>Synergetics End2End Trust IdP Circle of Trust Manager</h1>
<img align=right src="synergetics_logo.png">
...
if ($cgi{'op'} eq 'viewreg') {
    ...
    syswrite STDOUT, "Content-Type: text/html\r\n\r\n".<<HTML;
<title>Synargetics End2End Trust IdP CoT Mgr: SP List</title>
<link type="text/css" rel=stylesheet href="e2eta.css">
<h1 class=zxtop>Synergetics End2End Trust IdP Circle of Trust Manager</h1>
<img align=right src="synergetics_logo.png">
$cgi{'msg'}
