<?
# zxid/zxidpds.php  -  IoS Personal Data Store Id-WSF WSP using zxid PHP extension
#
...
$conf = "PATH=/var/zxid/&URL=http://my.eportfolio.eu/zxidpds.php";
$cf = zxid_new_conf_to_cf($conf);
zxid_set_opt_cstr($cf, 2, "\tzxphp");
?>
<?
zxid_set_opt_cstr($cf, 3, "pdswsp: ");
